              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchLabTestRate" method="POST" onsubmit="return showLoadingImg();">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Lab Test" name="searchTest">
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active" >Search Lab Test</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="viewAllLabTests"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Lab Test</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="retriveAllLabTests" var="groupTest">
		                        	<tr>
								
											<td><s:property value="labTest" /></td>
											
											<td><s:property value="testRate" /></td>
										
											<td align="center"><s:url id="approveURL"
												action="renderEditLabTestRate">
                    ...
                    %>
		              ...
		              <script>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="ConfigureTestRate" method="POST" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Select Test">Select Lab Test<span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <s:select list="labTests" id="labTestID" name="labTestID" class="form-control" headerValue = "Select Lab Test" headerKey = "-1"></s:select>
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="groupRate">Test Rate <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="testRate" required="required" placeholder="Test Rate" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditConfigureLabTestCharges" method="POST" onsubmit="return submitForm(categoryID.value);" style="margin-top:20px;">
						  
						   <s:iterator value="labTestList" var="concessionForm">
						  
						 					  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Select Lab Test">Select Lab Test<span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <s:select list="labTests" id="labTestID" name="labTestID" class="form-control" headerValue = "" headerKey = ""></s:select>
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="testRate" required="required" value="<s:property value="testRate" />" placeholder="Test Rate" class="form-control">
	                        </div>
	                      </div>
