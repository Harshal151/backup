...
<html lang="en">
  <head>
    ...
    <title>Add User | E-Dhanvantari</title>
	...
	function verifyUsernameExists(userName) {
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				var array = JSON.parse(xmlhttp.responseText);
				for (var i = 0; i < array.Release.length; i++) {
					var check = array.Release[i].username;
					if (check != userName) {
						document.getElementById("usernameCheckID").innerHTML = "<img src='images/correct.png' alt='Username is available' title='Username is available' style='height:24px;margin-top: 5px;'>";
						$("#usernameSubmitID").attr('disabled', false);
					}else {
						document.getElementById("usernameCheckID").innerHTML = "<img src='images/wrong.png' alt='Username already exists' title='Username already exists' style='height:24px;margin-top: 5px;'>";
						$("#usernameSubmitID").attr('disabled', true);
					}
				}
			}
		};
		xmlhttp.open("GET","VerifyUsernameExists?username=" + userName, true);
		xmlhttp.send();
	}
	</script>
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" id ="profPicID" data-toggle="dropdown" aria-expanded="false">
                  	<%
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="AddUser" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;" enctype="multipart/form-data">
                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name <span class="required">*</span>
                        </label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input  class="form-control" name="firstName" placeholder="First Name" id="firstNameID" required="required" type="text" onblur="validate(this.value, 'firstNameID');">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input  class="form-control" name="middleName" placeholder="Middle Name" id="middleNameID" type="text" onblur="validate(this.value, 'middleNameID');">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input class="form-control" name="lastName" placeholder="Last Name" id="lastNameID" required="required" type="text" onblur="validate(this.value, 'lastNameID');">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-10">
                          <input type="number" name="phone" class="form-control" placeholder="Phone"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-10">
                          <input type="number" name="mobile" class="form-control" placeholder="Mobile"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" name="emailID" required="required" placeholder="Email Address" class="form-control">
                        </div>
                      </div> 
					...
					<div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="username" required="required" placeholder="Username" id="usernameID" class="form-control" onkeyup="verifyUsernameExists(usernameID.value);">
                        </div>
                        <div id="usernameCheckID" class="col-md-1 col-sm-1 col-xs-1"></div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="PIN" placeholder="PIN" required="required" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <!--<s:select list="#{'administrator':'Administrator','clinician':'Clinician','staff':'Staff','compounder':'Compounder','receptionist':'Receptionist','dietician':'Dietician'}" value="-1" headerKey="-1" headerValue="Select Role" onclick="abc(userType.value);" id="userTypeID" name="userType" class="form-control" required="required"></s:select>-->
                     <%  if(form.getUserType().equals("superAdmin")){  %>
                     
                     		<s:select list="#{'superAdmin':'SuperAdmin','manager':'Manager','administrator':'Administrator','accountant':'Accountant','billDesk':'Bill Desk','clinician':'Clinician','compounder':'Compounder','dietician':'Dietician','pharmacist':'Pharmacist','receptionist':'Receptionist','staff':'Staff','surveyor':'Surveyor','optician':'Optician'}" value="-1" headerKey="-1" headerValue="Select Role" id="userTypeID" name="userType" class="form-control" required="required" onchange = "showDoctorRegNo(this.value)"></s:select>
                     
                     <%	}else{  %>
                        
                          	<s:select list="#{'administrator':'Administrator','manager':'Manager','accountant':'Accountant','billDesk':'Bill Desk','clinician':'Clinician','compounder':'Compounder','dietician':'Dietician','pharmacist':'Pharmacist','receptionist':'Receptionist','staff':'Staff','surveyor':'Surveyor','optician':'Optician'}" value="-1" headerKey="-1" headerValue="Select Role" id="userTypeID" name="userType" class="form-control" required="required" onchange = "showDoctorRegNo(this.value)"></s:select>
                  ...
                  <%  if(form.getUserType().equals("superAdmin")){  %>       
                     ...
                     <div class="item form-group clinicianRegNo" style = "display: none">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          	<input  type="text" name="clinicianRegNo" class="form-control" required="required" placeholder="Clinician Registration Number">
                        </div>
               		</div>
               ...
               <% }else{ %>       
                  ...
                  <div class="item form-group">
                     <label for="Clinic" class="control-label col-md-3 col-xs-3">Default Clinic<span class="required">*</span></label>
                     <div class="col-md-6 col-sm-6 col-xs-12" id="clinicListID">
                       	<s:select list="clinicList" headerKey="-1" value="-1" headerValue="Select Clinic" id="clinicID" name="clinicID" class="form-control" ></s:select> 
                     </div>
                 </div>
               ...
               <% } %>
                 ...
                 <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <input  type="text" name="activityStatus" class="form-control" value="Active" readonly="readonly">
                      </div>
                  </div>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<s:file name="signature" class="form-control"></s:file>
				</div>
				</div>
