...
<html lang="en">
  <head>
    ...
    <title>Manage OPD Charges | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchOPDCharges" method="POST" onsubmit="return showLoadingImg();">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search OPD Charges by name" name=searchCharges>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active" >Search Charges</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllOPDCharges"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Charges</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="OPDChargesList" var="UserForm">
		                        	<tr>
											...
											<td align="center"><s:url id="approveURL"
												action="RenderEditOPDCharges">
												<s:param name="chargesID" value="%{chargesID}" />
												...
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit OPD Charges"
													title="Edit OPD Charges" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteOPDCharges">
												<s:param name="chargesID" value="%{chargesID}" />
												<s:param name="searchCharges" value="%{searchCharges}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete OPD Charges"
													title="Delete OPD Charges" />
											</s:a></td>
		                        	</tr>
		                        </s:iterator>
		                      </tbody>
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="AddOPDCharges" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="ChargeType">Charge Type <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="chargeType" required="required" placeholder="Charge Type" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditOPDCharges" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="editOPDChargesList" var="OPDChargesForm">
						  
						  <input type="hidden" name="chargesID" value="<s:property value="chargesID" />" >
						  <input type="hidden" name="searchCharges" value="<s:property value="searchCharges" />" >
						  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Instruction">Charge Type <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="chargeType" required="required" value="<s:property value="chargeType" />" placeholder="Instruction" class="form-control">
	                        </div>
	                      </div>
