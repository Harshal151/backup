...
PatientDAOInf patientDAOInf1 = new PatientDAOImpl();

HashMap<Integer, String> OPDChargesList = patientDAOInf1.retrieveOPDChargesList(form.getPracticeID());
%>
...
<script type="text/javascript">
		...
		function printInvestigation(){
			...
			document.forms["genPhyInvestID"].action = "PrintGenPhyInvestigation";
		...
		function saveInvestigation(){
			...
			document.forms["genPhyInvestID"].action = "AddNewInvestigation";
			document.forms["genPhyInvestID"].submit();
...
<script type="text/javascript" charset="UTF-8">
	...
	function blankPrescription(visitID,aptID,patientID){
		if($("#visitID").val() == 0)
			{
				alert("Please Add visit.")				
			}
		else
			{
				$('html, body').animate({
				...
				xmlhttp.onreadystatechange = function() {
					if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
						...
						for ( var i = 0; i < array.Release.length; i++) {
							var fileName = array.Release[i].fileName;
							popup = window.open('PDFDownload?pdfOutPath='+fileName,"Popup", "width=700,height=700");
							popup.focus();
							popup.print();
							$('body').css('background', '#107B95');
				...
				xmlhttp.open("GET", "downloadBlankPrescription?visitID="
						+ visitID + "&aptID=" + aptID + "&patientID=" + patientID , true);
				xmlhttp.send();
			}
		
	}
	
	function freqAutoCal()
	{
		var freqCount = $("#frequencyCountID").val();
		var noOfDays = $("#noOfDays").val();
		//var freqCount = (freq.match(/1/g) || []).length;
		
		var totalQuantity = noOfDays*freqCount;
		$("#noOfPills").val(totalQuantity);
...
<%
System.out.println("lastEneteredVisitList");
...
ValueMap.put("manager", "OPD Visit,Prescription,Billing,Report,Medical Certificate,Referral Letter");
...
//idMap.put("Investigation", "invest");
...
<%
System.out.println("medicalCertificateTabEnable");
...
<script type="text/javascript">
		...
		// Function to get frequency count
		var xmlhttp;
		if (window.XMLHttpRequest) {
			xmlhttp = new XMLHttpRequest();
		} else {
		...
		function getFreqCount(frequency){
			
			if(frequency == "-1"){
				
				$("#frequencyCountID").val(0)
				return false;
			}
			...
			xmlhttp.onreadystatechange = function() {
				if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
					...
					for ( var i = 0; i < array.Release.length; i++) {
						var freqCount = array.Release[i].freqCount;
						
						$("#frequencyCountID").val(freqCount)
					}
					
					freqAutoCal();
				}
			};
			xmlhttp.open("GET", "GetFrequencyCount?frequency="
					+ frequency, true);
			xmlhttp.send();
		}
	</script>
...
<body class="nav-md">
	...
	<div id="netStockAlertModal" class="modal fade" tabindex="-1"
		role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
		data-keyboard="false" data-backdrop="static">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
 ...
 %> <span class=" fa fa-angle-down"></span>
			...
			<div class="right_col" role="main">
				<div class="">
										...
										<div id="myTabContent1" class="tab-content">
											...
											<div class="tab-pane fade in active" id="visit">
												<form class="form-horizontal form-label-left" novalidate
													action="AddNewVisit" name="visitrForm" id="visitrForm"
													...
													<div class="row">
														<div class="col-md-6 col-sm-6 col-xs-12">
															<div class="col-md-4">
																<label for="name"
																	style="font-size: 15px; padding-left: 49px; margin-top: 0.5em;">Name:</label>
															</div>
															<div class="col-md-4">
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<div class="col-md-4">
																<label for="name"
																	style="font-size: 15px; margin-top: 0.5em; padding-left: 62px;">Age:</label>
															</div>
															<div class="col-md-4">
																<input type="text" class="form-control"
													...
													<div class="row" style="padding-top: 10px;">
														<div class="col-md-6 col-sm-6 col-xs-12">
															<div class="col-md-4">
																<label for="name"
																	style="font-size: 15px; padding-left: 75px; margin-top: -1%;">ID:</label>
															</div>
															<div class="col-md-4">
																<input type="text" class="form-control"
																	readonly="readonly"
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<div class="col-md-4">
																<label for="name"
																	style="font-size: 15px; margin-top: 0.5em; padding-left: 43px">Mobile:</label>
															</div>
															<div class="col-md-4">
																<input type="text" class="form-control"
																	readonly="readonly"
													...
													<div class="row" style="padding-top: 10px;">
														<div class="col-md-6 col-sm-6 col-xs-12">
															<div class="col-md-4">
																<label for="name"
																	style="font-size: 15px; padding-left: 38px; margin-top: -1%;">Gender:</label>
															</div>
															<div class="col-md-4">
																<input type="text" class="form-control"
																	readonly="readonly"
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<div class="col-md-4">
																<label for="name"
																	style="font-size: 15px; margin-top: 0.5em;">Blood
																	Group:</label>
															</div>
															<div class="col-md-4">
																<input type="text" class="form-control"
																	readonly="readonly"
																	value="<s:property value="bloodGroup"/>" />
															</div>
														</div>
													</div>
													...
													<div class="row" style="padding-top: 10px;">
														<div class="col-md-6 col-sm-6 col-xs-12">
															<div class="col-md-4">
																<label for="name"
																	style="font-size: 15px; padding-left: 6px;">Date
																	of visit:</label>
															</div>
															<div class="col-md-4">
																<input type="text" class="form-control"
													...
													<div class="item form-group">
														<div class="col-md-8 col-sm-8 col-xs-12"
															...
															<div class="col-md-3 col-sm-3 col-xs-4">
																<label for="User Type"
																	style="font-size: 15px; padding-left: 10px;">Diagnosis*</label>
															</div>
															<div class="col-md-6 col-sm-5 col-xs-8 ">
																<%-- <sx:autocompleter name="cancerType" cssStyle="padding-left:14px;" list="diagnoseList" showDownArrow="false" cssClass="form-control"/> --%>
																<s:select list="diagnoseList" headerKey="-1"
													...
													<div class="row">
														<div class="col-md-3">
															<label for="User Type"
																style="font-size: 15px; padding-left: 10px; padding-top: 15px;">Present
																Complaints</label>
														</div>
													</div>
													<div class="item form-group">
														<div class="control-label col-md-10 col-sm-12 col-xs-12"
																...
																<tbody>
																	<tr>
																		<td><input type="text" class="form-control"
																			name="symptom" id="symptomOID" placeholder="symptom"></td>
																		<td><input type="number" class="form-control"
																			name="duration" id="presentDurationID"
																			placeholder="Duration"></td>
																		<td><input type="text" class="form-control"
																			name="comments" id="presentCommentsID"
																			placeholder="Comments"></td>
																		<td align="center"><a
																			onclick="addComplaintRow(symptomOID.value, presentDurationID.value, presentCommentsID.value);">
																				<img src="images/add_icon_1.png"
																				onmouseover="this.src='images/add_icon_2.png'"
																				onmouseout="this.src='images/add_icon_1.png'"
																	...
																	<s:iterator value="complaintList">
																		<tr
																			id="visitComplaintTRID<s:property value="complaintID"/>">
																			<td style="font-size: 14px; text-align: center;"><s:property
																					value="symptomCheckName" /></td>
																			<td style="font-size: 14px; text-align: center;"><s:property
																					value="duration" /></td>
																			<td style="font-size: 14px; text-align: center;"><s:property
																					value="comments" /></td>
													...
													<div class="item form-group">
														<div class="col-md-3 col-xs-6 col-sm-6">
															<label for="User Type"
																style="font-size: 15px; padding-left: 5px; padding-top: 15px;">MHO(Medical
																History)</label>
														</div>
													</div>
													<div class="item form-group">
														<div class="control-label col-md-10  col-sm-12 col-xs-12"
															style="padding-left: 50px; margin-top: -1%;">
															<table id="datatable-responsive"
																class="table table-striped table-bordered dt-responsive nowrap"
																cellspacing="0" width="100%">
																<thead>
																...
																<tbody>
																	<tr>
																		<td><input type="text" class="form-control"
																			name="diagnosis" id="MHOdiagnosisID"
																			placeholder="diagnosis"></td>
																		<td><input type="text" class="form-control"
																			name="description" id="MHOdescriptionID"
																			placeholder="description"></td>
																		<td align="center"><a
																			onclick="addMedicalHistoryRow(MHOdiagnosisID.value,MHOdescriptionID.value);">
																				<img src="images/add_icon_1.png"
																				onmouseover="this.src='images/add_icon_2.png'"
																				onmouseout="this.src='images/add_icon_1.png'"
																				alt="Add History" title="Add History"
																				style="margin-top: 5px; height: 20px;" />
																		</a></td>
																	</tr>
																	...
																	<s:iterator value="historyList">
																		<tr
																			id="visitHistoryTRID<s:property value="historyID"/>">
																			<td style="font-size: 14px; text-align: center;"><s:property
																					value="diagnosis" /></td>
																			<td style="font-size: 14px; text-align: center;"><s:property
													...
													<div class="row">
														<div class="col-md-3">
															<label for="User Type"
																style="font-size: 15px; padding-left: 13px; padding-top: 15px;">Personal
																History</label>
														</div>
													</div>
													<div class="item form-group">
														<div class="control-label col-md-10  col-sm-12 col-xs-12"
															style="padding-left: 30px; margin-top: -3%;">
															<div class="row" style="padding-top: 30px;">
																<div class="col-md-6 col-sm-6">
																	<div class="col-md-4">
																		<label for="User Type" style="font-size: 15px;">Smoking</label>
																	</div>
																	<div class="col-md-4"
																		style="padding-top: 3px; padding-left: 20px;">
																		<s:radio list="#{'Yes':'Yes','No':'No'}"
																			name="personalHistorySmoking"
																			onclick="displayConentDocDiv(this.value);"></s:radio>
																	</div>
																</div>

																<div class="col-md-6 col-sm-6">
																	<div class="col-md-4">
																		<label for="User Type" style="font-size: 15px;">Comments</label>
																	</div>
																	<div class="col-md-8">
																		<s:textarea name="personalHistorySmokingDetails"
																			class="form-control" placeholder="comments"></s:textarea>
																	</div>
																</div>
															</div>
															...
															<div class="row" style="padding-top: 20px;">
																<div class="col-md-6 col-sm-6">
																	<div class="col-md-4">
																		<label for="User Type" style="font-size: 15px;">Alcohol</label>
																	</div>
																	<div class="col-md-4" style="padding-top: 3px;">
																		<s:radio list="#{'Yes':'Yes','No':'No'}"
																			name="personalHistoryAlcohol"
																			onclick="displayConentDocDiv(this.value);"></s:radio>
																	</div>
																</div>
																...
																<div class="col-md-6 col-sm-6">
																	...
																	<div class="col-md-8">
																		<s:textarea name="personalHistoryAlcoholDetails"
																			class="form-control" placeholder="comments"></s:textarea>
																	</div>
																</div>
															</div>
															...
															<div class="row" style="padding-top: 20px;">
																<div class="col-md-6 col-sm-6">
																	<div class="col-md-4">
																		<label for="User Type" style="font-size: 15px;">Tobacco</label>
																	</div>
																	<div class="col-md-4" style="padding-top: 3px;">
																		<s:radio list="#{'Yes':'Yes','No':'No'}"
																			name="personalHistoryTobacco"
																			onclick="displayConentDocDiv(this.value);"></s:radio>
																	</div>
																</div>
																<div class="col-md-6 col-sm-6">
																	...
																	<div class="col-md-8">
																		<s:textarea name="personalHistoryTobaccoDetails"
																			class="form-control" placeholder="comments"></s:textarea>
																	</div>
																</div>
															</div>
															...
															<div class="row" style="padding-top: 20px;">
																<div class="col-md-6 col-sm-6">
																	<div class="col-md-4">
																		<label for="User Type" style="font-size: 15px;">Food
																			Choice</label>
																	</div>
																	<div class="col-md-5" style="padding-top: 3px;">
																		<s:radio list="#{'Veg':'Veg','Non-Veg':'Non-Veg'}"
																			name="personalHistoryFoodChoice"
																			onclick="displayConentDocDiv(this.value);"></s:radio>
																	</div>
																</div>
																...
																<div class="col-md-6 col-sm-6">
																	...
																	<div class="col-md-8">
																		<s:textarea name="personalHistoryFoodChoiceDetails"
																			class="form-control" placeholder="comments"></s:textarea>
																	</div>
																</div>
															</div>
													...
													<div class="item form-group" style="padding-top: 20px;">
														<div class="col-md-3">
															<label for="User Type"
																style="font-size: 15px; padding-left: 7px; padding-top: 15px;">Current
																Medication</label>
														</div>
													</div>
													<div class="item form-group">
														<div class="control-label col-md-10  col-sm-12 col-xs-12"
															...
															<table id="datatable-responsive"
																...
																<tbody>
																	<tr>
																		<td><input type="text" class="form-control"
																			name="" id="CurrentMedidrugnameID"
																			placeholder="drugName"></td>
																		<td><input type="number" class="form-control"
																			name="" id="CurrentMedidurationID"
																			placeholder="duration"></td>
																		<td><input type="text" class="form-control"
																			name="" id="CurrentMedicommentsID"
																			placeholder="comments"></td>
																		<td align="center"><a
																			onclick="addMedicationRow(CurrentMedidrugnameID.value,CurrentMedidurationID.value,CurrentMedicommentsID.value);">
																				<img src="images/add_icon_1.png"
																				onmouseover="this.src='images/add_icon_2.png'"
																				onmouseout="this.src='images/add_icon_1.png'"
																				alt="Add Medication" title="Add Medication"
																				style="margin-top: 5px; height: 20px;" />
																		</a></td>
																	</tr>
																	...
																	<s:iterator value="medicationList">
																		<tr
																			id="visitMedicationTRID<s:property value="medicationID"/>">
																			<td style="font-size: 14px; text-align: center;"><s:property
																					value="drugName" /></td>
																			<td style="font-size: 14px; text-align: center;"><s:property
																					value="duration" /></td>
													...
													<div class="item form-group col-md-10"
														...
														<div class="col-md-2" style="padding-top: 30px;">
															<label for="User Type"
																style="font-size: 15px; padding-left: 10px;">Vital
																Signs :</label>
														</div>
														<div class="col-md-10  col-sm-12 col-xs-8">
															<div class="col-xs-12 col-md-3 col-sm-3"
																...
																<label for="User Type" class="control-label"
																	style="font-size: 15px; margin-left: 15px;">Weight</label>
																<input type="number" style="width: 70%;"
																	class="form-control" name="weight" id="weightID"
															...
															<div class="col-xs-12 col-md-3 col-sm-3"
																style="margin-left: 0%;">
																<label for="User Type" class="control-label"
																	style="font-size: 15px;">Systolic-BP</label> <input
																	class="form-control" style="width: 70%;"
																	id="systolicBPID"
																	onkeyup="myFunction1('sysSpanID',this.value)"
																	type="number" name="OEBPSys"
																	value="<s:property value="OEBPSys"/>"
																	placeholder="Systolic _"> <font
																	style="color: red;" id="sysSpanID"></font>
															</div>

															<div class="col-xs-12 col-md-3 col-sm-3"
																style="margin-left: 0%;">
																<label for="User Type" class="control-label"
																	style="font-size: 15px;">Diastolic-BP</label> <input
																	class="form-control" style="width: 71%;"
																	id="diastolicBPID"
																	onkeyup="myFunction1('diaSpanID',this.value)"
																	type="number" name="OEBPDia"
																	value="<s:property value="OEBPDia"/>"
																	placeholder="Diastolic_"> <font
																	style="color: red;" id="diaSpanID"></font>
															</div>

															<div class="col-xs-12 col-md-3 col-sm-3"
																style="margin-left: 0%;">
																<label for="User Type" class="control-label"
																	style="font-size: 15px;">Pulse</label> <input
																	type="number" style="width: 70%;" class="form-control"
																	name="OEPulse" id="pulseID"
																	onkeyup="myFunction1('pulseSpanID',this.value)"
																	value="<s:property value="OEPulse"/>"
																	placeholder="Pulse"> <font style="color: red;"
																	id="pulseSpanID"></font>
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														<div class="col-md-12 col-sm-12 col-xs-12"
															style="padding-top: 50px;" align="center">
															...
															<button class="btn btn-success" type="button" id="send"
																onclick="updateOPDVisit();">Update</button>
															<button class="btn btn-warning" type="button"
																style="width: 15%" id="printButton"
																onclick="printVisit();">Print</button>
															<%
															} else {
															%>
															<button id="send" type="button" class="btn btn-success "
																onclick="CheckDiagnosisField();">Add Visit</button>
											...
											<div class="tab-pane fade" id="presc">
												<form class="form-horizontal form-label-left" novalidate
													id="genPhyPrescID" onsubmit="return savePrescription();"
													name="genPhyPrescID" action="AddNewPrescription"
													method="POST" style="margin-top: 20px;">
													...
													<div class="row"
														...
														<button type="button" class="btn btn-primary"
															onclick="blankPrescription(visitID.value,aptID.value,patientID.value)">Blank
															Prescription</button>
													</div>
													<div class="row"
																	...
																	<s:iterator value="prescriptionList">
																		<tr
																			...
																			<td style="font-size: 14px; text-align: center;"><img
																				...
																				style='height: 24px; cursor: pointer;'
																				alt='Remove row' title='Remove row'
																				onclick="deletePrescRow('visitPrescTRID<s:property value="prescriptionID"/>',<s:property value="prescriptionID"/>, '<s:property value="tradeName"/>',<s:property value="productQuantity"/>);" />
																			</td>
																		</tr>
																	</s:iterator>
														...
														<div class="col-md-3 col-xs-7 col-sm-3">
															<div>
																<input type='text' required='required' name="tradeName"
																	...
																	id="tradeName" placeholder='Drug Name'>

															</div>
														</div>

														<div class="col-md-2 col-xs-7 col-sm-2">
															<s:select list="frequencyList" name="frequency"
																style="margin-top:10px;" id="frequency1"
																class="form-control" headerKey="-1"
																onchange="getFreqCount(this.value)"
																headerValue="Frequency"></s:select>
														</div>

														<div class="col-md-1 col-xs-7 col-sm-1">
															<input type="number" class="form-control"
																style="margin-top: 10px;" name="noOfDays" id="noOfDays"
																onkeyup="freqAutoCal()" placeholder="Days"> <input
																type="hidden" id="frequencyCountID">
														</div>

														<div class="col-md-1 col-xs-7 col-sm-1">
															<input type="number" class="form-control"
																style="margin-top: 10px;" name="noOfPills"
																id="noOfPills" placeholder="Qty" disabled>
														</div>

														<div class="col-md-4 col-xs-7 col-sm-4">
															<input type="text" class="form-control"
																style="margin-top: 10px;" name="comment" id="comment"
																placeholder="Comment">
														</div>

														<div class="col-md-1">
															<a
																onclick="addOPDPrescription(tradeName.value ,frequency1.value ,visitID.value,comment.value,noOfPills.value,noOfDays.value);">
																<img src="images/add_icon_1.png"
																onmouseover="this.src='images/add_icon_2.png'"
																onmouseout="this.src='images/add_icon_1.png'"
													...
													<div class="row"
														...
														<div class="form-horizontal form-label-left" novalidate
															id="genPhyInvestID" name="genPhyInvestID"
															action="AddNewInvestigation" method="POST"
															style="margin-top: 20px;">
															<h5 style="margin-top: 20px; margin-left: 15px;">
																<b>Investigation</b>
															</h5>
													...
													<div class="row" style="margin-top: 100px;">
														...
														<div class="col-md-2 col-xs-6 col-sm-3">
															<label class="control-label" for="Date"
																style="padding-left: 50px;">Follow-up after</label>
														</div>
			        ...
			        <form class="form-horizontal form-label-left" novalidate id="genPhyInvestID" name="genPhyInvestID" action="AddNewInvestigation" method="POST" style="margin-top:20px;">
				      ...
				      <div class="ln_solid"></div>
		                    ...
		                    <div class="form-group">
	                          ...
	                          <button type="submit" class="btn btn-success" id="saveInvestID" onclick="saveInvestigation();">Save</button>
			                 <button class="btn btn-warning" type="button" id="PrintInvestID" onclick="printInvestigation();">Save & Print</button>
									...
									<input class="form-control" name="cashToReturn" id="cashToReturnID" value="<s:property value="cashToReturn"/>" placeholder="Cash To Return" type="number">
												...
												<form class="form-horizontal form-label-left" novalidate
													...
													<div class="row" style="padding-left: 25px;">
														<div class="col-md-3"
															...
															<input type="file" name="labReport" id="Uploadfile"
																onchange="validate_fileupload('Uploadfile');">
											...
											<div class="tab-pane fade" id="medCerti">
												<form class="app-cam" id="" name=""
													...
													<div class="row" style="margin: 15px;">
														<s:radio list="#{'1':'Pre-defined','0':'Free-text'}"
															name="radioVal" id="radioValID"
															onclick="displaycertificate(this.value);"></s:radio>
													</div>
													<%
													}
													%>
													<div class="row" style="margin: 15px;">
														...
														<div class="col-md-12 col-xs-12" id="medicalTextDivID"
															...
															<s:textarea cols="2" rows="10" id="medicalCertiText"
																name="medicalCertiText" style="width:100%;"></s:textarea>
														</div>

														<div class="col-md-12 col-xs-12"
															id="medicalCertiTextDivID"
															style="border: 1px solid gray; margin: 25px; display: none;">

															<label for="Name"
																style="font-size: 14px; margin-top: 20px;">I,
																Dr. <%=fullName%> registered medical practitioner, after
																careful personal examination of the case hereby certify
																that, Sh./Smt. <s:property value="firstName" /> <s:property
																	value="lastName" /> working in <input type="text"
																class="form-control"
																...
																class="form-control" name="disease" id="disease"
																style="width: 20%; display: inline-block; margin-top: 10px;"
																required> and I consider that the period of
																absence from duty of <input type="text"
																class="form-control" name="dutyDays" id="dutyDays"
																style="width: 20%; display: inline-block; margin-top: 10px; margin-bottom: 10px;"
																required> days with effect from <input
																type="text" class="form-control" name="wef" id="wef"
																style="width: 20%; display: inline-block; margin-top: 10px; margin-bottom: 10px;"
																required> is absolutely necessary for the
														...
														<div class="col-md-12 col-xs-12"
															...
															<label for="Name"
																...
																value="<%=strval[1]%>" required>, is suffering
																from <input type="text" class="form-control"
																name="disease" id="disease" value="<%=strval[2]%>"
																style="width: 20%; display: inline-block; margin-top: 10px;"
																required> and I consider that the period of
																absence from duty of <input type="text"
																class="form-control" name="dutyDays" id="dutyDays"
															...
															<div class="row" style="margin-top: 25px;">
																<div class="col-md-12 col-xs-12">
																	...
																	<div class="col-md-3">
																		<input type="text" class="form-control" name="place"
																			id="place" value="<%=strval[5]%>" required>
																	</div>
																</div>
															</div>
															...
															<div class="row"
																...
																<div class="col-md-12 col-xs-12">
																	...
																	<div class="col-md-3">
																		<input type="text" class="form-control"
																			value="<%=strval[6]%>" name="date" id="date11">
																	</div>
																	<div class="col-md-4" style="padding-top: 20px;"
																		align="center">
																		<label>(SEAL)</label>
											...
											<div class="tab-pane fade" id="refLetter">
												...
												<form class="app-cam" id="" name=""
													...
													<div class="row" style="margin: 15px;">
														<s:radio list="#{'1':'Pre-defined','0':'Free-text'}"
															name="radioRefVal" id="radioRefValID"
															onclick="displayRefLetter(this.value);"></s:radio>
													</div>
													<%
													}
													%>
													...
													<div class="col-md-12 col-xs-12" id="refLetterTextDivID"
														style="margin: 25px; display: none;">
														<s:textarea cols="2" rows="10" id="refLetterText"
															name="refLetterText" style="width:100%;"></s:textarea>
													</div>

													<div class="col-md-12 col-xs-12" id="refLetterDivID"
														style="margin: 25px; display: none;">
														...
														<div class="row">
															...
															<div class="col-md-12 col-xs-12" style="margin: 15px;">
																...
																<label for="Name"
																	...
																	Dr. </label>
																<s:select list="doctorList" name="doctName"
																	id="doctName" style="width:20%; " class="form-control"></s:select>
																,
														...
														<div class="row">
															...
															<div class="col-md-12 col-xs-12" style="margin: 15px;">
																...
																<textarea rows="4" name="conditionText"
																	id="conditionText" class="form-control" required></textarea>
																<br> <br> <label for="Name"
																	style="font-size: 14px;">Please advise Mr/Ms <s:property
																		value="firstName" /> <s:property value="lastName" />
																	on further treatment.
																</label> <br> <br> <label for="Name"
																	style="font-size: 14px;">Sincerely, </label> <br>
																<label for="Name" style="font-size: 14px;">Dr. <%=fullName%>
																</label>
													...
													<div class="col-md-12 col-xs-12" id="refLetterDivID"
														...
														<div class="row">
															...
															<div class="col-md-12 col-xs-12" style="margin: 15px;">
																...
																<textarea rows="4" name="conditionText"
																	id="conditionText" class="form-control" required><%=strval[3]%></textarea>
																<br> <br> <label for="Name"
																	style="font-size: 14px;">Please advise Mr/Ms <s:property
																		value="firstName" /> <s:property value="lastName" />
																	on further treatment.
																	...
																	style="font-size: 14px;">Sincerely, </label> <br>
																<label for="Name" style="font-size: 14px;">Dr. <%=strval[4]%>
																</label>
