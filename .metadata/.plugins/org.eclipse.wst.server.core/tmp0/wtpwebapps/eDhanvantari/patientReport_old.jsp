...
<html lang="en">
  <head>
    ...
    <title>Patient Report | E-Dhanvantari</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                    ...
                    <div class="row">
                     <form action="SearchPatientReport" method="POST">
                       <div class="col-md-2 col-sm-3 col-xs-6">
                         <input type="text" name="searchName" id="searchNameID" class="form-control" placeholder="Enter search term here*" required="required">
                       </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <s:select list="#{'All Patients':'All Patients','Diagnosis':'Diagnosis','Drug':'Drug'}" headerKey="Patient Name" headerValue="Patient Name" name="searchCriteria" onchange="checkCriteria(searchCriteriaID.value);" class="form-control" id="searchCriteriaID"></s:select>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <input type="text" id="sDateID1" class="form-control" name="startDate">
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <input type="text" id="eDateID1" class="form-control" name="endDate">
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <input type="submit" class="btn btn-success" value="Search Patient Report">
                        </div>
                      </form>
                     </div>
                  ...
                  %>
		            ...
		            <%
                  	}else if(searchCriteria.equals("Employee Name")){
		            %> 
                      ...
                      <thead>
                        <tr>
                          ...
                          <th>Leaves Scheduled</th>
                          <th>Leaves Taken</th>
                          <th>Leaves Balance</th>
                        </tr>
                      </thead>
                      <tbody>
                        <s:iterator value="leaveList" var="UserForm">
                        	<tr>
									<td><s:property value="employeeName" /></td>
										
									<td><s:property value="leaveType" /></td>
									
									<td><s:property value="leavesEntitled" /></td>
										 
									<td><s:property value="leavesScheduled" /></td>
										
									<td><s:property value="leavesTaken" /></td>
									
									<td><s:property value="leaveBalance" /></td>
                        	</tr>
                        </s:iterator>
                      </tbody>
                    </table>
                   ...
                   <%
                  	}else if(searchCriteria.equals("Leave Type")){
                   %>
