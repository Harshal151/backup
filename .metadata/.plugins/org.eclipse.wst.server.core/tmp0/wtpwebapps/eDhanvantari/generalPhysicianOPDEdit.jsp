			...
			<div class="right_col" role="main">
				<div class="">
										...
										<div id="myTabContent1" class="tab-content">
											...
											<div class="tab-pane fade in active" id="visit">
												<form class="form-horizontal form-label-left" novalidate
													action="EditVisit" name="visitrForm" id="visitrForm"
													...
													<div class="row">
														<div class="col-md-3">
															<label for="User Type"
																style="font-size: 15px; padding-left: 15px; padding-top: 15px;">Present
																Complaints</label>
														</div>
													</div>
													<div class="item form-group">
																...
																<tbody>
																	<tr>
																		<td><input type="text" class="form-control"
																			name="" id="symptomOID" placeholder="symptom"></td>
																		<td><input type="number" class="form-control"
																			name="" id="presentDurationID" placeholder="duration"></td>
																		<td><input type="text" class="form-control"
																			name="" id="presentCommentsID" placeholder="comments"></td>
																		<td align="center"><a
														...
														<div class="control-label col-md-10  col-sm-12 col-xs-12"
															...
															<table id="datatable-responsive"
																...
																<tbody>
																	<tr>
																		<td><input type="text" class="form-control"
																			name="" id="MHOdiagnosisID" placeholder="diagnosis"></td>
																		<td><input type="text" class="form-control"
																			name="" id="MHOdescriptionID"
													...
													<div class="item form-group" style="padding-top: 20px;">
														<div class="col-md-3">
															<label for="User Type"
																style="font-size: 15px; padding-left: 10px; padding-top: 15px;">Current
																Medication</label>
														</div>
													</div>
													<div class="item form-group">
													...
													<div class="item form-group col-md-10"
														...
														<div class="col-md-2"">
															<label for="User Type"
																style="font-size: 15px; margin-left: 6px; padding-top: 20%;">Vital
																Signs :</label>
														</div>
														<div class="col-md-10  col-sm-12 col-xs-8">
															<div class="col-xs-12 col-md-3 col-sm-3"
																...
																<label for="User Type" class="control-label"
																	style="font-size: 15px;">Weight</label> <input
																	type="number" style="width: 70%;" class="form-control"
																	name="weight" id="weightID"
													...
													<div class="form-group">
														<div class="col-md-12 col-sm-12 col-xs-12"
															...
															<button id="send" type="button" class="btn btn-success "
																onclick="CheckDiagnosisField();">Update Visit</button>
			      ...
			      <div class="tab-pane fade" id="invest" >
			        <form class="form-horizontal form-label-left" novalidate id="genPhyInvestID" name="genPhyInvestID" action="EditInvestigation" method="POST" style="margin-top:20px;">
		             ...
		             <div class="form-group">
		                 <div class="col-md-12 col-xs-12" align="center">
		                     ...
		                     <button type="submit" id="saveInvestID" class="btn btn-success" onclick="updateInvestigation();">Save</button>
											...
											<div class="tab-pane fade" id="medCerti">
												<form class="app-cam" id="" name=""
													...
													<div class="row" style="margin: 15px;">
														...
														%>
														<div class="col-md-12 col-xs-12"
															id="medicalCertiTextDivID" style="margin: 25px;">
													...
													<div class="form-group">
														<div class="col-md-12 col-xs-12" align="center">
															...
															%>
															<button class="btn btn-success" type="submit"
																onclick="displayVal();">Update & Print</button>
															<%
															} else {
															%>
															<button class="btn btn-success" type="submit"
												...
												<form class="app-cam" id="" name=""
														...
														<div class="row">
															...
															<div class="col-md-12 col-xs-12" style="margin: 15px;">
																...
																<div class="col-md-3" style="margin-left: -15px;">
																	<label><%=currentDate%><input type="hidden"
																		class="form-control" value="<%=currentDate%>"
																		name="date" id="date12"></label>
																</div>
															...
															<div class="col-md-12 col-xs-12" style="margin: 15px;">
																...
																<div class="col-md-3" style="margin-left: -15px;">
																	<label><input type="text" class="form-control"
																		value="<%=strval[0]%>" name="date" id="date12"></label>
																</div>
													...
													<div class="form-group">
														<div class="col-md-12 col-xs-12" align="center">
															...
															%>
															<button class="btn btn-success" type="submit"
																onclick="displayRefLet();">Update & Print</button>
															<%
															} else {
															%>
															<button class="btn btn-success" type="submit"
