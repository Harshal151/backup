...
<html lang="en">
  <head>
    ...
    LoginForm form = (LoginForm) session.getAttribute("USER");
		...
		String lastEneteredVisitList = (String) request.getAttribute("lastEnteredIPDVisitList");
	...
	<script type="text/javascript">
		function printVisit(){
			...
			document.forms["visitrForm"].action = "PrintIPDGeneralClinicVisit";
			document.forms["visitrForm"].submit();
		}
	
		function updateIPDVisit(){
			 $('html, body').animate({
		        scrollTop: $('body').offset().top
		    }, 1000);
			...
			document.forms["visitrForm"].action = "UpdateIPDGeneralClinicVisit";
			document.forms["visitrForm"].submit();
		}
	</script>
	<!-- Ends -->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
			     ...
			     <div class="tab-pane fade in active" id="visit">
				    <form class="form-horizontal form-label-left" novalidate action="AddNewIPDGeneralClinicVisit" onsubmit="return showLoadingImg();" name="visitrForm" id="visitrForm" method="POST" style="margin-top:20px;">
				      ...
				      <div class="ln_solid"></div>
	                     ...
	                     <div class="form-group" >
	                        <div class="col-md-12 col-xs-12"  style="padding-top: 50px;" align="center">
	                          ...
	                          %>
	                         	<button class="btn btn-success" type="button" id="send" onclick="updateIPDVisit();">Save</button>
	                      ...
	                      <div class="item form-group" style="margin-top:15px;">
	                        <label for="User Type" class="control-label col-md-3 col-xs-5">Charges(Rs)<span class="required">*</span></label>
	                         <div class="col-md-6 col-sm-6 col-xs-6">
	                          <input type="text" class="form-control" name="charges" id="charges" required="required" value="<s:property value="totalAmount"/>" onkeyup="changeTotalBill('totalBill',charges.value);" placeholder="Charges(Rs)">
	                        </div>
	                      </div>
