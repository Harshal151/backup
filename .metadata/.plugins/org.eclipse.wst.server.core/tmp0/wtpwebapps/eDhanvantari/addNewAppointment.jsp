...
<html lang="en">
  <head>
	...
	function getAppointmentDurationForSlot(visitTypeID, startTime){
		
		var appointmentDuration = 10;
...
<script type="text/javascript">
  ...
  <script type="text/javascript" charset="UTF-8">
	...
	function getAppointmentSlots(apptDate) {

		var apptDate = apptDate;
		console.log(typeof apptDate);
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				var s = '<option value="-1">Available Appointment Times</option>';  
               	for (var i = 0; i < parseInt(array.Release.length) - 1; i++) {
               		
               		if(parseInt(array.Release[i].slot) > 0 && parseInt(array.Release[i].slot) < 10){
               			var slot = array.Release[i].slot + ":00:00";
               			
               			var slotText = array.Release[i].slot + ":00 - " + parseInt(parseInt(array.Release[i].slot) + 1) + ":00";
               			
               			s += '<option value="0' + slot + '">0' + slotText + '</option>';  
               		}
               		else{
               			var slot = array.Release[i].slot + ":00:00";
               			...
               			s += '<option value="' + slot + '">' + slotText + '</option>';  
               		}
               		
               		console.log("type of array var is " + typeof array.Release[i].slot);
               		console.log("value  is " +  array.Release[i].slot);
               	}  
               	$("#apptStartTimeID1").html(s); 

			}
		};
		xmlhttp
				.open("POST", "GetAppointmentSlots?apptDate=" + apptDate, true);
		xmlhttp.send();
	}
</script>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="AddNewAppointment" onsubmit="return showLoadingImg();" name="apptFormID" id="apptFormID" method="POST" style="margin-top:20px;" >
					...
					<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" name="age" placeholder="Age" id="ageID" value="<s:property value='age'/>" class="form-control" required="required" >
							</div>
					</div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="mobile" value="<s:property value="mobile"/>" id="mobileNo" min="10" required="required" placeholder="Mobile No." class="form-control"  onKeyPress="if(this.value.length==10) return false;"  aria-describedby="inputGroupSuccess1Status">
                        </div>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Appointment Date">Appointment Date<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control" name="appointmentDate" required="required" onchange="getAppointmentSlots(this.value);" id="single_cal3" value="<s:property value="appointmentDate"/>" placeholder="Appointment Date" aria-describedby="inputSuccess2Status3">
                        </div>
                      </div>
                      
                      <%
		              if (form.getFacilityDashboard() == 0){ %> 
		              
                      <div class="item form-group">
		                  <label for="User Type" class="control-label col-md-3">Appointment Time From<span class="required">*</span></label>
		                 ...
		                 <div class="col-md-3 col-sm-3 col-xs-12">
		                    <div class="input-group date clinic_start col-md-12" data-date="" data-date-format="hh:ii:00" data-link-field="dtp_input3" data-link-format="hh:ii:00">
				             	<input class="form-control" size="16" id="apptStartTimeID1" required type="text" name="aptTimeFrom" value="" onfocus="addReadonly();" onblur="removeReadonly();">
					            <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
	                		</div>
		                  </div>
		                
		                <!-- <input type="hidden" id="apptStartTimeID1" name="aptTimeFrom" class="form-control" placeholder="Appt Start Time"> -->
		               </div>
		              
		              <%} else if (form.getFacilityDashboard() == 2){%>
		              <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Appointment Slot">Appointment Slot<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="apptStartTimeID1" name="apptSlot" class="form-control" required="required">
                          		<option value="">Available Appointment Times</option>
        					</select>
        				</div>
        				</div>
		              <%
		              ...
		              <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="apptTypeID1" name="visitTypeID" class="form-control" required="required" onchange="getAppointmentDuration(apptTypeID1.value, apptStartTimeID1.value);">
		              ...
		              <div class="item form-group">
		                <label for="User Type" class="control-label col-md-3">Appointment Time To<span class="required">*</span></label>
		                        
		                <div class="col-md-6 col-sm-6 col-xs-12">
		                   <input type="text" id="apptEndTimeID1" name="aptTimeTo" class="form-control" placeholder="Appt End Time" required="required" readonly="readonly">
		                     <font id="timeToFontTID" style="display:none;color: red;margin-top: 5px;font-size: 15px;">Appointment time to is blank. Please select/re-select appointment type to auto generate appointment time to.</font>
		                </div>
		              </div>
		              <%
							}else if (form.getFacilityDashboard() == 2){
						...
						<div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <select id="apptTypeID1" name="visitTypeID" class="form-control" required="required" onchange="getAppointmentDurationForSlot(apptTypeID1.value, apptStartTimeID1.value);">
	        					<option value="">Select Appt. Type</option>
						...
						<input type="hidden" id="apptEndTimeID1" name="aptTimeTo" class="form-control" placeholder="Appt End Time" readonly="readonly">
						<%
							}
						%>
		              
		              <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Appointment Type">Appointment By<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="apptByID" class="form-control" required name="cliniciaID">
        					<option value="">Select Appt. By</option>
                      ...
                      <div class="item form-group">
	                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Status">Walk In?
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12"> 
	                          <input type="checkbox" name="walkIn" value="1" style="zoom: 1.8;">
	                        </div>
	                      </div>
	                      
	                  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Status">Comments (if any)
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        	<s:textarea rows="" cols="" class="form-control" name="comment" placeholder="Enter comments here"></s:textarea>
                        </div>
                      </div>
    ...
    function myFun(){
      $(document).ready(function() {
        ...
        $('#single_cal3').daterangepicker({
          ...
          getAppointmentSlots(single_cal3.value);
        });
