...
<html lang="en">
  <head>
    ...
    LoginForm form = (LoginForm) session.getAttribute("USER");
		...
		System.out.println("changedClinicID on generic:"+changedClinicID);
...
<!-- Ends -->
    ...
    <%
	    ...
	    //ValueMap.put("patient","OPD Visit,Prescription,Billing,Report,Medical Certificate,Referral Letter");
    ...
    <%
		...
		if(tabs.contains(",")){
			...
			System.out.println("TABBB:"+ID+ "    ;;;"+idMap.get(ID));
	%>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
					  ...
					  <ul id="myTab1" class="nav nav-tabs">
					  	...
					  	System.out.println("..."+tabs);
		              		...
		              		if(tabs.contains(",")){
		              			...
		              			System.out.println("TAB ARRAY::"+tabsArray);
		              			for(int i = 0; i < tabsArray.length; i++){
		              				
		              				if(count == 1){
		              					count++;
		              					System.out.println("inside count ==1 ::"+tabsArray[i]+"  "+idMap.get(tabsArray[i]));	
						%>
			     ...
			     <div class="tab-pane fade in active" id="visit">
				    ...
				    <div class="row">	
				     <div class="col-md-6">
				     	<div class="col-md-4"><label for="name" style="font-size: 15px; padding-left: 20px;">Name:</label></div>
		               	<div class="col-md-6"><input type="text" class="form-control" readonly="readonly" value="<s:property value="firstName"/> <s:property value="lastName"/>" /></div>
			          </div>
	                    
	                  <div class="col-md-6">
	                  	<div class="col-md-4"><label for="name" style="font-size: 15px">Age:</label></div>
	              ...
	              <div class="row" style="padding-top: 10px;">	
				     <div class="col-md-6">
				     	<div class="col-md-4"><label for="name" style="font-size: 15px; padding-left: 20px;">ID:</label></div>
		               	<div class="col-md-4"><input type="text" class="form-control" readonly="readonly" value="<s:property value="registrationNo"/>" /></div>
			          </div>
	                    
	                  <div class="col-md-6">
	                  	<div class="col-md-4"><label for="name" style="font-size: 15px">Mobile:</label></div>
		               	<div class="col-md-4"><input type="text" class="form-control" readonly="readonly"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status" value="<s:property value="mobile"/>" /></div>
	                  </div>                      
	              </div>  
	              ...
	              <div class="row" style="padding-top: 10px;">	
				     <div class="col-md-6">
				     	<div class="col-md-4"><label for="name" style="font-size: 15px; padding-left: 20px;">Gender:</label></div>
		               	<div class="col-md-4"><input type="text" class="form-control" readonly="readonly" value="<s:property value="gender"/>" /></div>
			          </div>
	                    
	                  <div class="col-md-6">
	                  	<div class="col-md-4"><label for="name" style="font-size: 15px">Blood Group:</label></div>
	               ...
	               <div class="row" style="padding-top: 10px;">	
				     <div class="col-md-6">
				     	<div class="col-md-4"><label for="name" style="font-size: 15px; padding-left: 20px;">Date of visit:</label></div>
				 ...
				 <div class="item form-group" >
				  	<div class="col-md-8" style="padding-top: 20px;">
	                        <div class="col-md-3"><label for="User Type" style="font-size: 15px; padding-left: 10px;">Diagnosis*</label></div>
	                          <div class="col-md-6">
	                          		
	                          		<input type="text" class="form-control"  readonly="readonly" id="search" name="cancerType" required="required" value="<s:property value="cancerType"/>" placeholder="Diagnosis">
	                          </div>
	             ...
	             <div class="row" >
		              <div class="col-md-3"><label for="User Type" style="font-size: 15px; padding-left: 10px; padding-top: 15px;">Present Complaints</label></div>
	             			...
	             			<div class="item form-group">
		                      <div class="control-label col-md-9" style="padding-left:50px;">
      			...
      			<div class="item form-group">
		              <div class="col-md-2"><label for="User Type" style="font-size: 15px; padding-left: 10px; padding-top: 15px;">MHO</label></div>
		            	 </div> 
	             			<div class="item form-group">
		                      <div class="control-label col-md-9" style="padding-left:50px;">
						      	<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                     	   ...
                     	   <div class="row" >
				           		<div class="col-md-2"><label for="User Type" style="font-size: 15px; padding-left: 10px; padding-top: 15px;">Personal History</label></div>
						    </div> 
						    <div class="item form-group">
						    <div class="control-label col-md-9" style="padding-left:30px;">
		                     	<div class="row" style="padding-top: 30px;">
		                     	   <div class="col-md-6"> 
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;">Smoking</label></div>
		                	 		<div class="col-md-4"  style="padding-top: 3px; padding-left:20px;"><s:radio list="#{'Yes':'Yes','No':'No'}" name="personalHistorySmoking" class="radioClass" onclick="displayConentDocDiv(this.value);" ></s:radio></div>
								</div>
				     			...
				     			<div class="col-md-6"> 
	                      		...
	                      		<div class="col-md-6">             
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;">Alcohol</label></div>                    
			               			<div class="col-md-4"  style="padding-top: 3px;"><s:radio list="#{'Yes':'Yes','No':'No'}" name="personalHistoryAlcohol"  class="radioClass" onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>
								...
								<div class="col-md-6"> 
	                      		...
	                      		<div class="col-md-6">           
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;" >Tobacco</label></div>
			               			<div class="col-md-4" style="padding-top: 3px;"><s:radio list="#{'Yes':'Yes','No':'No'}" name="personalHistoryTobacco"  class="radioClass" onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>	
								<div class="col-md-6"> 
									<div class="col-md-4"><label for="User Type" style="font-size: 15px;" >Comments</label></div>
		                 		...
		                 		<div class="row" style="padding-top: 20px;">
	                      		<div class="col-md-6">              
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;">Food Choice</label></div>
			               			<div class="col-md-5" style="padding-top: 3px;"><s:radio list="#{'Veg':'Veg','Non-Veg':'Non-Veg'}" name="personalHistoryFoodChoice"  class="radioClass"  onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>
	             ...
	             <div class="item form-group" style="padding-top: 20px;">
		              <div class="col-md-3"><label for="User Type" style="font-size: 15px; padding-left: 10px; padding-top: 15px;">Current Medication</label></div>
		                 ...
		                 <div class="col-md-10">
			                     <div class="col-xs-12 col-md-2" style="margin-left:-5%;" >
			                        <label for="User Type" class="control-label" style="font-size: 15px;" >Weight</label>
			                        <input type="number" readonly="readonly"  style="width: 70%;" class="form-control" name="weight" id="weightID" value="<s:property value="weight"/>"  placeholder="Weight (in kgs)">
			                     </div>
		                        ...
		                        <div class="col-xs-12 col-md-2" style="margin-left:-2%;">
			                        ...
			                        <input class="form-control"  readonly="readonly" style="width: 70%;" id="systolicBPID" onkeyup="myFunction1('sysSpanID',this.value)" type="number" name="OEBPSys" value="<s:property value="OEBPSys"/>"  placeholder="Systolic _">
		                       ...
		                       <div class="col-xs-12 col-md-2" style="margin-left:-2%;">
		                          	...
		                          	<input type="number"  readonly="readonly" style="width: 70%;" class="form-control" name="OEPulse" id="pulseID" onkeyup="myFunction1('diaSpanID',this.value)"  value="<s:property value="OEPulse"/>"  placeholder="Pulse">
			   ...
			   <!-- Prescription div -->
			      <div class="tab-pane fade" id="presc" >
				       	...
				       	<h4 style="margin-top:20px;margin-left:15px;"><b>Prescription</b></h4>
							...
							<div class="row" id="OPDPResc" style="margin-left:0px;margin-right:0px;margin-top:15px;">
					                        ...
					                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="width: 97%; margin-left: 1%;">
					                            <thead>
													<tr>
					                                    <th style="width: 25%; text-align: center;">Drug Name</th>
					                                    <th style="width: 17%; text-align: center;">Frequency</th>
					                                    <th style="width: 10%; text-align: center;">No. of days</th>
					                                    <th style="width: 9%; text-align: center;">Quantity</th>
					                                    <th style="width: 31%; text-align: center;">Comments</th>
				    ...
				    <div class="row" style="margin-top:100px;"> 
					      ...
					      <div class="col-md-3">
                          	  <label class="control-label" for="Date" style="padding-left:150px;">Follow-up after</label>
                          </div>
                          <div class="col-md-1" >
			      ...
			      <form class="form-horizontal form-label-left" novalidate id="genPhyBillID" name="genPhyBillID" action="EditBill" method="POST" style="margin-top:20px;">
						...
						<div id="cardDetailID" style="padding: 15px; display: none;">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<input type="number"  readonly="readonly" class="form-control" id="cMobileNoID" value="<s:property value="cMobileNo"/>"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status" name="cMobileNo" placeholder="Mobile No.">
								</div>
							</div>
						</div>
			    ...
			    <div class="tab-pane fade" id="labRep" >
			     ...
			     <!--  <div class="row" style="padding-left:25px;">
			      	...
			      	<div class="col-md-6" style="margin-top:10px;">
			      		<button type="button" class="btn btn-default" >Add More Files</button>  onclick="myFunction();"
			      	</div>
			    	...
			    	<form class="app-cam" id="" name="" action="UpdateMedicalCertificate" method="POST" style="width:95%;margin:0px;" >
				      ...
				      <input type="hidden"  name="firstName" id="firstName" value="<s:property value="firstName"/>">
				       <input type="hidden"  name="lastName" id="lastName" value="<s:property value="lastName"/>">
					    ...
					    <input type="hidden" id="doctrName" value="<%=doctName %>">
						    ...
						    %>
								<div class="col-md-12" id="medicalTextDivID" style="margin:25px;display: none;" >
										<s:textarea cols="2"  readonly = "true"  rows="10" id="medicalCertiText" name="medicalCertiText" style="width:100%;"></s:textarea>
								</div>
 
								<div class="col-md-12" id= "medicalCertiTextDivID" style="margin:25px;display: none;">
							    
							    <label for="Name" style="font-size:14px;margin-top:20px;">I, Dr. <%=doctName %> registered medical practitioner, 
							      after careful personal examination of the case hereby certify that, 
							      Sh./Smt. <s:property value="firstName"/> <s:property value="lastName"/> working in <input type="text"  readonly="readonly" class="form-control" style="width:20%; display: inline-block;margin-top:10px;" name="companyName" id="companyName" required>, 
							      is suffering from <input type="text" readonly="readonly"  class="form-control"  name="disease" id="disease" style="width:20%; display: inline-block;margin-top:10px;" required> and I consider that 
							      the period of absence from duty of <input type="text" readonly="readonly"  class="form-control"  name="dutyDays" id="dutyDays" style="width:20%; display: inline-block;margin-top:10px; margin-bottom:10px;" required> days 
							      with effect from <input type="text"  readonly="readonly" class="form-control"  name="wef" id="wef" style="width:20%; display: inline-block;margin-top:10px; margin-bottom:10px;" required> is 
							      ...
							      <div class="row" style="margin-top:25px;">
							        <div class="col-md-12">
							          ...
							          <div class="col-md-3"><input type="text" class="form-control"  readonly="readonly"  name="place" id="place" required></div>
							        </div>
							      </div>
							      ...
							      <div class="row" style="margin-top:25px;margin-bottom: 20%;">
							        <div class="col-md-12">
							          ...
							          <div class="col-md-3" ><input type="text" readonly="readonly" class="form-control" value="<%=currentDate %>"  name="date" id="date11"></div>
							    ...
							    <label for="Name" style="font-size:14px;margin-top:20px;">I, Dr. <%=strval[0]%> registered medical practitioner, 
							      ...
							      <div class="row" style="margin-top:25px;margin-bottom: 20%;">
							        <div class="col-md-12">
							          <div class="col-md-1" style="padding-top: 5px;"> <label>Date:</label></div>
							          <div class="col-md-3" ><input type="text" readonly="readonly"  class="form-control" value="<%=strval[6] %>" name="date" id="date11"></div>
							          <div class="col-md-4" style="padding-top: 20px;" align="center"> <label>(SEAL)</label></div>
							          <div class="col-md-4" style="padding-top: 20px;"><label>Registered Medical Practitioner</label></div>
							        </div>
							      </div>
							    ...
							    <%
							      ...
							      %> 
									<div class="col-md-12" id="medicalTextDivID" style="margin:25px;" >
										<textarea cols="2" readonly="readonly" rows="10"  id="medicalCertiText" name="medicalCertiText" style="width:100%;"><%=medicalCertiText %></textarea>
									</div>
				      ...
				      <input type="hidden"  name="firstName" id="firstName" value="<s:property value="firstName"/>">
				       <input type="hidden"  name="lastName" id="lastName" value="<s:property value="lastName"/>">
						...
						<div class="col-md-12" id="refLetterTextDivID" style="margin:25px;display: none;" >
							<s:textarea cols="2" rows="10"  readonly = "true" id="refLetterText" name="refLetterText" style="width:100%;"></s:textarea>
						</div>
						...
						<div class="col-md-12" id= "refLetterDivID" style="margin:25px;display: none;">
						    <div class="row" >
						      ...
						      <div class="col-md-12" style="margin:15px;">
						          ...
						          <div class="col-md-3" style="margin-left: -15px;"> <label><%=currentDate %><input type="hidden"  readonly="readonly" class="form-control" value="<%=currentDate %>"  name="date" id="date12"></label></div>
						    ...
						    <div class="row" >
						      ...
						      <div class="col-md-12" style="margin:15px;">
						          ...
						          <label for="Name" style="font-size:14px;margin-top: 10px;">Dear Dr. </label><input type="hidden"  readonly="readonly"  name="doctName" id="doctName" style="width:20%; " class="form-control" value="<%=doctName %>">, 
						    ...
						    <div class="row" >
						      ...
						      <div class="col-md-12" style="margin:15px;">
						          ...
						          <textarea rows="4"   readonly="readonly"  name="conditionText" id="conditionText" class="form-control" required ></textarea><br><br>
						          ...
						          <br>
						          <label for="Name" style="font-size:14px;">Dr. <%=doctName %> </label>
							...
							<div class="col-md-12" id= "refLetterDivID" style="margin:25px;">
						      ...
						      <div class="col-md-12" style="margin:15px;">
						          ...
						          <div class="col-md-1" style="margin-left: -15px;"> <label>Date:</label> </div>
						          <div class="col-md-3" style="margin-left: -15px;"> <label><input type="text" readonly="readonly" class="form-control" value="<%=strval[0] %>" name="date" id="date12"></label></div>
						    ...
						    <div class="row" >
						      ...
						      <div class="col-md-12" style="margin:15px;">
						          ...
						          <label for="Name" style="font-size:14px;margin-top: 10px;">Dear Dr. </label><input type="text" readonly="readonly" value="<%=strval[1] %>"  name="doctName" id="doctName" style="width:20%; " class="form-control">, 
						    ...
						    <div class="row" >
						      ...
						      <div class="col-md-12" style="margin:15px;">
						          ...
						          <textarea rows="4"   readonly="readonly"  name="conditionText" id="conditionText" class="form-control" required><%=strval[3] %></textarea><br><br>
						...
						<div class="col-md-12" id="refLetterTextDivID" style="margin:25px;" >
							<textarea cols="2"  readonly="readonly" rows="10" id="refLetterText" name="refLetterText" style="width:100%;"><%=referralLetterText %></textarea>
						</div>
