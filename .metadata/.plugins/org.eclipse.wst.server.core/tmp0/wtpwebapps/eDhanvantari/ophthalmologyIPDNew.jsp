              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content span_11">
		              ...
		              <h4 style=""><b>IPD Visit For <s:property value="firstName"/>&nbsp;<s:property value="lastName"/>&nbsp;(<s:property value="registrationNo"/>)</b></h4>
		              ...
		              <ul id="myTab1" class="nav nav-tabs">
			        	...
			        	<!-- <ul id="myTab1" class="nav nav-tabs">
		             	...
		             	<div id="myTabContent1" class="tab-content">
		             		...
		             		<form class="form-horizontal form-label-left" id="OPDForm" name="OPDForm" action="AddNewIPDVisit" onsubmit="return showLoadingImg();" method="POST" enctype="multipart/form-data">
						    ...
						    <div class="tab-pane fade in active" id="visit">
								...
								<div class="col-md-3" >
								 ...
								 <div class="col-md-3" >
									 <s:file name="consentFile" id = "consentFileID" class="form-control" required="required"></s:file>
								 </div>
								...
								<div class="col-md-12" >
							    		<table border="1" width="100%">
							    			...
							    			<tr>
							    				...
							    				<input type="hidden" name="" value="<s:property value="cancerType"/>" id="hdCancerType" >
							    			...
							    			<tr>
							    				...
							    				<td> <input type="text" class="form-control" style="border:none;" required="required" name="dateOfDischarge" value="<%=currentDate %>" id="dateOfDischarge" placeholder="Discharge Date" aria-describedby="inputSuccess2Status3"></td>
							   ...
							   <div class="ln_solid"></div>
			                      ...
			                      <div class="form-group">
			                        <div class="col-md-12 col-xs-12" align="center">
			                          <button type="button" onclick="windowOpen1();" class="btn btn-primary" style="width:15%">Cancel</button>
									 ...
									 <div class="ln_solid"></div>
				                      ...
				                      <div class="form-group">
				                        <div class="col-md-12" align="center">
				                          ...
				                          <button class="btn btn-success" type="button" id="saveBtnID" name="addButton" value="save"  onclick="submitSaveForm()">Save & Print</button>
				                        </div>
				                      </div>
						    ...
						    <div class="tab-pane fade" id="prescription">
						    	<form class="form-horizontal form-label-left" novalidate id="genPhyPrescID" name="genPhyPrescID" onsubmit="return savePrescription();" action="AddNewIPDPrescription" method="POST" style="margin-top:20px;">
					                    ...
					                    <div class="form-group">
					                      <div class="col-md-12 col-xs-12" align="center">
					                        ...
					                        <button type="submit" class="btn btn-success" id="savePrescID" name="addButton" value="add">Save</button>
						                 	<button class="btn btn-warning" type="submit" id="PrintPrescID" name="addButton" value="print">Save & Print Discharge Card</button>
				                          </div>
					                    </div>
						    ...
						    <div class="tab-pane fade" id="billing">
						    	<form class="form-horizontal form-label-left" onsubmit="checkCheckbox();" name="OPDBILLForm" id="OPDBILLForm" action="AddNewIPDOpthBill" method="POST" style="margin-top:20px;">
							...
							<div class="row" style="margin-top: 15px;">
								...
								<div class="row" style="margin-top: 15px;">
									...
									<div class="col-md-4">
										...
										<input type="hidden" name="cancerType" value="<s:property value="cancerType"/>">
									</div>
										...
										<tbody>
											...
											<tr>
												...
												<td style="text-align: center;" colspan="2">
													<input type="number" class="form-control billingRateClass" name="charges" id="charges" value="<s:property value="consultationCharges"/>" onkeyup="changeTotalBill('totalBill',charges.value);" placeholder="Charges(Rs)">
												</td>
											</tr>
