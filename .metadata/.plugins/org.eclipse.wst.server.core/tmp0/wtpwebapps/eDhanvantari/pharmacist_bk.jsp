...
<!-- Ends -->
<script>
function changeTotalBill(rate, quantity) {
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for ( var i = 0; i < array.Release.length; i++) {
	            ...
	            trTag += "<tr id=" + trID + " style='font-size:14px;'>" +
	                    ...
	                    "<td>" + drugName + "</td>" +
	                    "<td><input id='quantityInput'  type='number' name='quantity' class='form-control' style='width: 50%;' onkeyup='changeTotalBill("+rate+",  this.value);'></td>" +
	                    "<td>" + rate + "</td>" +
	                    "<td><input class='billingRateClass form-control' id='totalBill1' type = 'number' readonly='readonly'></input></td>" +
	                    "</tr>";
