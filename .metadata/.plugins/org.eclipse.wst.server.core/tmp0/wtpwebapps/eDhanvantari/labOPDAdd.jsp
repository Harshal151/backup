            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
			   ...
			   <!--  <div class="tab-pane fade in active" id="visit"> -->
				    <form class="form-horizontal form-label-left" action="AddNewLabVisit" name="visitrForm" id="visitrForm" method="POST" style="margin-top:20px;">
			         ...
			         <input type="hidden"  name="lastName" id="lastName" value="<s:property value="lastName"/>">
						  ...
						  <div class="row" style="margin-top:15px;">
						    ...
						    <div class="row">
						    	...
						    	<div class="col-md-2">
						    		<input type="text" class="form-control" name="sampleID" required="required" id="sampleID" value="<s:property value="sampleID"/>" placeholder="Enter Sample ID here">
						    	</div>
							</div>
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-2" id="refDocDivID">
						    		<s:select list="referringDoctorList" headerKey="" headerValue="Select Referred By" name="referredBy" id="doctName" class="form-control" ></s:select>
						    	</div>
						    	<div class="col-md-1">
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class ="row">
						    		<s:select list="getGroupTestList" name="groupTest" id="groupTest" class="form-control" onchange = "selectGroupLabTest()"></s:select>
	                      ...
	                      <div class="form-group">
	                        <div class="col-md-12" align="center">
	                         <!--  <button type="button" onclick="windowOpen1();" class="btn btn-primary">Cancel</button> -->
	                          ...
	                          %>
	                          <button id="sendBtnID" type="submit" class="btn btn-success " disabled="disabled" onclick="showLoadingImg1();">Save</button>
	                          <%
					        	}else{
			                 %>
			                 <button id="sendBtnID" type="submit" class="btn btn-success " onclick="feildCheck(event);">Save</button>
			                 <%
					        	}
			                 %>
	                       </div>
			    ...
			    Billing div
			     ...
			     <hr>
			      <form class="form-horizontal form-label-left" novalidate id="genPhyBillID" name="genPhyBillID" onsubmit="return disableSubmitBtn('addBillBtnID');" action="AddNewLabBill" method="POST" style="margin-top:20px;">
	                   ...
	                   <div class="row" style="margin-top:10px;padding: 15px;">
							      	...
							      	<table  class="table table-striped table-bordered dt-responsive nowrap">
								        ...
								        <tbody>
											...
											<tr>
								        		...
								        		<td>
								        			<input type="number" class="checkClass form-control" value="<s:property value="totalDiscount"/>" onkeyup="changeNetAmtByDiscount(this.value,totalAmountID.value);" name="totalDiscount" id="totalVatID">
								        		</td>
							      ...
							      <div class="row" style="padding: 0 15px 0 15px;">
			                    	...
			                    	<div class="col-md-2 col-sm-3 col-md-4">
			                    		<div class="col-md-4 col-sm-4 col-xs-6">
			                    			<input type="checkbox" name="paymentType" onclick="hideChequeDetailsDiv(this);" style="height: 25px;box-shadow: none;" id="paymentTypeCashID" value="Cash" class="checkClass form-control" checked>
			                    		</div>
			                    	...
			                    	<div class="col-md-2 col-sm-3 col-md-4">
			                    		<div class="col-md-4 col-sm-4 col-xs-6">
			                    			<input type="checkbox" name="paymentType" onclick="displayChequeDetailsDiv(this);" style="height: 25px;box-shadow: none;" id="paymentTypeChequeID" value="Cheque" class="checkClass form-control">
			                    		</div>
			                    	...
			                    	<div class="col-md-2 col-sm-3 col-md-4">
			                    		<div class="col-md-4 col-sm-4 col-xs-6">
			                    			<input type="checkbox" name="paymentType" onclick="displayCardDiv(this);" style="height: 25px;box-shadow: none;" id="paymentTypeCardID" value="Credit/Debit Card" class="checkClass form-control">
			                    		</div>
			                    	...
			                    	<div class="col-md-2 col-sm-3 col-md-4">
			                    		<div class="col-md-4 col-sm-4 col-xs-6">
			                    			<input type="checkbox" name="paymentType" onclick="displayChequeDetailsDivOther(this);" style="height: 25px;box-shadow: none;" id="paymentTypeOtherID" value="Other" class="checkClass form-control">
			                    		</div>
			                    		<div class="col-md-8 col-sm-4 col-xs-6" style="padding-top:5px;">
                           ...
                           <div class="ln_solid"></div>
		                    ...
		                    <div class="form-group">
		                      <div class="col-md-12" align="center">
		                        <button type="button" onclick="windowOpen1();" class="btn btn-primary">Cancel</button>
		                    	<button class="btn btn-success" type="submit" id="addBillBtnID">Add</button>
			                 </div>
		                    </div>
