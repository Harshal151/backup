...
<html lang="en">
  <head>
    ...
    <title>Edit Product | E-Dhanvantari</title>
    ...
    <script type="text/javascript">
    	...
    	function SubmitPrice(){
    		...
    		document.forms["productForm"].action = "AddPrice";
  ...
  <!-- Ends -->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
                   ...
                   <form class="form-horizontal form-label-left" novalidate name="productForm" id="productForm" action="EditProduct" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;" enctype="multipart/form-data">
                      <s:iterator value="productList" var="productForm">
                      
                      <input type="hidden" name="productID" value="<s:property value="productID"/>">
                      <!-- <input type="hidden" name="productPriceID" value="<s:property value="productPriceID"/>"> -->
                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Drug Name">Drug Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="drugName" required="required" value="<s:property value="drugName"/>" placeholder="Drug Name" class="form-control">
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Trade Name">Trade Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="tradeName" required="required" value="<s:property value="tradeName"/>" placeholder="Trade Name" class="form-control">
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label for="Role" class="control-label col-md-3 col-xs-3">Category<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <s:select list="productCategoryList" headerKey="" headerValue="Select Category" name="categoryID" class="form-control" ></s:select>
                        </div> 
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="barcode" id="barcodeID" placeholder="Barcode" required="required" value="<s:property value="barcode"/>" class="form-control">
                        </div>
                        <div class="col-md-1 col-sm-1 col-xs-12" id="checkID"> </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <textarea name="description"  class="form-control" placeholder="Description"><s:property value="description"/></textarea>
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Dose">Strength
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="dose" placeholder="Strength" value="<s:property value="dose"/>" class="form-control">
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label for="User Type" class="control-label col-md-3 col-xs-3">Unit</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
							<s:select list="#{'g':'g','ml':'ml','packs':'packs'}" headerKey="-1" headerValue="Select Unit" name="unit" class="form-control" ></s:select>
						</div>
                      </div>
                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Form">Form
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="productFormName" placeholder="Form" value="<s:property value="productFormName"/>" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="code" placeholder="Code" value="<s:property value="code"/>" class="form-control">
                        </div>
                      </div>
                     
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Minimum Quantity">Minimum Quantity<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="minQuantity" placeholder="Minimum Quantity" value="<s:property value="minQuantity"/>" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-xs-12" align="center">
                          ...
                          <button id="send" type="submit" class="btn btn-success " >Update Product</button>
                        </div>
                      </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
    	...
    	$("select[name=categoryID]").attr("required","required");
