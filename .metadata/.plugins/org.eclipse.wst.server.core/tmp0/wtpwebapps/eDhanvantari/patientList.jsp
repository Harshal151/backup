...
<html lang="en">
  <head>
    ...
    <title>Participant List | E-Dhanvantari</title>
    
    <%
    	}else{
    %>
    
     <title>Patient List | E-Dhanvantari</title>
    ...
    <script type="text/javascript">
    				...
    				<%
		            	...
		            	*/
		            	String[] formNameArray = form.getPatientJSPName().split("&");
		            	if(formNameArray[0].trim().equals("addRasayuPatient.jsp")){
		            		System.out.println("Inside...");
		            %>
		            
			            function submitForm(){
			    			document.getElementById("myForm").action = "InsertRasayuPatient";
			    			document.forms["myForm"].submit();
			    		}
			            
			            <%
			            	}else if(formNameArray[0].trim().equals("addAnuyashPatient.jsp")){
			            %>
	    
	    
						function submitForm(){
							document.getElementById("myForm").action = "InsertAnuyashPatient";
							document.forms["myForm"].submit();
						}
						...
						function submitForm(){
							...
							document.getElementById("myForm").action = "InsertPatient";
							document.forms["myForm"].submit();
						}
		...
		function cancelForm(){
			...
			document.getElementById("myForm").action = "PatientAdd";
			document.forms["myForm"].submit();
		}
	</script>
...
S3ObjectInputStream s3ObjectInputStream = s3.getObject(new GetObjectRequest(bucketName + "/" + s3reportFilePath, daoInf.retrieveProfilePic(form.getUserID()))).getObjectContent();
                  ...
                  <div class="x_content">
		              ...
		              <div>
		              	<s:if test="hasActionErrors()">
							...
							<center>
							<font style="color: green;font-size:16px;margin-bottom: 10px;"><s:actionmessage /></font>
							</center>
						</s:else>
		              </div>
                    ...
                    <div class="row" style="margin-top:15px;">
	                    ...
	                    <div class="col-md-4">
	                        <div class="col-md-6">
	                            <button class="btn btn-success" type="submit" onclick="submitForm();">Add New</button>
	                        </div>
	                        <div class="col-md-6">
        ...
        <div style="display: none;">
           <form class="" name="myForm" id="myForm" action="" method="POST" style="margin-top:30px;" enctype="multipart/form-data">

			<s:iterator value="newPatientList" var="form">
				<!--<input type="text" readonly="readonly" class="form-control1" name="patientID"
					value=" <s:property value='patientID'/> ">
			      --><input type="text" class="form-control1" value="<s:property value='firstName'/>" required name="firstName" placeholder="First Name" autofocus="">
			      <input type="text" class="form-control1" value="<s:property value='middleName'/>"  name="middleName" placeholder="Middle Name" autofocus="">
			      <input type="text" class="form-control1" value="<s:property value='lastName'/>" required name="lastName" placeholder="Last Name" autofocus="">
			     	
			      <s:radio list="#{'Male':'Male','Female':'Female','Unknown':'Unknown'}" name="gender"  ></s:radio>
			      <input type="text"  style="width: 100%;color:#999;font-size: 0.85em;outline: none;font-weight: 300;border: none;background:#222224;margin:0 0 1em 0;border-radius: 2px;-webkit-border-radius: 2px;-moz-border-radius: 2px;-o-border-radius: 2px;margin-top:15px;" class="form-control1" name="dateOfBirth" placeholder="Date of Birth" autofocus="" value="<s:property value='dateOfBirth'/>" onfocus="(this.type='date')" onblur="(this.type='text')">	
			      <input type="text" class="form-control1"  name="age" placeholder="Age" autofocus="" value="<s:property value='age'/>">
			      <input type="text" class="form-control1"  name="bloodGroup" placeholder="Blood Group" autofocus="" value="<s:property value='bloodGroup'/>">
			      <input type="text" class="form-control1"  name="rhFactor" placeholder="RH Factor" autofocus="" value="<s:property value='rhFactor'/>">
			      <input type="text" class="form-control1"  name="aadhaarNo" placeholder="Aadhaar No" autofocus="" value="<s:property value='aadhaarNo'/>">
			       <input type="text" class="form-control1"  name="address" placeholder="Address" autofocus="" value="<s:property value='address'/> ">
			       <input type="text" class="form-control1"  name="city" placeholder="City" autofocus="" value="<s:property value='city'/>">
			       <input type="text" class="form-control1"  name="state" placeholder="State" autofocus="" value="<s:property value='state'/>">
			       <input type="text" class="form-control1"  name="country" placeholder="Country" autofocus="" value="India">
			       <input type="text" class="form-control1"  name="phone" placeholder="Phone" autofocus="" value="<s:property value='phone'/>">
			        <input type="text" class="form-control1"  name="mobile" placeholder="Mobile" autofocus="" value="<s:property value='mobile'/>">
			        <input type="email" class="form-control1"  name="emailID" placeholder="Email Address" value="<s:property value='emailID'/>" autofocus="" style="width: 100%;color:#999;font-size: 0.85em;outline: none;font-weight: 300;border: none;background:#222224;margin:0 0 1em 0;border-radius: 2px;-webkit-border-radius: 2px;-moz-border-radius: 2px;-o-border-radius: 2px;">
				    <input type="text"   class="form-control1"  name="emFname" placeholder="First Name" autofocus="" value="<s:property value='emFname'/>">
				    <input type="text"  class="form-control1"  name="emMname" placeholder="Middle Name" autofocus="" value="<s:property value='emMname'/>">
				    <input type="text"   class="form-control1"  name="emLname" placeholder="Last Name" autofocus="" value="<s:property value='emLname'/>">
				    <input type="text" class="form-control1"  name="emRelation" placeholder="Relation" autofocus="" value="<s:property value='emRelation'/>">
				    <input type="text" class="form-control1"  name="emAdd" placeholder="Address" autofocus="" value="<s:property value='emAdd'/>">
				    <input type="text" class="form-control1"  name="emCity" placeholder="City" autofocus="" value="<s:property value='emCity'/>">
				    <input type="text" class="form-control1"  name="emState" placeholder="State" autofocus="" value="<s:property value='emState'/>">
				    <input type="text" class="form-control1"  name="emCountry" placeholder="Country" autofocus="" value="<s:property value='emCountry'/>">
				    <input type="text" class="form-control1"  name="emPhone" placeholder="Phone" autofocus="" value="<s:property value='emPhone'/>">
				     <input type="text" class="form-control1"  name="emMobile" placeholder="Mobile" autofocus="" value="<s:property value='emMobile'/>">
				     <input type="email" class="form-control1"  name="emEmailID" placeholder="Email Address" value="<s:property value='emEmailID'/>" autofocus="" style="width: 100%;color:#999;font-size: 0.85em;outline: none;font-weight: 300;border: none;background:#222224;margin:0 0 1em 0;border-radius: 2px;-webkit-border-radius: 2px;-moz-border-radius: 2px;-o-border-radius: 2px;">
				     <input type="text" class="form-control1"  name="occupation" placeholder="occupation" autofocus="" value="<s:property value='occupation'/>">
				     <input type="text" class="form-control1"  name="EC" placeholder="EC" autofocus="" value="<s:property value='EC'/>">
				     <input type="text" class="form-control1"  name="dobDate" placeholder="dobDate" autofocus="" value="<s:property value='dobDate'/>">
				     <input type="text" class="form-control1"  name="dobMonth" placeholder="dobMonth" autofocus="" value="<s:property value='dobMonth'/>">
				     <input type="text" class="form-control1"  name="dobYear" placeholder="dobYear" autofocus="" value="<s:property value='dobYear'/>">
				     <input type="text" name="registrationNo" readonly="readonly" value="<s:property value='registrationNo'/>" placeholder="Medical Registration No." class="form-control1">
				     <input type="text" name="sugarAvgValue" readonly="readonly" value="<s:property value='sugarAvgValue'/>" class="form-control1">
				     <input type="text" name="diagnosis" readonly="readonly" value="<s:property value='diagnosis'/>" class="form-control1">
				     <input type="text" name="documentType" readonly="readonly" value="<s:property value='documentType'/>" class="form-control1">
				     <input type="file" name="XRAYFindingReportFile" readonly="readonly" value="<s:property value='XRAYFindingReportFile'/>" class="form-control1">
				     <input type="file" name="UCGFindingReportFile" readonly="readonly" value="<s:property value='UCGFindingReportFile'/>" class="form-control1">
				     <input type="file" name="CTFindingReportFile" readonly="readonly" value="<s:property value='CTFindingReportFile'/>" class="form-control1">
				         <input type="text" name="locationLatLong" readonly="readonly" value="<s:property value='locationLatLong'/>" class="form-control1">
				         <input type="text" name="centerName" readonly="readonly" value="<s:property value='centerName'/>" class="form-control1">
			</s:iterator>
