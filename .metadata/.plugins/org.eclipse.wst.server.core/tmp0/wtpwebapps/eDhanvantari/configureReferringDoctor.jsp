...
<html lang="en">
  <head>
    ...
    <title>Configure Referring Doctors | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                      <div class="title_left">
                        <h3>CONFIGURE REFERRING DOCTORS</h3>
                      </div>
                    </div>
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchRefDoctor" method="POST" onsubmit="return showLoadingImg();">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search Referring Doctor" name="searchRefDoctor">
				              	</div>
				              	<div class="col-md-3 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active" >Search Referring Doctor</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllRefDoctor"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Referring Doctors</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="configureReferringDoctorList" var="UserForm">
		                        	<tr>
								
											<td><s:property value="referringDoctName" /></td>
											
											<td><s:property value="referringDoctSpecialisation" /></td>
											
											<td><s:property value="referringDoctClinicName" /></td>
											
											<td><s:property value="referringDoctClinicAddres" /></td>
											
											<td><s:property value="referringDoctPhone" /></td>
											
											<td><s:property value="referringDoctEmail" /></td>
												 
											<td align="center"><s:url id="approveURL"
												action="RenderEditRefDoc">
												<s:param name="referringDoctID" value="%{referringDoctID}" />
												<s:param name="searchRefDoctor" value="%{searchRefDoctor}" />
											</s:url> <s:a href="%{approveURL}">
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Referring Doctor"
													title="Edit Referring Doctor" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteRefDoc">
												<s:param name="referringDoctID" value="%{referringDoctID}" />
												<s:param name="searchRefDoctor" value="%{searchRefDoctor}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete Referring Doctor"
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="ConfigureReferringDoctor" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Doctor Name">Doctor Name <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="referringDoctName" required="required" placeholder="Doctor Name" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="referringDoctPhone" placeholder="Phone" class="form-control"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditConfigureReferringDoctor" method="POST" onsubmit="return showLoadingImg();" style="margin-top:20px;">
						  
						   <s:iterator value="referringDoctEditList" var="concessionForm">
						  
						  <input type="hidden" name="referringDoctID" value="<s:property value="referringDoctID" />" >
						  <input type="hidden" name="searchRefDoctor" value="<s:property value="searchRefDoctor" />" >
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Doctor Name">Doctor Name <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="referringDoctName" value="<s:property value="referringDoctName" />"  required="required" placeholder="Doctor Name" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="referringDoctSpecialisation" value="<s:property value="referringDoctSpecialisation" />"  placeholder="Specialization" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="referringDoctClinicName" value="<s:property value="referringDoctClinicName" />"  placeholder="Clinic Name" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <s:textarea name="referringDoctClinicAddres"  placeholder="Clinic Address" class="form-control"></s:textarea>
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="referringDoctPhone" value="<s:property value="referringDoctPhone" />"  placeholder="Phone" class="form-control"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="email" name="referringDoctEmail" value="<s:property value="referringDoctEmail" />"  placeholder="Email" class="form-control">
	                        </div>
	                      </div>
