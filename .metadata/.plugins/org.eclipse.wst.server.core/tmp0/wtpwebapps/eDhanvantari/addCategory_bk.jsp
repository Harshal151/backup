...
<html lang="en">
  <head>
    ...
    <title>Manage Category | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchCategory" onsubmit="return showLoadingImg();" method="POST">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search Category" name="searchCategory">
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<button style="width:100%;" type="submit" class="btn btn-success active">Search Category</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllCategories"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Categories</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="categoryList" var="categoryForm">
		                        	<tr>
								
											<td><s:property value="category" /></td>
											
											<td><s:property value="categoryType" /></td>
												 
											<td align="center"><s:url id="approveURL"
												action="RenderEditCategory">
												...
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Category"
													title="Edit Category" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteCategory">
												<s:param name="categoryID" value="%{categoryID}" />
												<s:param name="searchCategory" value="%{searchCategory}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete Category"
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="AddCategory" method="POST" onsubmit="return showLoadingImg();" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Category">Category <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="category" required="required" placeholder="Category" class="form-control">
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Type">Type <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <s:select list="#{'Compound':'Compound','Single':'Single'}" value="-1" headerKey="-1" headerValue="Select Type" id="categoryTypeID" name="categoryType" class="form-control" required="required"></s:select>
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group">
	                        <div class="col-md-12 col-xs-12" align="center">
	                          ...
	                          <button id="send" type="submit" class="btn btn-success " onclick="return submitForm(categoryTypeID.value);">Add</button>
	                        </div>
	                      </div>
	                    </form>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditCategory" method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="editCategoryList" var="concessionForm">
						  
						  <input type="hidden" name="categoryID" value="<s:property value="categoryID" />" >
						  <input type="hidden" name="searchCategory" value="<s:property value="searchCategory" />" >
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Category">Category <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="category" required="required" value="<s:property value="category" />" placeholder="Category" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <s:select list="#{'Compound':'Compound','Single':'Single'}" headerKey="-1" headerValue="Select Type" id="categoryTypeID" name="categoryType" class="form-control" required="required"></s:select>
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group">
	                        <div class="col-md-12 col-xs-12" align="center">
	                          <button type="reset" class="btn btn-primary"  onclick="windowOpen();">Cancel</button>
	                          <button id="send" type="submit" class="btn btn-success " onclick="return submitForm(categoryTypeID.value);">Update</button>
	                        </div>
	                      </div>
