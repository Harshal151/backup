                  ...
                  <div class="x_content">
                  	...
                  	<div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <s:select list="#{'X-RAY':'X-RAY','USG':'USG','CT SCAN':'CT SCAN'}" id="TempReportType" name="TempReportType" class="form-control" headerKey="" headerValue="Select Report Type" required="required"></s:select>
