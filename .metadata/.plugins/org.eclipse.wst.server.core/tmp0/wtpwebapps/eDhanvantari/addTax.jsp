...
<html lang="en">
  <head>
    ...
    <title>Manage Tax | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchTax" method="POST" onsubmit="return showLoadingImg();">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search Tax" name="searchTaxName">
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<button type="submit" class="btn btn-success active">Search Tax</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllTaxes"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Taxes</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="taxList" var="categoryForm">
		                        	<tr>
											...
											<td align="center"><s:url id="approveURL"
												action="RenderEditTax">
												<s:param name="taxID" value="%{taxID}" />
												<s:param name="searchTaxName" value="%{searchTaxName}" />
											</s:url> <s:a href="%{approveURL}">
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Tax"
													title="Edit Tax" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteTax">
												<s:param name="taxID" value="%{taxID}" />
												<s:param name="searchTaxName" value="%{searchTaxName}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete Tax"
													title="Delete Tax" />
											</s:a></td>
		                        	</tr>
		                        </s:iterator>
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="AddTax" method="POST" onsubmit="return showLoadingImg();" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Tax Name">Tax Name <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="taxName" required="required" placeholder="Tax Name" class="form-control">
	                        </div>
	                      </div>
	                      
	                       <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Tax Percent">Tax Percent <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="taxPercent" required="required" placeholder="Tax Percent" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditTax" method="POST" onsubmit="return showLoadingImg();" style="margin-top:20px;">
						  
						   <s:iterator value="editTaxList" var="concessionForm">
						  
						  <input type="hidden" name="taxID" value="<s:property value="taxID" />" >
						  <input type="hidden" name="searchTaxName" value="<s:property value="searchTaxName" />" >
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Tax Name">Tax Name <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="taxName" required="required" value="<s:property value="taxName" />" placeholder="Tax Name" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="taxPercent" value="<s:property value="taxPercent" />" required="required" placeholder="Tax Percent" class="form-control">
	                        </div>
	                      </div>
