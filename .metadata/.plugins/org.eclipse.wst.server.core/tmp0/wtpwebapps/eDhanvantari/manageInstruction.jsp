...
<html lang="en">
  <head>
    ...
    <title>Manage Instructions | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchInstructions" method="POST" onsubmit="return showLoadingImg();">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search Insruction by name" name="searchInstructionName">
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active" >Search Instruction</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllInstructions"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Instructions</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="configureInstructionsList" var="UserForm">
		                        	<tr>
								
											<td><s:property value="instruction" /></td>
												 
											<td align="center"><s:url id="approveURL"
												action="RenderEditInstruction">
												...
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Instruction"
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="ConfigureInstructions" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Instruction">Instruction <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="instruction" required="required" placeholder="Instruction" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditConfigureInstructions" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="instructionsList" var="instructionForm">
						  
						  <input type="hidden" name="instructionID" value="<s:property value="instructionID" />" >
						  <input type="hidden" name="searchInstructionName" value="<s:property value="searchInstructionName" />" >
						  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Instruction">Instruction <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="instruction" required="required" value="<s:property value="instruction" />" placeholder="Instruction" class="form-control">
	                        </div>
	                      </div>
