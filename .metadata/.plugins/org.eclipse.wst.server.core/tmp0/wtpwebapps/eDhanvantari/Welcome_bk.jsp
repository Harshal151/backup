...
<html lang="en">
  <head>
    ...
    <%
		...
		if(form.getUserType().equals("manager") || form.getUserType().equals("clinician") || form.getUserType().equals("compounder") || form.getUserType().equals("dietician") || form.getUserType().equals("billDesk") || form.getUserType().equals("accountant") || form.getUserType().equals("receptionist") || form.getUserType().equals("optician") ){
			Date date = new Date();
    ...
    <%
    	}else if(form.getUserType().equals("receptionist") || form.getUserType().equals("optician") || form.getUserType().equals("manager")){
    %>
...
<script type="text/javascript">
 ...
 <!-- To show loading icon while page is loading -->
        ...
        <div class="modal-body">
        	...
        	<div class="row" style="margin-top:15px;">
        		...
        		<div class="col-md-12 col-sm-12 col-xs-12">
        			...
        			<div class="col-md-3 col-sm-3 col-xs-6">
        				<input type="number" id="patientSearchMobNoID" class="form-control" placeholder="Mobile Number" onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
        			</div>
        		</div>
        	</div>
        </div>
  ...
  <div id="patientDetailModal1" class="modal fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <input type="hidden" id="patientIDIDID1" name="patientID">
        	...
        	<div class="row" style="margin-top:15px;">
        		...
        		<div class="col-md-12 col-sm-12 col-xs-12">
        			...
        			<div class="col-md-3 col-sm-3 col-xs-6">
        				<input type="number" id="mobID" name="mobile" class="form-control" placeholder="Mobile Number" onkeypress="if(this.value.length==10) return false;">
        			</div>
        			<div class="col-md-3 col-sm-3 col-xs-6">
        				<font style="font-size: 14px;">Patient Reg. No.</font>
        			</div>
        ...
        <div class="modal-footer" align="center">
          <button type="button" class="btn btn-default" id="patientDetailsCloseID" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary" onclick="checkPatientForAppointment(fNameID.value, mNameID.value, lNameID.value, mobID.value, regNoID.value, roomTypeID.value);">Check Patient</button>
        </div>
  ...
  <div id="multipatdetails" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title" id="myModalLabel" style="text-align:center;">APPOINTMENT DETAILS</h4>
        </div>
        <div class="modal-body">
        
        <div id="showValidationMsgID" style="display:none" >
        			<center>
        				<font style="color:red; font-size: 14px;">Patient not found. Please click Add New Patient button to register the patient.</font>
        			</center>
        </div>
        	...
        	<div class="row">
        		<div class="col-md-12 col-sm-12 col-xs-12" id="patientDetailsListID" style="padding:15px;">
        			<input type='text' required='required' name="patientID" style="margin-top:10px;" class='form-control' id="patientName" placeholder='Patient Name'>
        		</div>
        	</div>
        	...
        	<div class="row" style="margin-top:15px;">
        		...
        		<div class="col-md-12 col-sm-12 col-xs-12">
        			...
        			<div class="col-md-3 col-sm-3 col-xs-6">
        				<input type="text" id="apptDateID2" class="form-control" readonly="readonly" placeholder="Appointment Date">
        			</div>
        			<div class="col-md-2 col-sm-2 col-xs-6">
        				<font style="font-size: 14px;">Appt. Start Time</font>
        			</div>
        			<div class="col-md-4 col-sm-4 col-xs-6">
        				<div class="input-group date clinic_start col-md-12" data-date="" data-date-format="hh:ii:00" data-link-field="dtp_input3" data-link-format="hh:ii:00">
				             <input class="form-control" size="16" id="apptStartTimeID2" type="text" value="" readonly oninput="myFunction()">
				                <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
	                	</div>
        	...
        	<div class="row" style="margin-top:15px;">
        		...
        		<div class="col-md-12 col-sm-12 col-xs-12">
        			...
        			<div class="col-md-3 col-sm-3 col-xs-6">
        				<font style="font-size: 14px;">Appointment Type<span class="required">*</span></font>
        			</div>
        			<div class="col-md-3 col-sm-3 col-xs-6">
        			...
        			<div class="col-md-3 col-sm-3 col-xs-6">
        				<font style="font-size: 14px;">Appointment By<span class="required">*</span></font>
        			</div>
        			<div class="col-md-3 col-sm-3 col-xs-6">
        ...
        <div class="modal-footer" align="center">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-success" onclick="addNewPatient( patientName.value, apptDateID2.value, apptStartTimeID2.value);">Add New Patient</button>
          <button type="button" class="btn btn-primary"  id="multiplePatSubmtBtnID" onclick="registerAppointment3(startTimeID2.value, endTimeID2.value, agendaID2.value, apptPatientID1.value, apptDateID2.value, apptStartTimeID2.value, apptTypeID2.value, apptEndTimeID2.value, patientName.value, apptByID2.value);">Add Appointment</button>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        	...
        	<form action="" name="apptPatFormID2" id="apptPatFormID2">
	        	...
	        	<input type="hidden" name="dateOfBirth" id="patdateOfBirthID1">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer" align="center">
        	...
        	<center>
        		...
        		<button type="button" class="btn btn-primary" style="margin-left: 16%;" onclick="updateAppointment(patDetailsID1.value, sDateID.value, sHHID.value, eDateID.value, eHHID.value, updateapptTypeID.value);">Update Appointment</button>
        		
        		<button type="button" class="btn btn-success" id="ConsultationBtnID" style="display: none; width: 27%; margin-right: 17px;" onclick="verifyVisitExistsForAppointment(patientIDForClinician.value, apptIDForClinician.value, updateapptTypeID.value);">Consultation</button>
        	</center>
  ...
  <div id="ConsentModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-md">
      <div class="modal-content">

        <div class="modal-header">
          <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
          <h4 class="modal-title" id="myModalLabel" style="text-align:center;color: black;">Telephonic Consultation (nCOVID19 Pandemic)</h4>
		  <h4 class="modal-title" id="myModalLabel" style="text-align:center;color: black;">Regulations & Consent</h4>
        </div>
        ...
        <div class="modal-body">
        	...
        	<div class="row" style="margin-left: 3%;margin-right: 3%;">
        		...
        		<div class="col-md-12 col-sm-12 col-xs-12" style="color: black;padding-bottom: 1%;">Dear Doctor,</div>

				<div class="col-md-12 col-sm-12 col-xs-12" style="color: black;padding-bottom: 1%;">
					Thank you for your service during these distressing times! You truly are the fore-runner in our fight against nCOVID19!
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12" style="color: black;padding-bottom: 1%;">
					The State Medical Councils have come up with the following rules that you <b>MUST</b> comply with for using eDhavantari application 
					for Telephonic Consultation during the on-going nCOVID19 pandemic in India.
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12" style="color: black;padding-bottom: 1%;">
					Please review the rules below and provide your consent by clicking the checkbox below.
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12 example" style="color: black;padding-bottom: 1%;">
					Thanks,<br>
					Team eDhanvantari
        		</div>
        		<hr>
        		<div class="col-md-12 col-sm-12 col-xs-12" style="color: black;margin-top: 2%;">
        			<b>Rules to follow:</b>
        		</div>
			<% int count = 1;%>
			
			<div class="col-md-12 col-sm-12 col-xs-12 exampleNew" style="color: black; margin-left: 4%;">
	        	<%=count++ %>. Only <b>minor ailments</b> must be treated through Telephonic Consultation over eDhanvantari.<br/>
				<%=count++ %>. Only Routine Follow-ups must be done through Telephonic Consultation over eDhanvantari.<br/>
				<%=count++ %>. Only patients whose medical history is known to the Registered Medical Practitioner must be treated through Telephonic Consultation over eDhanvantari. <br/> 
				<%=count++ %>. No injectable to be prescribed through Telephonic Consultation over eDhanvantari.<br/>
				<%=count++ %>. No prescription should be given for clinically suspected case of COVID-19 through Telephonic Consultation over eDhanvantari.<br/>
				<%=count++ %>. Prescription on letter-head of the RMP, signed by the RMP and in format specified by the State Medical Council should be sent to patient as PDF (eDhanvantari allows sending email and downloading prescription PDF)<br/>
				<%=count++ %>. Prescription should be dated and period of medication should be mentioned. (eDhanvantari provides this feature in Prescription)<br/>
				<%=count++ %>. Prescription should mention "Telephonic Consultation" on the Header (eDhanvantari has this feature).<br/>
				<%=count++ %>. RMP should note down short medical history on letter-head. (eDhanvantari allows this through the Case Report Form)<br/>
				<%=count++ %>. No advice should be given on social media.<br/>
				<%=count++ %>. RMPs can refer to images sent by patients pertaining to their disease. (eDhanvantari allows image and PDF upload in the Reports section of the visit)<br/>
				<%=count++ %>. All records of Telephonic Consultation should be strictly preserved by RMP. (eDhanvantari will allow you to do this, and export all records into Excel format as well)
        	</div>         
			
			<div class="col-md-12 col-sm-12 col-xs-12" style="color: black; margin-left: 2%;padding-top: 4%;padding-bottom: 2%;">
				<input type="hidden" name="consentType" value="COVID19 Usage Consent">
		
		<% if(UsageConsentDetailsList.contains(null)) { System.out.println("Inside: ");%>
			<input type="checkbox" name="readRule" id="readRuleID" class="checkboxClass" value="Yes"  onclick="checkCheckbox();" />I hereby declare that I have read all the 12 rules mentioned above.<br/>
			<input type="checkbox" name="acceptRule" id="acceptRuleID" class="checkboxClass" value="Yes" onclick="checkCheckbox();" />I accept that I will follow all the rules above strictly while using eDhanvantari.<br/>
			<input type="checkbox" name="infoTrue" id="infoTrue" class="checkboxClass" value="Yes" onclick="checkCheckbox();" />I declare that all information provided by me to eDhanvantari is true.
		<%}else{
			for(LoginForm formVal: UsageConsentDetailsList){ System.out.println("UsageConsent: "+formVal.getReadRule());%>
			
				<% if(formVal.getReadRule().equals("Yes")){%>
					<input type="checkbox" name="readRule" id="readRuleID" class="checkboxClass" value="Yes" checked="checked" onclick="checkCheckbox();" />I hereby declare that I have read all the 12 rules mentioned above.<br/>
				<% } %>				
				
				<% if(formVal.getAcceptRule().equals("Yes")){%>
					<input type="checkbox" name="acceptRule" id="acceptRuleID" class="checkboxClass" value="Yes" checked="checked" onclick="checkCheckbox();" />I accept that I will follow all the rules above strictly while using eDhanvantari.<br/>
				<% } %>
				
				<% if(formVal.getInfoTrue().equals("Yes")){ %>
					<input type="checkbox" name="infoTrue" id="infoTrue" class="checkboxClass" value="Yes" checked="checked" onclick="checkCheckbox();" />I declare that all information provided by me to eDhanvantari is true.
				<% } %>
		<% } 
		}%>
        ...
        <div class="modal-footer">
        <center>
          <button type="submit" class="btn btn-primary" id="AcceptSubmitID" onclick="SaveConsent();" data-dismiss="modal">Accept</button>
          <a href="Logout"><button type="button" class="btn btn-danger" >Reject</button></a>
          </center>
        </div>
         ...
         <%
          ...
          %>
		   ...
		   <div class="ln_solid"></div>
		   			...
		   			<div class="row">
						...
						%> 
						 ...
						 <div class="col-md-2 col-sm-3 col-xs-4">
							...
							<a href="ViewAppointment"> <button type="button" class="btn btn-warning active"  style="width:100%; margin-top:1%;" onclick="showLoadingImg();">All Appointments</button></a>
						
						</div> 
						
						<form action="SearchPatient"  onsubmit="return showLoadingImg();" method="POST">
						...
						<div class="col-md-2 col-sm-3 col-xs-4" id="dateDivID1" style="display: none;">
						
							<input type="text" class="form-control" style="margin-top:0.2em;" name ="fromDate" id="datepicker1" placeholder="From Date" title="Enter only From Date if you want to search for a single date rather than a range.">
							<input type="text" class="form-control" style="margin-top:0.2em;" name ="toDate" id="datepicker2" placeholder="End Date" >
							
						</div>
						
						<div class="col-md-3 col-sm-3 col-xs-4" id="searchDivID1">
						
							<input type="text" class="form-control" style="margin-top:0.2em;" name="patientName" placeholder="Search Patient By Name/Mobile No" >
						
						</div>
						
						<div class="col-md-2 col-sm-3 col-xs-4">
						
							<button class="btn btn-success active" type="submit" style="margin-top:0.32em; width:100%; margin-top: 1%;" >Search Patient</button>
						...
						<div class="col-md-2 col-sm-3 col-xs-6">
							...
							<a href="#patientDetailModal1" data-toggle="modal"> <button type="button" class="btn btn-default"  style="width:100%;" >Add Appointments</button></a>
						
						</div>
						
						<div class="col-md-2 col-sm-3 col-xs-6">
						
							<a href="ViewMyAppointment"> <button type="button" class="btn btn-default active" style="width:100%; margin-top:1%;" onclick="showLoadingImg();" >My Appointments</button></a>
                       ...
                       <div class="col-md-2 col-sm-3 col-xs-6" id="dateDivID1" style="display: none;"> 
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-6 " id="searchDivID1">
							...
							<input type="text" class="form-control" style="margin-top:0.2em;" name="patientName" placeholder="Search Term" >
						...
						<div class="col-md-2 col-sm-3 col-xs-6">
							...
							<a href="javascript:checkSearchPatientForm();"> <button class="btn btn-primary active" type="button" style="width:100%; margin-top:0.32em;margin-top: 1%;">Add New Patient</button></a>
					...
					<% if(form.getClinicID()!=0){ %>
						...
						<div class="row">
							...
							<div class="col-md-2 col-sm-3 col-xs-6">
								<a href="javascript:submitViewApptForm();"> <button type="button" class="btn btn-warning active"  style="width:100%; margin-top:1%;" onclick="showLoadingImg();">All Appointments</button></a>
							</div> 
							
							<div class="col-md-2 col-sm-3 col-xs-6">
								<a href="javascript:checkSearchPatientForm();"> <button class="btn btn-primary active" type="button" style="width:100%; margin-top:1%;">Add New Patient</button></a>
							</div>
                      ...
                      <tbody>
                        ...
                        <form action="" id="ViewAptForm" name="ViewAptForm" style="display: none;">
                        	...
                        	<tr>
									...
									<td align="center">
									<%
					                  if(form.getUserType().equals("administrator") || form.getUserType().equals("receptionist") || form.getUserType().equals("manager")){
					                %>
									<s:url id="approveURL"
				            ...
				            %>
			            	 <div class="row" align="right" style="padding-right: 15px;">
	                             ...
	                             <a href="javascript:submitApptReportFormToday();">
		                             <button class="btn btn-warning" type="button" id="dwldApptReportBtnID" disabled="disabled">Download Appointment Report</button></a>
			            	 	</form>
			            	 </div>
			            <%
			            	}
				            ...
				            %>
				            	 <div class="row" align="right" style="padding-right: 15px;">
				            		...
				            		<!-- <button type="submit" value="" name="" class="btn btn-success" id="excelWeekID" disabled="disabled">Download Visit Reports</button>
		                             ...
		                             <button class="btn btn-warning" type="button" id="dwldApptReportWeekBtnID" disabled="disabled">Download Appointment Report</button></a>
				            	 	</form>
				            	 </div>
				            <%
				            	}
				            ...
				            %>
				            	 <div class="row" align="right" style="padding-right: 15px;">
				            		...
				            		<!-- <button type="submit" value="" name="" class="btn btn-success" id="excelID" disabled="disabled">Download Visit Reports</button>
		                             ...
		                             <button class="btn btn-warning" type="button" id="dwldApptReportMonthBtnID" disabled="disabled">Download Appointment Report</button></a>
				            	 	</form>
				            	 </div>
				            <%
				            	}
          ...
          <%
           ...
           <% 
           		...
           		HashMap<String, List<ClinicForm>> bookingMap = clinicDaoInf.retrieveRoomBookingList(form.getClinicID(), form.getPracticeID());
				     		...
				     		<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
		                      ...
		                      <tbody>
		                      	<%
		                      		...
		                      		%>
		                      			<tr>
			                      			<td rowspan="<%= rowSpan%>" style="text-align: center;vertical-align: middle;"><%=srNo %></td>
			                      			<td rowspan="<%= rowSpan%>" style="text-align: center;vertical-align: middle;"><%=roomName %></td>
				                      		...
				                      		<td style="text-align: center;vertical-align: middle;">
			                      				...
			                      				%>
			                      				<button type="button" class="btn btn-warning" id="" onclick="javascript:verifyVisitExistsForAppointment('<%=clinicForm.getPatientID() %>', '<%=clinicForm.getApptID() %>', '<%=clinicForm.getVisitTypeID() %>');">Consultation</button>
			                      				<%
			                      					}else{
			                      				%>
			                      				<button type="button" class="btn btn-primary" id="" onclick="javascript:openAppointmentPopup('patientDetailModal1','<%=clinicForm.getRoomTypeID() %>');">Book this room</button>&nbsp;
			                      				<%
			                      					}
			                      				%>
			                      			</td>
