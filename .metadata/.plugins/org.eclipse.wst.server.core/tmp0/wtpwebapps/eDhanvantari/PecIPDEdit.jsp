...
int IOLProductID = (Integer)request.getAttribute("productID");
...
<script type="text/javascript">
		...
		function submitSaveWithoutPrintForm(){
			document.forms["OPDForm"].action = "UpdateIPDVisitWithoutPrint";
			document.forms["OPDForm"].submit();
		}
	</script>
									...
									<s:iterator value="patientList" var="patientVat">
										...
										<h4 style="">
											<b>IPD Visit For <s:property value="firstName" />&nbsp;<s:property
													value="lastName" />&nbsp;(<s:property value="patientID" />)
											</b>
										</h4>
										...
										<div id="myTabContent1" class="tab-content">
											...
											<div class="tab-pane fade in active" id="IPDVisit">
												...
												<form class="form-horizontal form-label-left" id="OPDForm"
													name="OPDForm" onsubmit="return showLoadingImg();"
													action="UpdateIPDVisit" method="POST"
													...
													<div id="myTabContent2" class="tab-content">
														...
														<input type="hidden" name="patientID" id="patientID"
															...
															value="<s:property value="aptID"/>"> <input
										...
										<button class="btn btn-warning" type="button" id="downloadButtonID" onclick="window.location='DownloadConsent?fileName=<%=consentDocFileName%>'">Download Consent</button>
																...
																<div class="col-md-8" id="consentID1">
																	<div class="col-md-4" style="margin-left: -10px;">
																		<label>Upload Consent Document</label> <input
																			type="text" name="consentFileDBName"
																	...
																	<table border="1" width="100%">
																		...
																		<tr>
																			...
																			<td><input type="text" class="form-control"
																				...
																				value="<s:property value="admission_time"/>"
																				...
																				<div class="item form-group search-container">
																					<div class="col-md-6 col-sm-6 col-xs-12">
																						<input type="text" class="form-control"
																							name="cancerType" id="search" required="required"
																		...
																		<tr>
																			<td colspan="2" style="padding-left: 10px;">
																				Discharge Date*:</td>
																			<td><input type="text" class="form-control"
																				style="border: none;" name="dateOfDischarge"
																				value="<s:property value="dateOfDischarge"/>"
						    		...
						    		<div class="col-md-12 col-sm-12">
						        		...
						        		<%-- <input type="text" class="form-control"  name="lensOS" value="<s:property value="lensOS"/>" placeholder="Lens OS"> --%>
														...
														<div class="tab-pane fade" id="ipd12">
															...
															<div class="form-group">
																<div class="col-md-12" align="center">
																	...
																	<button class="btn btn-success" type="button"
																		...
																		onclick="submitSaveWithoutPrintForm()">Update</button>
																	<button class="btn btn-success" type="button"
																		id="saveBtnID" style="width: 15%"
																		onclick="submitSaveForm()">Update & Print</button>
																</div>
															</div>
															...
															<div class="form-group">
																<div class="col-md-12" align="center">
																	<a href="#ipd1" data-toggle="tab"><button
																			class="btn btn-primary" type="button"
																			style="width: 15%" id="printButton">Previous</button></a>
											...
											<div class="tab-pane fade" id="prescription">
												<form class="form-horizontal form-label-left" novalidate
													...
													action="EditIPDPrescription" method="POST"
													...
													<input type="hidden" name="patientID"
														...
														type="hidden" name="addButton" id="addButton" value="add">
							             ...
							             <div class="col-md-2 col-xs-7 col-sm-1" id="noOfDays">
													...
													<div class="form-group">
														<div class="col-md-12 col-xs-12" align="center">
															...
															<button type="button" class="btn btn-success"
																id="savePrescID" name=""
																onclick="setBtnValue('add','addButton','genPhyPrescID')">Save</button>
															<button class="btn btn-warning" type="button"
																id="PrintPrescID" name=""
																onclick="setBtnValue('print','addButton','genPhyPrescID')">Save
											...
											<div class="tab-pane fade" id="billing">
												<form class="form-horizontal form-label-left"
													...
													id="OPDBILLForm" action="EditIPDOpthBill" method="POST"
													style="margin-top: 20px;">
													...
													<input type="hidden" name="patientID" id="patientID"
														...
														type="hidden" name="addButton" id="addButtonBill"
														value="add">
															...
															<table id="billingItemTableID"
																...
																<tbody>
																	...
																	<tr id="billingItemTRID1">
																		...
																		&nbsp; <select id="billIOLItemChargesID"
																			class="form-control" 
																			style="width: 50%; display: inline-block;" 
																			onchange="setIOLChargesRate(this)" >
																				...
																				for (Integer iolID : IOLChargesList.keySet()) {
																					...
																					if(IOLProductID == iolID){
																					
																				%>
																				<option id="<%=name[2]%>" value="<%=name[1]%>" selected><%=name[0]%></option>
																				<%
																					}	
																					else{
											...
											<input class="form-control" name="cashToReturn" id="cashToReturnID" value="<s:property value="cashToReturn"/>" placeholder="Cash To Return" type="number">
													...
													<div class="form-group">
														<div class="col-md-12 col-xs-12" align="center">
															...
															<button type="button" class="btn btn-success"
																id="billSubmtBtnID" name=""
																onclick="setBtnValue('add','addButtonBill','OPDBILLForm')">Save</button>
															<button class="btn btn-warning" type="button"
																id="billSubmtBtnID" name=""
																onclick="setBtnValue('print','addButtonBill','OPDBILLForm')">Save
																& Print</button>
