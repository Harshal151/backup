...
<script type="text/javascript">
			...
			//var diag = $("#cancerType").val(); 
			var diag = $("#hiddenCancerTypeID").val(); 
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
			     ...
			     <div class="tab-pane fade in active" id="visit">
				    <form class="form-horizontal form-label-left" novalidate action="AddNewVisit" name="visitrForm" id="visitrForm" method="POST" onsubmit="return CheckDiagnosisField();" style="margin-top:20px;">
	             ...
	             <div class="row" >
      			...
      			<div class="item form-group">
		               <div class="col-md-3 col-xs-6 col-sm-6"><label for="User Type" style="font-size: 15px; padding-left: 5px; padding-top: 15px;">MHO(Medical History)</label></div>
		            	 </div> 
	             			<div class="item form-group">
		              ...
		              <div class="col-md-3"><label for="User Type" style="font-size: 15px; padding-left: 7px; padding-top: 15px;">Current Medication</label></div>
		                ...
		                <div class="col-md-10  col-sm-12 col-xs-8">
		                      ...
		                      <div class="col-xs-12 col-md-2 col-sm-2" style="margin-left:0%;">
		                          	...
		                          	<input type="number"  class="form-control" name="OEPulse" id="pulseID"  onkeyup="myFunction1('pulseSpanID',this.value)" value="<s:property value="OEPulse"/>"  placeholder="Pulse">
	                      ...
	                      <div class="form-group" >
	                        <div class="col-md-12 col-sm-12 col-xs-12"  style="padding-top: 50px;" align="center">
			                 ...
			                 %>
			                 <button id="send" type="button" class="btn btn-success " onclick="return CheckDiagnosisField();"  >Add Visit</button>
			    ...
			    <!--  END -->
			     ...
			     <div class="tab-pane fade" id="presc" >
			        <form class="form-horizontal form-label-left" novalidate id="genPhyPrescID" onsubmit="return savePrescription();" name="genPhyPrescID" action="AddNewPrescription" method="POST" style="margin-top:20px;">
				      ...
				      <div class="row" style="margin-top:10px;margin-left:0px;margin-bottom:5px;">
				      	 <button type="button" class="btn btn-primary" onclick = "blankPrescription(visitID.value,aptID.value,patientID.value)">Blank Prescription</button>
				      </div>
				      ...
				      <div class="row" id="OPDPResc" style="margin-left:0px;margin-right:0px;margin-top:15px;">
				            ...
				            <div class="col-md-2 col-xs-7 col-sm-2">
				            	<s:select list="frequencyList" name="frequency" style="margin-top:10px;"  id="frequency1" class="form-control" onchange="getFreqCount(this.value)" headerKey="-1" headerValue="Frequency"></s:select>
				            </div>
