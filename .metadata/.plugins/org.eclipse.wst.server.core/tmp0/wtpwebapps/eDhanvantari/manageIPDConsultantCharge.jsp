...
<html lang="en">
  <head>
    ...
    <title>Manage IPD Consultant Charges | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                      <div class="title_left">
                        <h3>CONFIGURE IPD CONSULTANT CHARGES</h3>
                      </div>
                    </div>
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchIPDConsultantCharges" method="POST" onsubmit="return showLoadingImg();">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Enter clinician name to search" name=searchCharges>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active">Search Charges</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllIPDConsultantCharges"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Charges</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="consultantChargesList" var="UserForm">
		                        	<tr>
											...
											<td align="center"><s:url id="approveURL"
												action="RenderEditIPDConsultantCharges">
												<s:param name="consultationChargeID" value="%{consultationChargeID}" />
												<s:param name="searchCharges" value="%{searchCharges}" />
											</s:url> <s:a href="%{approveURL}">
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit IPD Consultant Charges"
													title="Edit IPD Consultant Charges" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteIPDConsultantCharges">
												<s:param name="consultationChargeID" value="%{consultationChargeID}" />
												<s:param name="searchCharges" value="%{searchCharges}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete IPD Consultant Charges"
													title="Delete IPD Consultant Charges" />
											</s:a></td>
		                        	</tr>
		                        </s:iterator>
		                      </tbody>
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="AddIPDConsultantCharges" onsubmit="return disableButton('send');" method="POST" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="ChargeType">Clinician Name <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="doctorName" required="required" placeholder="Clinician Name" class="form-control">
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="ChargeType">Room Type <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <s:select list="roomTypeMap" name="roomTypeID" id="" headerKey="" headerValue="Select Room Type" required="true" class="form-control"></s:select>
	                        </div>
	                      </div>
	
						<div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Charges">Charges <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="charges" required="required" placeholder="Charges" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditIPDConsultantCharges" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="editConsultantChargesList" var="OPDChargesForm">
						  
						  <input type="hidden" name="consultationChargeID" value="<s:property value="consultationChargeID" />" >
						  <input type="hidden" name="searchCharges" value="<s:property value="searchCharges" />" >
						  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Instruction">Doctor Name <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="doctorName" required="required" value="<s:property value="doctorName" />" placeholder="Doctor Name" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="charges" required="required" value="<s:property value="charges" />" placeholder="Charges" class="form-control">
	                        </div>
	                      </div>
