...
<html lang="en">
  <head>
    ...
    <title>Manage Supplier | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchSupplier" onsubmit="return showLoadingImg();" method="POST">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search Supplier" name="searchSupplierName">
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<button type="submit" class="btn btn-success active">Search Supplier</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllSuppliers"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Suppliers</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="supplierList" var="categoryForm">
		                        	<tr>
											...
											<td align="center"><s:url id="approveURL"
												action="RenderEditSupplier">
												<s:param name="supplierID" value="%{supplierID}" />
												<s:param name="searchSupplierName" value="%{searchSupplierName}" />
											</s:url> <s:a href="%{approveURL}">
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Supplier"
													title="Edit Supplier" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteSupplier">
												<s:param name="supplierID" value="%{supplierID}" />
												<s:param name="searchSupplierName" value="%{searchSupplierName}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete Supplier"
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="AddSupplier" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
	                      ...
	                      <div class="item form-group">
	                       ...
	                       <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Agency">Agency <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="agency" required="required" placeholder="Agency" class="form-control">
	                        </div>
	                      </div>
	
						<div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for=" Mobile"> Mobile 
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="mobile" placeholder="Mobile" class="form-control"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <textarea rows="2" cols="" class="form-control" placeholder="Address" name="address"></textarea>
	                        </div>
	                      </div>
	                     
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for=" City"> City 
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                      ...
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for=" State"> State 
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                      ...
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for=" Country"> Country 
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                      ...
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for=" PIN Code"> PIN Code 
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                      ...
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for=" VAT Number"> VAT Number <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="vatNumber" required="required" placeholder="VAT Number" class="form-control">
	                        </div>
	                      </div>
	                      
	                       <div class="item form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Registration Date ">Registration Date  
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control" name="registrationDate" value="<%=dateFormat.format(date) %>" id="single_cal3" placeholder="Registration Date " aria-describedby="inputSuccess2Status3">
                        </div>
                      </div>  
	                  ...
	                  <div class="ln_solid"></div>
	                      <div class="form-group">
	                        <div class="col-md-12 col-xs-12" align="center">
	                          <button type="reset" class="btn btn-primary" onclick="showLoadingImg();">Cancel</button>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditSupplier" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="editSupplierList" var="concessionForm">
						  
						  <input type="hidden" name="supplierID" value="<s:property value="supplierID" />"s >
						  <input type="hidden" name="searchSupplierName" value="<s:property value="searchSupplierName" />" >
	                     
	                     <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Name">Name <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="name" value="<s:property value="name" />" required="required" placeholder="Name" class="form-control">
	                        </div>
	                      </div>
	                       ...
	                       <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="agency" value="<s:property value="agency" />" required="required" placeholder="Agency" class="form-control">
	                        </div>
	                      </div>
						...
						<div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="mobile" value="<s:property value="mobile" />" placeholder=" Mobile" class="form-control"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="email" name="email" value="<s:property value="email" />" required="required" placeholder=" Email" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <textarea rows="2" cols="" class="form-control" placeholder="Address" name="address"><s:property value="address" /></textarea>
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="city" value="<s:property value="city" />" value="Pune" placeholder=" City" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="state" value="<s:property value="state" />" value="Maharashtra" placeholder=" State" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="country" value="<s:property value="country" />" value="India"  placeholder=" Country"  class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="pinCode" value="<s:property value="pinCode" />" placeholder=" PIN Code" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="vatNumber" value="<s:property value="vatNumber" />" required="required" placeholder=" VAT Number" class="form-control">
	                        </div>
	                      </div>
