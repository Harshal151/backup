...
<script>
	...
	function addProcedure1(procedure){
		...
		var TRID = "newProcTRID"+diagCounter;
...
<script type="text/javascript">
	  ...
	  function calculateTotal(){
	    ...
	    if(typeof discountType === "undefined" || discount == ""){
	    	discount = 0;
	    }
...
<body class="nav-md">
 ...
 %> <span class=" fa fa-angle-down"></span>
										...
										<div id="myTabContent1" class="tab-content">
											...
											<div class="tab-pane fade" id="visit">
												...
												<form class="form-horizontal form-label-left" novalidate
													id="OPDForm" name="OPDForm" action="UpdateOPDVisit"
													...
													<div class="row" style="margin-top: 15px;">
														...
														<div class="col-md-12 col-xs-12">
															<div class="col-md-2 col-xs-6">
																<s:checkbox name="selectedPrintField"
																	fieldValue="complainingOf" />
																<label for="Name"
														...
														<div class="col-md-4 col-xs-12">
															...
															<div class="col-md-8 col-xs-12">
																<input type="text" readonly="readonly"
																	class="form-control"
																	id="sd&t_<s:property value='visitID'/>"
																	name="dilationStartTime" placeholder="Yet to start"
																	value="<s:property value="dilationStartTime"/>">
															</div>
														</div>
														<div class="col-md-4 col-xs-12">
															<div class="col-md-4 col-xs-12">
															...
															<div class="col-md-8 col-xs-12">
																<input type="text" readonly="readonly"
																	class="form-control"
																	id="ed&t_<s:property value='visitID'/>"
																	name="dilationEndTime" placeholder="Yet to stop"
																	value="<s:property value="dilationEndTime"/>">
															</div>
														</div>
														<div class="col-md-4 col-xs-12">
															<div class="col-md-4 col-xs-12">
															...
															<div class="col-md-8 col-xs-12">
																<input type="text" readonly="readonly"
																	class="form-control"
																	id="dura_<s:property value='visitID'/>"
																	name="dilationDuration" placeholder="Yet to decide"
																	value="<s:property value="dilationDuration"/>">
															</div>
														</div>
													</div>
					      			...
					      			<s:textarea name="medicalNotes"  class="form-control" placeholder="Medical Notes"></s:textarea>
													...
													<div class="form-group">
														<div class="col-md-12" align="center">
															<button type="button"
																onclick="windowOpen1(<s:property value="patientID"/>);"
																class="btn btn-primary">Cancel</button>
															<button id="SaveVisitID" type="button"
																class="btn btn-success" onclick="CheckDiagnosisField();">Update</button>
															<button class="btn btn-warning" id="PrintVisitID"
																type="button" onclick="printOPDVisit();">Update
																& Print</button>
											...
											<div class="tab-pane fade" id="optician">
												...
												<form class="app-cam" id="genOpticianID" name=""
													action="UpdateOptician" onsubmit="return showLoadingImg();"
													...
													<input type="hidden" name="patientID"
														value="<s:property value="patientID"/>"> <input
														type="hidden" name="aptID" id="aptID" value="<%=apptID%>">
													<input type="hidden" name="visitNumber" id="visitNumber"
														value="<s:property value="visitNumber"/>"> <input
													...
													<div class="form-group">
														<div class="col-md-12" align="center">
															...
															<button class="btn btn-warning" type="button"
																onclick="printOptician();">Update & Print</button>
														</div>
													</div>
												</form>
											</div>
											...
											<div class="tab-pane fade" id="presc">
												<form class="form-horizontal form-label-left" novalidate
													...
													action="EditPrescription" method="POST"
													style="margin-top: 20px;">

													<input type="hidden" name="patientID"
														value="<s:property value="patientID"/>"> <input
														type="hidden" name="visitID"
														value="<s:property value="visitID"/>"> <input
														type="hidden" name="aptID" id="aptID" value="<%=apptID%>">
													...
													<div class="row"
														...
														<div class="col-md-4">
															...
															<div class="row" style="margin-left: 3px;">
																<div class="col-md-9">
																	<s:select list="DiagnosticList1" name="diagnostic"
																		id="diagnostic" class="form-control"
																		style="padding-left:14px;" headerKey=""
																		headerValue="Select Diagnostic">
																	</s:select>
														...
														<div class="col-md-4">
															...
															<div class="row" style="margin-left: 3px;">
																<div class="col-md-9">
																	<s:select list="ProcedureList" name="procedure"
																		id="procedure" class="form-control"
																		style="padding-left:14px;" headerKey=""
																...
																<tbody>
																	<s:iterator value="prescriptionList">
																		<tr
																			...
																			<td style="font-size: 14px; text-align: center;"><s:property
																					escape="false" value="frequency" /></td>

																			<td style="font-size: 14px; text-align: center;"><s:property
																					escape="false" value="noOfDays" /></td>
				             ...
				             <div class="col-md-2 col-xs-7 col-sm-1" id="noOfDays">
				            	<div id="selectdFrq">
														...
														<div class="col-md-1 col-xs-7 col-sm-1">
															<input type="text" class="form-control" name="noOfPills"
																id="noOfPills" placeholder="Qty">
														</div>
											...
											<div class="tab-pane fade" id="bill">
												<form class="form-horizontal form-label-left"
													onsubmit="return checkCheckbox();" id="OPDBILLForm"
													action="EditBill" method="POST" style="margin-top: 20px;">

													<div class="row"
														style="margin-top: 10px; margin-left: 0px;"></div>
								...
								<div class="col-md-2 col-xs-4" style="padding-top:3%;">
									<input class="form-control" name="cashToReturn" id="cashToReturnID" value="<s:property value="cashToReturn"/>" placeholder="Cash To Return" type="number">
														...
														<div class="row" style="padding-left: 15px;">
															...
															<div class="col-md-6 col-xs-12">
																<s:checkboxlist style="zoom: 2"
																	cssStyle="zoom: 2; font-size: 20px !important;"
																	list="#{'1':'  Is consultation done?'}"
																	labelposition="top" name="isConsultationDone" />
															</div>
											...
											<div class="tab-pane fade" id="labRep">
												...
												<form class="form-horizontal form-label-left" novalidate
													action="EditLabReport" onsubmit="return showLoadingImg();"
											...
											<div class="tab-pane fade" id="medCerti">
												<form class="app-cam" id="" name=""
													action="UpdateMedicalCertificate" method="POST"
						        ...
						        <div class="row" style="margin-top:25px;margin-bottom: 20%;">
									...
									Registered Medical Practitioner</textarea>
											...
											<div class="tab-pane fade" id="refLetter">
												...
												<form class="app-cam" id="" name=""
													action="UpdateReferralLetter" method="POST"
													style="width: 95%; margin: 0px;">
    ...
    $(document).ready(function() {
        ...
        // Construct the ID using the visitID value
    ...
    $(document).ready(function() {
        // Retrieve visit last edit history details
        var visitId = $("#visitID").val();
        var patientName = $("#firstName").val() + " " + $("#lastName").val();
        var elementID = "timer" + visitId;
        var displayElement = document.getElementById("timerDisplay_" + visitId);
        var stopElement = document.getElementById("stopButton_" + visitId);
        var startElement = document.getElementById("startButton_"+ visitId);
        var timer, keySaved;
        var newKey;

        // Check for existing timer data in localStorage
        for (let i = 0; i < localStorage.length; i++) {
            let key = localStorage.key(i);

            if (key.startsWith('timer')) {
                let data = JSON.parse(localStorage.getItem(key));
                let [storedVisitId] = key.split('_');

                console.log("elementID: ", elementID, "visitId: ", storedVisitId);
                
                if (elementID === storedVisitId) {
                    console.log("Inside if block: Timer found for this visit.");
                    keySaved = key;
                    ...
                    var startTimeMs = parseInt(data.startTimeMs);
                    var elapsedTime = parseInt(data.elapsedTime);
                    var isRunning = data.isRunning;
                    var fullNameDis = data.fullName;
                    
                    // Start the timer if it was running
                    if (isRunning) {
                        timer = setInterval(() => {
                            elapsedTime = Date.now() - startTimeMs;
                            updateDisplay(displayElement, elapsedTime);
                        }, 1000);
                    } else {
                        updateDisplay(displayElement, elapsedTime);
                    }
                    ...
                    console.log("Inside else block: Timer for this visit is not initialized.");
        ...
        function updateDisplay(element, elapsedTime) {
        ...
        function calculateDifferenceInMinutes(start, end) {
        ...
        document.getElementById("stopButton_" + visitId).addEventListener('click', function() {
            console.log("Stop Button clicked!!!");
				let data;
            	if(keySaved){
                data = JSON.parse(localStorage.getItem(keySaved));
                clearInterval(timer);
            	}else{
            	console.log("newKey:", newKey);
                data = JSON.parse(localStorage.getItem(newKey));
                clearInterval(timer);
            	}
					
                elapsedTime = Date.now() - data.startTimeMs;
                updateDisplay(displayElement, elapsedTime);

                const updatedState = {
                    isRunning: false,
                    fullName: data.fullName,
                    startDateNTime: data.startDateNTime,
                    stopDateNTime: new Date(),
                    elapsedTime: elapsedTime,
                    startTimeMs: data.startTimeMs
                };
                if(keySaved){
                	localStorage.setItem(keySaved, JSON.stringify(updatedState));
                }else{
                	localStorage.setItem(newKey, JSON.stringify(updatedState));
                }
                ...
                document.getElementById("endButton_" + visitId).style.display = 'inline-block';
            
        });
        
     // Start button event
        document.getElementById("startButton_" + visitId).addEventListener('click', function() {

            const timestamp = new Date().toISOString();
            console.log("startButton_");
            console.log(visitId);
            console.log(timestamp);
            newKey = "timer" + visitId + "_" + timestamp;
            console.log(newKey);
            ...
            let value = JSON.parse(localStorage.getItem(newKey));

            timer = setInterval(() => {
                value.elapsedTime = Date.now() - value.startTimeMs;
                updateDisplay(displayElement, value.elapsedTime);
            }, 1000);
        ...
        document.getElementById("restartButton_" + visitId).addEventListener('click', function() {
            console.log("Restart Button clicked!!!");
            	...
            	if(keySaved){
            	console.log("Inside if keySaved");
                	localStorage.removeItem(keySaved);
            	}else{
                ...
                if(keySaved) {
                    ...
                    let value = JSON.parse(localStorage.getItem(keySaved));
     ...
     // End button event
        document.getElementById("endButton_" + visitId).addEventListener('click', function() {
            console.log("End Button clicked!!!");
                ...
                if (data) {
                    var sDateNTime = formatDate(data.startDateNTime, 'dd-mm-yyyy HH:MM:SS');
                    console.log("sDateNTime: ", sDateNTime);

                    var eDateNTime = formatDate(data.stopDateNTime, 'dd-mm-yyyy HH:MM:SS');
                    console.log("eDateNTime: ", eDateNTime);

					var duraDiff = calculateDifferenceInMinutes(data.startDateNTime, data.stopDateNTime);
                    console.log("duraDiff", duraDiff); 
                    
                    var startDTEle = document.getElementById("sd&t_"+visitId);
                    var endDTEle = document.getElementById("ed&t_"+visitId);
                    var diffEle = document.getElementById("dura_"+visitId);
                   
                    if (startDTEle) {
                    	startDTEle.value = sDateNTime;
                    }
                    
                    if(endDTEle){
                    	endDTEle.value = eDateNTime;
                    }
                    
                    if(diffEle){
                    	diffEle.value = duraDiff + " min";
                    }
                    ...
                    // Optionally, clear the display or perform other actions
                    /* displayElement.innerText = "00:00:00"; */ 
                    document.getElementById("stopButton_" + visitId).style.display = 'none';
                    document.getElementById("restartButton_" + visitId).style.display = 'none';
                    document.getElementById("endButton_" + visitId).style.display = 'none';
