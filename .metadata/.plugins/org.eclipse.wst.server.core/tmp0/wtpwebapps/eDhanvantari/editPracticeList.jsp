...
<html lang="en">
  <head>
    ...
    <title>Edit Practice List | E-Dhanvantari</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                    ...
                    <div class="row">
                     <form action="SearchPractice" method="POST" onsubmit="return showLoadingImg();">
                       <div class="col-md-4 col-sm-4 col-xs-6">
                         <input type="text" name="searchPracticeName" class="form-control" placeholder="Search Practice" required="required">
                       </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <button type="submit" class="btn btn-success active"  style="width:100%;">Search Practice</button>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <a href="ViewAllPracticeList"> <button type="button" class="btn btn-primary"  style="width:100%;" onclick="showLoadingImg();">View All Practices</button></a>
                        </div>
                      </form>
                     </div>
                  ...
                  %>
		            ...
		            %> 
                      ...
                      <thead>
                        <tr>
                          <th>Practice ID</th>
                          <th>Practice Name</th>
                          <th>Practice Suffix</th>
                          <th>URL</th>
                          <th style="text-align:center;">Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        <s:iterator value="searchPracticeList" var="UserForm">
                        	<tr>
									
                        			<td><s:property value="practiceID" /></td>
						
									<td><s:property value="practiceName" /></td>
									
									<td><s:property value="practiceSuffix" /></td>
									
									<td>
										<%-- <a href="javascript:void(0)" data-toggle="tooltip" style="color:#73879C;" data-placement="top" title="Click to open"><s:property value="practiceURL" /></a> --%>
										<s:property value="practiceURL" />
									</td>
										 
									<td align="center"><s:url id="approveURL"
										action="RenderEditPractice">
										<s:param name="practiceID" value="%{practiceID}" />
										<s:param name="searchPracticeName" value="%{searchPracticeName}" />
									</s:url> <s:a href="%{approveURL}">
										<img src="images/clinic_1.png" style="height:24px;" onmouseover="this.src='images/clinic_2.png'"
											onmouseout="this.src='images/clinic_1.png'" alt="Edit Practice"
											title="Edit Practice" />
									</s:a></td>
                        	</tr>
                        </s:iterator>
                   ...
                   <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <s:iterator value="practiceList" var="UserForm">
                        	<tr>
                        			<td><s:property value="practiceID" /></td>
