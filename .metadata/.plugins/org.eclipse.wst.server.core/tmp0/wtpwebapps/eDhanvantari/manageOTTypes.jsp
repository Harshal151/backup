...
<html lang="en">
  <head>
    ...
    <title>Manage OT | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchOTType" method="POST" onsubmit="return showLoadingImg();" >
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search OT" name=searchOTType>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active">Search OT</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllOTTypes"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All OTs</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="OTTypeList" var="UserForm">
		                        	<tr>
								
											<td><s:property value="OTType" /></td>
											
											<td align="center"><s:url id="approveURL"
												action="RenderEditOTType">
												<s:param name="OTTypeID" value="%{OTTypeID}" />
												<s:param name="searchOTType" value="%{searchOTType}" />
											...
											<s:url id="disableUserURL" action="DeleteOTType">
												<s:param name="OTTypeID" value="%{OTTypeID}" />
												<s:param name="searchOTType" value="%{searchOTType}" />
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="AddOTType" method="POST" onsubmit="return disableButton('send');" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="ChargeType">OT Type<span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="OTType" required="required" placeholder="OT Type" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditOTType" onsubmit="return showLoadingImg();"  method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="editOTTypeList" var="roomTypeForm">
						  
						  <input type="hidden" name="OTTypeID" value="<s:property value="OTTypeID" />" >
						  <input type="hidden" name="searchOTType" value="<s:property value="searchOTType" />" >
						  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Instruction">OT Type <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="OTType" required="required" value="<s:property value="OTType" />" placeholder="OT Type" class="form-control">
	                        </div>
	                      </div>
