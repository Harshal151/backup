                  ...
                  <div class="x_content">
                   ...
                   <div>
                     ...
                     <div class="row" style="margin-top:15px;">
                     	...
                     	<div class="col-md-4 col-xs-6">
                     		<input  class="form-control" readonly="readonly"  name="vatNumber" id="customerVATNoID" placeholder="VAT Number" type="text">
                     	</div>
                     ...
                     <div class="row" style="margin-top:15px;">
                      ...
                      <tbody>                       	
                        	...
                        	<tr>
                        		...
                        		<td colspan="2">
                        			<input  class="form-control" name="productVAT" id="productVATID" readonly="readonly" placeholder="Total VAT on Stock Added" type="number">
                        		</td>
