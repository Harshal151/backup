...
<html lang="en">
  <head>
    ...
    <title>Manage Room Type | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchRoomType" method="POST" onsubmit="return showLoadingImg();" >
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search rooms" name=searchCharges>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active">Search Rooms</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllRoomTypes"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Rooms</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="roomTypeList" var="UserForm">
		                        	<tr>
											...
											<td align="center"><s:url id="approveURL"
												action="RenderEditRoomType">
												<s:param name="roomTypeID" value="%{roomTypeID}" />
											...
											<s:url id="disableUserURL" action="DeleteRoomType">
												<s:param name="roomTypeID" value="%{roomTypeID}" />
												<s:param name="searchCharges" value="%{searchCharges}" />
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="AddRoomType" method="POST" onsubmit="return disableButton('send');" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="ChargeType">Room Type <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="roomType" required="required" placeholder="Room Type" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditRoomType" onsubmit="return showLoadingImg();"  method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="editRoomTypeList" var="roomTypeForm">
						  
						  <input type="hidden" name="roomTypeID" value="<s:property value="roomTypeID" />" >
						  <input type="hidden" name="searchCharges" value="<s:property value="searchCharges" />" >
						  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Instruction">Room Type <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="roomType" required="required" value="<s:property value="roomType" />" placeholder="Room Type" class="form-control">
	                        </div>
	                      </div>
