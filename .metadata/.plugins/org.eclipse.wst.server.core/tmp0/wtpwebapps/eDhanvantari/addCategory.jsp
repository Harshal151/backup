											...
											<form action="SearchCategory"
												...
												<div class="col-md-4 col-sm-4 col-xs-6">
													<input type="text" class="form-control" required="required"
														placeholder="Search Category" name="searchCategory">
												</div>
												<div class="col-md-2 col-sm-3 col-xs-4">
													<button style="width: 100%;" type="submit"
														class="btn btn-success active">Search Category</button>
												</div>
												<div class="col-md-2 col-sm-3 col-xs-4">
													<a href="ViewAllCategories">
														<button type="button" class="btn btn-primary "
															onclick="showLoadingImg();">View All Categories</button>
													</a>
												</div>
											</form>
										</div>
                    ...
                    %>
		              ...
		              %>
										...
										<form class="form-horizontal form-label-left" novalidate
											...
											onsubmit="return showLoadingImg();" style="margin-top: 20px;">
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<s:select list="#{'Compound':'Compound','Single':'Single'}"
														value="-1" headerKey="-1" headerValue="Select Type"
														id="categoryTypeID" name="categoryType"
														class="form-control" required="required"></s:select>
												</div>
											</div>
											
											<div class="item form-group">
												<label class="control-label col-md-4 col-sm-4 col-xs-12"
													for="otCategory">OT Category
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<s:radio
														list="#{'Yes':'Yes'}"
														id="otCategory" name="otCategory" style="margin-left:5px; margin-right:5px; padding-top:13px"></s:radio>
													<s:radio
														list="#{'No':'No'}"
														id="otCategory" name="otCategory" checked="true" style="margin-left:5px; margin-right:5px; padding-top:13px"></s:radio>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="col-md-12 col-xs-12" align="center">
													<button type="reset" class="btn btn-primary"
														onclick="windowOpen();">Cancel</button>
													<button id="send" type="submit" class="btn btn-success "
														onclick="return submitForm(categoryTypeID.value);">Add</button>
												</div>
											</div>
										</form>
	                  ...
	                  %>
										...
										<form class="form-horizontal form-label-left" novalidate
											action="EditCategory" method="POST" style="margin-top: 20px;">
											...
											<s:iterator value="editCategoryList" var="concessionForm">
												...
												<input type="hidden" name="searchCategory"
													value="<s:property value="searchCategory" />">
												<div class="item form-group">
													<label class="control-label col-md-4 col-sm-4 col-xs-12"
														for="Category">Category <span class="required">*</span>
													</label>
												...
												<div class="item form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<s:select
															list="#{'Compound':'Compound','Single':'Single'}"
												...
												<div class="form-group">
													<div class="col-md-12 col-xs-12" align="center">
														<button type="reset" class="btn btn-primary"
															onclick="windowOpen();">Cancel</button>
														<button id="send" type="submit" class="btn btn-success "
															onclick="return submitForm(categoryTypeID.value);">Update</button>
													</div>
												</div>
