...
<html lang="en">
  <head>
    ...
    <title>Edit Visit Type | E-Dhanvantari</title>
    ...
    <script type="text/javascript">
      function windowOpen(){
        ...
        document.location="editVisitTypeList.jsp";
      }
    </script>
    ...
    <!-- Retrieving tab name list by form name -->
	...
	function retrieveTabName(workflowOPDForm) {
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				var tabSelectTag = "<select name='' id='tabNameID' class='form-control' multiple='multiple'>"
								  +"<option value='000'>Select tab</option>";

				for ( var i = 0; i < array.Release.length; i++) {
					
					tabSelectTag += "<option value='"+array.Release[i].tabName+"'>"+array.Release[i].tabName+"</option>";
					
				}
				
				tabSelectTag += "</select>";
				
				$("#tabNameTDID").html(tabSelectTag);
			}
		};
		xmlhttp.open("GET", "RetrieveTabName?workflowOPDForm="
				+ workflowOPDForm , true);
		xmlhttp.send();
	}
	</script>
    ...
    <!-- Show IsDischarge div if careType value is IPD -->
    <script type="text/javascript">
    	
    	
		function displayConentDocDiv(hasConsentValue){
    		
    		if(hasConsentValue =="1"){
    			console.log("hasConsentValue : "+hasConsentValue);
    			$("#consentID1").show();
    		}else{
    			$("#consentID1").hide();
    		}
		...
		document.addEventListener('DOMContentLoaded', function() {
			...
			setTimeout(function(){
				$("input[name=careType]").attr("required", "required");
			},500);
  ...
  <body class="nav-md" onload="retrieveTabName(opdFormID.value);">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="EditVisitType" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;" enctype="multipart/form-data">
                      
                      <s:iterator value="visitTypeList" var="visitTypeForm">
                      
                      <input type="hidden" name="visitTypeID" value="<s:property value='visitTypeID'/>">
                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Visit Type Name">Visit Type Name<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-11">
                          <input type="text" name="visitTypeName" required="required" value="<s:property value='visitTypeName'/>" placeholder="Visit Type Name" class="form-control">
                        </div>
                      </div>
                      
                      <div class="item form-group">
		                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Visit Duration">Visit Duration<span class="required">*</span>
		                        </label>
		                        <div class="col-md-5 col-sm-5 col-xs-8">
		                          <input type="number" name="visitDuration" value="<s:property value='visitDuration'/>" placeholder="Visit Duration" required="required" class="form-control">
		                        </div>
		                        <div class="col-md-1 col-sm-1 col-xs-4" style="padding-top:7px;">
		                          <font style="font-size: 14px;font-weight: bold;">minutes</font>
		                        </div>
		                    </div>
		                 
		             <div class="item form-group">
		                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Visit Duration">Next Visit Days<span class="required">*</span></label>
		                  <div class="col-md-5 col-sm-5 col-xs-8">
		                      <input type="number" name="nextVisitDays" value="<s:property value='nextVisitDays'/>" placeholder="Next Visit Days" required="required" class="form-control">
		                  </div>
		             </div>
		                
					  <div class="item form-group">
		                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Billing Type">Billing Type
		                        </label>
		                        <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                          <s:radio list="#{'Consultation':'Consultation','Prescription':'Prescription','Both':'Both'}" name="billingType"></s:radio>
		                        </div>
		              </div>
		              
		              <div class="item form-group">
		                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Care Type">Care Type<span class="required">*</span></label>
		                 <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                    <s:radio list="#{'IPD':'IPD','OPD':'OPD','XRay':'XRay','USG':'USG','CTScan':'CTScan','PathologyLab':'Pathology Lab','Diagnostic':'Diagnostic'}" name="careType" required="required" ></s:radio>
		                 </div>
		            </div> 
		            
		            <div class="item form-group" id="isDiscgargeDivID" style="display: none;">
		                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Is Discgarge">IsDischarge</label>
		                 <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                    <s:radio list="#{'1':'Yes','0':'No'}" name="isDischarge" ></s:radio>
		                 </div>
		            </div> 
		               
		               <div class="item form-group">
		                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Has Consent">Has Consent</label>
		                 <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                    <s:radio list="#{'1':'Yes','0':'No'}" name="hasConsent" onclick="displayConentDocDiv(this.value);"></s:radio>
		                 </div>
		            </div> 
	                
	                <script type="text/javascript">
                        document.addEventListener('DOMContentLoaded', function() {
                           var hasConsent = "<s:property value='hasConsent'/>";
                                   
                           console.log(".."+hasConsent);
                                   
                           displayConentDocDiv(hasConsent);
                        });
                    </script>
                    
                    <div class="item form-group" id="consentID1" >
                        <label for="Profile Pic" class="control-label col-md-3 col-sm-3 col-xs-12">Upload Consent Document</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left:-10px;">
                          	<input  type="text" name="consentDocDBName" class="form-control" style="width:100%" value="<s:property value="consentDocDBName"/>" readonly="readonly">
                          </div>
		            ...
		            <div class="item form-group" id="consentDocumentDivID" style="display: none;">
		                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Consent Document">Upload Consent Document</label>
		                 <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                  <s:file name="consentDoc" class="form-control" id="consentDocClickID"></s:file>
		                 </div>
		            </div>
		               
		              <div class="item form-group">
		                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Consultation Charges">Consultation Charges
		                        </label>
		                        <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                          <input type="number" class="form-control" name="consultationCharge" placeholder="Consultation Charges" value="<s:property value='consultationCharge'/>">
		                       </div>
		              </div>
		                    
		              <div class="item form-group">
		                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Care Type">New Visit?
		                        </label>
		                        <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                          <s:radio list="#{'1':'Yes','0':'No'}" name="newVisitFlag"></s:radio>
		                        </div>
		                    </div>
		                    
		              <div class="item form-group">
		                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Practice">Clinic<span class="required">*</span>
		                        </label>
		                        <div class="col-md-6 col-sm-6 col-xs-12">
		                           <s:select list="practiceMap" name="clinicID" class="form-control" required="required"></s:select>
		                        </div>
		                    </div>
		                    
		              <div class="item form-group">
		                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Practice">Form Name<span class="required">*</span>
		                        </label>
		                        <div class="col-md-6 col-sm-6 col-xs-12">
		                           <s:select list="OPDJSPList" name="workflowOPDForm" id="opdFormID" class="form-control" required="reqiured" onchange="retrieveTabName(opdFormID.value);"></s:select>
		                        </div>
		                    </div>
        			  
        			  <div class="item form-group">
		                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Practice">Currency</label>
		                        <div class="col-md-6 col-sm-6 col-xs-12">
		                           <s:select list="#{'INR':'INR','USD':'USD'}" name="currency" class="form-control" ></s:select>
		                        </div>
		                    </div>
                   ...
                   <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-12 col-xs-12" align="center">
                          ...
                          <button id="practiceSubmitID" type="submit"  class="btn btn-success " >Update Visit Type</button>
                        </div>
                      </div>
