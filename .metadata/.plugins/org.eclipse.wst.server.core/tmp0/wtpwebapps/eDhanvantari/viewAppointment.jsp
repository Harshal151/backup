...
<html lang="en">
  <head>
    ...
    <title>Appointment List | E-Dhanvantari</title>
	...
	<!-- Appointment list from request -->
	
	<%
		List<String> appointmentList = (List<String>) request.getAttribute("appointmentList");
	
		
		//Patient Name with patient ID
		String patientName = (String) request.getAttribute("patientName");
		
		String listEmpty = (String) request.getAttribute("listEmpty");
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
                      ...
                      <tbody>
                      	...
                      	<%
                            	Iterator<String> iterator = appointmentList.iterator();
                            
                            	while(iterator.hasNext()){
                            		
                            		String[] itrArray = iterator.next().split("=");
                            		
                            		String aptDate = itrArray[0];
                            		String aptTimeFrom = itrArray[1];
                            		String aptTimeTo = itrArray[2];
                            		String patientID = itrArray[3];
                            		String aptID = itrArray[4];
                            		String aptStatus = itrArray[5];
                        %>
                        	...
                        	<tr>
									...
									<td align="center">
											<% 
												if(aptStatus.equals(ActivityStatus.CONFIRMED)){
											%><img src="images/appointment_edit1.png" style="opacity:0.6;height: 24px;" alt="Appointment Confirmed"
													title="Appointment Confirmed" />&nbsp;
											<%
												}else{
											%><a href="javascript:confirmAppt('ConfirmAppointment?aptID=<%=aptID %>')">
												<img src="images/appointment_edit1.png" style="height:24px;" onmouseover="this.src='images/appointment_edit2.png'"
													onmouseout="this.src='images/appointment_edit1.png'" alt="Confirm Appointment"
													title="Confirm Appointment" />
											</a>
											<%
												}
											%><a href="RenderAddNewApptVisit?patientID=<%=patientID %>&aptID=<%=aptID %>">
												<img src="images/visit_add_1.png" style="height:24px;" onmouseover="this.src='images/visit_add_2.png'"
													onmouseout="this.src='images/visit_add_1.png'" alt="Add New Visit"
													title="Add New Visit" />
											</a>
											<%
												if(form.getSpecailization().contains("Ophthalmologist")){
											%><a href="RenderApptIPDVisit?patientID=<%=patientID %>&aptID=<%=aptID %>">
												<img src="images/OT_icon_1.png" style="height:24px;" onmouseover="this.src='images/OT_icon_2.png'"
													onmouseout="this.src='images/OT_icon_1.png'" alt="Transfer to OT List"
													title="Transfer to OT List" />
											</a>
											<%
												}
											%><a href="javascript:cancelAppt('CancelAppointment?aptID=<%=aptID %>')">
												<img src="images/reject1.png" style="height:24px;"
													onmouseover="this.src='images/reject.png'"
													onmouseout="this.src='images/reject1.png'" alt="Cancel Appointment"
