...
<html lang="en">
  <head>
    ...
    <title>Edit User | E-Dhanvantari</title>
    ...
    <!-- To visible profile pic file upload div -->
      ...
      function activityStatusMsg(){
		...
		if(value == "Disabled"){
			if(confirm("Disabled users cannot access application. Are you sure you want to disable this user?")){
				document.getElementById("activityStatusID").value = "Disabled";
			}else{
				document.getElementById("activityStatusID").value = "Active";
			}

		}else if(value == "Locked"){
			if(confirm("Locked users cannot access application. Are you sure you want to lock this user?")){
				document.getElementById("activityStatusID").value = "Locked";
			}else{
				document.getElementById("activityStatusID").value = "Active";
			}
		}else{
				...
				if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
					...
					var array = JSON.parse(xmlhttp.responseText);
				 	...
				 	if(userType =="administrator"){
						...
						var array_element = "<select name='specialsation' class='form-control'"+
...
<script type="text/javascript">
  ...
  function showDoctorRegNo(userType)
	{
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="EditUser" method="POST" onsubmit="return showLoadingImg();"  style="margin-top:20px;" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input  class="form-control" name="firstName" value="<s:property value="firstName"/>" id="firstNameID" placeholder="First Name" required="required" type="text" onblur="validate(this.value, 'firstNameID');">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input  class="form-control" name="middleName" value="<s:property value="middleName"/>" id="middleNameID" placeholder="Middle Name" type="text" onblur="validate(this.value, 'middleNameID');">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input class="form-control" name="lastName" value="<s:property value="lastName"/>" id="lastNameID" placeholder="Last Name" required="required" type="text" onblur="validate(this.value, 'lastNameID');">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-10">
                          <input type="number" name="phone" class="form-control"  value="<s:property value="phone"/>" placeholder="Phone"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-2" align="center">
                          <label class="control-label">+91</label>
                        </div>
                        <div class="col-md-5 col-sm-5 col-xs-10">
                          <input type="number" name="mobile" class="form-control" value="<s:property value="mobile"/>" placeholder="Mobile"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" name="emailID" required="required" value="<s:property value="emailID"/>" placeholder="Email Address" class="form-control">
                        </div>
                      </div>

					  <div class="item form-group">
                        <label for="Activity Status" class="control-label col-md-3 col-sm-3 col-xs-12">Qualification</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="qualification" placeholder="Qualification" value="<s:property value="qualification"/>" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="username" required="required" value="<s:property value="username"/>" placeholder="Username" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="password" name="password" placeholder="Password" required="required" value="<s:property value="password"/>" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="PIN" placeholder="PIN" required="required" value="<s:property value="PIN"/>" class="form-control">
                        </div>
                      </div>
                      
                      
                      <div class="item form-group">
                        <label for="User Type" class="control-label col-md-3 col-xs-3">User Type<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                    <%  if(form.getUserType().equals("superAdmin")){  %>
                     
                     		<s:select list="#{'superAdmin':'SuperAdmin','manager':'Manager','administrator':'Administrator','accountant':'Accountant','billDesk':'Bill Desk','clinician':'Clinician','compounder':'Compounder','dietician':'Dietician','pharmacist':'Pharmacist','receptionist':'Receptionist','staff':'Staff','surveyor':'Surveyor','optician':'Optician'}" headerKey="-1"  headerValue="Select Role" id="userTypeID" name="userType" class="form-control" required="required" onchange = "showDoctorRegNo(this.value)"></s:select>
                     	
                     <%	}else{  %>
                          <s:select list="#{'manager':'Manager','administrator':'Administrator','accountant':'Accountant','billDesk':'Bill Desk','clinician':'Clinician','compounder':'Compounder','dietician':'Dietician','pharmacist':'Pharmacist','receptionist':'Receptionist','staff':'Staff','surveyor':'Surveyor','optician':'Optician'}" headerKey="-1" headerValue="Select Role" id="userTypeID" name="userType" class="form-control" required="required" disabled="true" onchange = "showDoctorRegNo(this.value)"></s:select>
                       	  <input type="hidden" name="userType" value="<s:property value="userType"/>">
                     <% } %>
                   ...
                   <s:if test = "userType.equals('clinician')">
				       	<div class="item form-group clinicianRegNo">
				    </s:if>
				    <s:else>
				    	<div class="item form-group clinicianRegNo" style = "display: none">
				    </s:else>
               			<label for="Clinic" class="control-label col-md-3 col-xs-3">Clinician Registration Number <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          	<input  type="text" name="clinicianRegNo" class="form-control" required="required" value="<s:property value="clinicianRegNo"/>" placeholder="Clinician Registration Number">
                        </div>
               		</div>
               		 
                     <div class="item form-group">
                        <label for="Clinic" class="control-label col-md-3 col-xs-3">Practice<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <s:select list="practiceList" headerKey="-1" headerValue="Select Practice" id="practiceID" onchange="getPracticeClinic(practiceID.value);" name="practiceID" class="form-control" required="required"></s:select>
                        </div>
                      </div>
                      
                     <div class="item form-group">
                        <label for="Clinic" class="control-label col-md-3 col-xs-3">Default Clinic<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12" id="clinicListID">
                          <input type="text" readonly="readonly" required="required" name="clinicName" id="clinicNameID" value="<s:property value="clinicName"/>" class="form-control">
                          <input type="hidden" value="<s:property value="clinicID"/>" id="clinicID" name="clinicID">
                        </div>
                      </div>
                 ...
                 <%}else{ %>
                   ...
                   <div class="item form-group">
                        <label for="Clinic" class="control-label col-md-3 col-xs-3">Practice<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <s:select list="practiceList" id="practiceID" onchange="getPracticeClinic(practiceID.value);" name="practiceID" class="form-control" readonly="readonly"></s:select>
                        </div>
                   </div>
                  ...
                  <div class="item form-group">
                     <label for="Clinic" class="control-label col-md-3 col-xs-3">Default Clinic<span class="required">*</span></label>
                     <div class="col-md-6 col-sm-6 col-xs-12" id="clinicListID">
                       	<s:select list="clinicList" id="clinicID" name="clinicID" class="form-control" ></s:select> 
                     </div>
                 </div>
                 ...
                 <%  } %>     
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <s:select list="#{'Active':'Active','Disabled':'Disabled','Locked':'Locked'}" onchange="activityStatusMsg();" id="activityStatusID" headerKey="-1" headerValue="Select Activity Status" name="activityStatus" class="form-control" required="required"></s:select>
                        </div>
                      </div>
                      
                      <div class="item form-group" id="profilePicID1" >
                        <label for="Profile Pic" class="control-label col-md-3 col-sm-3 col-xs-12">Upload Profile Pic</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        
                          <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left:-10px;">
                          	<input  type="text" name="profilePicDBName" class="form-control" style="width:100%" value="<s:property value="profilePicDBName"/>" readonly="readonly">
                          </div>
                          <div class="col-md-4 col-sm-4 col-xs-12">
                          	<button class="btn btn-default" type="button" onclick="profilePicShow();">Upload Profile Pic</button>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="item form-group" id="signatureID1" >
						<label for="Profile Pic" class="control-label col-md-3 col-sm-3 col-xs-12">Upload Signature Image</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
					
					<div class="col-md-8 col-sm-8 col-xs-12" style="margin-left:-10px;">
						<input type="text" name="signatureDBName" class="form-control" style="width:100%" value="<s:property value="signatureDBName"/>" readonly="readonly">
					</div>
					
					<div class="col-md-4 col-sm-4 col-xs-12">
						<button class="btn btn-default" type="button" onclick="signatureShow();">Upload Signature Image</button>
					</div>
					</div>
					</div>
					
					<div class="item form-group" id="signatureID" style="display: none;">
						<label for="Profile Pic" class="control-label col-md-3 col-sm-3 col-xs-12">Upload Signature Image</label>
					<div class="col-md-6 col-sm-6 col-xs-12" >
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-xs-12" align="center">
                          <button type="button" onclick="editUserList();" class="btn btn-primary">Cancel</button>
                          <button id="send" type="submit" class="btn btn-success " >Update User</button>
                        </div>
                      </div>
                    </form>
