...
<html lang="en">
  <head>
    ...
    <title>Edit Visit Type List | E-Dhanvantari</title>
    ...
    <!-- Disable Visit type start -->
    
    <script type="text/javascript">
    	function disableVisitType(url){
			if(confirm("Are you sure you want to disable this visit type?")){
    ...
    <%
    	String clinicListEnable = (String) request.getAttribute("clinicListEnable");
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                    ...
                    <div class="row">
                     <form action="SearchVisitType" method="POST" onsubmit="return showLoadingImg();">
                       <div class="col-md-4 col-sm-4 col-xs-6">
                         <input type="text" name="searchVisitTypeName" class="form-control" placeholder="Search Visit Type" required="required">
                       </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <button type="submit" class="btn btn-success active" >Search Visit Type</button>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <a href="ViewAllVisitTypeList"> <button type="button" class="btn btn-primary" onclick="showLoadingImg();" >View All Visit Type</button></a>
                        </div>
                      </form>
                     </div>
                  ...
                  <%
                  	if(clinicListEnable == null || clinicListEnable == ""){
                  %>
		            ...
		            <%
                  	}else if(clinicListEnable.equals("clinicSearchListEnable")){
		            %> 
                      ...
                      <tbody>
                        <s:iterator value="visitTypeList" var="UserForm">
                        	<tr>
									
                        			<td><s:property value="visitTypeName" /></td>
						
									<td><s:property value="practiceName" /></td>
									
									<td><s:property value="billingType" /></td>
									
									<td><s:property value="workflowOPDForm" /></td>
										 
									<td align="center"><s:url id="approveURL"
										action="RenderEditVisitType">
										<s:param name="visitTypeID" value="%{visitTypeID}" />
										<s:param name="searchVisitTypeName" value="%{searchVisitTypeName}" />
									</s:url> <s:a href="%{approveURL}">
										<img src="images/clinic_1.png" style="height:24px;" onmouseover="this.src='images/clinic_2.png'"
											onmouseout="this.src='images/clinic_1.png'" alt="Edit Visit Type"
											title="Edit Visit Type" />
									</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
									<s:url id="disableVisitTypeURL" action="DisableVisitType">
										<s:param name="visitTypeID" value="%{visitTypeID}" />
										<s:param name="searchVisitTypeName" value="%{searchVisitTypeName}" />
									</s:url> <s:a href="javascript:disableVisitType('%{disableVisitTypeURL}')">
										<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
											onmouseout="this.src='images/delete_icon_1.png'" alt="Disable Visit Type"
											title="Disable Visit Type" />
									</s:a></td>
                        	</tr>
                        </s:iterator>
                      </tbody>
                   ...
                   <%
                  	}else if(clinicListEnable.equals("clinicListEnable")){
                   %>
