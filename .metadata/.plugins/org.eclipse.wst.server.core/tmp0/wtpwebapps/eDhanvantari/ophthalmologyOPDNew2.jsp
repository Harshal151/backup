...
<%
  ...
  <div id="opdChargesModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">

        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick = "closeModal()">&times;</button>
          <h4 class="modal-title" id="myModalLabel" style="text-align:center">Add OPD Charges</h4>
        </div>
					    ...
					    <tbody>
			        		<tr style="font-size: 14px;" id="">
							   <td style="text-align:center">
								   <input type="text" class="form-control" name="" id="opdChargeTypeID" placeholder="Enter value here">
							   </td>
							   <td style="text-align:center"><input class="form-control" type="number" id="opdChargesID" name="" placeholder="Enter charges here"></td>
						   </tr>
						</tbody>
					</table>
				</div>
        ...
        <div class="modal-footer" style="text-align: center;">
          ...
          <button type="button" class="btn btn-success" id="" onclick = "addOPDCharges(opdChargeTypeID.value, opdChargesID.value)">Add</button>
       </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
			    ...
			    <div class="tab-pane fade" id="visit">
				    ...
				    <form class="form-horizontal form-label-left" novalidate id="OPDForm" name="OPDForm" action="AddNewOPDVisit" method="POST" style="margin-top:20px;">
				    	 ...
				    	 <div class="row">
							<div class="col-md-6">
								<button type="button" class="btn btn-warning" id="viewLastBtnID" onclick="viewPopUp('ViewLastOPDVisitDetails?sourceType=last&patientID='+<s:property value="patientID"/>+'&visitID='+<s:property value="visitID"/>);">View Last Visit</button>
							</div>
						...
						<div class="row" style="margin-top:15px;">
					    	...
					    	<div class="col-md-6 col-xs-12">
					    		...
					    		<div class="col-md-8 col-xs-6">
					    			<input type="text" class="form-control" readonly="readonly" name="visitDate" value="<%=currentDate %>" id="single_cal3" placeholder="Visit Date" aria-describedby="inputSuccess2Status3">
					    		</div>
					    ...
					    <div class="row" style="margin-top:15px;">
					    	...
					    	<div class="col-md-12 col-xs-12">
					    		...
					    		<div class="col-md-2 col-xs-6">
					      			<label for="Name" style=" margin-top:10px;font-size:16px;font-weight: bold;">Complaining Of</label>
					    		</div>
					    		
					    		<div class="col-md-10 col-xs-6" >
					      			<s:textarea name="complainingOf"  class="form-control" placeholder="Complaining Of"></s:textarea>
					    		</div>
					    ...
					    <div class="row" style="margin-top:15px;">
					    	...
					    	<div class="col-md-12 col-xs-12">
					    		...
					    		<div class="col-md-2 col-xs-6">
					      			<label for="Name" style=" margin-top:10px;font-size:16px;font-weight: bold;">Medical Note</label>
					    		</div>
					    ...
					    <div class="row" style="margin-top:15px;">
					    	...
					    	<div class="col-md-12 col-xs-12">
					    		...
					    		<div class="col-md-2 col-xs-6">
					      			<label for="Name" style=" margin-top:10px;font-size:14px;font-weight: bold;">1. Systemic History</label>
					    		</div>
					    		
					    		<div class="col-md-10 col-xs-6" >
					      			<s:textarea name="systemicHistory"  class="form-control" placeholder="Systemic History"></s:textarea>
					    		</div>
					    ...
					    <div class="row" style="margin-top:15px;">
					    	...
					    	<div class="col-md-12 col-xs-12">
					    		...
					    		<div class="col-md-2 col-xs-6">
					      			<label for="Name" style=" margin-top:10px;font-size:14px;font-weight: bold;">2. Ocular History</label>
					    		</div>
					    		
					    		<div class="col-md-10 col-xs-6" >
					      			<s:textarea name="occularHistory"  class="form-control" placeholder="Ocular History"></s:textarea>
					    		</div>
					    ...
					    <div class="row" style="margin-top:15px;">
					    	...
					    	<div class="col-md-12 col-xs-12">
					    		...
					    		<div class="col-md-2 col-xs-6">
					      			<label for="Name" style=" margin-top:10px;font-size:14px;font-weight: bold;">3. Personal History</label>
					    		</div>
					    		
					    		<div class="col-md-10 col-xs-6" >
					      			<s:textarea name="personalHistory"  class="form-control" placeholder="Personal History"></s:textarea>
					    		</div>
						...
						<div class="collapse" id="vision">
						    ...
						    <div class="row" style="margin-top:15px;">
						    	...
						    	<div class="col-md-4 col-sm-4 " align="left" > 
						    		...
						    		<div class="col-md-6">
						  				<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'Less than N36':'Less than N36', 'No PL':'No PL', 'PL/PR':'PL/PR', 'PL/Faulty PR':'PL/Faulty PR', '1 mtr':'1 mtr', '2 mtr':'2 mtr', '3 mtr':'3 mtr', 'HM +ve':'HM +ve', 'No improvement':'No improvement'}" name="visualAcuityNearOD"  class="form-control"   ></s:select>
						    		</div>
						    	...
						    	<div class="col-md-4 col-sm-4" align="left">
						    		...
						    		<div class="col-md-6">
						  				<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'Less than N36':'Less than N36', 'No PL':'No PL', 'PL/PR':'PL/PR', 'PL/Faulty PR':'PL/Faulty PR', '1 mtr':'1 mtr', '2 mtr':'2 mtr', '3 mtr':'3 mtr', 'HM +ve':'HM +ve', 'No improvement':'No improvement'}" name="visualAcuityNearOS"  class="form-control"   ></s:select>
						    		</div>
						    ...
						    <div class="row" style="margin-top:10px;">
						      	...
						      	<div class="col-md-4 col-sm-4" align="left">
						    		...
						    		<div class="col-md-12 col-sm-12">
						      			<label for="Name" style=" margin-top:10px;font-size:14px;">BCVA AIDED</label>
						    		</div>
						...
						<div class="row" style="margin-top:10px;">
						    <div class="col-md-6 col-xs-12 search-container" >
						    	...
						    	<div class="col-md-8 col-xs-6">
						      		...
						      		<s:select list="diagnoseList" headerKey="" headerValue="Select Diagnosis" name="cancerType" id="cancerType" class="form-control" style="border-radius: 5px;" required="required">
	                      ...
	                      <div class="form-group">
	                        <div class="col-md-12" align="center">
	                          ...
	                          <input type="hidden" name="savePrintVisitID" id="savePrintVisitID" value="">
	                           <%
	                          	if(lastEneteredVisitList.equals("success")){
	                          %>
	                            <button type="button" id="SaveVisitID" class="btn btn-success" onclick="updateOPDVisit();">Update</button>
	                          	<!-- <button class="btn btn-warning" type="button" id="PrintVisitID" onclick="printOPDVisit();">Print</button> -->
			                 ...
			                 %>
	                        	 ...
	                        	 <button id="SaveVisitID" type="button" class="btn btn-success" onclick="CheckDiagnosisField(this.id);" >Save</button>
	                          	 <!-- <button id="savePrintVisit" type="button" class="btn btn-warning" name="savePrintVisit" value="print" onclick="CheckDiagnosisField(this.id);" >Save & Print</button> -->
	                         	 <%  } %>
			     ...
			     <!-- Prescription div -->
			      <div class="tab-pane fade" id="presc" >
			        <form class="form-horizontal form-label-left" novalidate id="genPhyPrescID" name="genPhyPrescID" onsubmit="return savePrescription();" action=AddNewPrescription method="POST" style="margin-top:20px;">
				      ...
				      <div class="row" id="OPDPResc" style="margin-left:0px;margin-right:0px;margin-top:15px;">
					               ...
					               <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap addedFrequency" cellspacing="0" style="width: 97%; margin-left: 1%;">
					                            <thead>
													<tr>
				           ...
				           <div class="col-md-1 col-xs-7 col-sm-1">
				              <input type="number" class="form-control" name="noOfPills" id="noOfPills"  placeholder="Qty">
				            </div>
			    ...
			    <div class="tab-pane fade" id="optician" >
			   		 ...
			   		 <form class="app-cam" id="genOpticianID" name="" onsubmit="return showLoadingImg();" action="AddNewOptician" method="POST" style="width:100%;margin:0px;" >
			   		 
				      <input type="hidden"  name="visitID" id="visitID" value="<s:property value="visitID"/>">
				      <input type="hidden"  name="opticinID" id="opticinID" value="<s:property value="opticinID"/>">
				      <input type="hidden"  name="cycloplegicRefractionID" id="cycloplegicRefractionID" value="<s:property value="cycloplegicRefractionID"/>">
					...
					<div class="row" style="margin-top:15px;">
					    ...
					    <div class="col-md-8 col-xs-9">
					     <input type="text" readonly="readonly"  class="form-control" name="visitDate" value="<%=currentDate %>" placeholder="Visit Date"  >
					    </div>
					    </div>
				    </div>
				    ...
				    <div class="col-md-6">
				      <button type="button" class="btn btn-warning" style="margin-top:10px;" onclick="fetchOldGlassPreviousValues(lastVisitID.value);">Fetch Values</button>
				    </div>
				    </div>
				    ...
				    <div class="row">
				      ...
				      <div class="row col-xs-12">
				      	...
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--', '6/6':'6/6', '6/6P':'6/6P', '6/9':'6/9', '6/9P':'6/9P', '6/12':'6/12', '6/12P':'6/12P', '6/18':'6/18', '6/18P':'6/18P', '6/24':'6/24', '6/24P':'6/24P', '6/36':'6/36', '6/36P':'6/36P', '6/60':'6/60', '6/60P':'6/60P', 'No PL':'No PL', 'PL/PR':'PL/PR', 'PL/Faulty PR':'PL/Faulty PR', '1 mtr':'1 mtr', '2 mtr':'2 mtr', '3 mtr':'3 mtr', '2 ft':'2 ft', '1 ft':'1 ft', 'HM CF': 'HM CF', 'HM Only':'HM Only', 'PL+PR +ve':'PL+PR +ve', 'PL+PR -ve/Defect':'PL+PR -ve/Defect', 'No PL':'No PL', 'No Improvement':'No Improvement' }" name="oldVnDiskOD" id="oldVnDiskOD" class="form-control"></s:select>
						</div>
				      	<div class="col-md-2" align="center" style="width: 11%;">
							<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="oldSphDiskOS" id="oldSphDiskOS" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 11%;">
							<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="oldCylDiskOS" id="oldCylDiskOS" class="form-control" onclick="showValues(this.value, 'oldCylNearOS', 'oldSphNearOS');" ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%;">
				      	...
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--', '6/6':'6/6', '6/6P':'6/6P', '6/9':'6/9', '6/9P':'6/9P', '6/12':'6/12', '6/12P':'6/12P', '6/18':'6/18', '6/18P':'6/18P', '6/24':'6/24', '6/24P':'6/24P', '6/36':'6/36', '6/36P':'6/36P', '6/60':'6/60', '6/60P':'6/60P', 'No PL':'No PL', 'PL/PR':'PL/PR', 'PL/Faulty PR':'PL/Faulty PR', '1 mtr':'1 mtr', '2 mtr':'2 mtr', '3 mtr':'3 mtr', '2 ft':'2 ft', '1 ft':'1 ft', 'HM CF': 'HM CF', 'HM Only':'HM Only', 'PL+PR +ve':'PL+PR +ve', 'PL+PR -ve/Defect':'PL+PR -ve/Defect', 'No PL':'No PL', 'No Improvement':'No Improvement' }" name="oldVnDiskOS" id="oldVnDiskOS" class="form-control"></s:select>
						</div>
				      </div>
				      ...
				      <div class="row col-xs-12" style="margin-top:15px;">
				      	...
				      	<div class="col-md-2" align="center" style="width: 11%;">
							<s:select list="#{'--':'--','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50'}" value="--" name="oldSphNearOD" id="oldSphNearOD" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 11%;">
							<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="oldCylNearOD" id="oldCylNearOD" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="oldAxisNearOD" id="oldAxisNearOD" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'Less than N36':'Less than N36', 'No improvement':'No improvement'}" name="oldVnNearOD" id="oldVnNearOD" class="form-control"   ></s:select>
						</div>
				      	<div class="col-md-2" align="center" style="width: 11%;">
							<s:select list="#{'--':'--','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50'}" value="--" name="oldSphNearOS" id="oldSphNearOS" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 11%;">
							<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="oldCylNearOS" id="oldCylNearOS" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="oldAxisNearOS" id="oldAxisNearOS" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'Less than N36':'Less than N36', 'No improvement':'No improvement'}" name="oldVnNearOS" id="oldVnNearOS" class="form-control"   ></s:select>
						</div>
				      </div>
			    ...
			    <div class="row">
			      	<div class="col-md-3" align="left">
					    <div class="col-md-12">
					      <label for="Name" style=" margin-top:10px;font-size:18px;"><b>Cycloplegic Refraction</b></label>
					    </div>
			      	</div>
			
			    	<div class="col-md-8" align="" > 
			    		<div class="col-md-12">
			      			<s:checkboxlist style="zoom: 1.5" cssStyle="zoom: 1.5" list="#{'CTC':'CTC','HTC':'HTC','Atropine':'Atropine','T Plus':'T Plus', 'AR Values':'AR Values', 'Acceptance':'Acceptance'}" name="cycloplegicRefraction" value="defaultCycloplegicRefraction" />
			    		</div>
			    ...
			    <div class="row">
			      ...
			      <div class="row col-xs-12">
			      	<div class="col-md-2 col-xs-2" align="center">Dist</div>
			      	<div class="col-md-2" align="center" style="width: 11%;">
						<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="distCTCOD" id="distCTCOD" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 11%;">
						<s:select list="#{'--':'--','-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="distHTCOD" id="distHTCOD"  class="form-control" ></s:select>
					</div> 
			      	<div class="col-md-1" align="center" style="width: 9%;"> 
						<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="distAtropineOD" id="distAtropineOD"  class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', '6/6':'6/6', '6/6P':'6/6P', '6/9':'6/9', '6/9P':'6/9P', '6/12':'6/12', '6/12P':'6/12P', '6/18':'6/18', '6/18P':'6/18P', '6/24':'6/24', '6/24P':'6/24P', '6/36':'6/36', '6/36P':'6/36P', '6/60':'6/60', '6/60P':'6/60P', 'No PL':'No PL', 'PL/PR':'PL/PR', 'PL/Faulty PR':'PL/Faulty PR', '1 mtr':'1 mtr', '2 mtr':'2 mtr', '3 mtr':'3 mtr', '2 ft':'2 ft', '1 ft':'1 ft', 'HM CF': 'HM CF', 'HM Only':'HM Only', 'PL+PR +ve':'PL+PR +ve', 'PL+PR -ve/Defect':'PL+PR -ve/Defect', 'No PL':'No PL', 'No Improvement':'No Improvement' }" name="distTPlusOD" id="distTPlusOD" class="form-control"></s:select>
					</div>
			      	<div class="col-md-2" align="center" style="width: 11%;">
						<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="distCTCOS" id="distCTCOS" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 11%;">
						<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="distHTCOS" id="distHTCOS" class="form-control" ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="distAtropineOS" id="distAtropineOS" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', '6/6':'6/6', '6/6P':'6/6P', '6/9':'6/9', '6/9P':'6/9P', '6/12':'6/12', '6/12P':'6/12P', '6/18':'6/18', '6/18P':'6/18P', '6/24':'6/24', '6/24P':'6/24P', '6/36':'6/36', '6/36P':'6/36P', '6/60':'6/60', '6/60P':'6/60P', 'No PL':'No PL', 'PL/PR':'PL/PR', 'PL/Faulty PR':'PL/Faulty PR', '1 mtr':'1 mtr', '2 mtr':'2 mtr', '3 mtr':'3 mtr', '2 ft':'2 ft', '1 ft':'1 ft', 'HM CF': 'HM CF', 'HM Only':'HM Only', 'PL+PR +ve':'PL+PR +ve', 'PL+PR -ve/Defect':'PL+PR -ve/Defect', 'No PL':'No PL', 'No Improvement':'No Improvement' }" name="distTPlusOS" id="distTPlusOS" class="form-control"></s:select>
					</div>
			      </div>
			      ...
			      <div class="row col-xs-12" style="margin-top:15px;">
			      	<div class="col-md-2 col-xs-2" align="center">Near</div>
			      	<div class="col-md-2" align="center" style="width: 11%;">
						<s:select list="#{'--':'--','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50'}" value="--" name="nearCTCOD" id="nearCTCOD" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 11%;">
						<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="nearHTCOD" id="nearHTCOD" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="nearAtropineOD" id="nearAtropineOD" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'Less than N36':'Less than N36', 'No improvement':'No improvement'}" name="nearTPlusOD" id="nearTPlusOD" class="form-control"   ></s:select>
					</div>
			      	<div class="col-md-2" align="center" style="width: 11%;">
						<s:select list="#{'--':'--','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50'}" value="--" name="nearCTCOS" id="nearCTCOS" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 11%;">
						<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="nearHTCOS" id="nearHTCOS" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="nearAtropineOS" id="nearAtropineOS" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'Less than N36':'Less than N36', 'No improvement':'No improvement'}" name="nearTPlusOS" id="nearTPlusOS" class="form-control"   ></s:select>
					</div>
			      </div>
			      ...
			      <div class="row col-xs-12">
				    ...
				    <div class="row">
				      ...
				      <div class="row col-xs-12">
				      	<div class="col-md-2 col-xs-2" align="center">Dist</div>
				      	<div class="col-md-2" align="center" style="width: 11%;">
							<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="sphDiskOD"  class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 11%;">
							<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="cylDiskOD" id="cylDiskODID" class="form-control" onclick="showValues(this.value, 'cylNearODID', 'sphNearODID')"></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%; ">
				      	...
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--', '6/6':'6/6', '6/6P':'6/6P', '6/9':'6/9', '6/9P':'6/9P', '6/12':'6/12', '6/12P':'6/12P', '6/18':'6/18', '6/18P':'6/18P', '6/24':'6/24', '6/24P':'6/24P', '6/36':'6/36', '6/36P':'6/36P', '6/60':'6/60', '6/60P':'6/60P', 'No PL':'No PL', 'PL/PR':'PL/PR', 'PL/Faulty PR':'PL/Faulty PR', '1 mtr':'1 mtr', '2 mtr':'2 mtr', '3 mtr':'3 mtr', '2 ft':'2 ft', '1 ft':'1 ft', 'HM CF': 'HM CF', 'HM Only':'HM Only', 'PL+PR +ve':'PL+PR +ve', 'PL+PR -ve/Defect':'PL+PR -ve/Defect', 'No PL':'No PL', 'No Improvement':'No Improvement' }" name="vnDiskOD"  class="form-control"   ></s:select>
						</div>
				      	<div class="col-md-2" align="center" style="width: 11%;">
							<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="sphDiskOS"  class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 11%;">
							<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="cylDiskOS"  class="form-control" onclick="showValues(this.value, 'cylNearOSID', 'sphNearOSID')" ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%;">
				      	...
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--', '6/6':'6/6', '6/6P':'6/6P', '6/9':'6/9', '6/9P':'6/9P', '6/12':'6/12', '6/12P':'6/12P', '6/18':'6/18', '6/18P':'6/18P', '6/24':'6/24', '6/24P':'6/24P', '6/36':'6/36', '6/36P':'6/36P', '6/60':'6/60', '6/60P':'6/60P', 'No PL':'No PL', 'PL/PR':'PL/PR', 'PL/Faulty PR':'PL/Faulty PR', '1 mtr':'1 mtr', '2 mtr':'2 mtr', '3 mtr':'3 mtr', '2 ft':'2 ft', '1 ft':'1 ft', 'HM CF': 'HM CF', 'HM Only':'HM Only', 'PL+PR +ve':'PL+PR +ve', 'PL+PR -ve/Defect':'PL+PR -ve/Defect', 'No PL':'No PL', 'No Improvement':'No Improvement' }" name="vnDiskOS"  class="form-control"   ></s:select>
						</div>
				      </div>
				      ...
				      <div class="row col-xs-12">
				      	<div class="col-md-2 col-xs-2" align="center">Near</div>
				      	<div class="col-md-2" align="center" style="width: 11%;">
							<s:select list="#{'--':'--','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50'}" value="--" name="sphNearOD" id="sphNearODID" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 11%;">
							<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="cylNearOD" id= "cylNearODID" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="axisNearOD" id="axisNearODID" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'Less than N36':'Less than N36', 'No improvement':'No improvement'}" name="vnNearOD"  class="form-control"   ></s:select>
						</div>
				      	<div class="col-md-2" align="center" style="width: 11%;">
							<s:select list="#{'--':'--','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50'}" value="--" name="sphNearOS"  id ="sphNearOSID" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 11%;">
							<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" value="--" name="cylNearOS" id ="cylNearOSID" class="form-control"></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="axisNearOS" id="axisNearOSID" class="form-control"  ></s:select>
						</div>
				      	<div class="col-md-1" align="center" style="width: 9%;">
							<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'Less than N36':'Less than N36', 'No improvement':'No improvement'}" name="vnNearOS"  class="form-control"   ></s:select>
						</div>
				      </div>
			   ...
			   <div class="row">
			      ...
			      <div class="row col-xs-12">
			      	<div class="col-md-2 col-xs-2" align="center">Dist</div>
			      	<div class="col-md-2" align="center" style="width: 11%;">
						<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}"  name="distCTCOD" id="distCTCOD" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 11%;">
						<s:select list="#{'--':'--','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00'}" name="distHTCOD" id="distHTCOD"  class="form-control" ></s:select>
					</div> 
			      	<div class="col-md-1" align="center" style="width: 9%;"> 
						<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="distAtropineOD" id="distAtropineOD"  class="form-control"  ></s:select>
					</div>
			      	...
			      	<div class="col-md-2" align="center" style="width: 11%;">
						<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" name="distCTCOS" id="distCTCOS" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 11%;">
						<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}"  name="distHTCOS" id="distHTCOS" class="form-control" ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="distAtropineOS" id="distAtropineOS" class="form-control"  ></s:select>
					</div>
			      ...
			      <div class="row col-xs-12" style="margin-top:15px;">
			      	<div class="col-md-2 col-xs-2" align="center">Near</div>
			      	<div class="col-md-2" align="center" style="width: 11%;">
						<s:select list="#{'--':'--','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50'}" name="nearCTCOD" id="nearCTCOD" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 11%;">
						<s:select list="#{'--':'--','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00'}"  name="nearHTCOD" id="nearHTCOD" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="nearAtropineOD" id="nearAtropineOD" class="form-control"  ></s:select>
					</div>
			      	...
			      	<div class="col-md-2" align="center" style="width: 11%;">
						<s:select list="#{'--':'--','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50'}" name="nearCTCOS" id="nearCTCOS" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 11%;">
						<s:select list="#{'--':'--', '-20.00':'-20.00','-19.75':'-19.75','-19.50':'-19.50','-19.25':'-19.25','-19.00':'-19.00','-18.75':'-18.75','-18.50':'-18.50','-18.25':'-18.25','-18.00':'-18.00','-17.75':'-17.75','-17.50':'-17.50','-17.25':'-17.25','-17.00':'-17.00','-16.75':'-16.75','-16.50':'-16.50','-16.25':'-16.25','-16.00':'-16.00','-15.75':'-15.75','-15.50':'-15.50','-15.25':'-15.25','-15.00':'-15.00','-14.75':'-14.75','-14.50':'-14.50','-14.25':'-14.25','-14.00':'-14.00','-13.75':'-13.75','-13.50':'-13.50','-13.25':'-13.25','-13.00':'-13.00','-12.75':'-12.75','-12.50':'-12.50','-12.25':'-12.25','-12.00':'-12.00','-11.75':'-11.75','-11.50':'-11.50','-11.25':'-11.25','-11.00':'-11.00','-10.75':'-10.75','-10.50':'-10.50','-10.25':'-10.25','-10.00':'-10.00','-9.75':'-9.75','-9.50':'-9.50','-9.25':'-9.25','-9.00':'-9.00','-8.75':'-8.75','-8.50':'-8.50','-8.25':'-8.25','-8.00':'-8.00','-7.75':'-7.75','-7.50':'-7.50','-7.25':'-7.25','-7.00':'-7.00','-6.75':'-6.75','-6.50':'-6.50','-6.25':'-6.25','-6.00':'-6.00','-5.75':'-5.75','-5.50':'-5.50','-5.25':'-5.25','-5.00':'-5.00','-4.75':'-4.75','-4.50':'-4.50','-4.25':'-4.25','-4.00':'-4.00','-3.75':'-3.75','-3.50':'-3.50','-3.25':'-3.25','-3.00':'-3.00','-2.75':'-2.75','-2.50':'-2.50','-2.25':'-2.25','-2.00':'-2.00','-1.75':'-1.75','-1.50':'-1.50','-1.25':'-1.25','-1.00':'-1.00','-0.75':'-0.75','-0.50':'-0.50','-0.25':'-0.25','0':'0','+0.25':'+0.25','+0.50':'+0.50','+0.75':'+0.75','+1.00':'+1.00','+1.25':'+1.25','+1.50':'+1.50','+1.75':'+1.75','+2.00':'+2.00','+2.25':'+2.25','+2.50':'+2.50','+2.75':'+2.75','+3.00':'+3.00','+3.25':'+3.25','+3.50':'+3.50','+3.75':'+3.75','+4.00':'+4.00','+4.25':'+4.25','+4.50':'+4.50','+4.75':'+4.75','+5.00':'+5.00','+5.25':'+5.25','+5.50':'+5.50','+5.75':'+5.75','+6.00':'+6.00','+6.25':'+6.25','+6.50':'+6.50','+6.75':'+6.75','+7.00':'+7.00','+7.25':'+7.25','+7.50':'+7.50','+7.75':'+7.75','+8.00':'+8.00','+8.25':'+8.25','+8.50':'+8.50','+8.75':'+8.75','+9.00':'+9.00','+9.25':'+9.25','+9.50':'+9.50','+9.75':'+9.75','+10.00':'+10.00','+10.25':'+10.25','+10.50':'+10.50','+10.75':'+10.75','+11.00':'+11.00','+11.25':'+11.25','+11.50':'+11.50','+11.75':'+11.75','+12.00':'+12.00','+12.25':'+12.25','+12.50':'+12.50','+12.75':'+12.75','+13.00':'+13.00','+13.25':'+13.25','+13.50':'+13.50','+13.75':'+13.75','+14.00':'+14.00','+14.25':'+14.25','+14.50':'+14.50','+14.75':'+14.75','+15.00':'+15.00','+15.25':'+15.25','+15.50':'+15.50','+15.75':'+15.75','+16.00':'+16.00','+16.25':'+16.25','+16.50':'+16.50','+16.75':'+16.75','+17.00':'+17.00','+17.25':'+17.25','+17.50':'+17.50','+17.75':'+17.75','+18.00':'+18.00','+18.25':'+18.25','+18.50':'+18.50','+18.75':'+18.75','+19.00':'+19.00','+19.25':'+19.25','+19.50':'+19.50','+19.75':'+19.75','+20.00':'+20.00'}" name="nearHTCOS" id="nearHTCOS" class="form-control"  ></s:select>
					</div>
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', '0':'0','5':'5','10':'10','15':'15','20':'20','25':'25','30':'30','35':'35','40':'40','45':'45','50':'50','55':'55','60':'60','65':'65','70':'70','75':'75','80':'80','85':'85','90':'90','95':'95','100':'100','105':'105','110':'110','115':'115','120':'120','125':'125','130':'130','135':'135','140':'140','145':'145','150':'150','155':'155','160':'160','165':'165','170':'170','175':'175','180':'180'}" name="nearAtropineOS" id="nearAtropineOS" class="form-control"  ></s:select>
					</div>
			    ...
			    <div class="row" style="margin-top:10px;">
				    ...
				    <div class="col-md-4 col-sm-4" align="left">
				    	<div class="col-md-12 col-sm-12">
				      		<label for="Name" style="margin-top:10px;font-size:16px;"><b>Spectacle Comments</b></label>
				    	</div>
				    </div>
				
				    <div class="col-md-8 col-sm-8 col-xs-12" align="left" > 
				    	<div class="col-md-12 col-sm-12 col-xs-12">
				        	<s:checkboxlist style="zoom: 1.5" cssStyle="zoom: 1.5" list="#{'Constant Use':'Constant Use','Near Only':'Near Only','Distance Only':'Distance Only','Bifocal':'bifocal','Progressive':'Progressive','Photochromic':'Photochromic'}" name="spectacleComments" value="defaultSpectacleComments" />
				    	</div>
				    </div>
				</div>
				...
				<div class="row" style="margin-top:10px;">
				    ...
				    <div class="col-md-4 col-sm-4" align="left">
				    	<div class="col-md-12 col-sm-12">
				      		<label for="Name" style="margin-top:10px;font-size:16px;"><b>Comments</b></label>
				    	</div>
				    </div>
				
				    <div class="col-md-8 col-sm-8 col-xs-12" align="left" > 
				    	<div class="col-md-12 col-sm-12 col-xs-12">
				        	<s:textarea rows="3" class="form-control" name="optomeryComment" placeholder="Comment"></s:textarea>
				    	</div>
				    </div>
				</div>	
			  ...
			  <div class="row">
			    ...
			    <div class="row">
			      ...
			      %>
			        ...
			        <tr align="left">
			          <td>Frame</td>
			          <td><input type="text" name="frameCharge" style="border:none;" id="frameChargeID" onkeyup="calculateTotal();" class="form-control"></td>
			        ...
			        <tr align="left">
			          <td>Glass</td>
			          <td><input type="text" name="glassCharge" style="border:none;" id="glassChargeID" onkeyup="calculateTotal();" class="form-control" ></td>
			          <td colspan="2" style="border-top: 0;"></td>
			
			        </tr>
			        <tr align="left">
			          <td>Total</td>
			          <td><input type="text" name="total" style="border:none;cursor: not-allowed;background: transparent;" class="form-control" id="totalID" readonly="readonly"  ></td>
			          <td>Discount</td>
			          <td><input type="text" name="discount" style="border:none;" id="discountID" value="0" onkeyup="calculateDiscount();" class="form-control"></td>
			        </tr>
			
			        <tr align="left">
			          <td>Net Payment</td>
			          <td><input type="text" name="netPayment" style="border:none;cursor: not-allowed;background: transparent;" id="netPaymentID" readonly="readonly" class="form-control" ></td>
			          <td colspan="2"></td>
			        </tr>
			
			        <tr align="left">
			          <td>Advance</td>
			          <td><input type="text" name="advance" id="advanceID" style="border:none;" onkeyup="calculateBalance();" class="form-control"></td>
			          <td>Balance</td>
			          <td><input type="text" name="balance" id="balanceID" style="border:none;cursor: not-allowed;background: transparent;" readonly="readonly" class="form-control"></td>
			        </tr>
			
			        <tr align="left">
			          <td>Balance Paid</td>
			          <td><input type="text" name="balancePaid" style="border:none;"  class="form-control"></td>
			          <td>Balance Paid Date</td>
			          <td><input type="text" class="form-control" name="balancePaidDate" style="border:none;" id="single_cal31" placeholder="Balance Paid Date" aria-describedby="inputSuccess2Status3"></td>
			        </tr>
			      </table>
			 ...
			 <% } %>
				...
				<div class="ln_solid"></div>
		                    ...
		                    <div class="form-group">
		                      <div class="col-md-12" align="center">
		                        <button type="button" onclick="windowOpen1();" class="btn btn-primary">Cancel</button>
		                        <button class="btn btn-success" type="submit" style="width:15%" >Save</button>
		                        <button class="btn btn-warning" type="button" style="width:15%" onclick="printOptician();">Save & Print</button>
		                      </div>
		                    </div>			    
			    ...
			    <div class="tab-pane fade" id="bill" >
			      <form class="form-horizontal form-label-left" onsubmit="checkCheckbox();" name="OPDBILLForm" id="OPDBILLForm" action="AddNewBill" method="POST" style="margin-top:20px;">
								...
								<tbody>
									...
									<tr id="billingItemTRID">
										<td style="text-align: right">
											<a href="javascript:void(0)" onclick="openOPDChargesModal()" > 
								 				<img src="images/add_icon_1.png" onmouseover="this.src='images/add_icon_2.png'"
			    ...
			    <div class="tab-pane fade" id="labRep" >
			      ...
			      <form class="form-horizontal form-label-left" novalidate action="AddLabReport" onsubmit="return showLoadingImg();" name="labRepForm" id="labRepForm" method="POST" style="margin-top:20px;" enctype="multipart/form-data">
