...
<%  String clinicianCheck = (String) request.getAttribute("clinician");
	System.out.println("clinicianCheck: "+clinicianCheck);
	if(clinicianCheck.equals("Yes")){ %>
	...
	<script type="text/javascript">
		...
		document.addEventListener('DOMContentLoaded', function() {
			...
			var patientID = <%=form.getPatientID()%>
			if(finalCount == 0){
		...
		function openVisitTypeModal(patientID){
			...
			xmlhttp.open("GET", "VerifyIPDVisitType?patientID="+<%=form.getPatientID()%>, true);
			xmlhttp.send();
...
<script type="text/javascript" charset="UTF-8">
	...
	<script type="text/javascript">
		...
		function submitApptForm(){
			...
			var visitTypeID = $("#apptTypeID1").val();
			var age = $("#ageID").val();
			
			if(fname == "" || lname == "" || visitTypeID == "000" || age == ""){
				return true;
			}else if($("#mobileID").val().length < 10){
...
<!-- retrieving medica registration no -->

<%
	PatientDAOInf patientDAOInf = new PatientDAOImpl();
	String medicalRegNo = patientDAOInf.retireveMedicalRegistrationNo(form.getPracticeSuffix());
	String clinicRegNo = patientDAOInf.retirevePatientClinicRegistrationNo(form.getClinicSuffix(), form.getClinicID());
%>
...
<script type="text/javascript">
    ...
    document.addEventListener('DOMContentLoaded', function() {
		...
		setTimeout(function(){
			//alert('hii');
			$('#apptStartTimeID1').attr("value",$("#apptStartTimeID1Hidden").val());
		},1000);
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<%
										if (apptCheck.equals("appointment")) {
									%>

									<form class="form-horizontal form-label-left" action="AddPatientAppointment" name="apptFormID" onsubmit="return submitApptForm();"
										id="apptFormID" method="POST" style="margin-top: 20px;">
										...
										<s:iterator value="patientList" var="form">
											...
											<div class="item form-group">
												<label for="User Type" class="control-label col-md-3 col-sm-4">Date Of Birth</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" name="DateOfBirth" placeholder="Date Of Birth" id = "single_cal3" value="<s:property value='dob'/>" class="form-control" readonly="readonly">
												</div>
											</div>
											
											<div class="item form-group">
												<label 
													for="User Type" class="control-label col-md-3 col-sm-4">Age <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="number" name="age" placeholder="Age" required="required"
														id="ageID" value="<s:property value='age'/>" class="form-control">
												</div>
											</div>

											<div class="item form-group">
												<label 
													for="User Type" class="control-label col-md-3 col-sm-4">Mobile <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="number" name="mobile" placeholder="Mobile" required="required"
														id="mobileID" value="<s:property value='Mobile'/>" class="form-control"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
												</div>
												<div class="col-md-2 col-sm-2">
													<button type="button" class="btn btn-info" id="sendOTP">Verify Via OTP</button>
												</div>
											</div>
											...
											<div class="item form-group search-container">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<%-- <sx:autocompleter name="cancerType" cssStyle="padding-left:14px;" list="diagnoseList" showDownArrow="false" id="search" cssClass="form-control"/> --%>
										      		<s:select list="refDocList" headerKey="" headerValue="Select Doctor" name="refDoctor" id="refDoctor" class="form-control" >
											...
											<div class="item form-group">
												...
												<div class="col-md-4 col-sm-4 col-xs-12" style="padding-top:2%">
													<s:select list="#{'A':'A','B':'B','O':'O','AB':'AB'}" id="bloodGroupID" name="bloodGroup"
														class="form-control" headerKey="" headerValue="Blood Group"></s:select>
												</div>
												<div class="col-md-2 col-sm-2 col-xs-12" style="padding-top:2%">
													<s:select list="#{'+ve':'+ve','-ve':'-ve'}" name="rhFactor"
														 id="rhFactorID" class="form-control" headerKey="" headerValue="Rh"></s:select>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-12 col-sm-12" style="margin-bottom: 15px;">
													<a
														...
														href="#medicalHistory" aria-expanded="false"
														aria-controls="collapseExample"> MEDICAL HISTORY:
													</a>
												</div>
												...
												<div class="collapse" id="medicalHistory"
													...
													<div class="item form-group">
														<label class="control-label col-md-3 col-sm-4 col-xs-12"
															for="isDiabetes">Do you suffer from Diabetes?
														</label>
														<div class="col-md-6 col-sm-6 col-xs-12">
															<s:radio
																list="#{'Yes':'Yes','No':'No'}"
																id="isDiabetes" name="isDiabetes" style="margin-left:5px; margin-right:5px;"></s:radio>
														</div>
													</div>
													
													<div class="item form-group">
														<label class="control-label col-md-3 col-sm-4 col-xs-12"
															for="asthema">Do you suffer from Asthma?
														</label>
														<div class="col-md-6 col-sm-6 col-xs-12">
															<s:radio
																list="#{'Yes':'Yes','No':'No'}"
																id="asthema" name="asthema" style="margin-left:5px; margin-right:5px;"></s:radio>
														</div>
													</div>
													
													<div class="item form-group">
														<label class="control-label col-md-3 col-sm-4 col-xs-12"
															for="hypertension">Do you suffer from High Blood Pressure?
														</label>
														<div class="col-md-6 col-sm-6 col-xs-12">
															<s:radio
																list="#{'Yes':'Yes','No':'No'}"
																id="hypertension" name="hypertension" style="margin-left:5px; margin-right:5px;"></s:radio>
														</div>
													</div>
													
													<div class="item form-group">
														<label class="control-label col-md-3 col-sm-4 col-xs-12"
															for="Gender">Do you suffer from Heart Disease?
														</label>
														<div class="col-md-6 col-sm-6 col-xs-12">
															<s:radio
																list="#{'Yes':'Yes','No':'No'}"
																id="ischemicHeartDisease" name="ischemicHeartDisease" style="margin-left:5px; margin-right:5px;"></s:radio>
														</div>
													</div>
													
													<div class="item form-group">
														<label class="control-label col-md-3 col-sm-4 col-xs-12"
																for="otherDetails">Any other medical condition or disease? </label>
														<div class="col-md-6 col-sm-6 col-xs-12">
															<s:textarea name="otherDetails" class="form-control"
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" name="" readonly="readonly"
														value="<%=clinicRegNo%>" placeholder="Registration No."
														required="required" class="form-control" placeholder="Medical Registration No."> <input
											...
											<div class="row">
												...
												<div class="collapse" id="identification"
													...
													<div class="item form-group">
														<label for="User Type" class="control-label col-md-3 col-xs-12 col-sm-4">Aadhaar
															No.</label>
														<div class="col-md-6 col-sm-6 col-xs-12">
											...
											<div class="row">
												...
												<div class="collapse" id="emgContactInfo"
													...
													<div class="item form-group">
														...
														<div class="col-md-2 col-sm-2 col-xs-12" style="padding-top:2%">
															<input class="form-control" name="emFname"
																value="<s:property value='emFname'/>" id="emFnameID"
																placeholder="First Name" type="text"
																onblur="validate(this.value, 'emFnameID');">
														</div>
														<div class="col-md-2 col-sm-2 col-xs-12" style="padding-top:2%">
															<input class="form-control" name="emMname"
																value="<s:property value='emMname'/>" id="emMnameID"
																placeholder="Middle Name" type="text"
																onblur="validate(this.value, 'emMnameID');">
														</div>
														<div class="col-md-2 col-sm-2 col-xs-12" style="padding-top:2%">
															<input class="form-control" name="emLname"
																value="<s:property value='emLname'/>" id="emLnameID"
													...
													<div class="item form-group">
														<label class="control-label col-md-3 col-sm-4 col-xs-12"
															for="Country">Country </label>
														<div class="col-md-6 col-sm-6 col-xs-12">
															<input type="text" name="emCountry"
																value="<s:property value='emCountry'/>"
																placeholder="Country" readonly="readonly"
																class="form-control">
														</div>
													</div>
											...
											<div class="row">
												...
												<div class="collapse in" id="appointmentInfo"
													...
													<div class="item form-group">
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<input type="text" class="form-control"
																value="<s:property value='appointmentDate'/>"
																name="appointmentDate" id="single_cal3"
													...
													<div class="item form-group">
														<label class="control-label col-md-3 col-sm-4 col-xs-12"
															for="Appointment Date">Appointment Time From<span
															class="required">*</span>
														</label>
														<div class="col-md-6 col-sm-6 col-xs-12">
															<%--  <input type="text" class="form-control" value="<s:property value='aptTimeFrom'/>" name="aptTimeFrom" id="apptStartTimeID1" placeholder="Appointment Time From"> --%>
															<input type="hidden" id="apptStartTimeID1Hidden"
																value="<s:property value='aptTimeFrom'/>">
															<div class="input-group date clinic_start col-md-12"
																...
																<input class="form-control" size="16"
																	id="apptStartTimeID1" name="aptTimeFrom" type="text"
																	value="" readonly> <span
													...
													<div class="item form-group">
														<label class="control-label col-md-3 col-sm-4 col-xs-12"
															for="Appointment Type">Appointment Type<span
															class="required">*</span>
														</label>
														<div class="col-md-6 col-sm-6 col-xs-12">
															<select id="apptTypeID1" name="visitTypeID"
																class="form-control"
																onchange="getAppointmentDuration(apptTypeID1.value, apptStartTimeID1.value);">
													...
													<div class="item form-group">
														<label for="User Type" class="control-label col-md-3 col-sm-4">Appointment
															Time To<span class="required">*</span>
														</label>

														<div class="col-md-6 col-sm-6 col-xs-12">
															<input type="text" id="apptEndTimeID1" name="aptTimeTo"
																class="form-control" placeholder="Appt End Time"
													...
													<div class="item form-group">
														<label class="control-label col-md-3 col-sm-4 col-xs-12"
															for="Appointment Type">Appointment By </label>
														<div class="col-md-6 col-sm-6 col-xs-12">
													...
													<div class="item form-group">
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<input type="checkbox" name="walkIn" value="1"
																style="zoom: 1.8;">
														</div>
													</div>
									...
									<form class="form-horizontal form-label-left" id="apptFormID" onsubmit="return submitPatForm();" 
									name="apptFormID" action="AddPatient" method="POST"
										...
										<s:iterator value="patientList" var="form">
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
												<div>
													<input type="number" class="form-control" value="<s:property value='Mobile'/>" name="mobile" onKeyPress="if(this.value.length==10) return false;" 
													id="mobileID" placeholder="Mobile" required="required" aria-describedby="inputGroupSuccess1Status">
												</div>	
											...
											<div class="row">
												...
												<div class="collapse" id="emgContactInfo"
													...
													<div class="item form-group">
														<label for="User Type" class="control-label col-md-3 col-sm-4">Mobile</label>
														<div class="col-md-6 col-sm-6 col-xs-12">
															<input type="number" name="emMobile" value="<s:property value='emMobile'/>" placeholder="Mobile" class="form-control"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
														</div>
													</div>
											...
											<div class="form-group">
												<div class="col-md-12 col-xs-12" align="center">
													...
													<button type="submit" id="patSubmit" class="btn btn-success">Add Patient</button>
												</div>
											</div>
    	  ...
    	  $("#otpID").on("keyup",function(){
    		  ...
    		  if(userOTP == verificationOTP){
    			  ...
    			  var xmlhttp;
	  				...
	  				xmlhttp.open("POST", "ValidateOTP?mobile="+mobileNo, true);
	  				xmlhttp.send();
