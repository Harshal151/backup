...
<title>Edit Patient Profile | E-Dhanvantari</title>
					...
					<nav>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								aria-expanded="false"> <%
 									if (daoInf.retrieveProfilePic(patientID) == null || daoInf.retrieveProfilePic(patientID).isEmpty()) {
 									%> 
	                  ...
	                  <%
							 ...
							 %> <span class=" fa fa-angle-down"></span>
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a href="javascript:editPatientProfile(<%=patientID%>)" onclick="showLoadingImg();"> Profile</a></li>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form class="form-horizontal form-label-left" novalidate onsubmit="return showLoadingImg();"
										action="EditPatientProfile" method="POST" style="margin-top: 20px;">
										...
										<s:iterator value="patientList" var="form">
											...
											<div class="item form-group">
												<label for="User Type" class="control-label col-md-3 col-sm-4">Age<span class="required">*</span></label>
												<div class="col-md-6 col-sm-6 col-xs-12">
											...
											<div class="item form-group">
												<label for="User Type" class="control-label col-md-3 col-sm-4">Mobile<span
													class="required">*</span></label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="number" name="mobile" placeholder="Mobile"
														id="mobileID" value="<s:property value='Mobile'/>"
														required="required" class="form-control"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
												</div>
											</div>
