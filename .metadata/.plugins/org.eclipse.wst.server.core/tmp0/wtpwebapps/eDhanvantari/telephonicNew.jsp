	...
	<script type="text/javascript">
		...
		function downloadVisit(){
			...
			if(diag == null || diag ==""){
				...
				document.forms["visitrForm"].action = "DownloadGenPhyVisit";
				document.forms["visitrForm"].submit();
	   			return true;
			}
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				     ...
				     <div class="col-md-6 col-sm-6 col-xs-12">
	                  ...
	                  <div class="col-md-6 col-sm-6 col-xs-12">
	                  	<div class="col-md-4"><label for="name" style="font-size: 15px; margin-top: 0.5em; padding-left:43px">Mobile:</label></div>
		               	<div class="col-md-4"><input type="text" class="form-control" readonly="readonly"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status" style="margin-top: 0.5em; padding-left:11px" value="<s:property value="mobile"/>" /></div>
	                  </div>                      
	              </div>  
						    ...
						    <div class="control-label col-md-10  col-sm-12 col-xs-12" style="padding-left:30px; margin-top:-3%;">
		                     	<div class="row" style="padding-top: 30px;">
		                			...
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;">Smoking</label></div>
		                	 		<div class="col-md-4"  style="padding-top: 3px; padding-left:34px; margin-right:10px;"><s:radio list="#{'Yes':'Yes','No':'No'}" name="personalHistorySmoking"  cssStyle="margin-right:5px" onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>
				     			...
				     			<div class="col-md-6 col-sm-6"> 
	                      		...
	                      		<div class="col-md-6 col-sm-6">             
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;">Alcohol</label></div>                    
			               			<div class="col-md-4"  style="padding-top: 3px;  margin-right:10px; padding-left:34px;"><s:radio list="#{'Yes':'Yes','No':'No'}" name="personalHistoryAlcohol" cssStyle="margin-right:5px"  onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>
								...
								<div class="col-md-6 col-sm-6"> 
	                      		...
	                      		<div class="col-md-6 col-sm-6">           
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;" >Tobacco</label></div>
			               			<div class="col-md-4" style="padding-top: 3px; margin-right:10px;padding-left:34px;"><s:radio list="#{'Yes':'Yes','No':'No'}" name="personalHistoryTobacco"  cssStyle="margin-right:5px"  onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>	
								<div class="col-md-6 col-sm-6"> 
									<div class="col-md-4"><label for="User Type" style="font-size: 15px;" >Comments</label></div>
		                 		...
		                 		<div class="row" style="padding-top: 20px;">
	                      		<div class="col-md-6 col-sm-6">              
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;">Food Choice</label></div>
			               			<div class="col-md-5" style="padding-top: 3px; margin-right:10px; padding-left:10px;"><s:radio list="#{'Veg':'Veg','Non-Veg':'Non-Veg'}" name="personalHistoryFoodChoice" cssStyle="margin-right:5px"  onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>
	             ...
	             <div class="item form-group" style="padding-top: 20px;">
		              <div class="col-md-3"><label for="User Type" style="font-size: 15px; padding-left: 7px; padding-top: 15px;">Current Medication</label></div>
	                      ...
	                      <div class="item form-group col-md-10" style="padding-top: 20px;" >
		                     ...
		                     <div class="col-md-2" >
		                     <label for="User Type" style="font-size: 15px; margin-left:6px; padding-top:20%;">Vital Signs :</label></div>
			    ...
			    <!--  END -->
			     ...
			     <div class="tab-pane fade" id="presc" >
			        <form class="form-horizontal form-label-left" novalidate id="genPhyPrescID" name="return genPhyPrescID" onsubmit="savePrescription();" action=AddNewPrescription method="POST" style="margin-top:20px;">
				    ...
				    <div class="row" style="margin-top:100px;"> 
				      ...
				      <div class="ln_solid"></div>
			                ...
			                <button class="btn btn-warning" type="submit" id="PrintPrescID" name="addButton" value="print" >Save & Print</button>
		                      ...
		                      <%
	                          	if(lastEnteredPrescList.equals("success")){
	                          %>
			      ...
			      <form class="form-horizontal form-label-left" onsubmit = "return checkCheckbox();" id="genPhyBillID" name="genPhyBillID" action="AddNewBill" method="POST" style="margin-top:20px;">
						...
						<div class="row" style="margin-top: 15px;">
							...
							<div class="col-md-4 col-xs-11 col-sm-4">
								<%-- <font style="font-size: 14px;font-weight: bold;"><s:property value="<%=visitType%>"/></font> --%>
			     	...
			     	<div class="ln_solid"></div>
		                    ...
		                    <div class="form-group">
		                      <div class="col-md-12 col-xs-12" align="center">
			               	 ...
			               	 <button class="btn btn-warning" type="submit" name="addButton" value="print" >Add & Print</button>
			               	 
		                        <%
	                          	if(lastEnteredBillList.equals("success")){
	                          %>
					    ...
					    <input type="hidden" id="doctrName"  value="<%=fullName %>">
					        ...
					        <textarea style="display: none" name="medicalCertiForPDF" id="medicalCertiForPDF" cols="" rows="5"></textarea>
				    					...
				    					<div class="col-md-12" id="medicalTextDivID" style="margin:25px;display: none;" >
					     				...
					     				<div class="col-md-12" id= "medicalCertiTextDivID" style="border:1px solid gray;margin:25px;display: none;">
									    ...
									    %>
					     				...
					     				<div class="col-md-12" id= "medicalCertiTextDivID" style="border:1px solid gray;margin:25px;">
