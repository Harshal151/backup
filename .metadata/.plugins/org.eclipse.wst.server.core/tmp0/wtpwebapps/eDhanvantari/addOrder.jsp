...
<html lang="en">
  <head>
    ...
    <!-- Retrieving supplierName from request -->
    
    <% 
    
    	String supplierName = (String) request.getAttribute("supplierName");
    
    	boolean check = util.verifyCommunicationCheck("emailInventory");
    ...
    <!-- Retrieving order no based on clincSuffix from Orders table -->
    
    <%
    	//PrescriptionManagementDAOInf prescriptionManagementDAOInf = new PrescriptionManagementDAOImpl(); 
	...
	var popup;
		function OPDPdfAction(){
			popup = window.open('IPDPDFDownload?pdfOutPath=<%=pdfOutFIleName1%>',"Popup", "width=700,height=700");
			popup.focus();
			popup.print();
		}
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <form action="ConfirmOrder" method="POST" name="orderForm" id="orderForm">
		              
		              <h4 style="">Supplier: <b><%=supplierName %></b></h4>
					  <h4 style="">Order No: <b><%=orderNo %></b></h4>
                        ...
                        <s:iterator value="stockList" var="UserForm">
                        	<tr>
                        			...
                        			<td><s:property value="productName" />
                        				<input type="hidden" name="productCompID" value="<s:property value="productID" />">
                        				<input type="hidden" name="customerID" value="<s:property value="supplierID" />">
                        				<input type="hidden" name="stockClinicID" value="<s:property value="clinicID" />">
                        				</td>
                        			
                        			<td><s:property value="quantity" />
                        				<input type="hidden" name="productQuantity" value="<s:property value="quantity" />">
                        			</td>
                    ...
                    <div class="row" style="margin-top:15px;">
	                   			...
	                   			<div class="col-md-4">
	                   				<a href="RenderOrderStock"><button type="button" class="btn btn-default" onclick="showLoadingImg();">Cancel</button></a>
	                   				<%if(check){%>
	                   					<button type="submit" class="btn btn-success" id="addBtnID" name="submitButton" value="Email" >Email Order</button>
	                   				<%}else{%>
	                   					<button type="submit" class="btn btn-success" id="addBtnID" name="submitButton" disabled="disabled" value="Email" >Email Order</button>
	                   				<%}%>
	                   				
	                   				<button type="submit" class="btn btn-primary" id="addBtnID1" name="submitButton" value="Print" >Print Order</button>
	                   			</div>
	                   			<div class="col-md-4">
	                   			</div>
	                   </div>
