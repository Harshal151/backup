...
<script type="text/javascript">
    ...
    <%
	    ...
	    ValueMap.put("clinician","Tele. Consult,Prescription,Billing,Report");
						    ...
						    <div class="control-label col-md-10 col-sm-12 col-xs-12" style="padding-left:30px; margin-top:-3%;">
		                     	<div class="row" style="padding-top: 30px;">
		                			...
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;">Smoking</label></div>
		                	 		<div class="col-md-4"  style="padding-top: 3px; padding-left:34px;"><s:radio list="#{'Yes':'Yes','No':'No'}" name="personalHistorySmoking" onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>
				     			...
				     			<div class="col-md-6 col-sm-6"> 
	                      		...
	                      		<div class="col-md-6 col-sm-6">             
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;">Alcohol</label></div>                    
			               			<div class="col-md-4"  style="padding-top: 3px;  margin-right:10px; padding-left:34px;"><s:radio list="#{'Yes':'Yes','No':'No'}" name="personalHistoryAlcohol" onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>
								...
								<div class="col-md-6 col-sm-6"> 
	                      		...
	                      		<div class="col-md-6 col-sm-6">           
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;" >Tobacco</label></div>
			               			<div class="col-md-4" style="padding-top: 3px; margin-right:10px;padding-left:34px;"><s:radio list="#{'Yes':'Yes','No':'No'}" name="personalHistoryTobacco"  onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>	
								<div class="col-md-6 col-sm-6"> 
									<div class="col-md-4"><label for="User Type" style="font-size: 15px;" >Comments</label></div>
		                 		...
		                 		<div class="row" style="padding-top: 20px;">
	                      		<div class="col-md-6 col-sm-6">              
		                			<div class="col-md-4"><label for="User Type" style="font-size: 15px;">Food Choice</label></div>
			               			<div class="col-md-5" style="padding-top: 3px; margin-right:10px; padding-left:10px;"><s:radio list="#{'Veg':'Veg','Non-Veg':'Non-Veg'}" name="personalHistoryFoodChoice"  onclick="displayConentDocDiv(this.value);"></s:radio></div>
								</div>
		              ...
		              <div class="col-md-3"><label for="User Type" style="font-size: 15px; padding-left: 7px; padding-top: 15px;">Current Medication</label></div>
						      	...
						      	<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					                <thead>
										<tr>
					                        ...
					                        <th style="width: 10%; align="left">Action</th>
					                    </tr>
					                 </thead>
					                 <tbody> 
					                 <tr>
					                 <td><input type="text" class="form-control" name="" id="CurrentMedidrugnameID"  placeholder="Drug Name"></td>
		                 ...
		                 <div class="col-md-10  col-sm-12 col-xs-8">
			                     <div class="col-xs-12 col-md-3 col-sm-3" style="margin-left:-7%;" >
			                        ...
			                        <input type="number" style="width: 70%; margin-left:15px;" class="form-control" name="weight" id="weightID" value="<s:property value="weight"/>"  placeholder="Weight (in kgs)">
			                     </div>
	                      ...
	                      <div class="form-group" >
	                        <div class="col-md-12 col-sm-12 col-xs-12"  style="padding-top: 50px;" align="center">
			                 ...
			                 <button class="btn btn-warning" type="button" id="printButton"   onclick="printVisit();">Update & Print</button>
	                   
			                 <button class="btn btn-warning" type="button" id="downloadButton"   onclick="downloadVisit();">Download</button>
			   ...
			   <!-- Prescription div -->
				      ...
				      <div class="ln_solid"></div>
		                    ...
		                    <div class="form-group">
		                      <div class="col-md-12 col-xs-12" align="center">
		                        ...
		                        <button type="submit" id="savePrescID" class="btn btn-success" name="addButton" value="add">Update</button>
			                 	<button class="btn btn-warning" type="submit" id="PrintPrescID" name="addButton" value="print">Update & Print</button>
		                     
			                 	<button class="btn btn-warning" type="submit" id="DownPrescID" name="addButton" value="download">Download</button>
			    ...
			    <!-- Billing div -->
			     <div class="tab-pane fade" id="billing" >
			      <form class="form-horizontal form-label-left" onsubmit = "return checkCheckbox();" id="genPhyBillID" name="genPhyBillID" action="EditBill" method="POST" style="margin-top:20px;">
			     	...
			     	<div class="ln_solid"></div>
		                    ...
		                    <div class="form-group">
		                      <div class="col-md-12 col-xs-12" align="center">
		                        <button type="button" onclick="windowOpen1();" class="btn btn-primary">Cancel</button>
		                         <button class="btn btn-success" type="submit" name="addButton" value="add" >Update</button>
			               	  <button class="btn btn-warning" type="submit" name="addButton" value="print">Update & Print</button>
			               	  <button class="btn btn-warning" type="submit" name="addButton" value="download" >Download</button>
