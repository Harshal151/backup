...
<html lang="en">
  <head>
    ...
    <title>SMS Template | E-Dhanvantari</title>
	...
	<script type="text/javascript">
		function deleteSMSTemplate(url){
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchSMSTemplate" onsubmit="return showLoadingImg();" method="POST">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search SMS Template" name="searchSMSTemplate">
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<button style="width:105%;" type="submit" class="btn btn-success active">Search SMS Template</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllSMSTemplates"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All SMS Templates</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="SMSTemplateList" var="SMSTemplateForm">
		                        	<tr>
								
											<td><s:property value="SMSTemplateTitle" /></td>
											
											<td><s:property value="SMSTemplateText" /></td>
												 
											<td align="center"><s:url id="approveURL"
												action="RenderEditSMSTemplate">
												<s:param name="SMSTemplateID" value="%{SMSTemplateID}" />
												<s:param name="searchSMSTemplate" value="%{searchSMSTemplate}" />
											</s:url> <s:a href="%{approveURL}">
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit SMS Template"
													title="Edit SMS Template" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteSMSTemplate">
												<s:param name="SMSTemplateID" value="%{SMSTemplateID}" />
												<s:param name="searchSMSTemplate" value="%{searchSMSTemplate}" />
											</s:url> <s:a href="javascript:deleteSMSTemplate('%{disableUserURL}')">
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete SMS Template"
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="AddSMSTemplate" method="POST" onsubmit="return showLoadingImg();" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="SMSTemplate">Title <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="SMSTemplateTitle" required="required" placeholder="SMS Template Title" class="form-control">
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Type">Text <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <textarea rows="2" cols="" class="form-control" placeholder="SMS Text" name="SMSTemplateText"></textarea>
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group">
	                        <div class="col-md-12 col-xs-12" align="center">
	                          <button type="reset" class="btn btn-primary"  onclick="windowOpen();">Cancel</button>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditSMSTemplate" method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="editSMSTemplateList" var="concessionForm">
						  
						  <input type="hidden" name="SMSTemplateID" value="<s:property value="SMSTemplateID" />" >
						  <input type="hidden" name="searchSMSTemplate" value="<s:property value="searchSMSTemplate" />" >
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="SMSTemplate">Title <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="SMSTemplateTitle" required="required" value="<s:property value="SMSTemplateTitle" />" placeholder="SMS Template Title" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <textarea rows="2" cols="" class="form-control" placeholder="SMS Text" name="SMSTemplateText"><s:property value="SMSTemplateText" /></textarea>
	                        </div>
	                      </div>
