...
<html lang="en">
  <head>
    ...
    <title>Stock Report | E-Dhanvantari</title>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <center>
          	<h4 style="color:black;">No supplier is selected. Please select supplier.</h4>
          </center>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                    ...
                    <div class="row">
                     <form action="GenerateStockReport" method="POST" onsubmit="saveStockReport();">
                     <div class="row" style="margin: 0 15px 0 15px;">
                       <div class="col-md-2 col-sm-3 col-xs-6">
                       	 <font><b>Select Supplier</b></font>
                         <s:select list="supplierList" headerKey="-1" headerValue="Select Supplier" name="supplierID" class="form-control" id="supplierID"></s:select>
                       </div>
                       <div class="col-md-2 col-sm-3 col-xs-6">
                       	  <font><b>Select Criteria</b></font>
                          <s:select list="#{'StockRecptNo':'Stock Receipt No','ProductName':'Product Name'}" name="searchCriteria" class="form-control" id="" ></s:select>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <font><b>Select Status</b></font>
                          <s:select list="#{'Both':'Both','Empty':'Empty','Not Empty':'Not Empty'}" name="activityStatus" class="form-control" id=""></s:select>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                         <font><b>Enter Term</b></font>
                         <input type="text" name="searchPatientName" id="searchNameID" class="form-control" placeholder="Enter search term here*">
                       </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
