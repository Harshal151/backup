...
<html lang="en">
  <head>
    ...
    <title>Configure Diagnoses | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchDiagnoses" method="POST" onsubmit="return showLoadingImg();">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search Diagnosis" name="searchDiagnosis">
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active">Search Diagnosis</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllDiagnoses"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Diagnoses</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="configureDiagnosisList" var="UserForm">
		                        	<tr>
								
											<td><s:property value="diagnosis" /></td>
											
											<td><s:property value="diagnosisICD10Code" /></td>
												 
											<td align="center"><s:url id="approveURL"
												action="RenderEditDiagnosis">
												<s:param name="diagnosisID" value="%{diagnosisID}" />
												<s:param name="searchDiagnosis" value="%{searchDiagnosis}" />
											</s:url> <s:a href="%{approveURL}">
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Diagnosis"
													title="Edit Diagnosis" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteDiagnosis">
												<s:param name="diagnosisID" value="%{diagnosisID}" />
												<s:param name="searchDiagnosis" value="%{searchDiagnosis}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete Diagnosis"
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="ConfigureDiagnoses" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Diagnosis">Diagnosis <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="diagnosis" required="required" placeholder="Diagnosis" class="form-control">
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="ICD10 Code">ICD10 Code
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="diagnosisICD10Code" placeholder="ICD10 Code" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditConfigureDiagnosis" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="diagnosisEditList" var="concessionForm">
						  
						  <input type="hidden" name="diagnosisID" value="<s:property value="diagnosisID" />" >
						  <input type="hidden" name="searchDiagnosis" value="<s:property value="searchDiagnosis" />" >
						  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Diagnosis">Diagnosis <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="diagnosis" required="required" value="<s:property value="diagnosis" />" placeholder="Diagnosis" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="diagnosisICD10Code" value="<s:property value="diagnosisICD10Code" />" placeholder="ICD10 Code" class="form-control">
	                        </div>
	                      </div>
