...
<html lang="en">
  <head>
    ...
    <title>Add Visit Type | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="AddVisitType" method="POST" style="margin-top:20px;" onsubmit="return showLoadingImg();" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-11">
                          <input type="text" name="visitTypeName" required="required" placeholder="Visit Type Name" class="form-control">
                        </div>
                      </div>
                      
                      <div class="item form-group">
		                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Visit Duration">Visit Duration<span class="required">*</span></label>
		                  <div class="col-md-5 col-sm-5 col-xs-8">
		                      <input type="number" name="visitDuration" placeholder="Visit Duration" required="required" class="form-control">
		                  </div>
		              ...
		              <div class="item form-group">
		                  ...
		                  <div class="col-md-5 col-sm-5 col-xs-8">
		                      <input type="number" name="nextVisitDays" placeholder="Next Visit Days" required="required" class="form-control">
		                  </div>
		             </div>
		              
					<div class="item form-group">
		                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Billing Type">Billing Type</label>
		            ...
		            <div class="item form-group">
		                 ...
		                 <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                    <s:radio list="#{'IPD':'IPD','OPD':'OPD','XRay':'XRay','USG':'USG','CTScan':'CTScan','PathologyLab':'Pathology Lab','Diagnostic':'Diagnostic'}" name="careType" ></s:radio>
		                 </div>
		            </div> 
		            ...
		            <div class="item form-group" id="isDiscgargeDivID" style="display: none;">
		                 ...
		                 <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                    <s:radio list="#{'1':'Yes','0':'No'}" name="isDischarge" value="0"></s:radio>
		                 </div>
		            </div> 
		            ...
		            <div class="item form-group">
		                 ...
		                 <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                    <s:radio list="#{'1':'Yes','0':'No'}" name="hasConsent" value="0" onclick="displayConentDocDiv(this.value);"></s:radio>
		                 </div>
		            </div> 
		            ...
		            <div class="item form-group" id="consentDocumentDivID" style="display: none;">
		                 ...
		                 <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                  <s:file name="consentDoc" class="form-control"></s:file>
		                  </div>
		            </div> 
		            
		            <div class="item form-group">
		                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Consultation Charges">Consultation Charges</label>
		                 <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                    <input type="number" class="form-control" name="consultationCharge" placeholder="Consultation Charges">
		                 </div>
		            </div>
		               
					<div class="item form-group">
		               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Care Type">New Visit?</label>
		                  <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
		                     <s:radio list="#{'1':'Yes','0':'No'}" name="newVisitFlag" value="0"></s:radio>
		                  </div>
		            </div>
		                    
		              <div class="item form-group">
		                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Practice">Clinic<span class="required">*</span></label>
		                 <div class="col-md-6 col-sm-6 col-xs-12">
		                           <s:select list="practiceMap" name="clinicID" class="form-control" required="reqiured"></s:select>
		                  </div>
		              </div>

					  <div class="item form-group">
		                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Practice">Form Name<span class="required">*</span></label>
		                 <div class="col-md-6 col-sm-6 col-xs-12">
		                      <select id="opdFormID" name="workflowOPDForm" class="form-control" required="required" onchange="retrieveTabName(opdFormID.value);">
		              ...
		              <div class="item form-group">
		                  ...
		                  <div class="col-md-6 col-sm-6 col-xs-12">
		                      <s:select list="#{'INR':'INR','USD':'USD'}" name="currency" class="form-control" value="INR"></s:select>
		                  </div>
		              </div> 
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-xs-12" align="center">
                          ...
                          <button id="practiceSubmitID" type="submit"  class="btn btn-success " >Add Visit Type</button>
                        </div>
                      </div>
