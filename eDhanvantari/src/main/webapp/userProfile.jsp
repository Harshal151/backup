...
<html lang="en">
  <head>
    ...
    <title>User Profile | E-Dhanvantari</title>
    ...
    <script type="text/javascript">
		function abc(userType){
			...
			if(document.getElementById("userTypeID").value == -1){
				...
				if(userType == "clinician"){
					...
					document.getElementById("pageNameID").style.display = "block";
					document.getElementById("pageNameID1").style.display = "block";
					
				}else if(userType == "staff"){
					
					document.getElementById("pageNameID").style.display = "block";
					document.getElementById("pageNameID1").style.display = "none";
					
				}else{
					
					document.getElementById("pageNameID").style.display = "none";
					document.getElementById("pageNameID1").style.display = "none";
		...
		function displayOPDIPDDiv(){

			userType = document.getElementById("userTypeID").value;
    ...
    <%
    	String employeeCheck = (String) request.getAttribute("employeeCheck");
    
    	if(employeeCheck == null || employeeCheck == ""){
    		employeeCheck = "dummy";
    	}
    %>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="EditUserProfile" method="POST" onsubmit="return showLoadingImg();"  style="margin-top:20px;" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="username" required="required" readonly="readonly" value="<s:property value="username"/>" placeholder="Username" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="password" name="password" placeholder="Password" value="<s:property value="password"/>" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="PIN" placeholder="PIN" value="<s:property value="PIN"/>" class="form-control">
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label for="User Type" class="control-label col-md-3">User Type<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" readonly="readonly" class="form-control" name="userType" value="<s:property value="userType"/>"> 
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label for="Clinic" class="control-label col-md-3">Practice<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" readonly="readonly" required="required" name="practiceName" value="<s:property value="practiceName"/>" class="form-control">
                          <input type="hidden" value="<s:property value="practiceID"/>" name="practiceID">
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label for="Clinic" class="control-label col-md-3">Default Clinic<span class="required">*</span></label>
					...
					<div class="col-md-6 col-sm-6 col-xs-12" >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" readonly="readonly" class="form-control" name="activityStatus" value="<s:property value='activityStatus'/>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-12" align="center">
                          ...
                          <button id="send" type="submit" class="btn btn-success " >Update Profile</button>
                        </div>
                      </div>
                    </form>
