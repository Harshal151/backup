...
<html lang="en">
  <head>
    ...
    <title>Edit Stock List | E-Dhanvantari</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                    ...
                    <div class="row">
                     <form action="SearchStock" method="POST" onsubmit="return showLoadingImg();">
                       <div class="col-md-4 col-sm-4 col-xs-6">
                         <input type="text" name="searchStock" class="form-control" placeholder="Search on receiptNo or supplier" required="required">
                       </div>
                       <div class="col-md-4 col-sm-4 col-xs-6">
                          <s:select list="#{'StockRecptNo':'Stock Receipt No/Supplier Name','ProductName':'Product Name'}" name="searchCategory" class="form-control" id=""></s:select>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-6">
                          <button type="submit" class="btn btn-success active"  style="width:100%;" >Search Stock</button>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-6">
                          <a href="EditStockList"> <button type="button" class="btn btn-primary"  onclick="showLoadingImg();">View All Stock</button></a>
                        </div>
                      </form>
                     </div>
                      ...
                      <tbody>
                        <s:iterator value="stockList" var="UserForm">
                        	<tr>
									...
									<td><s:property value="productTotalAmount" /></td>
									
									<td><s:property value="clinicName" /></td>
										 
									<td align="center"><s:url id="approveURL"
										action="RenderEditStock">
										<s:param name="stockReceiptID" value="%{stockReceiptID}" />
									</s:url> <s:a href="%{approveURL}">
										<img src="images/editBill.png" style="height:24px;" onmouseover="this.src='images/editBill1.png'"
											onmouseout="this.src='images/editBill.png'" alt="Edit Stock"
											title="Edit Stock" />
									</s:a>
									</td>
                        	</tr>
