...
<html lang="en">
  <head>
    ...
    <title>Manage Room Charges | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchRoomCharges" method="POST" onsubmit="return showLoadingImg();">
				              	...
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllRoomCharges"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Charges</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="roomChargesList" var="UserForm">
		                        	<tr>
											...
											<td align="center"><s:url id="approveURL"
												action="RenderEditRoomCharges">
												<s:param name="roomChargesID" value="%{roomChargesID}" />
												...
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Room Charges"
													title="Edit IPD Consultant Charges" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteRoomCharges">
												<s:param name="roomChargesID" value="%{roomChargesID}" />
												<s:param name="searchCharges" value="%{searchCharges}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete Room Charges"
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="AddRoomCharges" onsubmit="return disableButton('send');" method="POST" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="ChargeType">Room Name <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="name" required="required" placeholder="Room Name" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditRoomCharges" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="editRoomChargesList" var="OPDChargesForm">
						  
						  <input type="hidden" name="roomChargesID" value="<s:property value="roomChargesID" />" >
						  ...
						  <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="name" required="required" value="<s:property value="name" />" placeholder="Doctor Name" class="form-control">
	                        </div>
	                      </div>
