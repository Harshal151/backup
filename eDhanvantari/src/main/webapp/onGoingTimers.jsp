...
<title>On-going Timers | E-Dhanvantari</title>
    ...
    function populateTableFromLocalStorage() {
        ...
        for (var i = 0; i < localStorage.length; i++) {
            ...
            if (key.startsWith("timer")) {
                // Get the data associated with the key (assuming it's stored in JSON format)
                var data = JSON.parse(localStorage.getItem(key));
                
                // Extract visit ID and visit Date from the key
                var [visitId, visitDateTime] = key.split('_').slice(1);
                ...
                visitIdCell.textContent = visitId;
                ...
                stopButton.id = `stopButton_${visitId}`;
                stopButton.textContent = "Stop";
                stopButton.disabled = !data.isRunning;
                var restartButton = document.createElement("button");
                restartButton.id = `restartButton_${visitId}`;
                restartButton.textContent = "Restart";
                restartButton.style.display = data.isRunning ? "none" : "inline-block";
                var endButton = document.createElement("button");
                endButton.id = `endButton_${visitId}`;
                endButton.textContent = "End";
                endButton.style.display = data.isRunning ? "none" : "inline-block";
                ...
                // Re-initialize timer instances
                addTimer(visitId, data.fullName);
            }
        }
    }
...
<body class="nav-md">
	...
	<div id="onSearchSelectID" class="modal fade" tabindex="-1"
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<center>
						<h4 style="color: black;">Please select criteria.</h4>
					</center>
 ...
 %> <span class=" fa fa-angle-down"></span>
			...
			<!-- page content -->
			<div class="right_col" role="main"> <!-- New added -->

				<div class="page-title">
					<div class="title_left">
						<h3>Ongoing Timers</h3>
					</div>
				</div>

				<div class="row"
					style="background: white; margin-left: 0px; margin-right: 0px; margin-bottom: 20px; margin-top: 40px; padding: 20px;">
					<div class="col-xs-12">
						<table
							id="timersTable"
				...
				<!-- <button id="chTH" onclick="changeColor()">Get all ongoing timers</button> -->
