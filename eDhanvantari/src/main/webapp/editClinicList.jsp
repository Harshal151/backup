...
<html lang="en">
  <head>
    ...
    <title>Edit Clinic List | E-Dhanvantari</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                    ...
                    <div class="row">
                     <form action="SearchClinic" method="POST" onsubmit="return showLoadingImg();">
                       <div class="col-md-4 col-sm-4 col-xs-6">
                         <input type="text" name="searchClinic" class="form-control" placeholder="Search Clinic" required="required">
                       </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <button type="submit" class="btn btn-success active"  style="width:100%;" >Search Clinic</button>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <a href="ViewAllClinicList"> <button type="button" class="btn btn-primary"  style="width:100%;" onclick="showLoadingImg();">View All Clinics</button></a>
                        </div>
                      </form>
                     </div>
                  ...
                  %>
		            ...
		            %> 
                      ...
                      <tbody>
                        <s:iterator value="searchClinicList" var="UserForm">
                        	<tr>
									...
									<td><s:property value="clinicType" /></td>
										 
									<td align="center"><s:url id="approveURL"
										action="RenderEditClinic">
										<s:param name="clinicID" value="%{clinicID}" />
									</s:url> <s:a href="%{approveURL}">
										<img src="images/clinic_1.png" style="height:24px;" onmouseover="this.src='images/clinic_2.png'"
											onmouseout="this.src='images/clinic_1.png'" alt="Edit Clinic"
											title="Edit Clinic" />
									</s:a></td>
                        	</tr>
                        </s:iterator>
                   ...
                   <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <s:iterator value="clinicList" var="UserForm">
                        	<tr>
                        			<td><s:property value="clinicID" /></td>
