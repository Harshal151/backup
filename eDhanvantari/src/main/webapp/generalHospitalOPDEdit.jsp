  ...
  <head>
	...
	<script type="text/javascript">
		function printVisit(){
			...
			document.forms["visitrForm"].action = "PrintEditGeneralHospitalVisit";
		...
		function updatePrescription(){
			...
			document.forms["genPhyPrescID"].action = "UpdateGeneralHospitalPrescription";
...
function monthCheck(dateVal, monthVal, yearVal, monthFontID, nextFocusID, finalDateStoreID){
	...
	<%
		...
		List<PrescriptionManagementForm> LabTestList = (List<PrescriptionManagementForm>) request.getAttribute("LabTestList");
		...
		List<PrescriptionManagementForm> OPDChargesList = (List<PrescriptionManagementForm>) request.getAttribute("OPDChargesList");
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		if($("#GovernmentID").is(":checked")){
		
			 $("#govtTypeID").val("<%=categoryVal1%>"); 
			 
			 $("#govtTypeID").show();
			 $("#payeeNameID").hide();
			 $("#otherTypeID").hide();
			 
		}else if($("#PayeeID").is(":checked")){
			
			 $("#payeeNameID").val("<%=categoryVal1%>"); 
			...
			<%-- console.log("otherTypeID : "+$("#otherTypeID").val("<%=categoryVal[1]%>")); --%>
			$("#otherTypeID").val("<%=categoryVal1%>"); 
...
<script type="text/javascript">
		...
		function changeTotalAmtByQuantyRate(checkBoxID, quantity, rate, amount, totalAmt, chargeID, chargeType){
			...
			console.log("changeTAmt: "+changeAmt);
			...
			if($("#"+checkBoxID).is(":checked")){
				...
				console.log("amount: "+changeTAmt+"--"+finalAmount);
				...
				console.log("totalamt if: "+finaltotalAmt);
				...
				$("#"+totalAmt).val(finaltotalAmt);
				$("#netAmountID").val(finaltotalAmt);
				console.log("totalamt else: "+finaltotalAmt);
...
function displayChequeDetailsDiv(input){
    	...
    	function checkCheckbox() {
    		...
    		if(checkboxLength>0){
    			...
    			document.forms["genPhyBillID"].action = "EditNewBill";
    ...
    <script type="text/javascript">
		function checkDiagnosis(){
			...
			if(tradeName == ""){
    			...
    			$('a#repID6').remove();	$('a#repID7').remove();	$('a#repID8').remove();	$('a#repID9').remove();	$('a#repID10').remove();  $('a#repID11').remove();	//To disable leftmenu options Reports
    			$('a#prID').remove();	$('a#prID1').remove();	$('a#prID2').remove();	//To disable leftmenu options Participant mng
				$("#visitrForm").attr("action","UpdateGeneralHospitalVisit");
			  	  $("#visitrForm").submit(); 
  ...
  <!-- Ends -->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content span_11">
		              ...
		              <% System.out.println("Hello patientList 1111......"); %> 
			         ...
			         <h4 style=""><b>Visit For <s:property value="firstName"/>&nbsp;<s:property value="lastName"/>&nbsp;(<s:property value="registrationNo"/>)</b></h4>
					  ...
					  <ul id="myTab1" class="nav nav-tabs">
						...
						<%		              					
		              		...
		              		System.out.println("Hello tab else");
		              	%>
			    ...
			    <div class="tab-pane fade in active" id="visit">
				    <form class="form-horizontal form-label-left" action="UpdateGeneralHospitalVisit" name="visitrForm" id="visitrForm" method="POST" style="margin-top:20px;">
			         ...
			         <input type="hidden"  name="firstName" id="firstName" value="<s:property value="firstName"/>">
			          ...
			          <input type="hidden" name="startDate" value="<%=systemStartDate%>">
	                      ...
	                      <div class="row" style="margin-top:15px;">
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-3 col-sm-3 col-xs-12">
						    		<font style="font-size: 14px;font-weight: bold;">Category </font>
						    	</div>
						    	<%
								  if(categoryList1.contains("Government")){
									  System.out.println("inside govt");
								  %>
									  
									  <div class="col-md-3 col-sm-3 col-xs-12">
							    		<label><input type="radio" name="category" checked="checked" value="Government" id="GovernmentID" onclick="displayCategoryTypeDiv('Govt');">&nbsp;Government</label>
							    		<s:select list="#{'ESIS':'ESIS','RGJY':'RGJY','PMC':'PMC','CGHS':'CGHS','CSMA':'CSMA'}" headerKey="" headerValue="Select Govt." class="form-control" name="categoryType" id="govtTypeID" style="margin-top: 15px;display: none;"></s:select>
							    	</div>
							    	<div class="col-md-3 col-sm-3 col-xs-12">
							    		<label><input type="radio" name="category" value="Payee" id="PayeeID" onclick="displayCategoryTypeDiv('Payee');">&nbsp;Payee</label>
							    		<input type="text" class="form-control" name="" id="payeeNameID" value="<s:property value="categoryType"/>" style="margin-top:15px; display: none;" placeholder="Payee Name">
							    	</div>
							    	 <div class="col-md-3 col-sm-3 col-xs-12">
							    		<label><input type="radio" name="category" value="Other" id="OtherID" onclick="displayCategoryTypeDiv('Other');">&nbsp;Other</label>
							    		<div class="row" id="otherDivID" style="margin-top: 15px;display: none;">
							    			<label><input type="radio" name="category1" value="" onclick="displayOtherTypeDiv('Insurance');">&nbsp;Insurance</label>
							    			<label><input type="radio" name="category1" value="" onclick="displayOtherTypeDiv('Company');">&nbsp;Company</label>
							    		</div>
										<s:select list="#{}" headerKey="" headerValue="Select" class="form-control" name="" id="otherTypeID" style="margin-top: 15px;display: none;"></s:select>						    		
							    	</div>
							    <% }else if(categoryList1.contains("Payee")){ System.out.println("categoryList1:"+categoryList1);%>
							    
							    	<div class="col-md-3 col-sm-3 col-xs-12">
							    		<label><input type="radio" name="category" value="Government" id="GovernmentID" onclick="displayCategoryTypeDiv('Govt');">&nbsp;Government</label>
							    		<s:select list="#{'ESIS':'ESIS','RGJY':'RGJY','PMC':'PMC','CGHS':'CGHS','CSMA':'CSMA'}" headerKey="" headerValue="Select Govt." class="form-control" name="" id="govtTypeID" style="margin-top: 15px;display: none;"></s:select>
							    	</div>
									 <div class="col-md-3 col-sm-3 col-xs-12">
							    		<label><input type="radio" name="category" checked="checked" id="PayeeID" value="Payee" onclick="displayCategoryTypeDiv('Payee');">&nbsp;Payee</label>
							    		<input type="text" class="form-control" name="categoryType" id="payeeNameID" style="margin-top:15px;display: none; " placeholder="Payee Name">
							    	</div>  
							    	 <div class="col-md-3 col-sm-3 col-xs-12">
							    		<label><input type="radio" name="category" value="Other" id="OtherID" onclick="displayCategoryTypeDiv('Other');">&nbsp;Other</label>
							    		<div class="row" id="otherDivID" style="margin-top: 15px;display: none;">
								...
								<% }else if(categoryList1.contains("Other")){ %>
									...
									<div class="col-md-3 col-sm-3 col-xs-12">
									 ...
									 <div class="col-md-3 col-sm-3 col-xs-12">
									  ...
									  <div class="col-md-3 col-sm-3 col-xs-12">
							    		<label><input type="radio" name="category" checked="checked" id="OtherID" value="Other" onclick="displayCategoryTypeDiv('Other');">&nbsp;Other</label>
							    		 
							    	<%
							    	
							    	if(categoryVal.length == 1 ){ %>
						    		
							    		<div class="row" id="otherDivID" style="margin-top: 15px;">
									    	<label><input type="radio" name="category1" value="" onclick="displayOtherTypeDiv('Insurance');">&nbsp;Insurance</label>
									    	<label><input type="radio" name="category1" value="" onclick="displayOtherTypeDiv('Company');">&nbsp;Company</label>
									    </div>
									    
									    <s:select list="#{}" headerKey="" headerValue="Select" class="form-control" name='categoryType' id="otherTypeID" style="margin-top: 15px; display:none;"></s:select>
							    		
						    	 	<% }else{
							    		/* String[] categoryType = categoryList1.split(",") */
							    	
                        				if(otherInsuranceList.contains(categoryVal1)){ %>
									    	<div class="row" id="otherDivID" style="margin-top: 15px;">
									    		<label><input type="radio" name="category1" value="" checked="checked" onclick="displayOtherTypeDiv('Insurance');">&nbsp;Insurance</label>
									    		<label><input type="radio" name="category1" value="" onclick="displayOtherTypeDiv('Company');">&nbsp;Company</label>
									    	</div>
									    	
									    	<s:select list="#{'Medi Assist':'Medi Assist','DHS':'DHS','Start Health':'Start Health','MD India':'MD India','Religare':'Religare','Universal Sampo':'Universal Sampo','TIK - Sigma':'TIK - Sigma'}" headerKey="" headerValue="Select" class="form-control" name="" id="otherTypeID" style="margin-top: 15px;"></s:select>
							    	  	<% }else if(otherCompanyList.contains(categoryVal1)){ %>
									    <div class="row" id="otherDivID" style="margin-top: 15px;">
									    	<label><input type="radio" name="category1" value="" onclick="displayOtherTypeDiv('Insurance');">&nbsp;Insurance</label>
									    	<label><input type="radio" name="category1" value="" checked="checked" onclick="displayOtherTypeDiv('Company');">&nbsp;Company</label>
									    </div>
									  
									    <s:select list="#{'JSW':'JSW','Jhonson':'Jhonson'}" headerKey="" headerValue="Select" class="form-control" name='categoryType' id="otherTypeID" style="margin-top: 15px;"></s:select>
							    	  <% }else{  %>
	                      ...
	                      <div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-3">
						    		<font style="font-size: 14px;font-weight: bold;">Past History</font>
						    	</div>
						    	
							</div>
							
						<% 
						for(PatientForm form1 : MedicalHistory){ System.out.println("inside med history");%>	  
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	if(form1.getDiabetesMellitus() == null){ %>
						    		<div class="col-md-1">
						    			<input type="checkbox" name="diabetesMellitus" id="diabetesMellitusID" style="zoom: 1.5;" onclick="enableFields('diabetesMellitusDurationID','diabetesMellitusDescID', this.id);" value="Yes" >
						    		</div>
						    		 <div class="col-md-2 col-xs-3">
						    		<input type="number" name="diabetesMellitusDuration" step="0.01" readonly="readonly" id="diabetesMellitusDurationID" value="<s:property value="diabetesMellitusDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-6 col-xs-3">
						    		<s:textarea name="diabetesMellitusDesc" readonly="readonly" id="diabetesMellitusDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    	<%}else{
							    	...
							    	<div class="col-md-1">
							    		<input type="checkbox" name="diabetesMellitus" checked="checked" id="diabetesMellitusID" style="zoom: 1.5;" onclick="enableFields('diabetesMellitusDurationID','diabetesMellitusDescID', this.id);" value="Yes" >
							    	</div>
							    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="diabetesMellitusDuration" step="0.01"  id="diabetesMellitusDurationID" value="<s:property value="diabetesMellitusDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-6 col-xs-3">
						    		<s:textarea name="diabetesMellitusDesc"  id="diabetesMellitusDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
							    	<%}else{ %>	 
						    ...
						    <%	if(form1.getHypertension()==null){ %>
							    	<div class="col-md-1">
							    		<input type="checkbox" name="hypertension" id="hypertensionID" style="zoom: 1.5;" onclick="enableFields('hypertensionDurationID','hypertensionDescID', this.id);" value="Yes" >
							    	</div>	
							    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="hypertensionDuration" step="0.01" readonly="readonly" id="hypertensionDurationID" value="<s:property value="hypertensionDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="hypertensionDesc" readonly="readonly" id="hypertensionDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    	<% }else{
						    		
						    		if(form1.getHypertension().equals("Yes")){ %>
							   		<div class="col-md-1">
							    		<input type="checkbox" name="hypertension" checked="checked" id="hypertensionID" style="zoom: 1.5;" onclick="enableFields('hypertensionDurationID','hypertensionDescID', this.id);" value="Yes" >
							    	</div>	
							    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="hypertensionDuration" step="0.01"  id="hypertensionDurationID" value="<s:property value="hypertensionDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="hypertensionDesc"  id="hypertensionDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
								   <% }else{ %> 	
								   		<div class="col-md-1">
								    		<input type="checkbox" name="hypertension" id="hypertensionID" style="zoom: 1.5;" onclick="enableFields('hypertensionDurationID','hypertensionDescID', this.id);" value="Yes" >
						   ...
						   <% if(form1.getAsthema() == null){ %>
							   <div class="col-md-1">
					    			<input type="checkbox" name="asthema" id="asthemaID" style="zoom: 1.5;" onclick="enableFields('asthemaDurationID','asthemaDescID', this.id);" value="Yes" >
					    	   </div>	
					    	   <div class="col-md-2 col-xs-3">
						    		<input type="number" name="asthemaDuration" step="0.01" readonly="readonly" id="asthemaDurationID" value="<s:property value="asthemaDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="asthemaDesc" readonly="readonly" id="asthemaDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						   <% }else{
						    	
						    	if(form1.getAsthema().equals("Yes")){ %>
							    	<div class="col-md-1">
							    		<input type="checkbox" name="asthema" id="asthemaID" checked="checked" style="zoom: 1.5;" onclick="enableFields('asthemaDurationID','asthemaDescID', this.id);" value="Yes" >
							    	</div>
							    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="asthemaDuration" step="0.01"  id="asthemaDurationID" value="<s:property value="asthemaDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="asthemaDesc"  id="asthemaDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
							   <%}else{ %>
							   		<div class="col-md-1">
							    		<input type="checkbox" name="asthema" id="asthemaID" style="zoom: 1.5;" onclick="enableFields('asthemaDurationID','asthemaDescID', this.id);" value="Yes" >
						  ...
						  <% if(form1.getIschemicHeartDisease()==null){%>
							   	<div class="col-md-1">
						    		<input type="checkbox" name="ischemicHeartDisease" id="ischemicHeartDiseaseID" style="zoom: 1.5;" onclick="enableFields('ischemicHeartDiseaseDurationID','ischemicHeartDiseaseDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="ischemicHeartDiseaseDuration" step="0.01" readonly="readonly" id="ischemicHeartDiseaseDurationID" value="<s:property value="ischemicHeartDiseaseDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="ischemicHeartDiseaseDesc" readonly="readonly" id="ischemicHeartDiseaseDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						  <% }else{
							  if(form1.getIschemicHeartDisease().equals("Yes")){ %>
						    	<div class="col-md-1">
						    		<input type="checkbox" name="ischemicHeartDisease" checked="checked" id="ischemicHeartDiseaseID" style="zoom: 1.5;" onclick="enableFields('ischemicHeartDiseaseDurationID','ischemicHeartDiseaseDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="ischemicHeartDiseaseDuration" step="0.01"  id="ischemicHeartDiseaseDurationID" value="<s:property value="ischemicHeartDiseaseDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="ischemicHeartDiseaseDesc"  id="ischemicHeartDiseaseDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
							  <%}else{ %> 	 
							    <div class="col-md-1">
							    	<input type="checkbox" name="ischemicHeartDisease" id="ischemicHeartDiseaseID" style="zoom: 1.5;" onclick="enableFields('ischemicHeartDiseaseDurationID','ischemicHeartDiseaseDescID', this.id);" value="Yes" >
						...
						<%if(form1.getAllergies()==null){ %>  
							<div class="col-md-1">
						    	<input type="checkbox" name="allergies" id="allergiesID" style="zoom: 1.5;" onclick="enableFields('allergiesDurationID','allergiesDescID', this.id);" value="Yes" >
						    </div>
						    <div class="col-md-2 col-xs-3">
						    		<input type="number" name="allergiesDuration" step="0.01" readonly="readonly" id="allergiesDurationID" value="<s:property value="allergiesDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="allergiesDesc" readonly="readonly" id="allergiesDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						<%}else{ 
							if(form1.getAllergies().equals("Yes")){ %>
						
						    	<div class="col-md-1">
						    		<input type="checkbox" name="allergies" id="allergiesID" checked="checked" style="zoom: 1.5;" onclick="enableFields('allergiesDurationID','allergiesDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="allergiesDuration" step="0.01"  id="allergiesDurationID" value="<s:property value="allergiesDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="allergiesDesc"  id="allergiesDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						   <%}else{ %> 
						   		<div class="col-md-1">
						    		<input type="checkbox" name="allergies" id="allergiesID" style="zoom: 1.5;" onclick="enableFields('allergiesDurationID','allergiesDescID', this.id);" value="Yes" >
						   ...
						   <% if(form1.getSurgicalHistory()==null){ %> 	
						   		<div class="col-md-1">
						    		<input type="checkbox" name="surgicalHistory" id="surgicalHistoryID" style="zoom: 1.5;" onclick="enableFields('surgicalHistoryDurationID','surgicalHistoryDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="surgicalHistoryDuration" step="0.01" readonly="readonly" id="surgicalHistoryDurationID" value="<s:property value="surgicalHistoryDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="surgicalHistoryDesc" readonly="readonly" id="surgicalHistoryDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						   <% }else{ 
						   	 if(form1.getSurgicalHistory().equals("Yes")){ %>
						    	<div class="col-md-1">
						    		<input type="checkbox" name="surgicalHistory" checked="checked" id="surgicalHistoryID" style="zoom: 1.5;" onclick="enableFields('surgicalHistoryDurationID','surgicalHistoryDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="surgicalHistoryDuration" step="0.01" id="surgicalHistoryDurationID" value="<s:property value="surgicalHistoryDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="surgicalHistoryDesc" id="surgicalHistoryDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    <% }else{ %>
						  		<div class="col-md-1">
						    		<input type="checkbox" name="surgicalHistory" id="surgicalHistoryID" style="zoom: 1.5;" onclick="enableFields('surgicalHistoryDurationID','surgicalHistoryDescID', this.id);" value="Yes" >
						   ...
						   <% } 
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-2 col-xs-3">
						    		<font style="font-size: 14px;">Gynecology History: </font>
						    	</div>
						  
						  <% if(form1.getGynecologyHistory()==null){ %>
						  		<div class="col-md-1">
						    		<input type="checkbox" name="gynecologyHistory" id="gynecologyHistoryID" style="zoom: 1.5;" onclick="enableFields('gynecologyHistoryDurationID','gynecologyHistoryDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="gynecologyHistoryDuration" step="0.01" readonly="readonly" id="gynecologyHistoryDurationID" value="<s:property value="gynecologyHistoryDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="gynecologyHistoryDesc" readonly="readonly" id="gynecologyHistoryDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						   <% }else{
						  	if(form1.getGynecologyHistory().equals("Yes")){ %> 	
						    	<div class="col-md-1">
						    		<input type="checkbox" name="gynecologyHistory" checked="checked" id="gynecologyHistoryID" style="zoom: 1.5;" onclick="enableFields('gynecologyHistoryDurationID','gynecologyHistoryDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="gynecologyHistoryDuration" step="0.01"  id="gynecologyHistoryDurationID" value="<s:property value="gynecologyHistoryDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="gynecologyHistoryDesc"  id="gynecologyHistoryDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						   <% }else{ %> 	
						   		<div class="col-md-1">
						    		<input type="checkbox" name="gynecologyHistory" id="gynecologyHistoryID" style="zoom: 1.5;" onclick="enableFields('gynecologyHistoryDurationID','gynecologyHistoryDescID', this.id);" value="Yes" >
						...
						<%} %> 
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-3">
						    		<font style="font-size: 14px;font-weight: bold;">Family History</font>
						    	</div>
						...
						<% for(PatientForm form2 : FamilyHistory){ %>	
						    ...
						    <% if(form2.getFamHistDiabetesMellitus() == null){ %>	
						    	<div class="col-md-1">
						    		<input type="checkbox" name="famHistDiabetesMellitus" id="famHistDiabetesMellitusID" style="zoom: 1.5;" onclick="enableFields('famHistDiabetesMellitusDurationID','famHistDiabetesMellitusDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="famHistDiabetesMellitusDuration" step="0.01" readonly="readonly" id="famHistDiabetesMellitusDurationID" value="<s:property value="famHistDiabetesMellitusDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="famHistDiabetesMellitusDesc" readonly="readonly" id="famHistDiabetesMellitusDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    <% }else{ 
						    	if(form2.getFamHistDiabetesMellitus().equals("Yes")){%>
						    		<div class="col-md-1">
					    				<input type="checkbox" name="famHistDiabetesMellitus" checked="checked" id="famHistDiabetesMellitusID" style="zoom: 1.5;" onclick="enableFields('famHistDiabetesMellitusDurationID','famHistDiabetesMellitusDescID', this.id);" value="Yes" >
					    			</div>
					    			<div class="col-md-2 col-xs-3">
						    		<input type="number" name="famHistDiabetesMellitusDuration" step="0.01"  id="famHistDiabetesMellitusDurationID" value="<s:property value="famHistDiabetesMellitusDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="famHistDiabetesMellitusDesc"  id="famHistDiabetesMellitusDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    	<% }else{%>
						    		<div class="col-md-1">
						    			<input type="checkbox" name="famHistDiabetesMellitus" id="famHistDiabetesMellitusID" style="zoom: 1.5;" onclick="enableFields('famHistDiabetesMellitusDurationID','famHistDiabetesMellitusDescID', this.id);" value="Yes" >
						    ...
						    <%if(form2.getFamHistHypertension() == null){ %>	
						    	<div class="col-md-1">
						    		<input type="checkbox" name="famHistHypertension" id="famHistHypertensionID" style="zoom: 1.5;" onclick="enableFields('famHistHypertensionDurationID','famHistHypertensionDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="famHistHypertensionDuration" step="0.01" readonly="readonly" id="famHistHypertensionDurationID" value="<s:property value="famHistHypertensionDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="famHistHypertensionDesc" readonly="readonly" id="famHistHypertensionDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    <%}else{ 
						    	if(form2.getFamHistHypertension().equals("Yes")){ %>
						    		<div class="col-md-1">
							    		<input type="checkbox" name="famHistHypertension" checked="checked" id="famHistHypertensionID" style="zoom: 1.5;" onclick="enableFields('famHistHypertensionDurationID','famHistHypertensionDescID', this.id);" value="Yes" >
							    	</div>
							    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="famHistHypertensionDuration" step="0.01"  id="famHistHypertensionDurationID" value="<s:property value="famHistHypertensionDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="famHistHypertensionDesc"  id="famHistHypertensionDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    	<% }else{ %>
						    		<div class="col-md-1">
							    		<input type="checkbox" name="famHistHypertension" id="famHistHypertensionID" style="zoom: 1.5;" onclick="enableFields('famHistHypertensionDurationID','famHistHypertensionDescID', this.id);" value="Yes" >
						    ...
						    <% if(form2.getFamHistAsthema() == null){ %>
						    	<div class="col-md-1">
						    		<input type="checkbox" name="famHistAsthema" id="famHistAsthemaID" style="zoom: 1.5;" onclick="enableFields('famHistAsthemaDurationID','famHistAsthemaDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="famHistAsthemaDuration" step="0.01" readonly="readonly" id="famHistAsthemaDurationID" value="<s:property value="famHistAsthemaDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="famHistAsthemaDesc" readonly="readonly" id="famHistAsthemaDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    <% }else{
						    	if(form2.getFamHistAsthema().equals("Yes")){ %>
						    		<div class="col-md-1">
							    		<input type="checkbox" name="famHistAsthema" checked="checked" id="famHistAsthemaID" style="zoom: 1.5;" onclick="enableFields('famHistAsthemaDurationID','famHistAsthemaDescID', this.id);" value="Yes" >
							    	</div>
							    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="famHistAsthemaDuration" step="0.01"  id="famHistAsthemaDurationID" value="<s:property value="famHistAsthemaDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="famHistAsthemaDesc"  id="famHistAsthemaDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    	<% }else{ %>
						    		<div class="col-md-1">
							    		<input type="checkbox" name="famHistAsthema" id="famHistAsthemaID" style="zoom: 1.5;" onclick="enableFields('famHistAsthemaDurationID','famHistAsthemaDescID', this.id);" value="Yes" >
						    ...
						    <% if(form2.getFamHistAllergies() == null){ %>
						    	<div class="col-md-1">
						    		<input type="checkbox" name="famHistAllergies" id="famHistAllergiesID" style="zoom: 1.5;" onclick="enableFields('famHistAllergiesDurationID','famHistAllergiesDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						   		<input type="number" name="famHistAllergiesDuration" step="0.01" readonly="readonly" id="famHistAllergiesDurationID" value="<s:property value="famHistAllergiesDuration"/>" class="form-control" placeholder="Duration">
						   	</div>
						    	
						   	<div class="col-md-2 col-xs-3">
						   		<s:textarea name="famHistAllergiesDesc" readonly="readonly" id="famHistAllergiesDescID" class="form-control" placeholder="Details"></s:textarea>
						   	</div>
						    <% }else{
						    	if(form2.getFamHistAllergies().equals("Yes")){ %>
						    		<div class="col-md-1">
							    		<input type="checkbox" name="famHistAllergies" checked="checked" id="famHistAllergiesID" style="zoom: 1.5;" onclick="enableFields('famHistAllergiesDurationID','famHistAllergiesDescID', this.id);" value="Yes" >
							    	</div>
							    	<div class="col-md-2 col-xs-3">
						   		<input type="number" name="famHistAllergiesDuration" step="0.01"  id="famHistAllergiesDurationID" value="<s:property value="famHistAllergiesDuration"/>" class="form-control" placeholder="Duration">
						   	</div>
						    	
						   	<div class="col-md-2 col-xs-3">
						   		<s:textarea name="famHistAllergiesDesc"  id="famHistAllergiesDescID" class="form-control" placeholder="Details"></s:textarea>
						   	</div>
						    	<% }else{ %>
						    		<div class="col-md-1">
							    		<input type="checkbox" name="famHistAllergies" id="famHistAllergiesID" style="zoom: 1.5;" onclick="enableFields('famHistAllergiesDurationID','famHistAllergiesDescID', this.id);" value="Yes" >
						...
						<% for(PatientForm form3 : PersonalHistory){ %>	
						   ...
						   <% if(form3.getPersonalHistorySmoking() == null){ %> 	
						    	<div class="col-md-1">
						    		<input type="checkbox" name="personalHistorySmoking" id="smokingID" " style="zoom: 1.5;" onclick="enableFields('smokingDurationID','smokingDetailsID', this.id);" value="Yes" >
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="smokingDuration" step="0.01" readonly="readonly" id="smokingDurationID" value="<s:property value="smokingDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="personalHistorySmokingDetails" readonly="readonly" id="smokingDetailsID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    <% }else{ 
						    	if(form3.getPersonalHistorySmoking().equals("Yes")){ %>
							    	<div class="col-md-1">
							    		<input type="checkbox" name="personalHistorySmoking" id="smokingID" checked="checked" style="zoom: 1.5;" onclick="enableFields('smokingDurationID','smokingDetailsID', this.id);" value="Yes" >
							    	</div>
							    	
							    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="smokingDuration" step="0.01"  id="smokingDurationID" value="<s:property value="smokingDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="personalHistorySmokingDetails" id="smokingDetailsID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    	<% }else{ %>
							    	<div class="col-md-1">
							    		<input type="checkbox" name="personalHistorySmoking" id="smokingID" style="zoom: 1.5;" onclick="enableFields('smokingDurationID','smokingDetailsID', this.id);" value="Yes" >
						 ...
						 <% if(form3.getAlcohol() == null){ %>   	
						 	<div class="col-md-1">
						    	<input type="checkbox" name="alcohol" id="alcoholID" style="zoom: 1.5;" onclick="enableFields('alcoholDurationID','alcoholDescID', this.id);" value="Yes" >
						    </div>
						    <div class="col-md-2 col-xs-3">
						    	<input type="number" name="alcoholDuration" step="0.01" readonly="readonly" id="alcoholDurationID" value="<s:property value="alcoholDuration"/>" class="form-control" placeholder="Duration">
						    </div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="alcoholDesc" readonly="readonly" id="alcoholDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						 <% }else{ 
						 	if(form3.getAlcohol().equals("Yes")){ %>
								 <div class="col-md-1">
								    <input type="checkbox" name="alcohol" id="alcoholID" checked="checked" style="zoom: 1.5;" onclick="enableFields('alcoholDurationID','alcoholDescID', this.id);" value="Yes" >
								 </div>
								 <div class="col-md-2 col-xs-3">
						    	<input type="number" name="alcoholDuration" step="0.01"  id="alcoholDurationID" value="<s:property value="alcoholDuration"/>" class="form-control" placeholder="Duration">
						    </div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="alcoholDesc"  id="alcoholDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						 	<% }else{ %>
							 	<div class="col-md-1">
							    	<input type="checkbox" name="alcohol" id="alcoholID" style="zoom: 1.5;" onclick="enableFields('alcoholDurationID','alcoholDescID', this.id);" value="Yes" >
						   ...
						   <%if(form3.getMishari() == null){ %> 	
						    	<div class="col-md-1">
						    		<input type="checkbox" name="mishari" id="mishariID" style="zoom: 1.5;" onclick="enableFields('mishariDurationID','mishariDescID', this.id);" value="Yes" >
						    	</div>
						    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="mishariDuration" step="0.01" readonly="readonly" id="mishariDurationID" value="<s:property value="mishariDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="mishariDesc" readonly="readonly" id="mishariDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    <%}else{ 
						    	if(form3.getMishari().equals("Yes")){%>
							    	<div class="col-md-1">
							    		<input type="checkbox" name="mishari" checked="checked" id="mishariID" style="zoom: 1.5;" onclick="enableFields('mishariDurationID','mishariDescID', this.id);" value="Yes" >
							    	</div>
							    	<div class="col-md-2 col-xs-3">
						    		<input type="number" name="mishariDuration" step="0.01"  id="mishariDurationID" value="<s:property value="mishariDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="mishariDesc"  id="mishariDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						    	<%}else{ %>
							    	<div class="col-md-1">
							    		<input type="checkbox" name="mishari" id="mishariID" style="zoom: 1.5;" onclick="enableFields('mishariDurationID','mishariDescID', this.id);" value="Yes" >
						...
						<%if(form3.getTobacco() == null){ %>    	
						    <div class="col-md-1">
						    	<input type="checkbox" name="tobacco" id="tobaccoID" style="zoom: 1.5;" onclick="enableFields('tobaccoDurationID','tobaccoDescID', this.id);" value="Yes" >
						    </div>
						    <div class="col-md-2 col-xs-3">
						    		<input type="number" name="tobaccoDuration" step="0.01" readonly="readonly" id="tobaccoDurationID" value="<s:property value="tobaccoDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="tobaccoDesc" readonly="readonly" id="tobaccoDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						 <% }else{   
						 	if(form3.getTobacco().equals("Yes")){ %>
						 		<div class="col-md-1">
							    	<input type="checkbox" name="tobacco" checked="checked" id="tobaccoID" style="zoom: 1.5;" onclick="enableFields('tobaccoDurationID','tobaccoDescID', this.id);" value="Yes" >
							    </div>
							    <div class="col-md-2 col-xs-3">
						    		<input type="number" name="tobaccoDuration" step="0.01"  id="tobaccoDurationID" value="<s:property value="tobaccoDuration"/>" class="form-control" placeholder="Duration">
						    	</div>
						    	
						    	<div class="col-md-2 col-xs-3">
						    		<s:textarea name="tobaccoDesc" id="tobaccoDescID" class="form-control" placeholder="Details"></s:textarea>
						    	</div>
						 	<%}else{ %>
						 		<div class="col-md-1">
							    	<input type="checkbox" name="tobacco" id="tobaccoID" style="zoom: 1.5;" onclick="enableFields('tobaccoDurationID','tobaccoDescID', this.id);" value="Yes" >
						...
						<%} %>	
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-3">
						    		<font style="font-size: 14px;font-weight: bold;">Present Complaints</font>
						    	</div>
						    	
							</div>
						
						<%-- <s:iterator value="IPDComplaintsList" var="IPDComplaints"> --%>
							<div class="row" style="margin-top:10px;padding: 0 15px 0 15px;">
							
							<div class="col-md-4">
								<input type="hidden" id="ComplaintsID1" name="complaints" >	
								<s:select list="PVComplaints" headerKey="-1" id="ComplaintsID" value="complaintsListValues" onchange="maxAllowedMultiselect(this)" multiple="true" ></s:select>
							</div>
								...
								<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
								                            ...
								                            <tbody>
								                            	...
								                            	<tr id="complaintOtherTRID">
								                            		...
								                            		<td>
								                            			<input type="text" name="" id="complaintOtherID" class="form-control">
								                            		</td>
								                            		
								                            		<td>
									                            		<a onclick="addOtherComplaints(complaintOtherID.value);" > 
																	  	  <img src="images/add_icon_1.png" onmouseover="this.src='images/add_icon_2.png'"
																									onmouseout="this.src='images/add_icon_1.png'" alt="Add Other Complaints"
																									title="Add Other Complaints" style="margin-top:5px;height: 24px;" />
																		</a>
								                            		</td>
							...
							<div class="row" style="margin-top:10px;padding: 0 15px 0 15px;">
						    	...
						    	<div class="col-md-2">
						    		<input type="number" class="form-control" name="height" value="<s:property value="height"/>" step="0.01" placeholder="Height">
						    	</div>
						    	...
						    	<div class="col-md-2">
						    		<input type="number" class="form-control" name="weight" value="<s:property value="weight"/>" step="0.01" placeholder="Weight">
						    	</div>
						    	...
						    	<div class="col-md-2">
						    		<input type="number" class="form-control" name="OEPulse" value="<s:property value="OEPulse"/>" step="0.01" placeholder="Pulse">
						    	</div>
						    	...
						    	<div class="col-md-1">
						    		<input type="number" class="form-control" name="OEBPSys" value="<s:property value="OEBPSys"/>" step="0.01" placeholder="Systolic">
						    	</div>
						    	
						    	<div class="col-md-1">
						    		<input type="number" class="form-control" name="OEBPDia" value="<s:property value="OEBPDia"/>" step="0.01" placeholder="Diastolic">
						    	</div>
							...
							<div class="row" style="margin-top:10px;padding: 0 15px 0 15px;">
						    	...
						    	<div class="col-md-2">
						    		<input type="number" class="form-control" step="0.01" value="<s:property value="temperature"/>" name="temperature" placeholder="Temperature">
						    	</div>
						    	...
						    	<div class="col-md-2">
						    		<input type="number" class="form-control" step="0.01" value="<s:property value="respiration"/>" name="respiration" placeholder="Respiration">
						    	</div>
						    	...
						    	<div class="col-md-2">
						    		<input type="text" class="form-control" name="pallor" value="<s:property value="pallor"/>" placeholder="Pallor">
						    	</div>
						    	...
						    	<div class="col-md-2">
						    		<input type="text" class="form-control" name="icterus" value="<s:property value="icterus"/>" placeholder="Icterus">
						    	</div>
							...
							<div class="row" style="margin-top:10px;padding: 0 15px 0 15px;">
						    	...
						    	<div class="col-md-3 col-xs-6">
						    		<font style="font-size: 14px;">Abdominal Circumference: </font>
						    	</div>
						    	
						    	<div class="col-md-2">
						    		<input type="number" class="form-control" step="0.01" value="<s:property value="abdominalCircumference"/>" name="abdominalCircumference" placeholder="Abdominal Circumference">
						    	</div>
						    	...
						    	<div class="col-md-2">
						    		<input type="number" class="form-control" step="0.01" value="<s:property value="bmi"/>" name="bmi" placeholder="BMI">
						    	</div>
						...
						<%for(PatientForm form4 : onEaminationList){ %>
						    ...
						    <% if(form4.getRsPhonchi() == null){ %>
						    	<div class="col-md-2">
						    		<label><input type="checkbox" name="rsPhonchi" style="zoom: 1.5;" value="Yes">&nbsp;Rhonchi</label>
						    	</div>
						  <% }else{
							  if(form4.getRsPhonchi().equals("Yes")){%>
						  		<div class="col-md-2">
						    		<label><input type="checkbox" name="rsPhonchi" checked="checked" style="zoom: 1.5;" value="Yes">&nbsp;Rhonchi</label>
						    	</div>
						   <% }else{ %>	
						    	<div class="col-md-2">
						    		<label><input type="checkbox" name="rsPhonchi" style="zoom: 1.5;" value="Yes">&nbsp;Rhonchi</label>
						  ...
						  <% if(form4.getRsCrepitation() == null){ %>
						    	<div class="col-md-2">
						    		<label><input type="checkbox" name="rsCrepitation" style="zoom: 1.5;" value="Yes">&nbsp;Crepitation</label>
						    	</div>
						   <%}else{ 
						   		if(form4.getRsCrepitation().equals("Yes")){%> 
						   	<div class="col-md-2">
						    		<label><input type="checkbox" name="rsCrepitation" checked="checked" style="zoom: 1.5;" value="Yes">&nbsp;Crepitation</label>
						    	</div>
						   <%}else {%>
						   	<div class="col-md-2">
						    		<label><input type="checkbox" name="rsCrepitation" style="zoom: 1.5;" value="Yes">&nbsp;Crepitation</label>
						 ...
						 <% }
						    ...
						    <%if(form4.getRsClear() == null){ %>
						    	<div class="col-md-2">
						    		<label><input type="checkbox" name="rsClear" style="zoom: 1.5;" value="Yes">&nbsp;Clear</label>
						    	</div>
						 <%}else{
							 if(form4.getRsClear().equals("Yes")){%>   
							 <div class="col-md-2">
						    		<label><input type="checkbox" name="rsClear" checked="checked" style="zoom: 1.5;" value="Yes">&nbsp;Clear</label>
						    	</div>
							 <%}else{ %>	
							 <div class="col-md-2">
						    		<label><input type="checkbox" name="rsClear" style="zoom: 1.5;" value="Yes">&nbsp;Clear</label>
						    ...
						    <%if(form4.getS1s2()==null){ %>	
						    	<div class="col-md-2">
						    		<label><input type="checkbox" name="s1s2" style="zoom: 1.5;" value="Yes">&nbsp;S1S2</label>
						    	</div>
						    <%}else{
						    	if(form4.getS1s2().equals("Yes")){ %>	
						    	<div class="col-md-2">
					    		<label><input type="checkbox" name="s1s2" checked="checked"  style="zoom: 1.5;" value="Yes">&nbsp;S1S2</label>
					    	</div>
						    	<% }else{%>	
						    	<div class="col-md-2">
					    		<label><input type="checkbox" name="s1s2" style="zoom: 1.5;" value="Yes">&nbsp;S1S2</label>
						   ...
						   <% }
						    ...
						    <%if(form4.getMurmur()==null){ %>
						    	<div class="col-md-6">
						    		<div class="col-md-4">
							    		<label><input type="checkbox" name="murmur" id="s1s2ID" style="zoom: 1.5;" value="Yes" onclick="showMurmurDiv(this.id, 'sysDivID', 'diaDivID');">&nbsp;Murmur</label>
							    	</div>
							    	<div class="col-md-4" id="sysDivID" style="display:none;"> 
							    		<input type="number" name="murmurSys" step="0.01" class="form-control" value="<s:property value="murmurSys"/>" placeholder="Systolic">
							    	</div>
								    <div class="col-md-4" id="diaDivID" style="display:none;">
							    		<input type="number" name="murmurDia" step="0.01" class="form-control" value="<s:property value="murmurDia"/>" placeholder="Diastolic">
							    	</div>
						    	</div>
						    <%}else{ 
						    	if(form4.getMurmur().equals("Yes")){%>
						    		<div class="col-md-6">
						    		<div class="col-md-4">
							    		<label><input type="checkbox" name="murmur" checked="checked" id="s1s2ID" style="zoom: 1.5;" value="Yes" onclick="showMurmurDiv(this.id, 'sysDivID', 'diaDivID');">&nbsp;Murmur</label>
							    	</div>
						    ...
						    <%if(form4.getWnl()==null){ %>
						    	<div class="col-md-2">
						    		<label><input type="checkbox" name="wnl" style="zoom: 1.5;" value="Yes">&nbsp;WNL</label>
						    	</div>
						    <%}else{
						    	if(form4.getWnl().equals("Yes")){ %>
						    	<div class="col-md-2">
						    		<label><input type="checkbox" name="wnl" checked="checked" style="zoom: 1.5;" value="Yes">&nbsp;WNL</label>
						    	</div>
						   <% }else{%>
						   <div class="col-md-2">
						    		<label><input type="checkbox" name="wnl" style="zoom: 1.5;" value="Yes">&nbsp;WNL</label>
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-2">
						    		<label><input type="checkbox" name="cnsWNL" style="zoom: 1.5;" value="Yes">&nbsp;WNL</label>
						    	</div>
						    	<%}else{
						    		if(form4.getCnsWNL().equals("YEs")){%>
						    		<div class="col-md-2">
						    		<label><input type="checkbox" checked="checked" name="cnsWNL" style="zoom: 1.5;" value="Yes">&nbsp;WNL</label>
						    	</div>
						    		<%}else{%>
						    		<div class="col-md-2">
						    		<label><input type="checkbox" name="cnsWNL" style="zoom: 1.5;" value="Yes">&nbsp;WNL</label>
						    	...
						    	<div class="col-md-2">
						    		<label><input type="checkbox" name="" style="zoom: 1.5;" id="cnsOtherCheckID" onclick="showOtherDiv(this.id,'cnsOtherDivID','cnsOtherID');" value="Yes">&nbsp;Other</label>
						    	</div>
						    	
						    	<div class="col-md-7" id="cnsOtherDivID" style="display: none;">
						    		<s:textarea name="cnsOther" class="form-control" id="cnsOtherID"></s:textarea>
						    	</div>
						    	<%}else{%>
							    	<div class="col-md-2">
							    		<label><input type="checkbox" name="" checked="checked"  style="zoom: 1.5;" id="cnsOtherCheckID" onclick="showOtherDiv(this.id,'cnsOtherDivID','cnsOtherID');" value="Yes">&nbsp;Other</label>
							    	</div>
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-1" align="right">
						    		<label><input type="radio" name="abdomen" id="hepatomegalyID" style="" onclick="showDiv('abdomenDivID');" value="Hepatomegaly"></label>
						    	</div>
						    	
						    	<div class="col-md-2">
						    		<font style="font-size: 14px;cursor: pointer;" onclick="checkRadioBtn('hepatomegalyID');"><b>Hepatomegaly</b></font>
						    	</div>
						    	
						    	<div class="col-md-1"  align="right">
						    		<label><input type="radio" name="abdomen" id="splenomegalyID" style="" onclick="showDiv('abdomenDivID');" value="Splenomegaly"></label>
						    	</div>
						    	
						    	<div class="col-md-2">
						    		<font style="font-size: 14px;cursor: pointer;" onclick="checkRadioBtn('splenomegalyID');"><b>Splenomegaly</b></font>
						    	</div>
						    	
							</div>
							
							<div class="row" style="margin-top:10px;display: none;" id="abdomenDivID">
								<div class="col-md-1">
						    	...
						    	<div class="col-md-6">
						    		<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
						    			<tbody>
						    				<tr>
						    					<td style="padding: 10px;"><label><input type="checkbox" name="rightHypochondriac" value="Yes">&nbsp;Right Hypochondriac</label></td>
						    					<td  style="padding: 10px;"><label><input type="checkbox" name="epigastric" value="Yes">&nbsp;Epigastric</label></td>
						    					<td  style="padding: 10px;"><label><input type="checkbox" name="leftHypochondriac" value="Yes">&nbsp;Left Hypochondriac</label></td>
						    				</tr>
						    				<tr>
						    					<td style="padding: 10px;"><label><input type="checkbox" name="rightLumbar" value="Yes">&nbsp;Right Lumbar</label></td>
						    					<td style="padding: 10px;"><label><input type="checkbox" name="umbilical" value="Yes">&nbsp;Umbilical</label></td>
						    					<td style="padding: 10px;"><label><input type="checkbox" name="leftLumbar" value="Yes">&nbsp;Left Lumbar</label></td>
						    				</tr>
						    				<tr>
						    					<td style="padding: 10px;"><label><input type="checkbox" name="rightIliac" value="Yes">&nbsp;Right Iliac</label></td>
						    					<td style="padding: 10px;"><label><input type="checkbox" name="hypogastric" value="Yes">&nbsp;Hypogastric</label></td>
						    					<td style="padding: 10px;"><label><input type="checkbox" name="leftIliac" value="Yes">&nbsp;Left Iliac</label></td>
						    				</tr>
						    			</tbody>
						    		</table>
						    	</div>
							...
							<%}else{ 
						    	...
						    	<div class="col-md-1" align="right">
						    		<label><input type="radio" name="abdomen" id="hepatomegalyID" checked="checked" style="" onclick="showDiv('abdomenDivID');" value="Hepatomegaly"></label>
						    	</div>
							...
							<div class="row" style="margin-top:10px;" id="abdomenDivID">
								<div class="col-md-1">
						    		...
						    		<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
						    			<tbody>
						    				...
						    				<%}else{
						    					...
						    					<td style="padding: 10px;"><label><input type="checkbox" checked="checked" name="rightHypochondriac" value="Yes">&nbsp;Right Hypochondriac</label></td>
						    					<%}else{%>
						    						<td style="padding: 10px;"><label><input type="checkbox" name="rightHypochondriac" value="Yes">&nbsp;Right Hypochondriac</label></td>
						    					<%}
						    				 } %>
						    				...
						    				<td  style="padding: 10px;">
						    					...
						    					<label><input type="checkbox" name="epigastric" value="Yes">&nbsp;Epigastric</label>
						    					<%}else{
						    						if(form4.getEpigastric().equals("Yes")){%>
						    							<label><input type="checkbox" checked="checked" name="epigastric" value="Yes">&nbsp;Epigastric</label>
						    						<%}else{%>
						    							<label><input type="checkbox" name="epigastric" value="Yes">&nbsp;Epigastric</label>
						    						<%}
						    					} %>
						    				...
						    				<% if(form4.getLeftHypochondriac()==null){%>
						    					<label><input type="checkbox" name="leftHypochondriac" value="Yes">&nbsp;Left Hypochondriac</label>
						    					<%}else{
						    						if(form4.getLeftHypochondriac().equals("Yes")){%>
						    						<label><input type="checkbox" checked="checked" name="leftHypochondriac" value="Yes">&nbsp;Left Hypochondriac</label>
						    						<%}else{%>
						    						<label><input type="checkbox" name="leftHypochondriac" value="Yes">&nbsp;Left Hypochondriac</label>
						    						<%}
						    					}%>
						    				...
						    				<tr>
						    					...
						    					<label><input type="checkbox" name="rightLumbar" value="Yes">&nbsp;Right Lumbar</label>
						    					<%}else{
						    						if(form4.getRightLumbar().equals("Yes")){%>
						    						<label><input type="checkbox" checked="checked" name="rightLumbar" value="Yes">&nbsp;Right Lumbar</label>
						    						<%}else{ %>
						    						<label><input type="checkbox" name="rightLumbar" value="Yes">&nbsp;Right Lumbar</label>
						    						<%}
						    					}%>
						    					...
						    					<label><input type="checkbox" name="umbilical" value="Yes">&nbsp;Umbilical</label>
						    					<%}else{
						    						if(form4.getUmbilical().equals("Yes")){%>
						    						<label><input type="checkbox" checked="checked" name="umbilical" value="Yes">&nbsp;Umbilical</label>
						    						<%}else{%>
						    							<label><input type="checkbox" name="umbilical" value="Yes">&nbsp;Umbilical</label>
						    						<%}
						    					}%>
						    					...
						    					<label><input type="checkbox" name="leftLumbar" value="Yes">&nbsp;Left Lumbar</label>
						    					<%}else{
						    						if(form4.getLeftLumbar().equals("Yes")){%>
						    						<label><input type="checkbox" checked="checked" name="leftLumbar" value="Yes">&nbsp;Left Lumbar</label>
						    						<%}else{%>
						    						<label><input type="checkbox" name="leftLumbar" value="Yes">&nbsp;Left Lumbar</label>
						    						<%}
						    					} %>
						    				...
						    				<tr>
						    					...
						    					<label><input type="checkbox" name="rightIliac" value="Yes">&nbsp;Right Iliac</label>
						    					<%}else{ 
							    					if(form4.getRightIliac().equals("Yes")){%>
							    					<label><input type="checkbox" checked="checked" name="rightIliac" value="Yes">&nbsp;Right Iliac</label>
							    					<%}else{%>
							    					<label><input type="checkbox" name="rightIliac" value="Yes">&nbsp;Right Iliac</label>
							    					<%}
						    					} %>
						    					...
						    					<label><input type="checkbox" name="hypogastric" value="Yes">&nbsp;Hypogastric</label>
						    					<%}else{
						    						if(form4.getHypogastric().equals("Yes")){%>
						    						<label><input type="checkbox" checked="checked"  name="hypogastric" value="Yes">&nbsp;Hypogastric</label>
						    						<%}else{ %>
						    						<label><input type="checkbox" name="hypogastric" value="Yes">&nbsp;Hypogastric</label>
						    						<% }
						    					}%>
						    					...
						    					<label><input type="checkbox" name="leftIliac" value="Yes">&nbsp;Left Iliac</label>
						    					<%}else{
						    						if(form4.getLeftIliac().equals("Yes")){%>
						    							<label><input type="checkbox" checked="checked" name="leftIliac" value="Yes">&nbsp;Left Iliac</label>
						    						<%}else{ %>
						    							<label><input type="checkbox" name="leftIliac" value="Yes">&nbsp;Left Iliac</label>
						    						<%} 
						    					}%>
						    	...
						    	<div class="col-md-1"  align="right">
						    		<label><input type="radio" name="abdomen" id="splenomegalyID" checked="checked"  style="" onclick="showDiv('abdomenDivID');" value="Splenomegaly"></label>
						    	</div>
						...
						<% } %>	
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-3">
						    		<font style="font-size: 14px;font-weight: bold;">Significant Findings</font>
						    	</div>
							...
							<div class="row" style="margin-top:10px;padding: 0 15px 0 15px;">
						    	...
						    	<div class="col-md-12">
						    		<s:textarea class="form-control" name="biopsyFindings" placeholder="Significant Findings"></s:textarea>
						    	</div>
							</div>
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-3">
						    		<font style="font-size: 14px;font-weight: bold;">Provisional  Diagnosis*</font>
						    	</div>
						    	
						    	<div class="col-md-3">
						    		<sx:autocompleter name="diagnosis" cssStyle="padding-left:14px;" id="ProvisionalDiagnosisID" cssClass="form-control" list="DiagnosisList" showDownArrow="false" />
	                      ...
	                      <div class="form-group">
	                        <div class="col-md-12 col-xs-12" align="center">
			                 ...
			                 <button id="send" type="button" class="btn btn-success " onclick="checkDiagnosis();">Update</button>
			     ...
			     <!-- Prescription div -->
			      <div class="tab-pane fade" id="presc" >
			        <form class="form-horizontal form-label-left" novalidate id="genPhyPrescID" name="genPhyPrescID" onsubmit="return updatePrescription();" action="UpdateGeneralHospitalPrescription" method="POST" style="margin-top:20px;">
			      ...
			      <input type="hidden" name="firstName" id="firstName" value="<s:property value="firstName"/>">
				   ...
				   <div class="row">
						<div class="col-md-4">
		               		<img src="<%= daoInf.retrieveClinicLogo(form.getPracticeID()) %>" alt="Clinic Logo" style="height:53px;padding:0px;margin-left:15px;" class="img-circle profile_img" >
		              	</div>
		              	<div class="col-md-4">
				     		<h4 style="margin-top:20px;" align="center"><b>Prescription</b></h4>
						</div>
						<div class="col-md-4">
							<h2 style="font-size:15px;margin-top:20px;">Consultant:<%=form.getFullName() %></h2>
             			</div>
					</div>
					...
					<div class="row" style="margin-top:15px;">
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"  >
							 <table border="1" width="100%">
							    <tr>
							    	<td colspan="1" style="padding-left:10px;font-size:14px; font-weight: bold;"> Name: <input type="text" style="border:none;cursor:not-allowed;background: transparent;"  class="form-control" readonly="readonly" value="<s:property value="lastName"/> <s:property value="firstName"/> <s:property value="middleName"/>"  name="" placeholder="Patient Name" autofocus=""></td>
							   		
							   		<td colspan="1" style="padding-left:10px;font-size:14px; font-weight: bold;"> Date of visit: <input type="text" class="form-control" name="" style="border:none;cursor:not-allowed;background: transparent;" readonly="readonly" value="<s:property value="visitDate"/>" aria-describedby="inputSuccess2Status3"></td>
							   		
									<td style="padding-left:10px;font-size:14px; font-weight: bold;">Age: <input type="number" style="border:none;background: transparent;cursor:not-allowed;" readonly="readonly" class="form-control" name="age" value="<s:property value="age"/>" placeholder="Age" autofocus=""></td>
							    
							    	<td style="padding-left:10px;font-size:14px; font-weight: bold;">Weight: <input type="text" name="weight" class="form-control" value="<s:property value="weight"/>" placeholder="Weight" ></td>
				 	...
				 	<div class="row" style="margin-top:10px;margin-left:0px;margin-bottom:5px;">
					 	<div class="row" id="OPDPResc" style="margin-left:0px;margin-right:0px;margin-top:15px;">
					                ...
					                <tbody>
					                  ...
					                  <s:iterator value="InjectionPrescriptionList">
					                       <tr id="visitPrescTRID<s:property value="prescriptionID"/>">
					                            ...
					                            <td style="font-size: 14px;text-align: center;"><s:property value="dosageBeforeMeal"/></td>
					                            			
					                            <td style="font-size: 14px;text-align: center;"><s:property value="dosageAfterMeal"/></td>
					                            		
					                            <td style="font-size: 14px;text-align: center;"><s:property value="dosageAfterDinner"/></td>
					                            ...
					                            <td style="text-align: center;"><img src='images/delete.png' style='height:24px;cursor: pointer;'
				            ...
				            <div class="col-md-2" >
				            	<sx:autocompleter name="tradeName" cssStyle="padding-left:14px;" cssClass="form-control" list="InjectionList" showDownArrow="false" />
				            	
							</div>
				            <div class="col-md-2">
				             <input type="number" class="form-control" name="" id="dosageBeforeMealID" placeholder="Before Meal">
				            </div>
				            <div class="col-md-2">
				             <input type="number" class="form-control" name="" id="dosageAfterMealID" placeholder="After Meal">
				            </div>
				            <div class="col-md-2">
				             <input type="number" class="form-control" name="" id="dosageAfterDinnerID" placeholder="After Dinner">
				            </div>
				            <div class="col-md-2 col-xs-3">
				             <textarea rows="1" cols="1" name="" class="form-control" id="dosageCommentID" placeholder="Comment"></textarea>
				            </div>
				           	<div class="col-md-1">
				              <input type="number" name="" id="durationID" class="form-control" placeholder="Duration">
				            </div>
				            
				            <div class="col-md-1">
				              <a onclick="addInjectionPrescriptionRow('',dosageBeforeMealID.value,dosageAfterMealID.value,dosageAfterDinnerID.value,dosageCommentID.value,durationID.value, 'Injection');" > 
							  	<img src="images/add_icon_1.png" onmouseover="this.src='images/add_icon_2.png'" onmouseout="this.src='images/add_icon_1.png'" 
							  		alt="Add Prescription" title="Add Prescription" style="margin-top:5px;height: 24px;" />
							  </a>
				            </div>
				      </div>
				      ...
				      <div class="row" style="margin-top:10px;margin-left:0px;margin-bottom:5px;">
					 	<div class="row" id="OPDPResc" style="margin-left:0px;margin-right:0px;margin-top:15px;">
					               ...
					               <thead>
					                ...
					                <tbody>
					                   ...
					                   <s:iterator value="TabletPrescriptionList">
					                       <tr id="visitPrescTabletTRID<s:property value="prescriptionID"/>">
					                            <td style="font-size: 14px;text-align: center;"><s:property value="tradeName"/></td>
				            ...
				            <div class="col-md-2" >
				            	<sx:autocompleter name="tradeNameTablet" cssStyle="padding-left:14px;" cssClass="form-control" list="TabletList" showDownArrow="false" />
				            	<%-- <s:select list="TabletList" headerKey="-1" headerValue="Select Tablet" class="form-control" name="tradeName" id="tabletID" ></s:select> --%>
							</div>
				            <div class="col-md-2">
				             <input type="number" class="form-control" name="" id="dosageBeforeMealTabID" placeholder="Before Meal">
				            </div>
				            <div class="col-md-2">
				             <input type="number" class="form-control" name="" id="dosageAfterMealTabID" placeholder="After Meal">
				            </div>
				           <div class="col-md-2">
				             <input type="number" class="form-control" name="" id="dosageAfterDinnerTabID" placeholder="After Dinner">
				            </div>
				            <div class="col-md-2 col-xs-3">
				             <textarea rows="1" cols="1" name="" class="form-control" id="dosageCommentTabID" placeholder="Comment"></textarea>
				            </div>
				           	<div class="col-md-1">
				              <input type="number" name="" id="durationTabID" class="form-control" placeholder="Duration">
				            </div>
				            
				            <div class="col-md-1">
				              <a onclick="addTabletPrescriptionRow('',dosageBeforeMealTabID.value,dosageAfterMealTabID.value,dosageAfterDinnerTabID.value,dosageCommentTabID.value,durationTabID.value, 'Tablet');" > 
							  	<img src="images/add_icon_1.png" onmouseover="this.src='images/add_icon_2.png'" onmouseout="this.src='images/add_icon_1.png'" 
							  		alt="Add Prescription" title="Add Prescription" style="margin-top:5px;height: 24px;" />
							  </a>
				            </div>
				      ...
				      <div class="row" style="margin-top:10px;margin-left:0px;margin-bottom:5px;">
					 	<div class="row" id="OPDPResc" style="margin-left:0px;margin-right:0px;margin-top:15px;">
					               ...
					               <thead>
					                ...
					                <tbody>
					                 ...
					                 <s:iterator value="LiquidPrescriptionList">
					                       <tr id="visitPrescLiquidTRID<s:property value="prescriptionID"/>">
					                            <td style="font-size: 14px;text-align: center;"><s:property value="tradeName"/></td>
				            ...
				            <div class="col-md-2" >
				            	<sx:autocompleter name="tradeNameLiquid" cssStyle="padding-left:14px;" cssClass="form-control" list="LiquidList" showDownArrow="false" />
				            	<%-- <s:select list="LiquidList" headerKey="-1" headerValue="Select Liquid" class="form-control" name="tradeName" id="liquidID" ></s:select> --%>
							</div>
				            <div class="col-md-2">
				             <input type="number" class="form-control" name="" id="dosageBeforeMealLiqID" placeholder="Before Meal">
				            </div>
				            <div class="col-md-2">
				             <input type="number" class="form-control" name="" id="dosageAfterMealLiqID" placeholder="After Meal">
				            </div>
				            <div class="col-md-2">
				             <input type="number" class="form-control" name="" id="dosageAfterDinnerLiqID" placeholder="After Dinner">
				            </div>
				            <div class="col-md-2 col-xs-3">
				             <textarea rows="1" cols="1" name="" class="form-control" id="dosageCommentLiqID" placeholder="Comment"></textarea>
				            </div>
				           	<div class="col-md-1">
				              <input type="number" name="" id="durationLiqID" class="form-control" placeholder="Duration">
				            </div>
				            
				            <div class="col-md-1">
				              <a onclick="addLiquidPrescriptionRow('',dosageBeforeMealLiqID.value,dosageAfterMealLiqID.value,dosageAfterDinnerLiqID.value,dosageCommentLiqID.value,durationLiqID.value, 'Liquid');" > 
							  	<img src="images/add_icon_1.png" onmouseover="this.src='images/add_icon_2.png'" onmouseout="this.src='images/add_icon_1.png'" 
							  		alt="Add Prescription" title="Add Prescription" style="margin-top:5px;height: 24px;" />
							  </a>
				            </div>
				   ...
				   <div class="row" style="margin-top:40px;">
						...
						<div class="col-md-4">
						   <font style="font-size: 14px;font-weight: bold;">Prescribed Investigations: </font>
						</div>
					</div>	   	
	...
	<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
		<tbody>		
			...
			<tr>
				<td style="text-align: center;"><input type="checkbox" name="investigation" style="zoom: 1.5;" value="<%=formOPD.getTest()%>" ></td>
			...
			<% j++; } %>	
					...
					<div class="row" style="margin-top:10px;">   	
						    ...
						    <div class="col-md-2">
						   		<s:textarea name="physiotherapy" id="PhysiotherapyID" class="form-control" placeholder="Physiotherapy"></s:textarea>
						   	</div>
					</div>
					<div class="row" style="margin-top:10px;">   	
					    	<div class="col-md-2">
						    ...
						    <div class="col-md-1 col-xs-2">
					    		<input type="text" class="form-control" name="nextVisitDays" value="<s:property value="nextVisitDays"/>" id="visitDayID" placeholder="Days" >
					    	</div>
						    <div class="col-md-1 col-xs-2">
					    		<input type="text" class="form-control" name="nextVisitWeeks" value="<s:property value="nextVisitWeeks"/>" id="visitWeekID" placeholder="Weeks" >
					    	</div>
						   	<div class="col-md-1 col-xs-2">
						   		<input type="text" class="form-control" name="nextVisitMonths" value="<s:property value="nextVisitMonths"/>" id="visitMonthID" placeholder="Months" >
						   	</div>
					</div>
				    ...
				    <div class="ln_solid"></div>
		                    ...
		                    <div class="form-group">
	                          ...
	                          %>
	                         	<button type="submit" id="savePrescID" class="btn btn-success" name="addButton" value="add">Save</button>
	                          <%
					        	}else{
			                 %>
			                 <button type="submit" id="savePrescID" class="btn btn-success" name="addButton" value="add">Save</button>
			   ...
			   <!-- Billing div -->
			    ...
			    <!--  <h3>Coming soon...</h3> -->
			      ...
			      <form class="form-horizontal form-label-left"  id="genPhyBillID" onsubmit = "return checkCheckbox();" name="genPhyBillID" action="EditNewBill" method="POST" style="margin-top:20px;">
				        ...
				        <div class="item form-group" style="margin-top:15px;padding-left: 15px;">
	                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
	                          <thead>
	                          	<tr>
									<th colspan="4" align="right" style="text-align: right;">Consultation Charges: </th>
									<th><input type="hidden" name="billingType" id="" value="<s:property value="billingType"/>"><input type="number" readonly="readonly" class="form-control" value = "<s:property value="charges"/>" name="charges" id="consultationChargeID"></th>
								</tr>
								<tr>
					                <th></th>
							...
							for(PrescriptionManagementForm formOPD : OPDChargesList){ 
								...
								if(ChargesDetails.contains(formOPD.getChargeType())){
									...
									if(ChargesDetails.contains(",")){ 
										...
										String[] Charges = ChargesDetails.split(",");
											...
											System.out.println("inside bill if");%>
											<tr>	
												<td><input type="checkbox" name="checkboxName" checked="checked" id="OPDChargeTypeID<%=ChargeValues[0]%>" style="zoom: 1.5;" onclick="changeTotalAmtByQuantyRate('OPDChargeTypeID<%=ChargeValues[0]%>', 'OPDChargesQuantyID<%=ChargeValues[0]%>', 'OPDChargesRateID<%=ChargeValues[0]%>', 'OPDChargesAmountID<%=ChargeValues[0]%>', 'totalAmountID', 'chargeID<%=ChargeValues[0]%>', 'chargeTypeID<%=ChargeValues[0]%>');" value="Yes" ></td>
												<td><input type="hidden" name="chargeID" id="chargeID<%=ChargeValues[0]%>" value="<%=ChargeValues[0]%>"><input type="hidden" name="chargeType" id="chargeTypeID<%=ChargeValues[0]%>" value="<%=ChargeValues[1]%>"><%=ChargeValues[1]%></td>
												<td><input type="number" name="chargeQuantity" id="OPDChargesQuantyID<%=ChargeValues[0]%>" onkeyup= "changeChargesAmount('OPDChargeTypeID<%=ChargeValues[0]%>', 'OPDChargesQuantyID<%=ChargeValues[0]%>', 'OPDChargesRateID<%=ChargeValues[0]%>', 'OPDChargesAmountID<%=ChargeValues[0]%>', 'totalAmountID', consultationChargeID.value);" class="form-control" value="<%=ChargeValues[2] %>" ></td>
												<td><input type="number" name="chargeRate" id="OPDChargesRateID<%=ChargeValues[0]%>" class="form-control" readonly="readonly" value="<%=ChargeValues[3]%>" ></td>
												<td><input type="number" name="chargeAmount" id="OPDChargesAmountID<%=ChargeValues[0]%>" class="form-control" readonly="readonly" value="<%=ChargeValues[4]%>" ></td>
											</tr>	
									<% 
										i++;
									}else{ 
										...
										System.out.println("inside bill eklse");%>
						 	...
						 	}else{ System.out.println("inside bill end else");%>
								
								<tr>
									<td><input type="checkbox" name="checkboxName" id="OPDChargeTypeID<%=formOPD.getChargesID()%>" style="zoom: 1.5;" onclick="changeTotalAmtByQuantyRate('OPDChargeTypeID<%=formOPD.getChargesID()%>', 'OPDChargesQuantyID<%=formOPD.getChargesID()%>', 'OPDChargesRateID<%=formOPD.getChargesID()%>', 'OPDChargesAmountID<%=formOPD.getChargesID()%>', 'totalAmountID', 'chargeID<%=formOPD.getChargesID()%>', 'chargeTypeID<%=formOPD.getChargesID()%>');" value="Yes" ></td>
									<td><input type="hidden" name="" id="chargeID<%=formOPD.getChargesID()%>" value="<%=formOPD.getChargesID()%>"><input type="hidden" name="" id="chargeTypeID<%=formOPD.getChargesID()%>" value="<%=formOPD.getChargeType()%>"><%=formOPD.getChargeType()%></td>
									<td><input type="number" name="" id="OPDChargesQuantyID<%=formOPD.getChargesID()%>" onkeyup= "changeChargesAmount('OPDChargeTypeID<%=formOPD.getChargesID()%>', 'OPDChargesQuantyID<%=formOPD.getChargesID()%>', 'OPDChargesRateID<%=formOPD.getChargesID()%>', 'OPDChargesAmountID<%=formOPD.getChargesID()%>', 'totalAmountID', consultationChargeID.value);" class="form-control" value="1" ></td>
									<td><input type="number" name="" id="OPDChargesRateID<%=formOPD.getChargesID()%>" class="form-control" readonly="readonly" value="<%= formOPD.getCharges() %>" ></td>
									<td><input type="number" name="" id="OPDChargesAmountID<%=formOPD.getChargesID()%>" class="form-control" readonly="readonly" ></td>
								</tr>
							<% }
			                  ...
			                  <tbody>
								...
								<tr>
									...
									<td>
										<input type="number" class="form-control" onkeyup="changeNetAmtByDiscount(this.value,totalAmountID.value);" value = "<s:property value="totalDiscount"/>" name="totalDiscount" id="totalVatID">
									</td>
								</tr>
								<tr>
									<td colspan="4" align="right">
						...
						<div id="cardDetailID" style="padding: 15px; display: none;">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<input type="number" class="form-control" id="cardAmountID" name="cardAmount" value="<s:property value="cardAmount"/>" placeholder="Amount">
								</div>
								<div class="col-md-2 col-xs-6">
			    ...
			    <div class="tab-pane fade" id="labRep" >
			      ...
			      <form class="form-horizontal form-label-left" novalidate action="EditLabReport" name="labRepForm" id="labRepForm" 
				      ...
				      <input type="hidden"  name="firstName" id="firstName" value="<s:property value="firstName"/>">
				       <input type="hidden"  name="lastName" id="lastName" value="<s:property value="lastName"/>">
					    ...
					    <div class="row" style="margin:15px;">
					     				...
					     				<%
					     				System.out.println("inside med cert");
									    	if(medicalCertiText == null || medicalCertiText == ""){
									    %>
									    
									     <div class="col-md-12 col-xs-12" style="border:1px solid gray;margin:25px;">
			    ...
			    <div class="tab-pane fade" id="refLetter" >
				      ...
				      <input type="hidden"  name="firstName" id="firstName" value="<s:property value="firstName"/>">
				       <input type="hidden"  name="lastName" id="lastName" value="<s:property value="lastName"/>">
						...
						<%
						System.out.println("inside ref letter");
							if(referralLetterText == null || referralLetterText == ""){
						%>
