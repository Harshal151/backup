...
function changeBalancePayment(advPayment,netAmount){
    ...
    <%
    	...
    	//HashMap<String, String> groupLabTestMap = patientDAOInf.retrieveGroupLabTestsList(genderMap.get(gender));
    	HashMap<String, String> groupLabTestMap = new HashMap<String, String>();
	...
	var popup;
		...
		function abc(event){
			var checked = $("input[name=test][type=checkbox]:checked").length;
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
			    ...
			    <div class="tab-pane fade in active" id="visit">
				    <form class="form-horizontal form-label-left" action="AddNewLabVisit" name="visitrForm" onsubmit="return disableSubmitBtn('sendBtnID');" id="visitrForm" method="POST" style="margin-top:20px;">
			         ...
			         <input type="hidden"  name="firstName" id="firstName" value="<s:property value="firstName"/>">
			          <input type="hidden"  name="lastName" id="lastName" value="<s:property value="lastName"/>">
				          ...
				          <%-- <div class="item form-group">
	                        <label for="User Type" class="control-label col-md-3">Visit Type<span class="required">*</span></label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                      ...
	                      <div class="item form-group">
	                        <label for="User Type" class="control-label col-md-3">Visit Date</label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                      ...
	                      <div class="form-group">
	                        <div class="col-md-12" align="center">
	                          ...
	                          %>
	                          <button id="sendBtnID" type="submit" class="btn btn-success " disabled="disabled" onclick="showLoadingImg();">Save</button>
	                          <%
					        	}else{
			                 %>
			                 <button id="sendBtnID" type="submit" class="btn btn-success " onclick="abc(event);">Save</button>
			                 <%
					        	}
			                 %>
