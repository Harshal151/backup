...
<html lang="en">
  <head>
    ...
    <title>Manage Service Type | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchServiceType" method="POST" onsubmit="return showLoadingImg();" >
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search services" name=searchServiceType>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active">Search Services</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllServiceTypes"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Services</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="serviceTypeList" var="UserForm">
		                        	<tr>
											...
											<td align="center"><s:url id="approveURL"
												action="RenderEditServiceType">
												<s:param name="serviceTypeID" value="%{serviceTypeID}" />
												<s:param name="searchServiceType" value="%{searchServiceType}" />
											</s:url> <s:a href="%{approveURL}">
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Room Type"
													title="Edit Room Type" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteServiceType">
												<s:param name="serviceTypeID" value="%{serviceTypeID}" />
												<s:param name="searchServiceType" value="%{searchServiceType}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete Room Type"
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="AddServiceType" method="POST" onsubmit="return disableButton('send');" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="ChargeType">Service <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="serviceType" required="required" placeholder="Service" class="form-control">
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="ChargeType">Room Capacity <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="roomCapacity" required="required" placeholder="Room Capacity" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditServiceType" onsubmit="return showLoadingImg();"  method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="editServiceTypeList" var="roomTypeForm">
						  
						  <input type="hidden" name="serviceTypeID" value="<s:property value="serviceTypeID" />" >
						  <input type="hidden" name="searchServiceType" value="<s:property value="searchServiceType" />" >
						  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Instruction">Service <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="serviceType" required="required" value="<s:property value="serviceType" />" placeholder="Room Type" class="form-control">
	                        </div>
	                      </div>
	                       ...
	                       <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="roomCapacity" required="required" value="<s:property value="roomCapacity" />" placeholder="Room Capacity" class="form-control">
	                        </div>
	                      </div>
