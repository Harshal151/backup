						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form class="form-horizontal form-label-left" action="AddPatientAppointment" name="apptFormID" onsubmit="submitApptForm();"
									...
									<form class="form-horizontal form-label-left" id="apptFormID" onsubmit="submitPatForm();" 
									name="apptFormID" action="AddPatient" method="POST"
										...
										<s:iterator value="patientList" var="form">
											...
											<div class="item form-group">
												<label for="User Type" class="control-label col-md-3 col-sm-4">Age </label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="number" name="age" placeholder="Age" id="ageID" value="<s:property value='age'/>" class="form-control">
												</div>
											</div>
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
												<div>
													<input type="number" class="form-control" value="<s:property value='Mobile'/>" name="mobile" onKeyPress="if(this.value.length==10) return false;" id="mobileID" placeholder="Mobile" aria-describedby="inputGroupSuccess1Status">
												</div>	
