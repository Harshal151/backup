										...
										<div id="myTabContent1" class="tab-content">
											...
											<div class="tab-pane fade" id="usgReport">
												<form class="form-horizontal form-label-left" novalidate
													action="addnewUSGReport" name="addnewUSGReport"
													...
													<div class="row" style="margin-top: 15px;">
														<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
															<div class="row" style="margin-top: 15px;">
																...
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Date
																			of first visit :</label>
																	</div>
																	<div class="col-md-6">
																		<input type="text" class="form-control"
															...
															<div class="row" style="margin-top: 15px;">
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Age
																			:</label>
																	</div>
																	<div class="col-md-6">
																		<input type="number" class="form-control" name="age"
																			id="age" value="<s:property value="age"/>"
																...
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Sex
																			:</label>
																	</div>
																	<div class="col-md-6">
																		<input type="text" name="gender" class="form-control"
																			value="<s:property value="gender"/>"
																			placeholder="Gender" autofocus="">
																	</div>
																</div>
															</div>
															...
															<div class="row" style="margin-top: 15px;">
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Phone
																			Number :</label>
																	</div>
																	<div class="col-md-6">
																...
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Email
																			Id :</label>
																	</div>
																	<div class="col-md-6">
																		<input type="text" name="email" class="form-control"
																			value="<s:property value="emailID"/>" autofocus="">
																	</div>
																</div>
															</div>
															...
															<div class="row" style="margin-top: 15px;">
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Husband's/Father's
																			Name :</label>
																	</div>
																	<div class="col-md-6">
																		<input type="text" class="form-control"
																			name="nameOfGuardian"
																			value="<s:property value="nameOfGuardian"/>" />
																	</div>
																</div>
																...
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	...
																	<div class="col-md-6">
																		<input type="text" id="dobID" class="form-control"
																			...
																			value="<s:property value="dateOfBirth"/>">
																	</div>
																</div>
															</div>
															...
															<div class="row" style="margin-top: 15px;">
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Address
																			:</label>
																	</div>
																	<div class="col-md-6">
																...
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Last
																			Period Date(LMP) :</label>
																	</div>
																	<div class="col-md-6">
																		<input type="text" id="apptDateID2"
																			class="form-control" name="lastMenstrualPeriod"
																			value="<s:property value="lastMenstrualPeriod"/>"
																			readonly="readonly"
																			placeholder="Last Period Date(LMP)">
																	</div>
																</div>
															</div>
															...
															<div class="row" style="margin-top: 15px;">
																...
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Weeks
																			of Pregnancy :</label>
																	</div>
																	<div class="col-md-6">
																		<input type="text" id="weekOfPregnancy"
																			name="weekOfPregnancy"
																			value="<s:property value="weekOfPregnancy"/>"
																...
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Estimated
																			Date of Delivery :</label>
																	</div>
																	<div class="col-md-6">
																		<input type="text" id="estimateDate"
																			name="estimatedDueDate" class="form-control"
																			value="<s:property value="estimatedDueDate"/>"
															...
															<div class="row" style="margin-top: 15px;">
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Sons
																			:</label>
																	</div>
																	...
																	<div class="col-md-2">
																		<s:select
																			...
																			class="form-control" name="numberOfSons"
																			headerValue="0"
																			style="width: 75%;height: 34px;padding-left: 5px;padding-top: 7px;"
																			onchange="sonAgeCount(this.value)"></s:select>
																	</div>

																	<div class="col-md-4" id="sonsAge"></div>
																	<input type="hidden" name="sonAge" id="sonAge">
																</div>

																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Daughters
																			:</label>
																	</div>
																	...
																	<div class="col-md-2">
																		<s:select
																			list="#{'0':'0','1':'1','2':'2','3':'3','4':'4'}"
																			class="form-control" name="numberOfDaughters"
																			headerValue="0"
																			style="width: 75%;height: 34px;padding-left: 5px;padding-top: 7px;"
																			onchange="daughtersAgeCount(this.value)"></s:select>

																	</div>

																	<div class="col-md-4" id="daughtersAge"></div>
																	<input type="hidden" name="daughterAge"
																		id="daughterAge">
																</div>
															</div>
															...
															<div class="row" style="margin-top: 15px;">
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Clinician
																			Name :</label>
																	</div>
																	<div class="col-md-6">
																		<s:select list="doctorList1" headerKey="-1"
																			headerValue="Select Clinician" name="clinicianID"
																			id="selectedClinicianID" class="form-control"
																			required="required">
																...
																<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
																	<div class="col-md-5">
																		<label for="name" style="font-size: 15px">Referral
																			Doctor :</label> <img src="images/addBill.png"
																			style="height: 24px; cursor: pointer;"
																			onclick="addReferralDoctor();"
																			alt="Add Referral Doctor" title="Add Referral Doctor" />
																	</div>
																	<div class="col-md-6" id="referredByDIV">
																		<s:select list="referringDoctorList" headerKey="-1"
																			headerValue="Select Referral Doctor"
																			name="referredBy" id="referredBy"
													...
													<div class="row" style="padding-top: 30px;" align="center">
														...
														<button class="btn btn-warning" type="submit"
															id="PrintReportID" name="addButton" value="print">Save</button>
														<button class="btn btn-warning" type="button"
															id="printFormF1"
															onclick="printFormF('<s:property value="visitID"/>', '<s:property value="patientID"/>');">Print
															FormF</button>
													</div>
											...
											<div class="tab-pane fade" id="selectReport">
												<form class="form-horizontal form-label-left" novalidate
													action="editBDPReport" name="visitrForm" id="visitrForm"
													method="POST" style="margin-top: 20px;">
													...
													<input type="hidden" name="firstName" id="firstName"
														...
														type="hidden" name="" id="clinicianRegNoID" value="">
															...
															<table border="1" width="98%">
																<tr>
																	...
																	<td colspan="1"
																		...
																		type="text" class="form-control" name="visitDate"
																		style="border: none; cursor: not-allowed; background: transparent;"
																...
																<tr>
																	<td colspan="1"
																		style="padding-left: 10px; font-size: 14px; font-weight: bold;">
																		Phone Number:</td>
																	<td colspan="4"><input type="number" name="mobile"
																		style="border: none; background: transparent; cursor: not-allowed;"
							    		...
							    		<td colspan="2"> <input type="number" name="phone" style="border:none;background: transparent;cursor:not-allowed;" readonly="readonly" class="form-control" value="<s:property value="phone"/>" autofocus=""  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status"></td> --%>
													...
													<div class="row" style="margin-top: 30px;">
														...
														<div class="col-md-3">
															...
															<s:select list="doctorList1" headerKey="-1"
																headerValue="Select Clinician" name="clinicianID"
																id="clinicianID" class="form-control"
														...
														<div class="col-md-3">
															<s:select list="reportList" headerKey="-1"
																headerValue="Select Report" name="reportID"
																id="reportID" class="form-control"
																style="border-radius: 5px;"
																onchange="getTemplate(this.value)" required="required">
						    			  ...
						    			  menubar: 'edit insert format table',
													...
													<div class="row" style="padding-top: 30px;" align="center">
														...
														<button class="btn btn-success" type="submit"
															name="addButton" value="print">Update & Print</button>
													</div>
											...
											<div class="tab-pane fade" id="billing">
												<form class="form-horizontal form-label-left"
													...
													name="genPhyBillID" action="EditBill" method="POST"
													...
													<s:iterator value="billList">
														...
														<div class="item form-group" style="margin-top: 15px;">
															<label for="User Type"
																class="control-label col-md-3 col-xs-5">Charges(Rs)</label>
															<div class="col-md-6 col-sm-6 col-xs-6">
																<input type="text" class="form-control" name="charges"
																	id="charges" value="<s:property value="totalAmount"/>"
																	onkeyup="changeTotalBill('totalBill',charges.value, totalVatID.value, advPaymentID.value);"
														...
														<div class="item form-group">
															<label for="User Type"
																class="control-label col-md-3 col-xs-5">Total
																Bill(Rs)</label>
															<div class="col-md-6 col-sm-6 col-xs-6">
														...
														<div class="item form-group">
															<label for="User Type"
																class="control-label col-md-3 col-xs-5">Concession,
																if any</label>
															<div class="col-md-6 col-sm-6 col-xs-6">
																<input type="number" class="checkClass form-control"
																	value="<s:property value="totalDiscount"/>"
																	onkeyup="changeNetAmtByDiscount(this.value,totalBill.value, advPaymentID.value);"
																	name="totalDiscount" id="totalVatID">
															</div>
														</div>

														<div class="item form-group">
															<label for="User Type"
																class="control-label col-md-3 col-xs-5">Net
																Amount</label>
															<div class="col-md-6 col-sm-6 col-xs-6">
														...
														<div class="item form-group">
															<label for="User Type"
																class="control-label col-md-3 col-xs-5">Amount
																Paid<span class="required">*</span>
															</label>
															<div class="col-md-6 col-sm-6 col-xs-6">
																<input type="number" class="form-control"
																	name="advPayment" id="advPaymentID" required="required"
																	value="<s:property value="advPayment"/>"
																	onkeyup="changeBalancePayment(this.value,netAmountID.value);">
															</div>
														</div>

														<div class="item form-group">
															<label for="User Type"
																class="control-label col-md-3 col-xs-5">Balance
																Payment</label>
															<div class="col-md-6 col-sm-6 col-xs-6">
																<input type="number" class="form-control"
																	name="balPayment"
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" style="text-align-last: center">Add
						New Referring Doctor</h4>
				</div>
				<div class="modal-body">
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="referringDoctName"
									id="referringDoctName" required="required"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="referringDoctSpecialisation"
									id="referringDoctSpecialisation" placeholder="Specialization"
									class="form-control">
							</div>
						</div>
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="referringDoctClinicName"
									id="referringDoctClinicName" placeholder="Clinic Name"
									class="form-control">
							</div>
						</div>
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<textarea name="referringDoctClinicAddres"
									id="referringDoctClinicAddres" placeholder="Clinic Address"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" name="referringDoctPhone"
									id="referringDoctPhone" placeholder="Phone"
									class="form-control"
									onKeyPress="if(this.value.length==10) return false;"
									aria-describedby="inputGroupSuccess1Status">
							</div>
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="email" name="referringDoctEmail"
									id="referringDoctEmail" placeholder="Email"
									class="form-control">
							</div>
						</div>
