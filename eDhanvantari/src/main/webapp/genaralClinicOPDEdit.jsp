  ...
  <head>
	...
	<script type="text/javascript">
		function printVisit(){
			...
			document.forms["visitrForm"].action = "PrintGeneralClinicEditVisit";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
			     ...
			     <div class="tab-pane fade in active" id="visit">
				    <form class="form-horizontal form-label-left" novalidate action="EditGeneralClinicVisit" onsubmit="return showLoadingImg();" name="visitrForm" id="visitrForm" method="POST" style="margin-top:20px;">
		            ...
		            <div class="row" style="padding-top: 20px;">
		             	...
		             	<div class="col-md-3">
		             	 	<input type="text" class="form-control" name="lastMenstrualPeriod" id="lastMenstrualPeriodID" value="<s:property value="lastMenstrualPeriod"/>" placeholder="dd-MM-yyyy">
		             	</div>
		             	<div class="col-md-3 col-xs-6">
			     ...
			     <div class="tab-pane fade" id="billing" >
			      <form class="form-horizontal form-label-left" id="genPhyBillID" onsubmit = "return checkCheckbox();" name="genPhyBillID" action="EditBill" method="POST" style="margin-top:20px;">
						...
						<div class="row" style="margin-top: 15px;">
	                      ...
	                      <div class="item form-group" style="margin-top:15px;">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-6">
	                          <input type="text" class="form-control"  name="charges" required="required" id="charges" value="<s:property value="netAmount"/>" onkeyup="changeTotalBill('totalBill',charges.value);" placeholder="Charges(Rs)">
	                        </div>
	                      </div>
						...
						<div id="cardDetailID" style="padding: 15px; display: none;">
							...
							<div class="row">
								<div class="col-md-2 col-xs-6">
									<font style="font-size: 16px;">Card Amount</font>
								</div>
								<div class="col-md-3">
									<input type="number" class="form-control" id="cardAmountID" value="<s:property value="cardAmount"/>" name="cardAmount" placeholder="Card Amount">
								</div>
								<div class="col-md-2 col-xs-6">
