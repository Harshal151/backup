...
<html lang="en">
  <head>
    ...
    <title>Edit Product List | E-Dhanvantari</title>
    ...
    <!-- Ends -->
     ...
     <script type="text/javascript">
    	function removeProductConsent(url){
			if(confirm("Are uou sure you want to delete this product?")){
				document.location = url;
			}
    	}
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                    ...
                    <div class="row">
                     <form action="SearchProduct" method="POST"  onsubmit="return showLoadingImg();">
                       <div class="col-md-4 col-sm-4 col-xs-6">
                         <input type="text" name="searchProductName" class="form-control" placeholder="Search Product" required="required">
                       </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <button type="submit" class="btn btn-success active"  style="width:100%;" >Search Product</button>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <a href="EditProductList"> <button type="button" class="btn btn-primary"  style="width:100%;" onclick="showLoadingImg();">View All Products</button></a>
                        </div>
                      </form>
                     </div>
                  ...
                  %>
		            ...
		            %> 
                      ...
                      <tbody>
                        <s:iterator value="productList" var="UserForm">
                        	<tr>
									...
									<td align="center"><s:url id="approveURL"
										action="RenderEditProduct">
										<s:param name="productID" value="%{productID}" />
									</s:url> <s:a href="%{approveURL}">
										<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
											onmouseout="this.src='images/user_1.png'" alt="Edit Product"
											title="Edit Product" />
									</s:a>
									<%
										if(form.getUserType().equals("accountant") || form.getUserType().equals("administrator")){
									%>
									&nbsp;<s:url id="approveURL1"
										action="DeleteProduct">
										<s:param name="productID" value="%{productID}" />
									</s:url> <s:a href="javascript:removeProductConsent('%{approveURL1}')">
										<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
											onmouseout="this.src='images/delete_icon_1.png'" alt="Remove Product"
