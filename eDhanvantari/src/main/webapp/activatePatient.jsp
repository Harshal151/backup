...
<html lang="en">
  <head>
    ...
    <!-- Ends -->
     ...
     <title>Activate Patient | E-Dhanvantari</title>
  ...
  <div id="visitTypeModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                    ...
                    <div class="col-md-12">
                     <form action="SearchInactivePatient" onsubmit="return showLoadingImg();" method="POST">
                       
                      	<div class="col-md-3 col-sm-3 col-xs-6">
                         <input type="text" name="searchPatientName" class="form-control" placeholder="Enter patient name / mobile no." required="required">
                       </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <s:select list="#{'PatientName':'Patient Name','MobileNo':'Mobile No.','RegNo':'Registration No.'}" class="form-control" name="searchCriteria"></s:select>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-3 col-xs-6 hidden-xs">
                          <a href="RenderViewInactivePatientList"> <button type="button" class="btn btn-primary" onclick="showLoadingImg();" style="width:100%;" >View All Patients</button></a>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6 hidden-sm hidden-md hidden-lg">
                          <button type="submit" class="btn btn-success active"  style="width:100%;margin-top:15px;" >Search Patient</button>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6 hidden-sm hidden-md hidden-lg">
                          <a href="RenderViewInactivePatientList"> <button type="button" class="btn btn-primary" onclick="showLoadingImg();" style="width:100%;margin-top:15px;" >View All Patients</button></a>
                        </div>
                        ...
                        <s:iterator value="searchPatientList" var="UserForm">
                        	<tr>
									...
									<s:url id="approveURL11"
										action="RenderActivatePatient">
										<s:param name="patientID" value="%{patientID}" />
									</s:url> <s:a href="javascript:disableUser('%{approveURL11}')">
										<img src="images/ok.png" style="height:20px;" onmouseover="this.src='images/ok1.png'"
											onmouseout="this.src='images/ok.png'" alt="Activate Patient"
