...
<title>Add Practice | E-Dhanvantari</title>
								...
								.click(
										function() {
											...
											if (clinicName == "") {
												...
												$('#workflowClinicID').val(
														clinicName);

												$('#workflowModalID').modal(
														'show');

												if (rowCheckCounter != 1) {

													$('#workflowTblID tr:gt(0)')
															.remove();
													...
													for (var i = 0; i < clinicNameArray.length; i++) {
														...
														var nameArray = clinicNameArray[i]
																.split("=");
														...
														clinicSelectTag += "<option value='"+value1+"'>"
																+ value1
																+ "</option>";
		...
		if (clinicName == "000") {
			...
			if (newWorkflowVal.includes(",")) {
				...
				for (var i = 0; i < workflowArray.length; i++) {
					...
					tag += "<tr style='font-size:14px;'>"
							+ "<td style='padding:5px;width:8%;'>" + srNo
							+ "</td>" + "<td style='padding:5px;width:23%;'>"
							+ workflowArrayq1[0] + "</td>"
							+ "<td style='padding:5px;width:23%;'>"
							+ workflowArrayq1[1] + "</td>"
							+ "<td style='padding:5px;width:23%;'>"
							+ workflowArrayq1[2] + "</td>"
							+ "<td style='padding:5px;width:23%;'>"
							+ workflowArrayq1[3] + "</td>" + "</tr>";
...
<script type="text/javascript">
	function viewWorkflowDetails(workflow) {
		...
		if (workflow.includes(",")) {
			...
			tag += "<tr style='font-size:14px;'>"
					+ "<td style='padding:5px;width:8%;'>" + srNo + "</td>"
					+ "<td style='padding:5px;width:23%;'>" + workflowArray[0]
					+ "</td>" + "<td style='padding:5px;width:23%;'>"
					+ workflowArray[1] + "</td>"
					+ "<td style='padding:5px;width:23%;'>" + workflowArray[2]
					+ "</td>" + "<td style='padding:5px;width:23%;'>"
					+ workflowArray[3] + "</td>" + "</tr>";
...
<script type="text/javascript">
	...
	var noOfVisit =  $("#noOfVisitID").val();
	var startDateID =  $("#datepicker1").val();
	var endDateID =  $("#datepicker2").val();
	console.log("noOfVisit"+noOfVisit+"  "+startDateID+"  "+endDateID);
		
	if(noOfVisit == null || noOfVisit =="" || startDateID == null || startDateID == "" || endDateID == null || endDateID ==""){
		...
		document.forms["addPract"].action = "AddPractice";
...
<script type="text/javascript">
	...
	function addNewRow() {
		...
		var trTag = "<tr id='"+trID+"'>"+
					"<td style='width: 35%;'><input type ='text' class='form-control' name='practiceClinicName' id='cNameID"+counter+"'></td>"+
					"<td style='width: 20%;'><input type ='text' class='form-control' name='practiceClinicSuffix' id='cSuffixID"+counter+"'></td>"+
					"<td style='width: 20%;'><input type ='text' class='form-control' name='clinicPhoneNoArray' id='cPhoneID"+counter+"'></td>"+
					"<td style='width: 20%; text-align: center;'><input class='form-control' name='mdSignatureImageArr' readonly='readonly' value='Active' id='statuID' placeholder='Status' type='text'></td>"+
					
					"<td id='aSettingID' style='text-align: center; width: 15%; font-weight: bold;'><a href='javascript:addSetting(\"" + dummyText + "\",\"cNameID" + counter + "\",\"cSuffixID" + counter + "\",\"cPhoneID" + counter + "\");'>Add Setting</a><input type='hidden' id='"+dummyText+"' name='dummySettingTextArr'></td>"+
					"<td id="+delImgTDID+" style='width: 20%; text-align: center;'><img src='images/delete.png' style='height:24px;cursor: pointer;' alt='Remove row' title='Remove row' onclick='removeTR(\""
					+ trID + "\",\"" + counter + "\");'/></td>" + "</tr>";
...
<script type="text/javascript" charset="UTF-8">
	...
	function verifyPracticeExists(practiceName) {
		...
		xmlhttp.open("GET",
				"VerifyPracticeExists?practiceName=" + practiceName, true);
		xmlhttp.send();
	}
</script>
...
<script type="text/javascript">
	...
	function addWorkflow(stepSeq, userRole, apptStatus, clinicName, OPDFormName) {
		...
		if (stepSeq == "" || userRole == "-1" || apptStatus == ""
				|| OPDFormName == "-1") {
			...
			if (workflowCheckCounter != 1) {
				...
				valueToAppend = "," + clinicName + "=" + stepSeq + "$"
						+ userRole + "$" + apptStatus + "$" + OPDFormName;

				workflowCheckCounter++;

			} else {

				valueToAppend = clinicName + "=" + stepSeq + "$" + userRole
						+ "$" + apptStatus + "$" + OPDFormName;
			...
			var nextTRTag = "<tr id='"+trID+"' style='font-size:14px;'>"
					...
					+ "<td><img src='images/delete.png' style='height:24px;cursor: pointer;' alt='Remove row' title='Remove row' onclick='removeWorkflowRow(\""
					+ valueToAppend + "\",\"" + trID + "\");'/></td>" + "</tr>";
...
function addCalendarSetting(clinicStartTime, clinicEndTime, breakStart1, breakEnd1, breakStart2, breakEnd2, workdays,patientForm,hiddenInput) {
	...
	function addCalendarSetting1(clinicStartTime, clinicEndTime, breakStart1, breakEnd1, breakStart2, breakEnd2, workdays, patientForm,hiddenInput) {
		...
		var calendarSettingVal = clinicStartTime + "$" + clinicEndTime + "$"
				+ breakStart1 + "$" + breakEnd1 + "$" + breakStart2 + "$"
				+ breakEnd2 + "$" + workdaysVals +"$" + pageSize + "$" + patientForm + "$"
				+ patientFormName;
...
<script type="text/javascript">
	function checkReviewForm(input, val) {
		...
		if ($("#smsReviewFormID").is(":checked")
				&& $("#emailReviewFormID").is(":checked")) {
...
<img src="images/Preloader_2.gif" alt="Loading Icon" class = "loadingImage" id="loader">
	...
	<div id="viewSettingModal" class="modal fade" tabindex="-1"
					...
					<div class="row" style="padding: 10px;">
						...
						<div class="row" style="margin-top: 15px;">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<font style="font-weight: bold;">Logo: </font><font
									id="logoFileID"></font>
							</div>
						</div>
						...
						<div class="row" style="margin-top: 15px;">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<font style="font-weight: bold;">Page Size: </font><font
									id="pageSizeID"></font>
							</div>
						</div>
						...
						<div class="row" style="margin-top: 15px;">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<font style="font-weight: bold;">Patient Form: </font><font
									id="pFormID"></font>
							</div>
						</div>
						...
						<div class="row" style="margin-top: 15px;">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<font style="font-weight: bold;">Letter Head Image: </font><font
									id="lHeadImageID"></font>
							</div>
						</div>

						<div class="row" style="margin-top: 15px;">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<font style="font-weight: bold;">Clinic Start: </font><font
									id="cStartID"></font>&nbsp;&nbsp; <font
									style="font-weight: bold;">Clinic End: </font><font id="cEndID"></font>
							</div>
						</div>

						<div class="row" style="margin-top: 15px;">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<font style="font-weight: bold;">Break Start1: </font><font
									id="b1StartID"></font>&nbsp;&nbsp; <font
									style="font-weight: bold;">Break End1: </font><font
									id="b1EndID"></font>
							</div>
						</div>
						...
						<div class="row" style="margin-top: 15px;">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<font style="font-weight: bold;">Break Start2: </font><font
									id="bStart2ID"></font>&nbsp;&nbsp; <font
									style="font-weight: bold;">Break End2: </font><font
									id="bEnd2ID"></font>
							</div>
						</div>
	...
	<div id="calendarSettingModal" class="modal fade" tabindex="-1"
		role="dialog" data-keyboard="false" data-backdrop="static">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<div class="modal-header" align="center" style="color: black;">
					<h4 class="modal-title" id="myModalLabel">ADD SETTING FOR
						CALENDAR</h4>
				</div>
					...
					<div class="row" style="padding: 5px;">
						...
						<div class="row" align="center" style="margin-top: 15px;">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="col-md-3 col-sm-3 col-xs-3">
									<s:select list="patientJSPList" name="patientForm"
										id="patientFormID" class="form-control" headerKey="-1"
										headerValue="Select Patient Form"></s:select>
								</div>
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="col-md-4 col-sm-4 col-xs-6">
									<div class="input-group date clinic_start col-md-12"
										...
										<input class="form-control" size="16" id="clinicStartID"
						...
						<div class="row" align="center" style="margin-top: 15px;">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="col-md-4 col-sm-4 col-xs-6">
									<div class="input-group date clinic_end col-md-12" data-date=""
										data-date-format="hh:ii" data-link-field="dtp_input3"
										data-link-format="hh:ii">
										<input class="form-control" size="16" id="clinicEndID"
											type="text" value="" readonly> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-time"></span></span>
									</div>
						...
						<div class="row" align="center" style="margin-top: 15px;">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="col-md-4 col-sm-4 col-xs-6">
									<div class="input-group date break1_start col-md-12"
										data-date="" data-date-format="hh:ii"
										data-link-field="dtp_input3" data-link-format="hh:ii">
										<input class="form-control" size="16" type="text"
											id="break1StartID" value="" readonly> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-time"></span></span>
									</div>
								</div>
						...
						<div class="row" align="center" style="margin-top: 15px;">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="col-md-4 col-sm-4 col-xs-6">
									<div class="input-group date break1_end col-md-12" data-date=""
										data-date-format="hh:ii" data-link-field="dtp_input3"
										data-link-format="hh:ii">
										<input class="form-control" size="16" id="break1EndID"
											type="text" value="" readonly> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-time"></span></span>
									</div>
						...
						<div class="row" align="center" style="margin-top: 15px;">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="col-md-4 col-sm-4 col-xs-6">
									<div class="input-group date break2_start col-md-12"
										data-date="" data-date-format="hh:ii"
										data-link-field="dtp_input3" data-link-format="hh:ii">
										<input class="form-control" size="16" type="text"
											id="break2StartID" value="" readonly> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-time"></span></span>
									</div>
								</div>
						...
						<div class="row" align="center" style="margin-top: 15px;">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="col-md-4 col-sm-4 col-xs-6">
									<div class="input-group date break2_end col-md-12" data-date=""
										data-date-format="hh:ii" data-link-field="dtp_input3"
										data-link-format="hh:ii">
										<input class="form-control" size="16" type="text" value=""
											id="break2EndID" readonly> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-time"></span></span>
									</div>
								</div>
						...
						<div class="row" align="center" style="margin-top: 15px;">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="col-md-3 col-sm-3 col-xs-6">
									<select id="workdaysID" name="" class="form-control"
										multiple="multiple">
				...
				<div class="modal-footer">
					<center>
						...
						<button type="button" class="btn btn-primary"
							onclick="addCalendarSetting(clinicStartID.value, clinicEndID.value, break1StartID.value, break1EndID.value, break2StartID.value, break2EndID.value, workdaysID.value, patientFormID.value, inputTextID.value);">Add</button>
					</center>
				</div>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form class="form-horizontal form-label-left" novalidate
										action="AddPractice" name="addPract" id="addPract" method="POST" style="margin-top: 20px;"
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="text" name="practiceSuffix"
													placeholder="Practice Suffix" required="required"
													class="form-control">
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="collapse" id="clinicSetting"
										...
										<div class="row">
											<div class="col-md-12 col-sm-12" style="margin-bottom: 15px;">
												<a
													style="text-decoration: underline; font-size: 14px; font-weight: bold; text-align: right; color: #23527c;"
													class="col-md-3 col-sm-3" data-toggle="collapse"
													href="#SMSSetting" aria-expanded="false"
													aria-controls="collapseExample"> SMS SETTINGS: </a>
											</div>

											<div class="collapse" id="SMSSetting"
												style="margin-top: 15px;">

												<!-- <div class="item form-group">
													<label class="control-label col-md-3 col-sm-3 col-xs-12"
														for="Consent Documents">SMS Username </label>
													<div class="col-md-6 col-sm-6 col-xs-12">
														<input type="text" name="smsUsername"
															placeholder="SMS Username" class="form-control">
													</div>
												</div>

												<div class="item form-group">
													<label class="control-label col-md-3 col-sm-3 col-xs-12"
														for="Session Timeout">SMS Password </label>
													<div class="col-md-6 col-sm-6 col-xs-10">
														<input type="password" name="smsPassword"
															class="form-control" placeholder="SMS Password">
													</div>
												</div>
 -->
												<div class="item form-group">
													<label class="control-label col-md-3 col-sm-3 col-xs-12"
														for="Invalid Attempts">SMS URL </label>
													<div class="col-md-6 col-sm-6 col-xs-10">
														<input type="url" name="smsURL" class="form-control"
															placeholder="SMS URL">
													</div>
												</div>
												...
												<div class="item form-group">
													<label class="control-label col-md-3 col-sm-3 col-xs-12"
														for="Invalid Attempts">SMS Sender ID </label>
													<div class="col-md-6 col-sm-6 col-xs-10">
														<input type="text" name="smsSenderID" class="form-control"
												...
												<div class="item form-group">
													<label class="control-label col-md-3 col-sm-3 col-xs-12"
														for="Invalid Attempts">SMS API Key</label>
													<div class="col-md-6 col-sm-6 col-xs-10">
														<input type="text" name="smsApiKey" class="form-control"
										...
										<div class="row">
											<div class="col-md-12 col-sm-12" style="margin-bottom: 15px;">
												<a
													...
													aria-controls="collapseExample"> COMMUNICATION SETTINGS: </a>
											</div>
													...
													<table id="datatable-responsive"
														...
														<tbody>
															...
															<tr>
																...
																<td style="text-align: center;"><input
																	type="checkbox" name="smsReviewForm"
																	id="smsReviewFormID"
																	onclick="checkReviewForm(this, 'SMS');" value="1"
																	style="zoom: 1.5;"></td>

																<td style="text-align: center;"><input
																	type="checkbox" name="emailReviewForm"
																	id="emailReviewFormID"
																	onclick="checkReviewForm(this, 'Email');" value="1"
																	style="zoom: 1.5;"></td>

															</tr>

															<tr id="reviewTRID" style="display: none;">
																<td style="font-size: 14px; text-align: center;">Review
																	Form Link</td>

																<td style="text-align: center;" colspan="2"><input
																	type="text" id="reviewFormID" name="reviewForm"
								...
								<!--  	<div class="row">
											...
											<div class="collapse" id="clinicWorklowSetting"
												style="margin-top: 15px; padding: 30px;">
												...
												<table id="datatable-responsive"
													...
													<tbody>
														...
														<tr id="compTRID">
															...
															<td><input class="form-control" name="clinicName1"
																id="clinicNameID" placeholder="Clinic Name" type="text"></td>

															<td><input class="form-control" name="clinicSuff1"
																id="clinicSuffixID" placeholder="Clinic Suffix"
																type="text"></td>

															<td><input class="form-control" name=""
																readonly="readonly" value="Active" id="statuID"
																placeholder="Status" type="text"></td>

															<td id="aSettingID" style="text-align: center; font-weight: bold;"><a
																href="javascript:addSetting();">Add Setting</a> <input
																type="hidden" id="dummySettingTextID"></td>

															<td><img src="images/addBill.png"
																style="height: 24px; margin-top: 5px; cursor: pointer;"
																onclick="addNewRow(clinicNameID.value, statuID.value,dummySettingTextID.value, clinicSuffixID.value);"
																onmouseover="this.src='images/addBill1.png'"
																onmouseout="this.src='images/addBill.png'"
																alt="Add Clinic" title="Add Clinic" /></td>
									...
									<!-- Plan Details table -->
										...
										<div class="row" style="margin-top: 15px; padding: 30px;">
											<table class="table table-striped table-bordered dt-responsive nowrap">
												<thead>
													...
													<tbody>
														...
														<s:iterator value="PlanDetailsList">
														<tr id="newplanTRID<s:property value="planDetailsID"/>">

															<td><s:property value="NoOfVisits"/></td>

															<td><s:property value="DateStart"/></td>

															<td><s:property value="DateEnd"/></td>
															
															<td><s:property value="planStatus"/></td>
														</tr>
													</s:iterator>
													</tbody>
											</table>
											...
											<div class="col-md-3" >
								            	<div>
													<s:select list="#{'100':'100','200':'200','500':'500','1000':'1000','2000':'2000','1000000':'Unlimited'}" class="form-control" name="NoOfVisits" id="noOfVisitID"></s:select>
													
												</div>
											</div>
				            
								            <div class="col-md-3">
								             	<input type="text" class="form-control" name ="DateStart" id="datepicker1" placeholder="Start Date" required="required">
								            </div>
								            
								            <div class="col-md-3">
								             	<input type="text" class="form-control" name ="DateEnd" id="datepicker2" placeholder="End Date" required="required">
								            </div>
								            
								            <div class="col-md-3">
								             	<input type="text" class="form-control" name ="planStatus" readonly="readonly" required="required" id="planStatusID">
								            </div>
										</div>
									<!-- End -->
										...
										<div class="col-md-12 col-sm-12">
											...
											<div class="col-md-1" align="left">
													<img src="images/addBill.png"
																style="height: 30px; margin-left:15px; cursor: pointer;"
																onclick="addNewRow();"
																onmouseover="this.src='images/addBill1.png'"
																onmouseout="this.src='images/addBill.png'"
																alt="Add Clinic" title="Add Clinic" />
												...
												<table class="table table-striped table-bordered dt-responsive nowrap">
													<thead>
														<tr>
															...
															<!-- <th style="text-align: center;">Logo File</th>
															<th style="text-align: center;">LetterHead Image</th> -->
															<th style="text-align: center;">Settings</th>
													...
													<tbody>
														...
														<s:iterator value="ClinicSettingList">
														<tr id="newcompTRID<s:property value="clinicSettingID"/>">

															<td><s:property value="clinicSettingName"/></td>

															<td><s:property value="clinicSettingSiffix"/></td>
															
															<td><s:property value="clinicPhoneNo"/></td>

															<td><s:property value="clinicSettingStatus"/></td>
															
															<td id="aSettingID" style="text-align: center; font-weight: bold;"><a
																href="javascript:addSetting();">Add Setting</a> 
																<input type="hidden" id="dummySettingTextID" name=dummySettingTextArr ></td>
							...
							<div class="form-group">
											<div class="col-md-12 col-xs-12" align="center">
												...
												<button id="practiceSubmitID" type="button"
													class="btn btn-success " disabled="disabled" onclick="CheckEmptyField();">Add Practice</button>
											</div>
										</div>
									</form>
								</div>
