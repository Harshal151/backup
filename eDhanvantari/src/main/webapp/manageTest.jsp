...
<html lang="en">
  <head>
    ...
    <title>Configure Test | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchTest" method="POST" onsubmit="return showLoadingImg();">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search Test" name="searchTest">
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active">Search Test</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllTests"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Tests</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="configureTestList" var="UserForm">
		                        	<tr>
										<td><s:property value="test" /></td>
											
										<td><s:property value="rate" /></td>
												 
										<td><s:property value="panel" /></td>
											
										<td><s:property value="normalValues" /></td>
											
										<td><s:property value="groupName" /></td>
										
										<td align="center"><s:url id="approveURL"
												action="RenderEditTest">
												<s:param name="testID" value="%{testID}" />
												...
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Test"
													title="Edit Test" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
										</td>
									</tr>
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="ConfigureTest" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Test">Test<span class="required">*</span></label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="test" required="required" placeholder="Test" class="form-control">
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Rate">Rate</label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Panel">Panel</label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="panel" placeholder="Panel" class="form-control">
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="NormalValues">Normal Values</label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="normalValues" placeholder="Normal Values" class="form-control">
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="GroupName">Group Name</label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditConfigureTests" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
						  
						   <s:iterator value="TestEditList" var="concessionForm">
						  
						  <input type="hidden" name="testID" value="<s:property value="testID" />" >
						  <input type="hidden" name="searchTest" value="<s:property value="searchTest" />" >
						  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Test">Test <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="test" required="required" value="<s:property value="test" />" placeholder="Test" class="form-control">
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Rate">Rate
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="rate" value="<s:property value="rate" />" placeholder="ICD10 Code" class="form-control">
	                        </div>
	                      </div>
						  ...
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Panel">Panel</label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="panel" value="<s:property value="panel" />" placeholder="Panel" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="NormalValues">Normal Values</label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="normalValues" value="<s:property value="normalValues" />" placeholder="Normal Values" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="GroupName">Group Name</label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="groupName" value="<s:property value="groupName" />" placeholder="Group Name" class="form-control">
	                        </div>
	                      </div>
