  ...
  <head>
	...
	<script type="text/javascript">
		function printVisit(){
			...
			document.forms["visitrForm"].action = "PrintIPDGeneralClinicEditVisit";
...
<!-- Add more file function for lab report -->
    ...
    <%
	    ...
	    ValueMap.put("clinician","IPD Visit,Billing,Report,Medical Certificate,Referral Letter");
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
			     ...
			     <div class="tab-pane fade in active" id="visit">
				    <form class="form-horizontal form-label-left" novalidate action="EditIPDGeneralClinicVisit" onsubmit="return showLoadingImg();" name="visitrForm" id="visitrForm" method="POST" style="margin-top:20px;">
	            	...
	            	<div class="row" style="padding-top: 20px;">
		             	<div class="col-md-3 col-xs-6">
		             	 	<label for="User Type" style="font-size: 15px; padding-left: 10px; ">Doctor's Orders</label>
		             	</div>
		             	<div class="col-md-6">
		             	 	<s:textarea name="advice" class="form-control" placeholder="Advice"></s:textarea>
		             	</div>
		            </div>
		            
		            <div class="row" style="padding-top: 20px;">
		             	<div class="col-md-3 col-xs-6">
		             	 	<label for="User Type" style="font-size: 15px; padding-left: 10px; ">Treatment</label>
		             	</div>
		             	<div class="col-md-6">
		             	 	<s:textarea name="treatmentTypeName" class="form-control" placeholder="Treatment"></s:textarea>
		             	</div>
		            </div>
				    ...
				    <div class="row" style="margin-top:100px;"> 
				      ...
				      <div class="ln_solid"></div>
		                     ...
		                     <div class="form-group">
	                          ...
	                          <button type="submit" class="btn btn-success" id="savePrescID">Save</button>
			                 	<button class="btn btn-warning" type="button" id="PrintPrescID" onclick="printVisit();">Print</button>
						...
						<div class="row" style="margin-top: 15px;">
	                      ...
	                      <div class="item form-group" style="margin-top:15px;">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-6">
	                          <input type="text" class="form-control"  name="charges" id="charges" value="<s:property value="totalAmount"/>" required="required" onkeyup="changeTotalBill('totalBill',charges.value);" placeholder="Charges(Rs)">
	                        </div>
	                      </div>
	                      ...
	                      <%-- <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-6">
	                          <input type="number" class="form-control" name="advPayment" id="advPaymentID" value = "<s:property value="advPayment"/>" required="required" onkeyup="changeBalancePayment(advPaymentID.value, totalBill.value);">
	                        </div>
	                      </div>
