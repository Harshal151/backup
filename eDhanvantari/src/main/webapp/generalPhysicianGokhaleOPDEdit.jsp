...
<html lang="en">
  <head>
    ...
    LoginForm form = (LoginForm) session.getAttribute("USER");
		...
		// Retrieving charges from the JSON File
    ...
    <script type="text/javascript" charset="UTF-8">
		...
		function addOPDPrescription(drugName, category, frequency1, visitID, comment, noOfPills,noOfDays){
			if(drugName == null || drugName.trim() === ''){
				...
				addOPDPrescription1(drugName, category, frequency1, visitID, comment, noOfPills,noOfDays)
			}
...
<!-- Ends -->
    ...
    <script type="text/javascript" charset="UTF-8">
    	...
    	function setDiagnosisRate(diagnosis){
    		if(diagnosis == "-1"){
    			$("#diagnosisRateID").val("")
    			$("#hiddenDiagnosisID").val("")
    		}else{
    			$("#diagnosisRateID").val(diagnosis)
    			$("#hiddenDiagnosisID").val($("#cancerType option:selected").text().trim())
    	
    		}
    	}
    
    	var diagnosisCounter = 1;
    	function addDiagnosisRow(diagnosis, rate, diagnosisText){
			...
			if(diagnosis == "-1"){
				...
				var divID = "newDiagnosisDivID"+diagnosisCounter
				
				var diagnosisDiv = "<div class='col-md-12 col-sm-12 col-xs-12' style='margin-top: 20px;' id='"+divID+"'><div class='col-md-4 col-sm-4 col-xs-4' style='text-align: center;'><input type='text' readonly='readonly' class='form-control diagnosisClass' value='"+diagnosis+"'></div>"
								  +"<div class='col-md-4 col-sm-4 col-xs-4'><img src='images/delete.png' alt='Remove Diagnosis' title='Remove Diagnosis' style='padding-left:5px;height: 20px;' onclick='removeDiagnosisDiv(\""+divID+"\");' /></div></div>";
								  
				diagnosisCounter++;		
				$("#diagnosisDivID").append(diagnosisDiv)
				
				$("#cancerType").val('-1').trigger('change')
				/* $("#diagnosisRateID").val("")
    			$("#hiddenDiagnosisID").val("") */
				
				// Creating diagnosis json
				var diagnosisJSON = {};
				
				var diagnosisArray = [];
				
 				var iterationIndex = 0;
				$(".diagnosisClass").each(function(){
					var diagnosis = $(this).val();
					//var rate = $(".diagnosisRateClass").eq(iterationIndex).val();
					diagnosisJSON.diagnosis = diagnosis;
					//diagnosisJSON.rate = rate;
					//diagnosisJSON = diagnosisJSON
					diagnosisArray.push({...diagnosisJSON});
					iterationIndex++;
				});
				
				//console.log(diagnosisArray)
				
				$("#hiddenCancerTypeID").val(JSON.stringify(diagnosisArray))
				
			}
    	}
		
		
		function removeDiagnosisDiv(divID){
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
			     ...
			     <div class="tab-pane fade in active" id="visit">
				    ...
				    <input type="hidden" name="patientID" id="patientID" value="<s:property value="patientID"/>">
			         ...
			         <input type="hidden"  name="firstName" id="firstName" value="<s:property value="firstName"/>">
			          ...
			          <input type="hidden" name="cancerType" id="hiddenCancerTypeID" value="<s:property value="cancerType"/>">
	               ...
	               <div class="row" style="padding-top: 10px;">	
				      <div class="col-md-6 col-sm-6 col-xs-12">
				     	<div class="col-md-4"><label for="name" style="font-size: 15px; padding-left: 6px;">Date of visit:</label></div>
		               	<div class="col-md-4"><input type="text" class="form-control" readonly="readonly" name="visitDate" value="<s:property value="firstVisitDate"/>" /></div>
			          </div>      
	              </div>        
	             ...
	             <div class="row" >
				  	<div class="col-md-3"><label for="User Type" style="font-size: 15px; padding-left: 10px; padding-top: 15px;">Diagnosis*</label></div>
	             </div>
	             
	             <div class="item form-group" >
				  	<div class="col-md-12 col-sm-12 col-xs-12" style="padding-top: 20px;" id="diagnosisDivID">
	                        <div class="col-md-4 col-sm-4 col-xs-4"  style='padding-left: 20px;'><!-- <label for="" style="font-size: 15px; padding-left: 10px;">Diagnosis</label> -->
	                        	<s:select list="diagnoseList" headerKey="-1" headerValue="Select Diagnosis" name="" id="cancerType" class="form-control " style="border-radius: 5px;" required="required">
								</s:select>
								<!-- <input type="hidden" name="" id="hiddenDiagnosisID"> -->
	                        </div>
	                        <!-- <div class="col-md-4 col-sm-4 col-xs-4"><label for="" style="font-size: 15px; padding-left: 10px;">Diagnosis</label>
	                        	<input type="number" name="" id="diagnosisRateID" class="form-control " placeholder="Diagnosis Rate">
	                        </div> -->
	                        <div class="col-md-4 col-sm-4 col-xs-4" style='padding-left: 17px;'>
	                        	<a onclick="addDiagnosisRow(cancerType.value);" > 
								 				<img src="images/add_icon_1.png" onmouseover="this.src='images/add_icon_2.png'"
												onmouseout="this.src='images/add_icon_1.png'" alt="Add Diagnosis"
												title="Add Diagnosis" style="margin-top:5px;height: 20px;" />
								    		</a>
	                        </div>
	                        
	                 <s:iterator value="orthoDiagnosisList">
	                
	                	<div class="col-md-12 col-sm-12 col-xs-12" style="padding-top: 20px;" id="viewDiagnosisDivID<s:property value="diagnosisID"/>">
		                        <div class="col-md-4 col-sm-4 col-xs-4" style="text-align: center;">
		                        	<input type='text' readonly='readonly' class='form-control diagnosisClass' value='<s:property value="diagnosis"/>'>
		                        </div>
		                        <%-- <div class="col-md-4 col-sm-4 col-xs-4" style="text-align: center;">
		                        	<input type="number" name="" id="" readonly="readonly" class="form-control diagnosisRateClass" value='<s:property value="diagnosisRate"/>'>
		                        </div> --%>
		                        <div class="col-md-4 col-sm-4 col-xs-4">
		                        	<a onclick="removeDiagnosisDiv('viewDiagnosisDivID<s:property value="diagnosisID"/>');" > 
									 				<img src="images/delete.png" onmouseover="this.src='images/delete.png'"
													onmouseout="this.src='images/delete.png'" alt="Remove Diagnosis"
													title="Remove Diagnosis" style="padding-left:5px;height: 20px;" />
									    		</a>
		                        </div>
		                </div>
	                </s:iterator>
	             ...
	             <div class="row" >
		                       ...
		                       <div class="control-label col-md-10  col-sm-12 col-xs-12" style="padding-left:50px;">
						      	<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					                <thead>
					                 ...
					                 <tbody> 
					                 <tr>
					                 <td><input type="text" class="form-control" name="" id="symptomOID"  placeholder="symptom"></td>
					                 <td><input type="number" class="form-control" name="" id="presentDurationID"  placeholder="duration"></td>
					                 <td><input type="text" class="form-control" name="" id="presentCommentsID"  placeholder="comments"></td>
      			...
      			<div class="item form-group">
		               <div class="col-md-2 col-xs-6 col-sm-6"><label for="User Type" style="font-size: 15px; padding-left:5px; padding-top: 15px;">MHO(Medical History)</label></div>
		            	 </div> 
	             			<div class="item form-group">
		                      <div class="control-label col-md-10  col-sm-12 col-xs-12" style="padding-left:50px; margin-top:-1%;">
						      	<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					                <thead>
					                 ...
					                 <tbody> 
					                 <tr>
					                 <td><input type="text" class="form-control" name=""  id="MHOdiagnosisID"  placeholder="diagnosis"></td>
					                 <td><input type="text" class="form-control" name="" id="MHOdescriptionID"  placeholder="description"></td>
						 ...
						 <div class="item form-group">
		               		<div class="col-md-3 col-xs-6 col-sm-6"><label for="User Type" style="font-size: 15px; padding-left: 5px; padding-top: 15px;">On Examination</label></div>
		            	 </div> 
             			<div class="item form-group">
	                      <div class="control-label col-md-12  col-sm-12 col-xs-12" style="padding-left:50px; margin-top:-1%;">
						      	<s:textarea name="onExamination" class="form-control"></s:textarea>
					         </div>
						 </div> 
	             ...
	             <div class="item form-group" style="padding-top: 20px;">
		              <div class="col-md-3"><label for="User Type" style="font-size: 15px; padding-left: 10px; padding-top: 15px;">Current Medication</label></div>
		            	 </div> 
	             			<div class="item form-group">
		                       <div class="control-label col-md-10  col-sm-12 col-xs-12" style="padding-left:50px; margin-top:-1%;">
						      	<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
		                 ...
		                 <div class="col-md-10  col-sm-12 col-xs-8">
			                     <div class="col-xs-12 col-md-2 col-sm-2" style="margin-left:-7%;" >
			                        <label for="User Type" class="control-label" style="font-size: 15px;" >Weight</label>
			                        <input type="number"  class="form-control" name="weight" id="weightID" value="<s:property value="weight"/>"  placeholder="Weight (in kgs)">
			                     </div>
			                     
			                     <div class="col-xs-12 col-md-2 col-sm-2" style="margin-left:0%;" >
			                        <label for="User Type" class="control-label" style="font-size: 15px; margin-left:15px;" >Height</label>
			                        <input type="number"  class="form-control" name="height" id="heightID" value="<s:property value="height"/>"  placeholder="Height (in cms)">
			                     </div>
		                        
		                       <div class="col-xs-12 col-md-2 col-sm-2" style="margin-left:0%;">
			                       	<label for="User Type" class="control-label" style="font-size: 15px;" >Systolic-BP</label>
			                        <input class="form-control" id="systolicBPID" onkeyup="myFunction1('sysSpanID',this.value)" type="number" name="OEBPSys" value="<s:property value="OEBPSys"/>"  placeholder="Systolic _">
						        	<font style="color: red;" id = "sysSpanID"></font>
						        </div>
		                        
		                         <div class="col-xs-12 col-md-2 col-sm-2" style="margin-left:0%;">
		                          	<label for="User Type" class="control-label" style="font-size: 15px;">Diastolic-BP</label>
			                        <input class="form-control" id="diastolicBPID" onkeyup="myFunction1('diaSpanID',this.value)"type="number" name="OEBPDia" value="<s:property value="OEBPDia"/>"  placeholder="Diastolic_">
		                      		<font style="color: red;" id = "diaSpanID"></font>
								</div>
		                       
		                      <div class="col-xs-12 col-md-2 col-sm-2" style="margin-left:0%;">
		                       	  	<label for="User Type" class="control-label" style="font-size: 15px;">Pulse</label>
		                          	<input type="number" class="form-control" name="OEPulse" id="pulseID" onkeyup="myFunction1('diaSpanID',this.value)"  value="<s:property value="OEPulse"/>"  placeholder="Pulse">
	                      ...
	                      <div class="form-group" >
			                 ...
			                 <button id="send" type="button" class="btn btn-success " onclick="CheckDiagnosisField();" >Update Visit</button>
			   ...
			   <!-- Prescription div -->
			      <div class="tab-pane fade" id="presc" >
				      ...
				      <div class="row" style="margin-top:10px;margin-left:0px;margin-bottom:5px;">
						...
						<div class="row" style="margin-top:20px;">
					 		<div class="col-md-4 col-xs-12 col-sm-6" style="margin-left:15px;">
					 			<h4><b>Diagnosis: </b><%-- <s:property value="cancerType"/> --%>
					 				<ul style="margin-top: 5px;">
				 						<s:iterator value="orthoDiagnosisList">
				 							<li><s:property value="diagnosis"/></li>
				 						</s:iterator>
				 					</ul>
					 			</h4>
					 		</div>
				      ...
				      <div class="row" style="margin-top:10px;margin-left:0px;margin-bottom:5px;">
				       	...
				       	<h4 style="margin-top:20px;margin-left:15px;"><b>Prescription</b></h4>
					                            ...
					                            <thead>
													<tr>
					                                   <th style="width: 20%">Drug Name</th>
					                                    ...
					                                    <th style="width: 10%">Duration(Daily/Weekly/Monthly)</th>
				            ...
				            <div class="col-md-2 col-xs-7 col-sm-2">
				            	<s:select list="categoryList" name="category" style="margin-top:10px;"  id="category1" class="form-control" headerKey="" headerValue="Category"></s:select>
				            </div>
				            
				            <div class="col-md-2 col-xs-7 col-sm-2">
				            	<s:select list="frequencyList" name="frequency" style="margin-top:10px;" id="frequency1" onchange="getFreqCount(this.value)" class="form-control" headerKey="-1" headerValue="Frequency"></s:select>
				            </div>
				            
				            <div class="col-md-1 col-xs-7 col-sm-1">
				              <input type="number" class="form-control" style="margin-top:10px;" name="noOfDays" id="noOfDays" onkeyup="freqAutoCal()" placeholder="Duration(Daily/Weekly/Monthly)">
				              <input type="hidden" id="frequencyCountID">
				            </div>
				           ...
				           <div class="col-md-1">
							  ...
							  <a onclick="addOPDPrescription(tradeName.value, category1.value,frequency1.value,visitID.value,comment.value,noOfPills.value,noOfDays.value);" > 
							  	<img src="images/add_icon_1.png" onmouseover="this.src='images/add_icon_2.png'"
				    ...
				    <div class="row" style="margin-top:10px;margin-left:0px;margin-bottom:5px;">
					 	 <div class="form-horizontal form-label-left" novalidate id="genPhyInvestID" name="genPhyInvestID" action="AddNewInvestigation" method="POST" style="margin-top:20px;">
				      <h5 style="margin-top:20px;margin-left:15px;"><b>Investigation</b></h5>
						...
						<div class="row" style="margin-top: 15px;">
	                      ...
	                      <%-- <div class="item form-group" style="margin-top:15px;">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-6">
	                          <input type="text" class="form-control"  name="charges" id="charges" value="<s:property value="totalAmount"/>" onkeyup="changeTotalBill('totalBill',charges.value);" placeholder="Charges(Rs)">
	                        </div>
	                      </div> --%>
	                      
	                      <div class="row col-md-12 col-lg-12 col-sm-12" style="margin-top: 15px;">
							<table id="billingItemTableID" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
								<thead>
									<tr>
										...
										<th style="width: 30%; text-align: center;">Rate (Rs.)</th>
									</tr>
								</thead>
								<tbody>
									...
									<tr id="billingItemTRID">
										<td>
											<select id="billItemChargesID" class="form-control" style="width: 100%" onchange="setChargesRate(this.value)">
												<option value="">Select Charges</option>
												<%
													for (Object jsonData : diagnosisJSON) {
														JSONObject data = (JSONObject) jsonData;
												%>
													<option value="<%=data.get("rate") %>"><%=data.get("chargeType") %></option>
												<%	
													}
												%>
											</select>
									...
									<s:iterator value="orthoBillItemList" var="form">
										<tr id="editBillItemTRID<s:property value="receiptItemID"/>">
											...
											<td style="text-align: center;">
												<a onclick="removeBillTR('editBillItemTRID<s:property value="receiptItemID"/>');" > 
									 				<img src="images/delete.png" onmouseover="this.src='images/delete.png'"
									...
									<tr>
										...
										<td style="text-align: center;">
											<input type="number" class="form-control" name="totalBill" id="totalBill" value="<s:property value="netAmount"/>" readonly="readonly" placeholder="Total Bill(Rs)">
										</td>
									</tr>
				       ...
				       <input type="hidden"  name="lastName" id="lastName" value="<s:property value="lastName"/>">
					    ...
					    <input type="hidden" id="doctrName" value="<%=fullName %>">
						    ...
						    %>
								...
								<div class="col-md-12 col-xs-12" id= "medicalCertiTextDivID" style="margin:25px;display: none;">
							    ...
							    %>
								<div class="col-md-12 col-xs-12" id= "medicalCertiTextDivID" style="margin:25px;">
			            ...
			            <div class="form-group">
			               <div class="col-md-12 col-xs-12" align="center">
	                          ...
	                          %>
	                         	<button class="btn btn-success" type="submit" onclick="displayVal();" >Update & Print</button>
	                          <%
					        	}else{
			                 %>
			                 <button class="btn btn-success" type="submit" onclick="displayVal();" >Update & Print</button>
			            ...
			            <div class="form-group">
			               <div class="col-md-12 col-xs-12" align="center">
			                   ...
			                   <%
	                          	if(lastEneteredVisitList.equals("success")){
	                          %>
	                         	<button class="btn btn-success" type="submit" onclick="displayRefLet();">Update & Print</button>
	                          <%
					        	}else{
			                 %>
			                 <button class="btn btn-success" type="submit" onclick="displayRefLet();" >Update & Print</button>
