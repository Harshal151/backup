...
<html lang="en">
  <head>
    ...
    <title>Edit Visit | E-Dhanvantari</title>
  ...
  <script type="text/javascript">
		...
		function checkCheckbox() {
			...
			if(checkboxLength>0){
				...
				document.forms["genPhyBillID"].action = "EditIPDBill";;
...
<!-- Ends -->
	...
	<script type="text/javascript">
		...
		function retrieveOTChargeDisbursementDetails(otChargeID, otRateID, otChargeID){
			
			$('#viewOtChargeDisbursementTbodyID tr:gt(0)').remove();
			
			$('#editOtChargeDisbursementTbodyID1 tr:gt(0)').remove();
			
			$("#editRateID").val(otRateID);
			
			$("#hiddenOtChargeID").val(otChargeID);
			...
			xmlhttp.onreadystatechange = function() {
				if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
					...
					for ( var i = 0; i < array.Release.length; i++) {
						...
						var TRID = "editChargeDisbrsmntTRID"+array.Release[i].disbursementID;
						
						var newRateID = "editOTCDRateID"+array.Release[i].disbursementID;

						TRTag += "<tr style='font-size: 14px;' id='"+TRID+"'>"
								+"<td><input type='text' class='form-control' name='editChargeType1' value='"+array.Release[i].chargeType+"'></td>"
								+"<td><input type='number' class='form-control' id='"+newRateID+"' name='editChargeRate1' value='"+array.Release[i].charges+"'><input type='hidden' name='editChargeID' value='"+array.Release[i].disbursementID+"'></td>"
								+"<td style='text-align:center'><img src='images/delete.png' style='height:24px;cursor: pointer;' alt='Remove row' title='Remove row' onclick='removeEditOTCDTR(\""+array.Release[i].disbursementID+"\",\""+array.Release[i].patientID+"\",\"OTChargesDisbursement\",\""+TRID+"\",\""+otRateID+"\",\""+newRateID+"\");'/></td>"
								+"</tr>";
  ...
  <div id="viewChargeDisbursementModalID" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-header" align="center" style="color:black;">
         ...
         <div class="row">
         	<table id="" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					               <thead>
					                ...
					                <tr>   
					                        <td id="">
					                        	<input type="text" class="form-control" id="editdsbrnmntChargeTypeID" placeholder="Charge type">
					                        	<input type="hidden" id="editRateID">
					                        	<input type="hidden" id="hiddenOtChargeID">
					                        </td> 	
					                        <td>
					                        	<input type="number" class="form-control" id="editdsbrnmntChargeID" placeholder="Charges">
					                        	
					                        </td>
					                        <td style="text-align: center;">
					                        	<a href="javascript:void(0)" id="editotChargeDsbrmntImgaID"> 
												  	<img src="images/add_icon_1.png" onmouseover="this.src='images/add_icon_2.png'" onmouseout="this.src='images/add_icon_1.png'" 
												  		alt="Add Charge" title="Add Charge" style="margin-top:5px;height: 24px;" />
												  </a>
					                        </td>
					                ...
					                <tbody id="editOtChargeDisbursementTbodyID1" style="font-size: 14px;">
					                 	<tr id="editOtChargeDisbursementTRID1">
					                    </tr>
					                 </tbody>
        ...
        <center>
          <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-success" id="updateDisbursementBtnID">Update</button>
        </center>
        </div>
...
S3ObjectInputStream s3ObjectInputStream = s3.getObject(new GetObjectRequest(bucketName + "/" + s3reportFilePath, daoInf.retrieveProfilePic(form.getUserID()))).getObjectContent();
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
				 ...
				 <div id="myTabContent1" class="tab-content">
				 	...
				 	<!-- Visit div -->
			    <div class="tab-pane fade in" id="visit">
				    <form class="form-horizontal form-label-left" action="EditGeneralHospitalIPDVisit" onsubmit="return showLoadingImg();"  name="visitrForm" id="visitrForm" method="POST" style="margin-top:20px;">
			          ...
			          <input type="hidden" name="startDate" value="<%=systemStartDate%>">
	                      ...
	                      <div class="row" style="margin-top:15px;">
							...
							<div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-2">
						    		<select name="roomTypeID" class="form-control" readonly="readonly" required="required" id="roomTypeID">
						    	...
						    	<table id="" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					               <thead>
					                ...
					                <tbody>
					                 ...
					                 <tbody id="tariffTbodyID" style="font-size: 14px;">
					                 	<tr id="tariffTRID">
					                    </tr>
					                 </tbody>
					                 <tbody>
					                 	<s:iterator value="IPDTariffChargeList">
					                 		<tr id="editIPDTariffTRID<s:property value="IPDChargeID"/>" style="font-size: 14px;">
					                 			<td><input type="text" readonly="readonly" name="editChargeName" class="form-control" value="<s:property value="IPDChargeName"/>">
					                 				<input type="hidden" name="editChargeID" value="<s:property value="IPDChargeID"/>">
					                 				<input type="hidden" name="editChargeType" value="<s:property value="IPDChargeType"/>">
					                 			</td>
					                 			<td><input type="number" name="editChargeRate" id="editTariffRateID<s:property value="IPDChargeID"/>" class="form-control" onkeyup="calculateAmount(this.value,editTariffQntyID<s:property value="IPDChargeID"/>.value,'editTariffAmtID<s:property value="IPDChargeID"/>');" value="<s:property value="IPDRate"/>"></td>
					                 			<td><input type="number" name="editChargeQuantity" id="editTariffQntyID<s:property value="IPDChargeID"/>" class="form-control" onkeyup="calculateAmount(editTariffRateID<s:property value="IPDChargeID"/>.value,this.value,'editTariffAmtID<s:property value="IPDChargeID"/>');" value="<s:property value="IPDQuantity"/>"></td>
					                 			<td><input type="number" name="editChargeAmount" id="editTariffAmtID<s:property value="IPDChargeID"/>" readonly="readonly" class="form-control" value="<s:property value="IPDAmount"/>"></td>
					                 			<td style="text-align: center;"><img src="images/delete.png" style="height:24px;cursor: pointer;" alt="Remove row" title="Remove row" onclick="removeEditTR('<s:property value="IPDChargeID"/>','<s:property value="patientID"/>','IPDCharges','editIPDTariffTRID<s:property value="IPDChargeID"/>');"/></td>
					                 		</tr>
					                 	</s:iterator>
					                 </tbody>
					            </table>
					                ...
					                <tbody>
					                 ...
					                 <tbody>
					                 	<s:iterator value="IPDConsultantChargeList">
					                 		<tr id="editIPDConsultantTRID<s:property value="IPDChargeID"/>" style="font-size: 14px;">
					                 			<td><input type="text" readonly="readonly" name="editChargeName" class="form-control" value="<s:property value="IPDChargeName"/>">
					                 				<input type="hidden" name="editChargeID" value="<s:property value="IPDChargeID"/>">
					                 				<input type="hidden" name="editChargeType" value="<s:property value="IPDChargeType"/>">
					                 			</td>
					                 			<td><input type="number" name="editChargeRate" id="editConsultantRateID<s:property value="IPDChargeID"/>" class="form-control" onkeyup="calculateAmount(this.value,editConsultantQntyID<s:property value="IPDChargeID"/>.value,'editConsultantAmtID<s:property value="IPDChargeID"/>');" value="<s:property value="IPDRate"/>"></td>
					                 			<td><input type="number" name="editChargeQuantity" id="editConsultantQntyID<s:property value="IPDChargeID"/>" class="form-control" onkeyup="calculateAmount(editConsultantRateID<s:property value="IPDChargeID"/>.value,this.value,'editConsultantAmtID<s:property value="IPDChargeID"/>');" value="<s:property value="IPDQuantity"/>"></td>
					                 			<td><input type="number" name="editChargeAmount" id="editConsultantAmtID<s:property value="IPDChargeID"/>" readonly="readonly" class="form-control" value="<s:property value="IPDAmount"/>"></td>
					                 			<td style="text-align: center;"><img src="images/delete.png" style="height:24px;cursor: pointer;" alt="Remove row" title="Remove row" onclick="removeEditTR('<s:property value="IPDChargeID"/>','<s:property value="patientID"/>','IPDCharges','editIPDConsultantTRID<s:property value="IPDChargeID"/>');"/></td>
					                 		</tr>
					                 	</s:iterator>
					                 </tbody>
					            </table>
					                ...
					                <tbody>
					                 ...
					                 <tbody>
					                 	<s:iterator value="OTChargeList">
					                 		<tr id="editOTChargeTRID<s:property value="otChargeID"/>" style="font-size: 14px;">
					                 			<td><input type="text" class="form-control" name="editOperation" value="<s:property value="operationName"/>">
					                 				<input type="hidden" name="editOTChargeID" value="<s:property value="otChargeID"/>">
					                 			</td>
					                 			<td><input type="text" class="form-control otDateTimeClass" name="editOtDateTimeArr" value="<s:property value="otDateTime"/>"></td>
					                 			<td><input type="text" class="form-control" name="editConsultant" value="<s:property value="consultantName"/>"></td>
					                 			<td><input type="text" class="form-control" name="editAnaesthetist" value="<s:property value="anaesthetistName"/>"></td>
					                 			<td><input type="text" class="form-control" name="editOTAssistant" value="<s:property value="OTAssistantName"/>"></td>
					                 			<td><input type="number" class="form-control" name="editOTRate" id="editOTCRateID<s:property value="otChargeID"/>" readonly="readonly" value="<s:property value="rate"/>"></td>
					                 			<td style="text-align: center;"><a href="javascript:retrieveOTChargeDisbursementDetails(<s:property value="otChargeID"/>,'editOTCRateID<s:property value="otChargeID"/>','<s:property value="otChargeID"/>');">Edit Details</a></td>
					                 			<td style="text-align: center;"><img src="images/delete.png" style="height:24px;cursor: pointer;" alt="Remove row" title="Remove row" onclick="removeEditTR('<s:property value="IPDChargeID"/>','<s:property value="patientID"/>','OTCharges','editOTChargeTRID<s:property value="otChargeID"/>');"/></td>
					                 		</tr>
					                 	</s:iterator>
					                 </tbody>
					            </table>
	                      ...
	                      <div class="form-group">
	                        <div class="col-md-12 col-xs-12" align="center">
	                          ...
	                          <button type="submit" class="btn btn-success" id="VisitSubmitID"  >Update Visit</button>
	                        </div>
	                      </div>
			    ...
			    <!-- Billing div -->
			     <div class="tab-pane fade" id="billing" >
					...
					<form class="form-horizontal form-label-left" id="genPhyBillID" name="genPhyBillID" action="EditIPDBill" onsubmit="return checkCheckbox();" method="POST" style="margin-top:20px;">
							...
							<tbody>	
			                  ...
			                  <tbody>
								...
								<tr>
									...
									<td>
										<input type="number" class="form-control" onkeyup="changeNetAmtByDiscount(this.value,totalAmountID.value, emergencyChargesID.value, advPaymentID.value, mlcChargesID.value);" value = "<s:property value="totalDiscount"/>" name="totalDiscount" id="totalVatID">
									</td>
								</tr>
								<tr>
									<td colspan="4" align="right" style="padding-top: 15px;">
								...
								<%-- <tr>
									...
									<td>
										<input type="number" class="form-control" name="advPayment" id="advPaymentID" required="required" value = "<s:property value="advPayment"/>" onkeyup="changeBalancePayment(advPaymentID.value, netAmountID.value);">
									</td>
								</tr>
								<tr>
									<td colspan="4" align="right" style="padding-top: 15px;">
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function(){
    		...
    		/* $("#tariffItemID").on('change',function(){
...
$("#otChargeDImgaID").on('click',function(){
    		...
    		var disbursementCounter = 1;
    		
			$("#editotChargeDsbrmntImgaID").on('click',function(){
    			
    			var dChargeType = $("#editdsbrnmntChargeTypeID").val();
    			var dCharge = $("#editdsbrnmntChargeID").val();
    			...
    			if(dChargeType == ""){
    				...
    				var TRID = "editDisbursementTRID"+disbursementCounter;
    				
    				var trTag = "<tr style='font-size: 14px;' id='"+TRID+"'>"
    						   +"<td style='text-align:center;'><input type='text' class='form-control ' name='chargeType1' value='"+dChargeType+"'></td>"
    						   +"<td ><input type='number' class='form-control ' name='chargeRate1' id='"+disbursementCounter+"'  value='"+dCharge+"'></td>"
    						   +"<td style='text-align:center'><img src='images/delete.png' style='height:24px;cursor: pointer;' alt='Remove row' title='Remove row' onclick='removeTR(\""+TRID+"\");'/></td>"
    						   +"</tr>";
    						   
    				$(trTag).insertAfter($("#editOtChargeDisbursementTRID1"));
    				
    				disbursementCounter++;
    				
    				$("#editdsbrnmntChargeTypeID").val("");
    				$("#editdsbrnmntChargeID").val("");    				
    			}
			...
			$("#updateDisbursementBtnID").on("click",function(){
    			
    			var OTCharge = 0;
    			
    			var i = 0;
    			
    			var editRateID = $("#editRateID").val();
    			
    			var otChargeID = $("#hiddenOtChargeID").val();
    			
    			var queryString = "otChargeID="+otChargeID;
    			
    			$("input[name=editChargeRate1]").each(function(){
    				
    				var chargeType = $($("input[name=editChargeType1]").get(i)).val();
    				
    				var chargeID = $($("input[name=editChargeID]").get(i)).val();
    				
    				var charge = $(this).val();
    				
    				OTCharge = parseFloat(parseFloat(OTCharge) + parseFloat(charge));
    				
    				queryString += "&editChargeRate="+charge+"&editChargeType="+chargeType+"&editChargeID="+chargeID;
				...
				$("input[name=chargeRate1]").each(function(){
    				
    				var chargeType = $($("input[name=chargeType1]").get(i)).val();
    				
    				var charge = $(this).val();
    				
    				OTCharge = parseFloat(parseFloat(OTCharge) + parseFloat(charge));
    				
    				queryString += "&chargeRate="+charge+"&chargeType="+chargeType;
    				
    				i++;
    				
    			});
    			
    			$("#"+editRateID).val(OTCharge);
    			
    			if(queryString.startsWith("&")){
    				queryString = queryString.substr(1);
    			}
    			
    			editOTChargesDisbursement(queryString);
    	...
    	function editOTChargesDisbursement(queryString){
    		xmlhttp.onreadystatechange = function() {
				if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
					...
					for ( var i = 0; i < array.Release.length; i++) {
						...
						check = array.Release[i].message;
	
					}
					
					/* if(check == "success"){
						alert("Disbursement details updated succewsfully.");
					}else{
						alert("Failed to update disbursement details. Please check server logs for more details.");	
					} */
					
					$("#viewChargeDisbursementModalID").modal("hide");
					
				}
			};
			xmlhttp.open("POST", "UpdateChargesDisbursement?"+ queryString, true);
			xmlhttp.send();
    	}
    	...
    	function removeEditTR(deleteID, patientID, tableName, trID){
    		...
    		if(confirm("Are you sure you want to delete this row?")){
    			$.ajax({
                    ...
                    success : function(jsonResponse) {
                    	alert(jsonResponse);
                    	if(jsonResponse == "NA"){
                    		alert("Unable to delete this row as bill has already been generated for this visit.");
                    	}else if(jsonResponse == "success"){
                    		$("#"+trID).remove();
                    		alert("Row deleted successfully.");
                    	}else{
                    		alert("Failed to delete the row. Please check server logs for more details.");
                    	}
                    },
                    error: function(errorMsg){
                    	alert("ERROR: "+errorMsg);
		...
		function removeEditOTCDTR(deleteID, patientID, tableName, trID, OTRateID, disbursementRateID){
    		
			var OTRate = $("#"+OTRateID).val();
			
			var disbursementRate = $("#"+disbursementRateID).val();
    		...
    		if(confirm("Are you sure you want to delete this row?")){
    			...
    			$.ajax({
                    ...
                    success : function(jsonResponse) {
                    	...
                    	var finalOTRate = parseFloat(parseFloat(OTRate) - parseFloat(disbursementRate));
                    	
                    	if(jsonResponse == "NA"){
                    		alert("Unable to delete this row as bill has already been generated for this visit.");
                    	}else if(jsonResponse == "success"){
                    		$("#"+trID).remove();
                    		$("#"+OTRateID).val(finalOTRate);
