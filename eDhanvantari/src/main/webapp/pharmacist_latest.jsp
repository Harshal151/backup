...
<!-- Ends -->
<script>
function changeTotalBill(rate, totalBillId, quantity) {
...
function showPharmaModal(visitID){
	...
	xmlhttp.onreadystatechange = function() {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			for ( var i = 0; i < array.Release.length; i++) {
				...
				var totalBillId = "totalBill" + counterRow;
	            ...
	            trTag += "<tr id=" + trID + " style='font-size:14px;'>" +
	                    ...
	                    "<td>" + drugName + "</td>" +
	                    "<td><input id='quantityInput'  type='number' name='quantity' class='form-control' style='width: 50%;' onkeyup='changeTotalBill("+rate+", "+totalBillId+",  this.value);'></td>" +
	                    "<td>" + rate + "</td>" +
	                    "<td><input class='billingRateClass form-control' id=" + totalBillId + " type = 'number' readonly='readonly'></input></td>" +
	                    "</tr>";
...
<tr>
             <td  colspan="7" align="right" style="font-size: 14px;padding-top:15px;">Subtotal</td>
              <td><input class='form-control' id="totalbillID" type = 'number' readonly='readonly'></input></td>
</tr>
...
<tr>
              ...
              <td colspan="5">
              <input  class="form-control" name="discountOnTotal" id="discountOnTotal" placeholder="% Discount" onkeyup="totalPriceAfterDiscount(totalbillID.value, discountOnTotal.value)" type="number">
              </td>
...
<tr>
             ...
             <td><input class='form-control' id="finalBill" type = 'number' readonly='readonly'></input></td>
             </td>
</tr>
</table>
				...
				<div class="">
					...
					<div class="row">
				  	...
				  	<form action="SearchPharmaPatients" method="POST" onsubmit="return showLoadingImg();" >								
   				     ...
   				     <div class="col-md-2 col-sm-3 col-xs-6 hidden-xs">
   	  			       <a href="pharmacist.jsp"><button type="submit" class="btn btn-primary active" style="width: 100%; margin-left: -10px;">Today's Prescription</button></a>
   				     </div>
   				     </form>
       				   </div>
										...
										<tbody>
											<s:iterator value="searchPatientList" var="UserForm">
												<tr>
													...
													<td align="center"> 
															<img src="images/visit_view_1.png" onclick="showPharmaModal(<s:property value="visitID" />)" style="height: 24px"
