	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditTemplate" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;"> 
						  ...
						  <div class="item form-group">
	                       <div class="col-md-2 col-sm-2 col-xs-12">
		                        <label class="control-label	" for="Report">Report Type <span class="required">*</span>
		                        </label>
	                        </div>
	                      ...
	                      <div class="item form-group">
	                      <div class="col-md-2 col-sm-2 col-xs-12">
		                        <label class="control-label	" for="tempName">Template Name <span class="required">*</span>
		                        </label>
	                        </div>
	                        <div class="col-md-8 col-sm-8 col-xs-12">
	                      ...
	                      <div class="item form-group">
	                      <div class="col-md-2 col-sm-2 col-xs-12">
		                        <label class="control-label	" for="template">Template <span class="required">*</span>
		                        </label>
	                        </div>
	                        <div class="col-md-8 col-sm-8 col-xs-12">
