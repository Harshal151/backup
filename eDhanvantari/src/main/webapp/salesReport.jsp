...
<html lang="en">
  <head>
    ...
    <title>Sale Report | E-Dhanvantari</title>
                    ...
                    <div class="row">
                     ...
                     <div class="row" style="margin: 0 15px 0 15px;">
                        <div class="col-md-4 col-sm-4 col-xs-6">
                         <font><b>Enter Product Name</b></font>
                         <input type="text" name="searchPatientName" id="searchNameID" class="form-control" placeholder="Enter product name to search">
                       </div>
