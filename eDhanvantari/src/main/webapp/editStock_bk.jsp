...
<html lang="en">
  <head>
    ...
    <title>Edit Stock | E-Dhanvantari</title>
    ...
    <script type="text/javascript">
      function windowOpen(){
        ...
        document.location="editStockList.jsp";
      }
    </script>
	...
	<script type="text/javascript" charset="UTF-8">
		...
		function retrieveProductListByClinicID(clinicID){
			if(clinicID == "-1"){
				...
				retrieveProductListByClinicID1(clinicID);
			}
		}
		...
		function retrieveProductListByClinicID1(clinicID) {
    ...
    <script type="text/javascript">
	    ...
	    document.addEventListener('DOMContentLoaded', function() {
	    	$('input[name="clinicID"]').val(
			    $("#clinicList_id option:selected").val()
			);
	     });
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
                   ...
                   <div>
		             ...
		             <form action="EditStockReceipt" class="form-horizontal" onsubmit="return showLoadingImg();" method="POST">                     
                     
                     <s:iterator value="stockList" var="stockForm">
                     
                     <input type="hidden" name="stockReceiptID" value="<s:property value="stockReceiptID"/>" id="stockReceiptID">
                     ...
                     <div class="row">
                     	...
                     	<div class="col-md-4 col-xs-6"">
                     		 <input type="text" name="receiptDate" readonly="readonly" class="form-control" value="<s:property value="receiptDate"/>">
                     	</div>
                     	<div class="col-md-2 col-xs-7">
                     		<font style="font-size: 16px;">Receipt No</font>
                     	</div>
                     	<div class="col-md-4 col-xs-6" >
                     		<input  class="form-control" name="receiptNo"  placeholder="Receipt No" value="<s:property value="receiptNo"/>" readonly="readonly" type="text">
                     	</div>
                     ...
                     <div class="row" style="margin-top:15px;">
                     	...
                     	<div class="col-md-3 col-xs-6">
                     		<input type="text" class="form-control" readonly="readonly" name="name" value="<s:property value="name"/>">
                     		<input type="hidden" name="supplierID" value="<s:property value="supplierID"/>" id="supplierID">
                     	</div>
                     	...
                     	<div class="col-md-4 col-xs-6">
                     		<input  class="form-control" readonly="readonly" value="<s:property value="mobile"/>" name="mobile" id="customerMobileID" placeholder="Mobile" type="text"  onKeyPress="if(this.value.length==10) return false;" aria-describedby="inputGroupSuccess1Status">
                     	</div>
                     ...
                     <div class="row" style="margin-top:15px;">
                     	...
                     	<div class="col-md-4 col-xs-6">
                     		<input  class="form-control" readonly="readonly" value="<s:property value="agency"/>" name="agency" id="customerAgencyID" placeholder="Agency" type="text">
                     	</div>
                     	<div class="col-md-2 col-xs-6">
                     		<font style="font-size: 16px;">VAT Number</font>
                     	</div>
                     	<div class="col-md-4 col-xs-6">
                     		<input  class="form-control" readonly="readonly" value="<s:property value="vatNumber"/>" name="vatNumber" id="customerVATNoID" placeholder="VAT Number" type="text">
                     	</div>
                     ...
                     <div class="row" style="margin-top:15px;">
                     	...
                     	<div class="col-md-4 col-xs-6">
                     	    <textarea rows="3" class="form-control" readonly="readonly" name="address"  class="form-control" id="customerAddressID" placeholder="Address"><s:property value="address"/></textarea>
                     	</div>
                     	<div class="col-md-2 col-xs-6">
                     		<font style="font-size: 16px;">Clinic</font>
                     	</div>
                     	<div class="col-md-4 col-xs-6">
                     		<s:select list="clinicList" headerKey="-1" headerValue="Select Clinic" id="clinicList_id" class="form-control" name="clinicID" onchange="retrieveProductListByClinicID(this.value);" disabled="true"></s:select>
                     		<s:hidden name="clinicID" />
						</div>
                      ...
                      <tbody>                       	
                        	...
                        	<tr id="compTRID">
									...
									<td id="productTDID"><select class="form-control" name="productCompID1" id="productID" onchange="getProductRate(productID.value);">
											<option value="000">Select Product</option>
											<%
									...
									<td><input  class="form-control" name="barcode1" id="barcodeID"  placeholder="Barcode" type="text"></td>
									
									<td><input  class="form-control" name="" id="expiryDateID"  placeholder="Expiry Date" type="text"></td>
									
									<td><input  class="form-control" name="cp" id="costPriceID" placeholder="Cost Price" onkeyup="QntyCheck(productQuantityID.value, costPriceID.value);" type="number"></td>
									
									<td><input  class="form-control" name="sp" id="sellingPriceID" placeholder="Selling Price" type="number"></td>
									
									<td><input type="radio" name="taxIncl" id="taxInclYesID" value="0">&nbsp;Yes<br>
									...
									<td><input type="number" name="" id="productTaxPercentID"  placeholder="Tax Percent" class="form-control"></td>
									
									<td><input  class="form-control" name="productQuantity1" id="productQuantityID" placeholder="Quantity" onkeyup="QntyCheck(productQuantityID.value, costPriceID.value);" value="1" onfocus="this.value='0'" onblur="this.value" type="number"></td>
									
									<td><input  class="form-control" name="productAmount1" id="productAmountID" placeholder="Amount" readonly="readonly" type="number"></td>
                        	...
                        	<s:iterator value="productList" var="productForm">
                      			
                      			<tr style="font-size: 14px;" id="prodTRID<s:property value="stockID" />">
                      			
                      				<td><s:property value="productName"/></td>
                      				
                      				<td><s:property value="productBarcode"/></td>
                      				...
                      				<td><s:property value="taxInclusiveName"/></td>
                      				
                      				<td><s:property value="taxName"/></td>
                      				
                      				<td><s:property value="taxPercent"/></td>
									 ...
									 onclick="deleteRow(<s:property value="stockID" />,<s:property value="amount" />,<s:property value="productID" />,<s:property value="receiptID" />, <s:property value="productVAT" />);" 
                        	...
                        	<tr>
                        		...
                        		<td colspan="2">
                        			<input  class="form-control" name="productTotalAmount" value="<s:property value="productTotalAmount"/>" id="productTotalAmountID" placeholder="Total Value of Stock Added" readonly="readonly" type="number">
                        		</td>
                        	...
                        	<tr>
                        		...
                        		<td colspan="2">
                        			<input  class="form-control" name="productAdvancePaymentAmt" value="<s:property value="productAdvancePaymentAmt"/>" id="productAdvancePaymentAmtID" placeholder="Advance Payment" onkeyup="actualPaymentAmtChange(productAdvancePaymentAmtID.value, productTotalAmountID.value);" type="number" step="0.01">
                        		</td>
                        	...
                        	<tr>
                        		...
                        		<td colspan="2">
                        			<input  class="form-control" name="productBalancePaymentAmt" value="<s:property value="productBalancePaymentAmt"/>" id="productBalancePaymentAmtID" readonly="readonly" placeholder="Balance Payment" type="number">
                        		</td>
                        	...
                        	<tr>
                        		...
                        		<td colspan="9" align="right" style="font-size: 14px;padding-top:15px;">Total VAT on Stock Added</td>
                        		
                        		<td colspan="2">
                        			<input  class="form-control" name="productVAT" id="productVATID" value="<s:property value="productVAT"/>" readonly="readonly" placeholder="Total VAT on Stock Added" type="number">
                        		</td>
                    ...
                    <div class="row" style="margin-top:15px;">
                    	...
                    	<div class="col-md-3 col-xs-2">
                    		<font style="font-size: 16px;"><b><s:property value=""/> </b></font>
                    	</div>
                     ...
                     <div class="row col-xs-12">
                    	...
                    	<div class="col-md-3">
                    		<button id="send" style="width:100%;" type="submit" name="addReceiptButton" value="Add" class="btn btn-success " >Update Stock</button>
                    	</div>
                    	<!-- <div class="col-md-2">
