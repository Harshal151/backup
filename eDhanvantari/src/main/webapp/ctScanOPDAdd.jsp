			     ...
			     <div class="tab-pane fade" id="selectReport">
	                ...
	                <div class="row" style="margin-top:15px;">
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"  >
							 <table border="1" width="98%">
							    	<tr>
							    		...
							    		<td colspan="2"> <input type="text" style="border:none;cursor:not-allowed;background: transparent;"  class="form-control" readonly="readonly" value="<s:property value="lastName"/> <s:property value="firstName"/> <s:property value="middleName"/>"  name="" id="patientName" placeholder="Patient Name" autofocus=""></td>
							    		<td colspan="1" style="padding-left:10px;font-size:14px; font-weight: bold;"> Date of first visit: </td>
							    		<td colspan="1" style="padding-left:10px;font-size:14px;"> <input type="text" class="form-control" name="visitDate" id="visitDate" style="border:none;cursor:not-allowed;background: transparent;" readonly="readonly" value="<%=currentDate%>" aria-describedby="inputSuccess2Status3"> </td>
							    	</tr>
							    			
							    	<tr>
							    		<td style="padding-left:10px;font-size:14px; font-weight: bold;">Age: </td>
							    		<td>
							    			<input type="number" style="border:none;background: transparent;cursor:not-allowed;" readonly="readonly" class="form-control" name="age" id = "age" value="<s:property value="age"/>" placeholder="Age" autofocus=""> 
							    		</td>
				        ...
				        <div class="row" style="padding-top: 30px;" align="center">
				        	...
				        	<s:if test="%{getVisitID() == 0}">
				        		<button class="btn btn-warning" type="submit" id="" name="addButton" value="">Save</button>
				        		<button class="btn btn-warning" type="submit" id="PrintReportID" name="addButton" value="print">Save & Print</button>
				        	</s:if>
				        	<s:else>
				        		<button class="btn btn-warning" type="submit" id="" name="addButton" value="">Update</button>
				        		<button class="btn btn-warning" type="submit" id="PrintReportID" name="addButton" value="print">Update & Print</button>
				        	</s:else>
