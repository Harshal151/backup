...
<html lang="en">
  <head>
    ...
    <title>Manage Template | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchTemplate" method="POST" onsubmit="return showLoadingImg();">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search Template by name" name=searchTemplate>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active" >Search Template</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="ViewAllTemplates"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Template</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="TemplateList" var="TemplateForm">
		                        	<tr>
								
											<td><s:property value="TempReportType" /></td>
											
											<td><s:property value="TempName" /></td>
												 
											<td align="center"><s:url id="approveURL"
												action="RenderEditTemplate">
												<s:param name="TemplateID" value="%{TemplateID}" />
												<s:param name="searchTemplate" value="%{searchTemplate}" />
											</s:url> <s:a href="%{approveURL}">
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Template"
													title="Edit Template" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<s:url id="disableUserURL" action="DeleteTemplate">
												<s:param name="TemplateTextID" value="%{TemplateID}" />
												<s:param name="searchTemplate" value="%{searchTemplate}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete Template"
                    ...
                    %>
		              ...
		              %>
		              	...
		              	<form class="form-horizontal form-label-left" rows="5" novalidate action="AddTemplate" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;margin-left:10px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Report">Report Type <span class="required">*</span>
	                        </label>
	                        <div class="col-md-8 col-sm-8 col-xs-12">
	                          <input type="text" name="TempReportType" required="required" value="" placeholder="report Type" class="form-control">
	                        </div>
	                      </div>
	 
	                       <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="TempName">Name<span class="required">*</span>
	                        </label>
	                        <div class="col-md-8 col-sm-8 col-xs-12">
	                          <input type="text" name="TempName" required="required" placeholder="Template Name" class="form-control">
	                        </div>
	                      </div>
	                       <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Template">Template<span class="required">*</span>
	                        </label>
	                        <div class="col-md-8 col-sm-8 col-xs-12">
	                  ...
	                  <%
		              	...
		              	{
		              		System.out.println("Else loopp");
	                  %>
	                     
	                  
	                  <form class="form-horizontal form-label-left" novalidate action="EditTemplate" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;"> 
						  
						   <s:iterator value="editTemplateList" var="TemplatesForm">
						  
						  <input type="hidden" name="TemplateID" value="<s:property value="TemplateID" />" >
						  <input type="hidden" name="searchTemplate" value="<s:property value="searchTemplate" />" >
						  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Report">Report Type<span class="required">*</span>
	                        </label>
	                        <div class="col-md-8 col-sm-8 col-xs-12">
	                          <input type="text" name="TempReportType" required="required" value="<s:property value="TempReportType" />" placeholder="report type" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <label class="control-label col-md-4 col-sm-4 col-xs-12" for="TempName">Name<span class="required">*</span>
	                        ...
	                        <div class="col-md-8 col-sm-8 col-xs-12">
	                          <input type="text" name="TempName" required="required" value="<s:property value="TempName" />" placeholder="Template Name" class="form-control">
	                        </div>
	                      <br>
	                      <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Template">Template<span class="required">*</span>
	                        </label>
	                        <div class="col-md-8 col-sm-8 col-xs-12">
	                        <s:textarea row="5" name="Template" id="editor" class="form-control" placeholder="Address"></s:textarea>
