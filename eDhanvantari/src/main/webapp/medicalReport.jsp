...
<html lang="en">
  <head>
    ...
    <title>Medical Report | E-Dhanvantari</title>
	...
	<%
		...
		String showMedNoteModal = (String) request.getAttribute("showMedNoteModal");
	
		//Data show msg
		String noVisitMsg = (String) request.getAttribute("noVisitMsg");
		
		//PDF fail msg
		String pdfFailMsg = (String) request.getAttribute("pdfFailMsg");
		
		if(pdfFailMsg == null || pdfFailMsg == ""){
			pdfFailMsg = "";
		}
		
		if(noVisitMsg == null || noVisitMsg == ""){
			noVisitMsg = "";
		}
	...
	<%
		...
		if(showMedNoteModal == null || showMedNoteModal == ""){
			
			showMedNoteModal = "nothing";
			
		}else{
	%>
	
	<!-- To show medical notes modal -->
	     ...
	     document.addEventListener('DOMContentLoaded', function() {
		    $("#upClick").on("click" ,function(){
		     scrolled=scrolled-10000;
		        $("#billingModal").animate({
		          scrollTop:  scrolled
		     });
		        $("#medicalNotesModal").animate({
		            scrollTop:  scrolled
		       });
		    });
	  	 });
  ...
  <!-- Billing Modal Starts -->
	...
	<div id="billingModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
	     <div class="modal-dialog modal-lg" >
	      <div class="modal-content" style="overflow:auto;height:600px; " >
	
	        <div style="padding:20px;">
	          <center><h2>BILLING REPORTS</h2></center>
	        </div >
	        ...
	        <div  style="margin:0px;">
	        	...
	        	<%
	        		if(showModal.equals("show")){
	        	%>
	        	
	        	<div class="">
					<center>
						<font style="color: red; padding: 15px;font-size:18px;"><%=pdfFailMsg %></font>
					</center>
	            </div>
	        	...
	        	<div class="">
	                <div class="">
	                	...
	                	<table id="datatable-responsive1" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
	                      ...
	                      <tbody>
	                        <s:iterator value="medicalBillingList" var="UserForm">
	                        	<tr>
	                        			<td><s:property value="visitNumber" /></td>
							
										<td><s:property value="careType" /></td>
										...
										<td align="center"><s:url id="approveURL"
											...
											<img src="images/print.png" style="height:24px;" onmouseover="this.src='images/print1.png'"
												onmouseout="this.src='images/print.png'" alt="Print Report"
												title="Print Report" />
										</s:a>
										</td>
	                        	</tr>
	            ...
	            <div class="" style="padding: 20px;">
					<center>
						<font style="color: red; margin-bottom: 10px;font-size:18px;"><%=noVisitMsg %></font>
					</center>
	            </div>
	       ...
	       <center>
	        ...
	        <button id="upClick" class="btn" disabled="disabled" style="background:white;"></button>
	...
	<!-- Medical notes Modal Starts -->
	
	<div id="medicalNotesModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
	     <div class="modal-dialog modal-lg" >
	      <div class="modal-content" style="overflow:auto;height:600px; " >
	
	        <div style="padding:20px;">
	          <center><h2>MEDICAL NOTES</h2></center>
	        </div >
	        ...
	        <div style="margin:0px;">
	        	...
	        	<%
	        		if(showMedNoteModal.equals("show")){
	        	%>
	                      ...
	                      <tbody>
	                        <s:iterator value="medicalBillingList" var="UserForm">
	                        	<tr>
										...
										<td align="center"><s:url id="approveURL"
											action="PrintMedicalNotesReport">
											<s:param name="visitID" value="%{visitID}" />
											<s:param name="patientID" value="%{patientID}" />
											<s:param name="patientName" value="%{patientName}" />
										</s:url> <s:a href="%{approveURL}">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                      <div class="title_left">
                        <h3>MEDICAL REPORT (PATIENT LIST)</h3>
                      </div>
                    </div>
                    ...
                    <div class="row">
                     <form action="SearchPatientMedicalReport" method="POST" onsubmit="return showLoadingImg();">
                       <div class="col-md-4 col-sm-4 col-xs-6">
                         <input type="text" name="patientName" class="form-control" placeholder="Search Patient By Patient Name" required="required">
                       </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <button type="submit" class="btn btn-success active"  style="width:100%;" >Search Patient</button>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <a href="RenderViewMedicalPatientList"> <button type="button" class="btn btn-primary"  style="width:100%;" onclick="showLoadingImg();">View All Patients</button></a>
                        </div>
                      </form>
                     </div>
                  ...
                  <div class="x_content">
		              ...
		              <%
							if(patientCheck.equals("Patient")){
					  %>
	                      ...
	                      <tbody>
	                        <s:iterator value="patientList" var="UserForm">
	                        	<tr>
										...
										<td align="center"><s:url id="approveURL"
											action="RenderMedicalBilling">
											<s:param name="patientID" value="%{patientID}" />
											<s:param name="patientName" value="%{patientName}" />
										</s:url> <s:a href="%{approveURL}">
											<img src="images/billing1.png" style="height:24px;" onmouseover="this.src='images/billing.png'"
												onmouseout="this.src='images/billing1.png'" alt="Billing Report"
												title="Billing Report" />
										</s:a>
										&nbsp;
										<s:url id="approveURL1"
											action="RenderMedicalNotes">
											<s:param name="patientID" value="%{patientID}" />
											<s:param name="patientName" value="%{patientName}" />
										</s:url> <s:a href="%{approveURL1}">
											<img src="images/presc1.png" style="height:24px;" onmouseover="this.src='images/presc.png'"
												onmouseout="this.src='images/presc1.png'" alt="Medical Note"
												title="Medical Note" />
										</s:a>&nbsp;
										<s:url id="approveURL2"
											action="PrintMedicalHistory">
											<s:param name="patientID" value="%{patientID}" />
											<s:param name="patientName" value="%{patientName}" />
										</s:url> <s:a href="%{approveURL2}">
											<img src="images/history.png"
												onmouseover="this.src='images/history1.png'"
												onmouseout="this.src='images/history.png'" style="height:24px;" alt="Medical History"
