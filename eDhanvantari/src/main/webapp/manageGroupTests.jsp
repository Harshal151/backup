...
<html lang="en">
  <head>
    ...
    <title>Manage Group Test | E-Dhanvantari</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                  ...
                  <div class="x_content">
		              ...
		              <div class="row">
		              	<div class="col-md-12 col-sm-12 col-xs-12">
		              		<form action="SearchGroupTest" method="POST" onsubmit="return showLoadingImg();">
				              	<div class="col-md-4 col-sm-4 col-xs-6">
				              		<input type="text" class="form-control" required="required" placeholder="Search Group Test" name="searchTest">
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-6">
				              		<button style="width:100%;" type="submit" class="btn btn-success active" >Search Group Test</button>
				              	</div>
				              	<div class="col-md-2 col-sm-3 col-xs-4">
				              		<a href="viewAllGroupTests"> <button type="button" class="btn btn-primary " onclick="showLoadingImg();">View All Group Test</button></a>
				              	</div>
				            </form>
		              	</div>
		              </div>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
			            ...
			            <div class="row" style="margin-top:30px;">
				            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
		                      ...
		                      <tbody>
		                        <s:iterator value="retriveAllGroupTests" var="groupTest">
		                        	<tr>
								
											<td><s:property value="groupName" /></td>
											
											<td><s:property value="labTest" /></td>
												 
											<td><s:property value="groupRate" /></td>
											
											<%-- <td><s:property value="groupRemark" /></td> --%>
											
											<td align="center"><s:url id="approveURL"
												action="RenderEditGroupTest">
												<s:param name="groupID" value="%{groupID}" />
												<s:param name="searchTest" value="%{searchTest}" />
											</s:url> <s:a href="%{approveURL}">
												<img src="images/user_1.png" style="height:24px;" onmouseover="this.src='images/user_2.png'"
													onmouseout="this.src='images/user_1.png'" alt="Edit Group Test"
													title="Edit Instruction" />
											</s:a>&nbsp;&nbsp;&nbsp;&nbsp;
											<%-- <s:url id="disableUserURL" action="DeleteInstruction">
												<s:param name="instructionID" value="%{instructionID}" />
												<s:param name="searchInstructionName" value="%{searchInstructionName}" />
												...
												<img src="images/delete_icon_1.png" style="height:20px;" onmouseover="this.src='images/delete_icon_2.png'"
													onmouseout="this.src='images/delete_icon_1.png'" alt="Delete Instruction"
                    ...
                    %>
		              ...
		              <script>
		              	...
		              	<form class="form-horizontal form-label-left" novalidate action="ConfigureGroupTest" method="POST" style="margin-top:20px;">
	
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="GroupName">Group Name <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="groupName" required="required" placeholder="Group Name" class="form-control">
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="groupRate">Group Rate <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="groupRate" required="required" placeholder="Group Rate" class="form-control">
	                        </div>
	                      </div>
	                 
	                 	 <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Select Test">Select Lab Test<span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <s:select list="labTests" id="labTest" name="labTest" class="form-control" ></s:select>
	                        </div>
	                      </div>
	                      
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Select Test">Group Remark </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                         <textarea class="form-control" id="groupRemark" name="groupRemark" rows="5" cols="200" placeholder="Group Remark" style="width: 100%;"></textarea>
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditGroupTest" method="POST" onsubmit="return submitForm(categoryID.value);" style="margin-top:20px;">
						  
						   <s:iterator value="groupTestList" var="concessionForm">
						  
						  <input type="hidden" name="groupID" value="<s:property value="groupID" />" >
						  <input type="hidden" name="labTest" value="<s:property value="labTest" />" >
						  
						  <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="GroupName">Group Name <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="groupName" required="required" value="<s:property value="groupName" />" placeholder="Group Name" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="number" name="groupRate" required="required" value="<s:property value="groupRate" />" placeholder="Group Rate" class="form-control">
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <s:select list="labTests" id="labTest" name="labTest" class="form-control" headerValue = "" headerKey = ""></s:select>
	                        </div>
	                      </div>
	                      ...
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="Select Test">Group Remark</label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                         <textarea class="form-control" id="groupRemark" name="groupRemark" value="<s:property value="groupRemark" />" rows="5" cols="200" placeholder="Group Remark" style="width: 100%;"><s:property value="groupRemark" /></textarea>
	                        </div>
	                      </div>
