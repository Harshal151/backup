...
<html lang="en">
  <head>
    ...
    <title>Login | E-Dhanvantari</title>
    ...
    <%-- <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4619436455442639"
     crossorigin="anonymous"></script>
	<!-- AdStrip -->
	<ins class="adsbygoogle"
	     style="display:block"
	     data-ad-client="ca-pub-4619436455442639"
	     data-ad-slot="6912827169"
	     data-ad-format="auto"
...
<%
    ...
    String version = configUtil.getVersion(realPath+File.separator);
%>
 <script type="text/javascript">
 	<%
 		if(sessionTimeoutMessage.trim() != ""){
 	%>
    ...
    <div>
      ...
      <div class="container">
        ...
        <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12"  align="center" style="padding-top: 0px;">
        	...
        	<!-- <a href="http://www.edhanvantari.com" style="text-decoration: underline;" target="_blank"><img alt="eDhanvantari Logo" src="images/Text.png" style="margin-top:5%; " class="img-responsive"></a> -->
        <%-- <h2 style=" text-align:  center; padding-bottom: 0px; padding-top: 20px;margin-bottom: 0;margin-top:0;">eDhanvantari <%=version %></h2> --%>
        <%-- <sub><b>CLINIC AT YOUR FINGERTIPS!!</b></sub> --%>
       
          <section class="login_content" style="padding-top:0px;margin-top:0px;max-width: 75%;">
            <form action="Login" method="POST">
              <h4 style="color:#107B95; font-size:30px;"><b></b>Login </h4> 
