		              ...
		              <div class="col-md-3"><label for="User Type" style="font-size: 15px; padding-left: 10px; padding-top: 15px;">Current Medication</label></div>
		                 ...
		                 <div class="col-md-10  col-sm-12 col-xs-8">
		                      ...
		                      <div class="col-xs-12 col-md-3 col-sm-3" style="margin-left:0%;">
		                          	...
		                          	<input type="number" style="width: 70%;" class="form-control" name="OEPulse" id="pulseID" onkeyup="myFunction1('diaSpanID',this.value)"  value="<s:property value="OEPulse"/>"  placeholder="Pulse">
