                    ...
                    %>
		              ...
		              %>
						...
						<div class="item form-group">
	                      ...
	                      <div class="item form-group">
	                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for=" VAT Number"> GSTIN <span class="required">*</span>
	                        </label>
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="vatNumber" required="required" placeholder="GSTIN" class="form-control">
	                        </div>
	                      </div>
	                  ...
	                  <form class="form-horizontal form-label-left" novalidate action="EditSupplier" onsubmit="return showLoadingImg();" method="POST" style="margin-top:20px;">
						...
						<div class="item form-group">
	                      ...
	                      <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input type="text" name="vatNumber" value="<s:property value="vatNumber" />" required="required" placeholder="GSTIN" class="form-control">
	                        </div>
	                      </div>
