									...
									<form class="form-horizontal form-label-left" action="AddPatientAppointment" name="apptFormID" onsubmit="submitApptForm();"
										...
										<s:iterator value="patientList" var="form">
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" name="DateOfBirth" placeholder="Date Of Birth" id = "single_cal3" value="<s:property value='dob'/>" class="form-control">
												</div>
											</div>
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="number" name="age" placeholder="Age"
														id="ageID" value="<s:property value='age'/>" class="form-control" required="required" readonly="readonly">
												</div>
											</div>
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" name="" readonly="readonly"
														value="<%=clinicRegNo%>" placeholder="Medical Registration No."
									...
									name="apptFormID" action="AddPatient" method="POST"
										...
										<s:iterator value="patientList" var="form">
											...
											<div class="item form-group">
												<label for="User Type" class="control-label col-md-3 col-sm-4">Age </label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="number" name="age" placeholder="Age" id="ageID" value="<s:property value='age'/>" required="required" class="form-control" readonly="readonly">
												</div>
											</div>
