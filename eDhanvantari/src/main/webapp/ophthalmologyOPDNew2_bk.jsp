              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="collapse" id="vision">
						    ...
						    <div class="row" style="margin-top:15px;">
						    	...
						    	<div class="col-md-4 col-sm-4 " align="left" > 
						    		...
						    		<div class="col-md-6">
						  				<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'No PL':'No PL', 'PL/PR':'PL/PR', 'Faulty PL':'Faulty PL', '1 mtr':'1 mtr', '2 mtr':'2 mtr', '3 mtr':'3 mtr', 'HM +ve':'HM +ve' }" name="visualAcuityNearOD"  class="form-control"   ></s:select>
						    		</div>
						    	...
						    	<div class="col-md-4 col-sm-4" align="left">
						    		...
						    		<div class="col-md-6">
						  				<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'No PL':'No PL', 'PL/PR':'PL/PR', 'Faulty PL':'Faulty PL', '1 mtr':'1 mtr', '2 mtr':'2 mtr', '3 mtr':'3 mtr', 'HM +ve':'HM +ve'}" name="visualAcuityNearOS"  class="form-control"   ></s:select>
						    		</div>
						    ...
						    <div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-4 col-sm-4" align="left" > 
								    ...
								    <div class="col-md-6">
									  	<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36'}" name="pinholeVisionNearOD"  class="form-control"   ></s:select>
						    		</div>
							    ...
							    <div class="col-md-4 col-sm-4" align="left">
							    	...
							    	<div class="col-md-6">
							  			<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36'}" name="pinholeVisionNearOS"  class="form-control" ></s:select>
							    	</div>
						    ...
						    <div class="row" style="margin-top:10px;">
						    	...
						    	<div class="col-md-4 col-sm-4" align="left" > 
						    		...
						    		<div class="col-md-6">
						  				<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'No improvement':'No improvement'}" name="BCVANearOD"  class="form-control" ></s:select>
						    		</div>
						    	...
						    	<div class="col-md-4 col-sm-4" align="left">
						    		...
						    		<div class="col-md-6">
						  				<s:select list="#{'--':'--','N6':'N6', 'N8':'N8', 'N10':'N10', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36', 'No improvement':'No improvement'}" name="BCVANearOS"  class="form-control"  ></s:select>
								    </div>
			    ...
			    <div class="row">
			    	...
			    	<div class="col-md-8" align="" > 
			    		<div class="col-md-12">
			      			<s:checkboxlist style="zoom: 1.5" cssStyle="zoom: 1.5" list="#{'CTC':'CTC','HTC':'HTC','Atropine':'Atropine','T Plus':'T Plus'}" name="cycloplegicRefraction" value="defaultCycloplegicRefraction" />
			    		</div>
			    ...
			    <div class="row">
			      ...
			      <div class="row col-xs-12">
			      	...
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', '6/6':'6/6', '6/9':'6/9', '6/12':'6/12', '6/18':'6/18', '6/24':'6/24', '6/36':'6/36', '6/60':'6/60'}" name="distTPlusOD" id="distTPlusOD" class="form-control"></s:select>
					</div>
			      	<div class="col-md-2" align="center" style="width: 11%;">
			      	...
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', '6/6':'6/6', '6/9':'6/9', '6/12':'6/12', '6/18':'6/18', '6/24':'6/24', '6/36':'6/36', '6/60':'6/60'}" name="distTPlusOS" id="distTPlusOS" class="form-control"></s:select>
					</div>
			      </div>
			      ...
			      <div class="row col-xs-12" style="margin-top:15px;">
			      	...
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', 'N6':'N6', 'N8':'N8', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36'}" name="nearTPlusOD" id="nearTPlusOD" class="form-control"   ></s:select>
					</div>
			      	<div class="col-md-2" align="center" style="width: 11%;">
			      	...
			      	<div class="col-md-1" align="center" style="width: 9%;">
						<s:select list="#{'--':'--', 'N6':'N6', 'N8':'N8', 'N12':'N12', 'N18':'N18', 'N24':'N24', 'N36':'N36'}" name="nearTPlusOS" id="nearTPlusOS" class="form-control"   ></s:select>
					</div>
			      </div>
