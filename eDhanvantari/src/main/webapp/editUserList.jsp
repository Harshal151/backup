...
<html lang="en">
  <head>
    ...
    <title>Edit User List | E-Dhanvantari</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="page-title">
                    ...
                    <div class="row">
                     <form action="SearchUser" method="POST" onsubmit="return showLoadingImg();">
                       <div class="col-md-4 col-sm-4 col-xs-6">
                         <input type="text" name="searchUserName" class="form-control" placeholder="Search User" required="required">
                       </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <button type="submit" class="btn btn-success active" >Search User</button>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-6">
                          <a href="RenderEditUserList"> <button type="button" class="btn btn-primary"  onclick="showLoadingImg();">View All Users</button></a>
                        </div>
                      </form>
                     </div>
