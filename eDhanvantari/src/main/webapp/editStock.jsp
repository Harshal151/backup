                  ...
                  <div class="x_content">
                   ...
                   <div>
                     ...
                     <div class="row" style="margin-top:15px;">
                     	...
                     	<div class="col-md-4 col-xs-6">
                     		<input  class="form-control" readonly="readonly" value="<s:property value="vatNumber"/>" name="vatNumber" id="customerVATNoID" placeholder="GSTIN" type="text">
                     	</div>
                     ...
                     <div class="row" style="margin-top:15px;">
                      ...
                      <tbody>                       	
                        	...
                        	<tr>
                        		...
                        		<td colspan="2">
                        			<input  class="form-control" name="productVAT" id="productVATID" value="<s:property value="productVAT"/>" readonly="readonly" placeholder="Total GST on Stock Added" type="number">
                        		</td>
