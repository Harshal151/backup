...
/**
 * Servlet implementation class ApptCalendarJSONServlet
 */
public class ApptCalendarJSONServlet extends HttpServlet {
	 ...
	 */
	public ApptCalendarJSONServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		 ...
		 */
		LoginForm userForm = (LoginForm) session.getAttribute("USER");
